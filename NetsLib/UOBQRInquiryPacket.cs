...
namespace PowerPOS.Nets
{
    ...
    /// </summary>
    class UOBQRInquiryPacket : Packet
    {
        private string debitAmount = "0";
        private string refno = "";
        private string uniqueNo = "";
        private string qrtype = NETSConstants.MessageHeader.QRMPMType.WECHAT;

        public UOBQRInquiryPacket()
        {
            init();
        }
        ...
        {
            string FunctionCode = NETSConstants.MessageHeader.FunctionCode.QRCODE_INQUIRY;
            ...
            */
            ...
            byte[] packet = generateFullPacket(content);
