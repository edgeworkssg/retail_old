...
namespace PowerPOS.Nets
{
    ...
    /// </summary>
    class NETSSwitchPrepaidBackPacket : Packet
    {
        ...
        public NETSSwitchPrepaidBackPacket()
        {
            init();
        }
        ...
        public override byte[] toBytes()
        {
            ...
            byte[] content = generateMessageHeader(NETSConstants.MessageHeader.FunctionCode.SWITCH_TO_NETS);
