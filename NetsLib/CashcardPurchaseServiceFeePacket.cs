...
namespace PowerPOS.Nets
{
    ...
    /// </summary>
    class CashcardPurchaseServiceFeePacket : Packet
    {
        private string debitAmount = "0";
        private string refno = "";

        public CashcardPurchaseServiceFeePacket()
        {
            init();
        }
        ...
        {
            byte[] content = generateMessageHeader(NETSConstants.MessageHeader.FunctionCode.CASHCARD_PURCHASE_WITH_SERVICE_FEE);
            ...
            #region Message Data 2 (ECR Reference Number H4)
            idx = 0; //reset idx
