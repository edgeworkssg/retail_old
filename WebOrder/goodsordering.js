...
$(function() {
    ...
    function GoodsOrderingViewModel(locations) {
        ...
        self.potypeDropdown = ["Replenish", "Back Order"];
        ...
        self.print = function(PurchaseOrderHeaderRefNo) {
            //debugger;
            var urlReport = settings.crReportLocation + "?r=OrderPrintout.rpt&ut=" + sessionStorage.userToken + "&showfilter=false&HideTopBannerMenu=true&DocNo=" + PurchaseOrderHeaderRefNo + "&UserName=" + sessionStorage.username;
