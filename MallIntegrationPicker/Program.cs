...
using MallIntegrationPicker.Properties;
using PowerPOS;
using System.IO;
using System.Data;
...
namespace MallIntegrationPicker
{
    ...
    public class AppContext : ApplicationContext
    {
        ...
        public AppContext()
        {
            ...
            trayIcon.BalloonTipText = "Starting Edgeworks Mall Integration Picker application";
                        ...
                        foreach (string path in files)
                        {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    msService.Url = Properties.Settings.Default.WS_URL + "/Synchronization/MallIntegration.asmx";
