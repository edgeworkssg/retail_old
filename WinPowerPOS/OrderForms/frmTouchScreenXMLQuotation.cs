...
{
    public partial class frmTouchScreenXMLQuotation : Form
    {
        TouchScreenHotKeysController MasterControl;
        public QuoteController pos;
        private DateTime startTime;
        //public bool IsEditMode = false;
        public frmTouchScreenXMLQuotation(QuoteController inPos)
        {
            InitializeComponent();
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            string Value = ((Button)sender).Tag.ToString();
                ...
                else
                {
                    ...
                    if (!pos.AddItemToOrder(new Item(((Button)sender).Tag.ToString()), 1, 0.00M, false, out status))
                    {
                    ...
                    else
                    {
                        ...
                        QuotationDet myDet = pos.myOrderDet[index];
