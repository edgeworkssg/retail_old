namespace WinPowerPOS.OrderForms
{
    partial class frmAddMember
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlAddItems.Controls.Add(this.labelTotalNewCreatedMembers);
            this.pnlAddItems.Controls.Add(this.label2);
            this.pnlAddItems.Controls.Add(this.labelTotalDownloadedMembers);
            this.pnlAddItems.Controls.Add(this.labelProgressBarSyncMembership);
            this.pnlAddItems.Controls.Add(this.txtSearch);
            this.pnlAddItems.Controls.Add(this.btnSearch);
            this.pnlAddItems.Controls.Add(this.progressBarSyncMembership);
