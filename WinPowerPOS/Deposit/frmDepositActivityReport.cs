...
{
    public partial class frmDepositActivityReport : Form
    {
        public frmDepositActivityReport()
        {
            InitializeComponent();
        ...
        private void btnName_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt
             = MembershipTapController.FetchMembershipTapLogReport("", "", txtSearch.Text, "activitydate", "desc");             
