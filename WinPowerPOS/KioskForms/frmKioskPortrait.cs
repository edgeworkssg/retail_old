...
{
    public partial class frmKioskPortrait : Form
    {
        POSController pos;
        ...
        public frmKioskPortrait()
        {
            ...
            btnCancelAll.OnClicked += new WinPowerPOS.KioskForms.CancelAllButton.OnClickEventHandler(btnCancelAll_OnClicked);
            btnFinishAndPay.OnClicked += new WinPowerPOS.KioskForms.FinishAndPayButton.OnClickEventHandler(btnFinishAndPay_OnClicked);
            lvOrders.KeyDown += new System.Windows.Input.KeyEventHandler(lvOrders_OnKeyDown);
        }        
        ...
        private void Form1_Resize(object sender, EventArgs e)
        {
            ...
            panel6.Width = Width;
            pnlCancelAll.Width = panel6.Width / 2;
            pnlFinishAll.Width = panel6.Width / 2;


            label1.Left = (pnlBottom.Width - label1.Width) / 2;
            pictureBox2.Left = (pnlBottom.Width - pictureBox2.Width) / 2;

            //pnlBottom.Width = Width;
            //pnlWeight.Width = pnlGroup2.Width / 2;

            pnlBanner.Width = pnlBottom.Width;

            if (pictureBox1.Image != null)
            {
                pictureBox1.Left = (pnlBottom.Width - pictureBox1.Image.Width) / 2;
            }

            pnlTopScanPack.Width = Width;
            pnlWeightKeyCode.Width = (int)(pnlTopScanPack.Width * 0.3);
            panel3.Width = (int)(pnlTopScanPack.Width * 0.7);

            if (pictureBox2.Image != null)
            {
                pictureBox2.Left = 0;
                pictureBox2.Width = panel3.Width;
            }

            panel5.Width = pnlBottom.Width;
            panel6.Width = pnlBottom.Width;
        }
