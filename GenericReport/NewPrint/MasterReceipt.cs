...
namespace GenericReport.NewPrint {
    ...
    public class MasterReceipt : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.MasterReceipt.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMasterReceipt : Component, ICachedReport {
        
        public CachedMasterReceipt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MasterReceipt rpt = new MasterReceipt();
            rpt.Site = this.Site;
            return rpt;
        }
