...
namespace GenericReport.NewPrint {
    ...
    public class Closing : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.Closing.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedClosing : Component, ICachedReport {
        
        public CachedClosing() {
        }
