...
namespace GenericReport.NewPrint.CustomerTemplate {
    ...
    public class Tanglin : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.CustomerTemplate.Tanglin.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTanglin : Component, ICachedReport {
        
        public CachedTanglin() {
        }
