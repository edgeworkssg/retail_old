...
namespace GenericReport.NewPrint.CustomerTemplate {
    ...
    public class Liberty : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.CustomerTemplate.Liberty.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLiberty : Component, ICachedReport {
        
        public CachedLiberty() {
        }
