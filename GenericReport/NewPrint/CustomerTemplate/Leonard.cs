...
namespace GenericReport.NewPrint.CustomerTemplate {
    ...
    public class Leonard : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.CustomerTemplate.Leonard.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLeonard : Component, ICachedReport {
        
        public CachedLeonard() {
        }
