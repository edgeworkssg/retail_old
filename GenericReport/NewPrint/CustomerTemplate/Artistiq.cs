...
namespace GenericReport.NewPrint.CustomerTemplate {
    ...
    public class Artistiq : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.CustomerTemplate.Artistiq.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedArtistiq : Component, ICachedReport {
        
        public CachedArtistiq() {
        }
