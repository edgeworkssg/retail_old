...
namespace GenericReport.NewPrint {
    ...
    public class Cargloss_A4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GenericReport.NewPrint.Cargloss_A4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCargloss_A4 : Component, ICachedReport {
        
        public CachedCargloss_A4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Cargloss_A4 rpt = new Cargloss_A4();
            rpt.Site = this.Site;
            return rpt;
        }
