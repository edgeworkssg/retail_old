...
namespace CitiLib
{
    ...
    class Utilities
    {
        ...
        public static string bytesArrayToHex(byte[] data)
        {
            ...
            {
                Logger.writeLog("Error Parsing From Byte To Hex " + ex.ToString());
            }
        ...
        public static string bytesArrayToASCIIString(byte[] data)
        {
            ...
            {
                Logger.writeLog("Error Parsing From Byte To Ascii " + ex.ToString());
            }
        ...
        public static int bytesBCDToInt(byte[] data)
        {
            ...
            {
                Logger.writeLog("Error Parsing From Bytes To Int " + ex.ToString());
        ...
        public static byte[] hexStrToBytesArray(string hexStr)
        {
            ...
            {
                Logger.writeLog("Error Parsing From Hex To Bytes Array " + ex.ToString());
            }
        ...
        public static string stringToCurrencyFormat(string str)
        {
            ...
            {
                Logger.writeLog("Error Parsing From string To Currency " + ex.ToString());
            }
