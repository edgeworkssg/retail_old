...
<%@ Page Language="C#" Title="EZLinkResponseCode Scaffold" Inherits="PowerPOS.EZLinkResponseCodeScaffold" MasterPageFile="~/PowerPOSMSt.master" Theme="default" Codebehind="EZLinkResponseCodeScaffold.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">
	
	<h2>EZLinkResponseCode</h2>
    ...
    DataKeyNames="ResponseCode" 
    PageSize="50"
    >
        <Columns>
	            <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="ResponseCode" DataNavigateUrlFormatString="EZLinkResponseCodeScaffold.aspx?id={0}
" />
	            
	            <asp:BoundField DataField="ResponseMessage" HeaderText="Response Message" SortExpression="ResponseMessage"></asp:BoundField>
	...
	<a href="EZLinkResponseCodeScaffold.aspx?id=0">Add New...</a>
	</asp:Panel>
	...
	<table cellpadding="5" cellspacing="0" Width="600px">
		...
		<td ><asp:TextBox ID="ctrlResponseMessage" runat="server" MaxLength="250" ></asp:TextBox></td>
		</tr>
		...
		<tr>
			...
			<input type="button" onclick="location.href='EZLinkResponseCodeScaffold.aspx'" class="scaffoldButton" value="Return" />
