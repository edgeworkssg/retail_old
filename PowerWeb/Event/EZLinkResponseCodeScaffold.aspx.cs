...
namespace PowerPOS
{
	public partial class EZLinkResponseCodeScaffold : System.Web.UI.Page 
	{
		...
		void LoadEditor(string id) 
		{
			...
			if (!String.IsNullOrEmpty(id) && id != "0")
			{
				...
				//pull the record
				EZLinkResponseCode item = new EZLinkResponseCode(id);
				//bind the page 
					
							ctrlResponseMessage.Text = item.ResponseMessage;
		...
		{
			EZLinkResponseCode.Delete(Utility.GetParameter("id"));
			//redirect
		...
		void BindAndSave(string id) 
		{
			...
			EZLinkResponseCode item;
			if (!String.IsNullOrEmpty(id) && id != "0") 
			{
				//it's an edit
				item = new EZLinkResponseCode(id);
			}

			else 
			{
				//add
				item = new EZLinkResponseCode();
			}
  
	      
			
						object valctrlResponseMessage = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("ResponseMessage"), ctrlResponseMessage, isAdd, false);
						
							item.ResponseMessage = Convert.ToString(valctrlResponseMessage);
						
						object valctrlDeleted = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("Deleted"), ctrlDeleted, isAdd, false);
						
							item.Deleted = Convert.ToBoolean(valctrlDeleted);
						
						object valctrlCreatedOn = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("CreatedOn"), ctrlCreatedOn, isAdd, false);
						...
						object valctrlModifiedOn = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("ModifiedOn"), ctrlModifiedOn, isAdd, false);
						...
						object valctrlCreatedBy = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("CreatedBy"), ctrlCreatedBy, isAdd, false);
						...
						object valctrlModifiedBy = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("ModifiedBy"), ctrlModifiedBy, isAdd, false);
						...
						object valctrlUniqueID = Utility.GetDefaultControlValue(EZLinkResponseCode.Schema.GetColumn("UniqueID"), ctrlUniqueID, isAdd, false);
        ...
        {
		    TableSchema.Table tblSchema = DataService.GetTableSchema("EZLinkResponseCode", "PowerPOS");
