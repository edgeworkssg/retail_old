...
namespace PowerPOS
{
	public partial class EZLinkMessageParameterScaffold : System.Web.UI.Page 
	{
		...
		void LoadEditor(string id) 
		{
			...
			if (!String.IsNullOrEmpty(id) && id != "0")
			{
				...
				//pull the record
				EZLinkMessageParameter item = new EZLinkMessageParameter(id);
				//bind the page 
					
							ctrlParameterLength.Text = item.ParameterLength.ToString();
		...
		{
			EZLinkMessageParameter.Delete(Utility.GetParameter("id"));
			//redirect
		...
		void BindAndSave(string id) 
		{
			...
			EZLinkMessageParameter item;
			if (!String.IsNullOrEmpty(id) && id != "0") 
			{
				//it's an edit
				item = new EZLinkMessageParameter(id);
			}

			else 
			{
				//add
				item = new EZLinkMessageParameter();
			}
  
	      
			
						object valctrlParameterLength = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("ParameterLength"), ctrlParameterLength, isAdd, false);
						
							item.ParameterLength = Convert.ToInt32(valctrlParameterLength);
						
						object valctrlDeleted = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("Deleted"), ctrlDeleted, isAdd, false);
						
							item.Deleted = Convert.ToBoolean(valctrlDeleted);
						
						object valctrlCreatedOn = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("CreatedOn"), ctrlCreatedOn, isAdd, false);
						...
						object valctrlCreatedBy = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("CreatedBy"), ctrlCreatedBy, isAdd, false);
						...
						object valctrlModifiedOn = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("ModifiedOn"), ctrlModifiedOn, isAdd, false);
						...
						object valctrlModifiedBy = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("ModifiedBy"), ctrlModifiedBy, isAdd, false);
						...
						object valctrlUniqueID = Utility.GetDefaultControlValue(EZLinkMessageParameter.Schema.GetColumn("UniqueID"), ctrlUniqueID, isAdd, false);
        ...
        {
		    TableSchema.Table tblSchema = DataService.GetTableSchema("EZLinkMessageParameter", "PowerPOS");
