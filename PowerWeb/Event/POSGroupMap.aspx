<%@ Page Language="C#" Theme="Default"  MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="POSGroupMap" Title="<%$Resources:dictionary,Special Event Location %>" Codebehind="POSGroupMap.aspx.cs" %>
        ...
        <tr>
            <td class="" colspan="2">
                <asp:GridView ID="gvDetails" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="EventLocationMapID" OnRowCancelingEdit="gvDetails_RowCancelingEdit" 
