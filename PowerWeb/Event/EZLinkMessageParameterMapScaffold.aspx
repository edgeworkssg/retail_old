...
<%@ Page Language="C#" Title="EZLinkMessageParameterMap Scaffold" Inherits="PowerPOS.EZLinkMessageParameterMapScaffold" MasterPageFile="~/PowerPOSMSt.master" Theme="default" Codebehind="EZLinkMessageParameterMapScaffold.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">
	
	<h2>EZLinkMessageParameterMap</h2>
    ...
    >
        <Columns>
	            <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="MapID" DataNavigateUrlFormatString="EZLinkMessageParameterMapScaffold.aspx?id={0}
" />
	            
	            <asp:BoundField DataField="MsgName" HeaderText="Msg Name" SortExpression="MsgName"></asp:BoundField>
	            
	            <asp:BoundField DataField="ParameterName" HeaderText="Parameter Name" SortExpression="ParameterName"></asp:BoundField>
	            
	            <asp:BoundField DataField="startingIndex" HeaderText="Starting Index" SortExpression="startingIndex"></asp:BoundField>
	...
	<a href="EZLinkMessageParameterMapScaffold.aspx?id=0">Add New...</a>
	</asp:Panel>
	...
	<table cellpadding="5" cellspacing="0" Width="600px">
		...
		<td ><asp:TextBox ID="ctrlMsgName" runat="server" MaxLength="50" ></asp:TextBox></td>
		</tr>
		
		<tr>
			<td >Parameter Name</td>
			
		<td ><asp:TextBox ID="ctrlParameterName" runat="server" MaxLength="50" ></asp:TextBox></td>
		</tr>
		
		<tr>
			<td >Starting Index</td>
			
		<td ><asp:TextBox ID="ctrlStartingIndex" runat="server" Width="50px" ></asp:TextBox></td>
		</tr>
		...
		<tr>
			...
			<input type="button" onclick="location.href='EZLinkMessageParameterMapScaffold.aspx'" class="scaffoldButton" value="Return" />
