...
namespace PowerPOS
{
	public partial class EZlinkMessageScaffold : System.Web.UI.Page 
	{
		...
		void LoadEditor(string id) 
		{
			...
			if (!String.IsNullOrEmpty(id) && id != "0")
			{
				...
				//pull the record
				EZlinkMessage item = new EZlinkMessage(id);
				//bind the page 
		...
		{
			EZlinkMessage.Delete(Utility.GetParameter("id"));
			//redirect
		...
		void BindAndSave(string id) 
		{
			...
			{
				//it's an edit
				item = new EZlinkMessage(id);
			}

			else 
			{
				//add
				item = new EZlinkMessage();
			}
  
	      
			
						object valctrlMsgContent = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("MsgContent"), ctrlMsgContent, isAdd, false);
						
							item.MsgContent = Convert.ToString(valctrlMsgContent);
						
						object valctrlDeleted = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("Deleted"), ctrlDeleted, isAdd, false);
						
							item.Deleted = Convert.ToBoolean(valctrlDeleted);
						
						object valctrlCreatedOn = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("CreatedOn"), ctrlCreatedOn, isAdd, false);
						...
						object valctrlCreatedBy = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("CreatedBy"), ctrlCreatedBy, isAdd, false);
						...
						object valctrlModifiedOn = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("ModifiedOn"), ctrlModifiedOn, isAdd, false);
						...
						object valctrlModifiedBy = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("ModifiedBy"), ctrlModifiedBy, isAdd, false);
						...
						object valctrlUniqueID = Utility.GetDefaultControlValue(EZlinkMessage.Schema.GetColumn("UniqueID"), ctrlUniqueID, isAdd, false);
        ...
        {
		    TableSchema.Table tblSchema = DataService.GetTableSchema("EZlinkMessage", "PowerPOS");
