...
namespace PowerWeb.API.Promo
{
    ...
    public class GetRetailPriceItem : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            var ItemNo = context.Request.Params["ItemNo"];
            ...
            try
            {
                ...
                string query = "Select ISNULL(RetailPrice,0) As RetailPrice " +
                                "from Item where ItemNo = N'" + ItemNo + "'";
                ...
                string query3 = "select PromoCampaignName " +
                        ...
                        "where ISNULL(h.Deleted,0) = 0 and ISNULL(d.Deleted,0) = 0 and CONVERT(date, h.DateTo) > GETDATE() and d.ItemNo = '" + ItemNo +"' " +
