...
{
    public partial class THKStockTakeImporter : System.Web.UI.Page
    {
        ...
        protected void btnExportItemQuanity_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = LowQtyImporterController.FetchItem(ddlInventoryLocation.SelectedValue.GetIntValue(), ddlDepartment.SelectedValue, ddlCategory.SelectedValue);
            ExportData("LowQtyImporter", dt);
        }
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            if (fuItemImporter.HasFile)
            {
                ...
                try
                {
                    ...
                    DataSet ds = CommonUILib.Convert(fuItemImporter.PostedFile.InputStream, "StockTake", "\t");
                    if (ds.Tables.Count > 0)
                        dtInput = ds.Tables["StockTake"];
                ...
                if (dtInput.Rows.Count > 0)
                {
                    ...
                    bool isSuccess = LowQtyImporterController.ImportStockTakeData(Session["UserName"] + "",
                        dtInput, ddlInventoryLocation1.SelectedItem.Text, out resultDt, out status);
                    if (isSuccess)
                    {
