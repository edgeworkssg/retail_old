<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="ViewLogReport" Title="<%$Resources:dictionary, View Data Base Log%>" CodeBehind="ViewLogReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="height: 20px;" class="wl_pageheaderSub">
        <asp:Literal ID="Literal4" runat="server" Text="<%$Resources:dictionary,SEARCH %>"></asp:Literal>
    </div>
    <table width="600px" id="FieldsTable">
       ...
       --%>
        ...
        <tr>
            <td>
                <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:dictionary, Message%>"></asp:Literal>
            </td>
            <td>
                <asp:TextBox ID="txtMessage" runat="server" Width="172px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
    ...
    <asp:GridView ID="gvReport" Width="100%" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        DataKeyNames="LogId" AutoGenerateColumns="False" PageSize="20" SkinID="scaffold"
        OnRowDataBound="gvReport_RowDataBound">
        <Columns>
            <asp:BoundField DataField="LogId" SortExpression="LogId" HeaderText="<%$Resources:dictionary, Log Id%>" />
            <asp:BoundField DataField="LogDate" SortExpression="LogDate" HeaderText="<%$Resources:dictionary, Log Date%>" />
            <asp:BoundField DataField="LogMsg" SortExpression="LogMsg" HeaderText="<%$Resources:dictionary, Log Msg%>" />
        </Columns>
        <PagerTemplate>
