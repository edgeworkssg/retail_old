<%@ Page Title="<%$Resources:dictionary, Stock Take Importer%>" Language="C#" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" CodeBehind="THKStockTakeImporter.aspx.cs" Inherits="PowerWeb.Support.THKStockTakeImporter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 800px" class="wl_pageheaderSub">
        <asp:Literal ID="SEARCHLbl" runat="server" Text="<%$Resources:dictionary, Stock Take Importer%>"></asp:Literal>
    </div>
    <table width="800px" id="FilterTable">
        ...
        <tr>
            <td>
                <asp:DropDownList ID="ddlInventoryLocation1" runat="server" Width="150px" OnInit="ddlInventoryLocation_Init">
                </asp:DropDownList>
            </td>
            <td class="fieldname">
        ...
        <tr>
            <td class="fieldname" colspan="3" style="text-align: center!important;">
