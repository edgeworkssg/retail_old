...
{
    /// <summary>
    /// Controller class for QuotationHdr
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class QuotationHdrController
    {
        // Preload our schema..
        QuotationHdr thisSchemaLoad = new QuotationHdr();
        ...
        public QuotationHdrCollection FetchAll()
        {
            QuotationHdrCollection coll = new QuotationHdrCollection();
            Query qry = new Query(QuotationHdr.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public QuotationHdrCollection FetchByID(object OrderHdrID)
        {
            QuotationHdrCollection coll = new QuotationHdrCollection().Where("OrderHdrID", OrderHdrID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public QuotationHdrCollection FetchByQuery(Query qry)
        {
            QuotationHdrCollection coll = new QuotationHdrCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (QuotationHdr.Delete(OrderHdrID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object OrderHdrID)
        {
            return (QuotationHdr.Destroy(OrderHdrID) == 1);
        }
