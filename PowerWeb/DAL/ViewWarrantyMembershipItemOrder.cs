...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewWarrantyMembershipItemOrder class.
    /// </summary>
    [Serializable]
    public partial class ViewWarrantyMembershipItemOrderCollection : ReadOnlyList<ViewWarrantyMembershipItemOrder, ViewWarrantyMembershipItemOrderCollection>
    {        
        public ViewWarrantyMembershipItemOrderCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewWarrantyMembershipItemOrder view.
    /// </summary>
    [Serializable]
    public partial class ViewWarrantyMembershipItemOrder : ReadOnlyRecord<ViewWarrantyMembershipItemOrder>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewWarrantyMembershipItemOrder", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                colvarStreetName.MaxLength = 150;
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewWarrantyMembershipItemOrder",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewWarrantyMembershipItemOrder()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewWarrantyMembershipItemOrder(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewWarrantyMembershipItemOrder(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewWarrantyMembershipItemOrder(string columnName, object columnValue)
        {
            SetSQLProps();
