...
namespace PowerPOS
{
	...
	public partial class SalesPerson : ActiveRecord<SalesPerson>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SalesPerson", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarSalesPersonGroupID.IsForeignKey = true;
				colvarSalesPersonGroupID.IsReadOnly = false;
				colvarSalesPersonGroupID.DefaultSetting = @"";
				
					colvarSalesPersonGroupID.ForeignKeyTableName = "SalesGroup";
				...
				DataService.Providers["PowerPOS"].AddSchema("SalesPerson",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a SalesGroup ActiveRecord object related to this SalesPerson
		/// 
		/// </summary>
		public PowerPOS.SalesGroup SalesGroup
		{
			get { return PowerPOS.SalesGroup.FetchByID(this.SalesPersonGroupID); }
			set { SetColumnValue("SalesPersonGroupID", value.SalesGroupId); }
		}
		...
		/// </summary>
		public static void Update(string varSalesPersonID,string varSalesPersonName,int varSalesPersonGroupID,string varNric,string varContactNo,string varAddress,string varRemark,string varModifiedBy,DateTime? varModifiedOn,string varCreatedBy,DateTime? varCreatedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesPerson item = new SalesPerson();
