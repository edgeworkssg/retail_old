...
{
	/// <summary>
	/// Strongly-typed collection for the ItemSummaryGroup class.
	/// </summary>
    [Serializable]
	public partial class ItemSummaryGroupCollection : ActiveList<ItemSummaryGroup, ItemSummaryGroupCollection>
	{	   
		public ItemSummaryGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemSummaryGroupCollection</returns>
		public ItemSummaryGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemSummaryGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemSummaryGroup table.
	/// </summary>
	[Serializable]
	public partial class ItemSummaryGroup : ActiveRecord<ItemSummaryGroup>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemSummaryGroup()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemSummaryGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemSummaryGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemSummaryGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemSummaryGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemSummaryGroupID = new TableSchema.TableColumn(schema);
				colvarItemSummaryGroupID.ColumnName = "ItemSummaryGroupID";
				colvarItemSummaryGroupID.DataType = DbType.AnsiString;
				colvarItemSummaryGroupID.MaxLength = 50;
				colvarItemSummaryGroupID.AutoIncrement = false;
				colvarItemSummaryGroupID.IsNullable = false;
				colvarItemSummaryGroupID.IsPrimaryKey = true;
				colvarItemSummaryGroupID.IsForeignKey = false;
				colvarItemSummaryGroupID.IsReadOnly = false;
				colvarItemSummaryGroupID.DefaultSetting = @"";
				colvarItemSummaryGroupID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemSummaryGroupID);
				...
				colvarInventoryLocationGroupID.IsNullable = true;
				...
				colvarInventoryLocationGroupID.DefaultSetting = @"";
				colvarInventoryLocationGroupID.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemSummaryGroup",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemSummaryGroupID")]
		[Bindable(true)]
		public string ItemSummaryGroupID 
		{
			get { return GetColumnValue<string>(Columns.ItemSummaryGroupID); }
			set { SetColumnValue(Columns.ItemSummaryGroupID, value); }
		}
		...
		{
			get { return GetColumnValue<int?>(Columns.InventoryLocationGroupID); }
			set { SetColumnValue(Columns.InventoryLocationGroupID, value); }
		}
		...
		/// </summary>
		public static void Insert(string varItemSummaryGroupID,string varItemNo,int? varInventoryLocationGroupID,double? varBalanceQty,decimal? varCostPrice,string varRemark,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemSummaryGroup item = new ItemSummaryGroup();
			
			item.ItemSummaryGroupID = varItemSummaryGroupID;
			
			item.ItemNo = varItemNo;
			
			item.InventoryLocationGroupID = varInventoryLocationGroupID;
		...
		/// </summary>
		public static void Update(string varItemSummaryGroupID,string varItemNo,int? varInventoryLocationGroupID,double? varBalanceQty,decimal? varCostPrice,string varRemark,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemSummaryGroup item = new ItemSummaryGroup();
        ...
        public static TableSchema.TableColumn ItemSummaryGroupIDColumn
        {
        ...
        public static TableSchema.TableColumn InventoryLocationGroupIDColumn
        {
		...
		{
			 public static string ItemSummaryGroupID = @"ItemSummaryGroupID";
