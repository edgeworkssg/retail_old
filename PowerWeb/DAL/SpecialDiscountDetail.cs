...
{
	/// <summary>
	/// Strongly-typed collection for the SpecialDiscountDetail class.
	/// </summary>
    [Serializable]
	public partial class SpecialDiscountDetailCollection : ActiveList<SpecialDiscountDetail, SpecialDiscountDetailCollection>
	{	   
		public SpecialDiscountDetailCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SpecialDiscountDetailCollection</returns>
		public SpecialDiscountDetailCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SpecialDiscountDetail o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SpecialDiscountDetail table.
	/// </summary>
	[Serializable]
	public partial class SpecialDiscountDetail : ActiveRecord<SpecialDiscountDetail>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public SpecialDiscountDetail()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public SpecialDiscountDetail(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SpecialDiscountDetail(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SpecialDiscountDetail(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SpecialDiscountDetail", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarDiscountName.IsForeignKey = true;
				colvarDiscountName.IsReadOnly = false;
				colvarDiscountName.DefaultSetting = @"";
				
					colvarDiscountName.ForeignKeyTableName = "SpecialDiscounts";
				...
				colvarDiscountPercentage.IsNullable = true;
				...
				colvarDiscountAmount.DataType = DbType.Decimal;
				...
				TableSchema.TableColumn colvarSpecialDiscountDetailID = new TableSchema.TableColumn(schema);
				colvarSpecialDiscountDetailID.ColumnName = "SpecialDiscountDetailID";
				colvarSpecialDiscountDetailID.DataType = DbType.Int32;
				colvarSpecialDiscountDetailID.MaxLength = 0;
				colvarSpecialDiscountDetailID.AutoIncrement = true;
				colvarSpecialDiscountDetailID.IsNullable = false;
				colvarSpecialDiscountDetailID.IsPrimaryKey = true;
				colvarSpecialDiscountDetailID.IsForeignKey = false;
				colvarSpecialDiscountDetailID.IsReadOnly = false;
				colvarSpecialDiscountDetailID.DefaultSetting = @"";
				colvarSpecialDiscountDetailID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSpecialDiscountDetailID);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["PowerPOS"].AddSchema("SpecialDiscountDetail",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("SpecialDiscountDetailID")]
		[Bindable(true)]
		public int SpecialDiscountDetailID 
		{
			get { return GetColumnValue<int>(Columns.SpecialDiscountDetailID); }
			set { SetColumnValue(Columns.SpecialDiscountDetailID, value); }
		}
		...
		/// <summary>
		/// Returns a SpecialDiscount ActiveRecord object related to this SpecialDiscountDetail
		/// 
		/// </summary>
		public PowerPOS.SpecialDiscount SpecialDiscount
		{
			get { return PowerPOS.SpecialDiscount.FetchByID(this.DiscountName); }
			set { SetColumnValue("DiscountName", value.DiscountName); }
		}
		...
		/// </summary>
		public static void Update(string varDiscountName,string varItemNo,decimal? varDiscountPercentage,decimal? varDiscountAmount,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int varSpecialDiscountDetailID)
		{
			SpecialDiscountDetail item = new SpecialDiscountDetail();
				...
				item.SpecialDiscountDetailID = varSpecialDiscountDetailID;
        ...
        public static TableSchema.TableColumn SpecialDiscountDetailIDColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string SpecialDiscountDetailID = @"SpecialDiscountDetailID";
