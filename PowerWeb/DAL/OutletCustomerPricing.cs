...
{
	/// <summary>
	/// Strongly-typed collection for the OutletCustomerPricing class.
	/// </summary>
    [Serializable]
	public partial class OutletCustomerPricingCollection : ActiveList<OutletCustomerPricing, OutletCustomerPricingCollection>
	{	   
		public OutletCustomerPricingCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OutletCustomerPricingCollection</returns>
		public OutletCustomerPricingCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OutletCustomerPricing o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OutletCustomerPricing table.
	/// </summary>
	[Serializable]
	public partial class OutletCustomerPricing : ActiveRecord<OutletCustomerPricing>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public OutletCustomerPricing()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public OutletCustomerPricing(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OutletCustomerPricing(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OutletCustomerPricing(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OutletCustomerPricing", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarOutletCustomerPricingID = new TableSchema.TableColumn(schema);
				colvarOutletCustomerPricingID.ColumnName = "OutletCustomerPricingID";
				colvarOutletCustomerPricingID.DataType = DbType.Int32;
				colvarOutletCustomerPricingID.MaxLength = 0;
				colvarOutletCustomerPricingID.AutoIncrement = true;
				colvarOutletCustomerPricingID.IsNullable = false;
				colvarOutletCustomerPricingID.IsPrimaryKey = true;
				colvarOutletCustomerPricingID.IsForeignKey = false;
				colvarOutletCustomerPricingID.IsReadOnly = false;
				colvarOutletCustomerPricingID.DefaultSetting = @"";
				colvarOutletCustomerPricingID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOutletCustomerPricingID);
				...
				DataService.Providers["PowerPOS"].AddSchema("OutletCustomerPricing",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OutletCustomerPricingID")]
		[Bindable(true)]
		public int OutletCustomerPricingID 
		{
			get { return GetColumnValue<int>(Columns.OutletCustomerPricingID); }
			set { SetColumnValue(Columns.OutletCustomerPricingID, value); }
		}
		...
		/// </summary>
		public static void Update(int varOutletCustomerPricingID,string varOutletName,string varMembershipNo,string varItemNo,decimal varRetailPrice,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			OutletCustomerPricing item = new OutletCustomerPricing();
			
				item.OutletCustomerPricingID = varOutletCustomerPricingID;
        ...
        public static TableSchema.TableColumn OutletCustomerPricingIDColumn
        {
		...
		{
			 public static string OutletCustomerPricingID = @"OutletCustomerPricingID";
