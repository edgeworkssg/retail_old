...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryLocation class.
	/// </summary>
    [Serializable]
	public partial class InventoryLocationCollection : ActiveList<InventoryLocation, InventoryLocationCollection>
	{	   
		public InventoryLocationCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryLocationCollection</returns>
		public InventoryLocationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryLocation o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryLocation table.
	/// </summary>
	[Serializable]
	public partial class InventoryLocation : ActiveRecord<InventoryLocation>, IActiveRecord
	{
		...
		public InventoryLocation(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryLocation(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryLocation(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryLocation", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInventoryLocationID.AutoIncrement = true;
				colvarInventoryLocationID.IsNullable = false;
				colvarInventoryLocationID.IsPrimaryKey = true;
				...
				colvarInventoryLocationName.DefaultSetting = @"";
				colvarInventoryLocationName.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryLocation",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.InventoryLocationName); }
			set { SetColumnValue(Columns.InventoryLocationName, value); }
		}
		...
		{
			return new PowerPOS.InventoryHdrCollection().Where(InventoryHdr.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemBaseLevelCollection ItemBaseLevelRecords()
		{
			return new PowerPOS.ItemBaseLevelCollection().Where(ItemBaseLevel.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemBatchSummaryCollection ItemBatchSummaryRecords()
		{
			return new PowerPOS.ItemBatchSummaryCollection().Where(ItemBatchSummary.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemBatchSummaryArchiveCollection ItemBatchSummaryArchiveRecords()
		{
			return new PowerPOS.ItemBatchSummaryArchiveCollection().Where(ItemBatchSummaryArchive.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemCookHistoryCollection ItemCookHistoryRecords()
		{
			return new PowerPOS.ItemCookHistoryCollection().Where(ItemCookHistory.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemQuantityTriggerCollection ItemQuantityTriggerRecords()
		{
			return new PowerPOS.ItemQuantityTriggerCollection().Where(ItemQuantityTrigger.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.StockTakeCollection StockTakeRecords()
		{
			return new PowerPOS.StockTakeCollection().Where(StockTake.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.StockTransferHdrCollection StockTransferHdrRecords()
		{
			return new PowerPOS.StockTransferHdrCollection().Where(StockTransferHdr.Columns.TransferFromLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.StockTransferHdrCollection StockTransferHdrRecordsFromInventoryLocation()
		{
			return new PowerPOS.StockTransferHdrCollection().Where(StockTransferHdr.Columns.TransferToLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemTagStatusDetailCollection ItemTagStatusDetailRecords()
		{
			return new PowerPOS.ItemTagStatusDetailCollection().Where(ItemTagStatusDetail.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.ItemTagSummaryCollection ItemTagSummaryRecords()
		{
			return new PowerPOS.ItemTagSummaryCollection().Where(ItemTagSummary.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.LocationTransferCollection LocationTransferRecords()
		{
			return new PowerPOS.LocationTransferCollection().Where(LocationTransfer.Columns.FromInventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.LocationTransferCollection LocationTransferRecordsFromInventoryLocation()
		{
			return new PowerPOS.LocationTransferCollection().Where(LocationTransfer.Columns.ToInventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.OutletCollection OutletRecords()
		{
			return new PowerPOS.OutletCollection().Where(Outlet.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		public PowerPOS.PurchaseOrderHdrCollection PurchaseOrderHdrRecords()
		{
			return new PowerPOS.PurchaseOrderHdrCollection().Where(PurchaseOrderHdr.Columns.InventoryLocationID, InventoryLocationID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varInventoryLocationID,string varInventoryLocationName,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryLocation item = new InventoryLocation();
        ...
        public static TableSchema.TableColumn InventoryLocationNameColumn
        {
