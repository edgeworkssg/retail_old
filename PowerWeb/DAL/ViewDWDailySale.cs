...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailySale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySaleCollection : ReadOnlyList<ViewDWDailySale, ViewDWDailySaleCollection>
    {        
        public ViewDWDailySaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailySales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySale : ReadOnlyRecord<ViewDWDailySale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailySales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailySales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailySale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailySale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailySale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailySale(string columnName, object columnValue)
        {
            SetSQLProps();
