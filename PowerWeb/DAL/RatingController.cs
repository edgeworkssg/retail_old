...
namespace PowerPOS
{
    ...
    public partial class RatingController
    {
	    ...
	    public void Insert(int? Posid,int? RatingX,string Staff,DateTime? Timestamp,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string UniqueId,string OrderHdrID)
	    {
	    ...
	    public void Update(int RatingID,int? Posid,int? RatingX,string Staff,DateTime? Timestamp,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string UniqueId,string OrderHdrID)
	    {
		    Rating item = new Rating();
	        item.MarkOld();
	        item.IsLoaded = true;
