...
{
    /// <summary>
    /// Controller class for LoginActivity
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class LoginActivityController
    {
        // Preload our schema..
        LoginActivity thisSchemaLoad = new LoginActivity();
        ...
        public LoginActivityCollection FetchAll()
        {
            LoginActivityCollection coll = new LoginActivityCollection();
            Query qry = new Query(LoginActivity.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public LoginActivityCollection FetchByID(object LoginActivityID)
        {
            LoginActivityCollection coll = new LoginActivityCollection().Where("LoginActivityID", LoginActivityID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public LoginActivityCollection FetchByQuery(Query qry)
        {
            LoginActivityCollection coll = new LoginActivityCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object LoginActivityID)
        {
            return (LoginActivity.Delete(LoginActivityID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object LoginActivityID)
        {
            return (LoginActivity.Destroy(LoginActivityID) == 1);
        }
	    ...
	    public void Update(Guid LoginActivityID,string UserName,string LoginType,DateTime LoginDateTime,int PointOfSaleID,string CreatedBy,DateTime CreatedOn,string ModifiedBy,DateTime ModifiedOn,Guid UniqueID,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    LoginActivity item = new LoginActivity();
	        item.MarkOld();
	        item.IsLoaded = true;
