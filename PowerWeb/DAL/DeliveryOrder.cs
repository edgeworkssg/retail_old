...
{
	/// <summary>
	/// Strongly-typed collection for the DeliveryOrder class.
	/// </summary>
    [Serializable]
	public partial class DeliveryOrderCollection : ActiveList<DeliveryOrder, DeliveryOrderCollection>
	{	   
        ...
        /// </summary>
        /// <returns>DeliveryOrderCollection</returns>
		public DeliveryOrderCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                DeliveryOrder o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the DeliveryOrder table.
	/// </summary>
	[Serializable]
	public partial class DeliveryOrder : ActiveRecord<DeliveryOrder>, IActiveRecord
	{
		...
		public DeliveryOrder(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public DeliveryOrder(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public DeliveryOrder(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("DeliveryOrder", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				TableSchema.TableColumn colvarPersonAssigned = new TableSchema.TableColumn(schema);
				colvarPersonAssigned.ColumnName = "PersonAssigned";
				colvarPersonAssigned.DataType = DbType.Int32;
				colvarPersonAssigned.MaxLength = 0;
				colvarPersonAssigned.AutoIncrement = false;
				colvarPersonAssigned.IsNullable = true;
				colvarPersonAssigned.IsPrimaryKey = false;
				colvarPersonAssigned.IsForeignKey = false;
				colvarPersonAssigned.IsReadOnly = false;
				colvarPersonAssigned.DefaultSetting = @"";
				colvarPersonAssigned.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPersonAssigned);
				...
				TableSchema.TableColumn colvarTimeSlotFrom = new TableSchema.TableColumn(schema);
				colvarTimeSlotFrom.ColumnName = "TimeSlotFrom";
				colvarTimeSlotFrom.DataType = DbType.DateTime;
				colvarTimeSlotFrom.MaxLength = 0;
				colvarTimeSlotFrom.AutoIncrement = false;
				colvarTimeSlotFrom.IsNullable = true;
				colvarTimeSlotFrom.IsPrimaryKey = false;
				colvarTimeSlotFrom.IsForeignKey = false;
				colvarTimeSlotFrom.IsReadOnly = false;
				colvarTimeSlotFrom.DefaultSetting = @"";
				colvarTimeSlotFrom.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTimeSlotFrom);
				
				TableSchema.TableColumn colvarTimeSlotTo = new TableSchema.TableColumn(schema);
				colvarTimeSlotTo.ColumnName = "TimeSlotTo";
				colvarTimeSlotTo.DataType = DbType.DateTime;
				colvarTimeSlotTo.MaxLength = 0;
				colvarTimeSlotTo.AutoIncrement = false;
				colvarTimeSlotTo.IsNullable = true;
				colvarTimeSlotTo.IsPrimaryKey = false;
				colvarTimeSlotTo.IsForeignKey = false;
				colvarTimeSlotTo.IsReadOnly = false;
				colvarTimeSlotTo.DefaultSetting = @"";
				colvarTimeSlotTo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTimeSlotTo);
				
				TableSchema.TableColumn colvarStatus = new TableSchema.TableColumn(schema);
				colvarStatus.ColumnName = "Status";
				colvarStatus.DataType = DbType.AnsiString;
				colvarStatus.MaxLength = 15;
				...
				TableSchema.TableColumn colvarSalesOrderRefNo = new TableSchema.TableColumn(schema);
				colvarSalesOrderRefNo.ColumnName = "SalesOrderRefNo";
				colvarSalesOrderRefNo.DataType = DbType.AnsiString;
				colvarSalesOrderRefNo.MaxLength = 50;
				colvarSalesOrderRefNo.AutoIncrement = false;
				colvarSalesOrderRefNo.IsNullable = true;
				colvarSalesOrderRefNo.IsPrimaryKey = false;
				colvarSalesOrderRefNo.IsForeignKey = false;
				colvarSalesOrderRefNo.IsReadOnly = false;
				colvarSalesOrderRefNo.DefaultSetting = @"";
				colvarSalesOrderRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSalesOrderRefNo);
				
				TableSchema.TableColumn colvarPurchaseOrderRefNo = new TableSchema.TableColumn(schema);
				colvarPurchaseOrderRefNo.ColumnName = "PurchaseOrderRefNo";
				colvarPurchaseOrderRefNo.DataType = DbType.AnsiString;
				colvarPurchaseOrderRefNo.MaxLength = 50;
				colvarPurchaseOrderRefNo.AutoIncrement = false;
				colvarPurchaseOrderRefNo.IsNullable = true;
				colvarPurchaseOrderRefNo.IsPrimaryKey = false;
				colvarPurchaseOrderRefNo.IsForeignKey = false;
				colvarPurchaseOrderRefNo.IsReadOnly = false;
				colvarPurchaseOrderRefNo.DefaultSetting = @"";
				colvarPurchaseOrderRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPurchaseOrderRefNo);
				...
				TableSchema.TableColumn colvarRecipientName = new TableSchema.TableColumn(schema);
				colvarRecipientName.ColumnName = "RecipientName";
				colvarRecipientName.DataType = DbType.String;
				colvarRecipientName.MaxLength = 200;
				colvarRecipientName.AutoIncrement = false;
				colvarRecipientName.IsNullable = true;
				colvarRecipientName.IsPrimaryKey = false;
				colvarRecipientName.IsForeignKey = false;
				colvarRecipientName.IsReadOnly = false;
				colvarRecipientName.DefaultSetting = @"";
				colvarRecipientName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRecipientName);
				...
				TableSchema.TableColumn colvarHomeNo = new TableSchema.TableColumn(schema);
				colvarHomeNo.ColumnName = "HomeNo";
				colvarHomeNo.DataType = DbType.AnsiString;
				colvarHomeNo.MaxLength = 50;
				colvarHomeNo.AutoIncrement = false;
				colvarHomeNo.IsNullable = true;
				colvarHomeNo.IsPrimaryKey = false;
				colvarHomeNo.IsForeignKey = false;
				colvarHomeNo.IsReadOnly = false;
				colvarHomeNo.DefaultSetting = @"";
				colvarHomeNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarHomeNo);
				...
				TableSchema.TableColumn colvarIsVendorDelivery = new TableSchema.TableColumn(schema);
				colvarIsVendorDelivery.ColumnName = "IsVendorDelivery";
				colvarIsVendorDelivery.DataType = DbType.Boolean;
				colvarIsVendorDelivery.MaxLength = 0;
				colvarIsVendorDelivery.AutoIncrement = false;
				colvarIsVendorDelivery.IsNullable = true;
				colvarIsVendorDelivery.IsPrimaryKey = false;
				colvarIsVendorDelivery.IsForeignKey = false;
				colvarIsVendorDelivery.IsReadOnly = false;
				colvarIsVendorDelivery.DefaultSetting = @"";
				colvarIsVendorDelivery.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsVendorDelivery);
				
				TableSchema.TableColumn colvarDeliveryOutlet = new TableSchema.TableColumn(schema);
				colvarDeliveryOutlet.ColumnName = "DeliveryOutlet";
				colvarDeliveryOutlet.DataType = DbType.AnsiString;
				colvarDeliveryOutlet.MaxLength = 50;
				colvarDeliveryOutlet.AutoIncrement = false;
				colvarDeliveryOutlet.IsNullable = true;
				colvarDeliveryOutlet.IsPrimaryKey = false;
				colvarDeliveryOutlet.IsForeignKey = false;
				colvarDeliveryOutlet.IsReadOnly = false;
				colvarDeliveryOutlet.DefaultSetting = @"";
				colvarDeliveryOutlet.ForeignKeyTableName = "";
				schema.Columns.Add(colvarDeliveryOutlet);
				
				TableSchema.TableColumn colvarIsDelivered = new TableSchema.TableColumn(schema);
				colvarIsDelivered.ColumnName = "IsDelivered";
				colvarIsDelivered.DataType = DbType.Boolean;
				colvarIsDelivered.MaxLength = 0;
				colvarIsDelivered.AutoIncrement = false;
				colvarIsDelivered.IsNullable = true;
				colvarIsDelivered.IsPrimaryKey = false;
				colvarIsDelivered.IsForeignKey = false;
				colvarIsDelivered.IsReadOnly = false;
				colvarIsDelivered.DefaultSetting = @"";
				colvarIsDelivered.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsDelivered);
				...
				colvarIsServerUpdate.DefaultSetting = @"";
				colvarIsServerUpdate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsServerUpdate);
				
				TableSchema.TableColumn colvarDeliveredDate = new TableSchema.TableColumn(schema);
				colvarDeliveredDate.ColumnName = "DeliveredDate";
				colvarDeliveredDate.DataType = DbType.DateTime;
				colvarDeliveredDate.MaxLength = 0;
				colvarDeliveredDate.AutoIncrement = false;
				colvarDeliveredDate.IsNullable = true;
				colvarDeliveredDate.IsPrimaryKey = false;
				colvarDeliveredDate.IsForeignKey = false;
				colvarDeliveredDate.IsReadOnly = false;
				colvarDeliveredDate.DefaultSetting = @"";
				colvarDeliveredDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarDeliveredDate);
				...
				DataService.Providers["PowerPOS"].AddSchema("DeliveryOrder",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("PersonAssigned")]
		[Bindable(true)]
		public int? PersonAssigned 
		{
			get { return GetColumnValue<int?>(Columns.PersonAssigned); }
			set { SetColumnValue(Columns.PersonAssigned, value); }
		}
		...
		[XmlAttribute("TimeSlotFrom")]
		[Bindable(true)]
		public DateTime? TimeSlotFrom 
		{
			get { return GetColumnValue<DateTime?>(Columns.TimeSlotFrom); }
			set { SetColumnValue(Columns.TimeSlotFrom, value); }
		}
		  
		[XmlAttribute("TimeSlotTo")]
		[Bindable(true)]
		public DateTime? TimeSlotTo 
		{
			get { return GetColumnValue<DateTime?>(Columns.TimeSlotTo); }
			set { SetColumnValue(Columns.TimeSlotTo, value); }
		}
		...
		[XmlAttribute("SalesOrderRefNo")]
		[Bindable(true)]
		public string SalesOrderRefNo 
		{
			get { return GetColumnValue<string>(Columns.SalesOrderRefNo); }
			set { SetColumnValue(Columns.SalesOrderRefNo, value); }
		}
		  
		[XmlAttribute("PurchaseOrderRefNo")]
		[Bindable(true)]
		public string PurchaseOrderRefNo 
		{
			get { return GetColumnValue<string>(Columns.PurchaseOrderRefNo); }
			set { SetColumnValue(Columns.PurchaseOrderRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.RecipientName); }
			set { SetColumnValue(Columns.RecipientName, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.HomeNo); }
			set { SetColumnValue(Columns.HomeNo, value); }
		}
		...
		[XmlAttribute("IsVendorDelivery")]
		[Bindable(true)]
		public bool? IsVendorDelivery 
		{
			get { return GetColumnValue<bool?>(Columns.IsVendorDelivery); }
			set { SetColumnValue(Columns.IsVendorDelivery, value); }
		}
		  
		[XmlAttribute("DeliveryOutlet")]
		[Bindable(true)]
		public string DeliveryOutlet 
		{
			get { return GetColumnValue<string>(Columns.DeliveryOutlet); }
			set { SetColumnValue(Columns.DeliveryOutlet, value); }
		}
		...
		{
			get { return GetColumnValue<bool?>(Columns.IsDelivered); }
			set { SetColumnValue(Columns.IsDelivered, value); }
		}
		...
		[XmlAttribute("DeliveredDate")]
		[Bindable(true)]
		public DateTime? DeliveredDate 
		{
			get { return GetColumnValue<DateTime?>(Columns.DeliveredDate); }
			set { SetColumnValue(Columns.DeliveredDate, value); }
		}
		...
		public PowerPOS.DeliveryOrderDetailCollection DeliveryOrderDetails()
		{
			return new PowerPOS.DeliveryOrderDetailCollection().Where(DeliveryOrderDetail.Columns.Dohdrid, OrderNumber).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Membership ActiveRecord object related to this DeliveryOrder
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varOrderNumber,DateTime? varDeliveryDate,int? varPersonAssigned,string varDeliveryAddress,DateTime? varTimeSlotFrom,DateTime? varTimeSlotTo,string varStatus,string varSalesOrderRefNo,string varPurchaseOrderRefNo,bool? varDeleted,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,string varMembershipNo,string varRecipientName,string varMobileNo,string varHomeNo,string varPostalCode,string varUnitNo,string varRemark,Guid varUniqueID,bool? varIsVendorDelivery,string varDeliveryOutlet,bool? varIsDelivered,bool? varIsServerUpdate,DateTime? varDeliveredDate,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.PersonAssigned = varPersonAssigned;
			
			item.DeliveryAddress = varDeliveryAddress;
			
			item.TimeSlotFrom = varTimeSlotFrom;
			
			item.TimeSlotTo = varTimeSlotTo;
			
			item.Status = varStatus;
			
			item.SalesOrderRefNo = varSalesOrderRefNo;
			
			item.PurchaseOrderRefNo = varPurchaseOrderRefNo;
			...
			item.RecipientName = varRecipientName;
			
			item.MobileNo = varMobileNo;
			
			item.HomeNo = varHomeNo;
			...
			item.IsVendorDelivery = varIsVendorDelivery;
			
			item.DeliveryOutlet = varDeliveryOutlet;
			
			item.IsDelivered = varIsDelivered;
			
			item.IsServerUpdate = varIsServerUpdate;
			
			item.DeliveredDate = varDeliveredDate;
		...
		/// </summary>
		public static void Update(string varOrderNumber,DateTime? varDeliveryDate,int? varPersonAssigned,string varDeliveryAddress,DateTime? varTimeSlotFrom,DateTime? varTimeSlotTo,string varStatus,string varSalesOrderRefNo,string varPurchaseOrderRefNo,bool? varDeleted,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,string varMembershipNo,string varRecipientName,string varMobileNo,string varHomeNo,string varPostalCode,string varUnitNo,string varRemark,Guid varUniqueID,bool? varIsVendorDelivery,string varDeliveryOutlet,bool? varIsDelivered,bool? varIsServerUpdate,DateTime? varDeliveredDate,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			DeliveryOrder item = new DeliveryOrder();
        ...
        public static TableSchema.TableColumn PersonAssignedColumn
        {
        ...
        public static TableSchema.TableColumn TimeSlotFromColumn
        {
        ...
        public static TableSchema.TableColumn TimeSlotToColumn
        {
        ...
        public static TableSchema.TableColumn SalesOrderRefNoColumn
        {
        ...
        public static TableSchema.TableColumn PurchaseOrderRefNoColumn
        {
        ...
        public static TableSchema.TableColumn RecipientNameColumn
        {
        ...
        public static TableSchema.TableColumn HomeNoColumn
        {
        ...
        public static TableSchema.TableColumn IsVendorDeliveryColumn
        {
        ...
        public static TableSchema.TableColumn DeliveryOutletColumn
        {
        ...
        public static TableSchema.TableColumn IsDeliveredColumn
        {
        ...
        public static TableSchema.TableColumn DeliveredDateColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string PersonAssigned = @"PersonAssigned";
			 public static string DeliveryAddress = @"DeliveryAddress";
			 public static string TimeSlotFrom = @"TimeSlotFrom";
			 public static string TimeSlotTo = @"TimeSlotTo";
			 public static string Status = @"Status";
			 public static string SalesOrderRefNo = @"SalesOrderRefNo";
			 public static string PurchaseOrderRefNo = @"PurchaseOrderRefNo";
			 ...
			 public static string RecipientName = @"RecipientName";
			 public static string MobileNo = @"MobileNo";
			 public static string HomeNo = @"HomeNo";
			 public static string PostalCode = @"PostalCode";
			 public static string UnitNo = @"UnitNo";
			 public static string Remark = @"Remark";
			 public static string UniqueID = @"UniqueID";
			 public static string IsVendorDelivery = @"IsVendorDelivery";
			 public static string DeliveryOutlet = @"DeliveryOutlet";
