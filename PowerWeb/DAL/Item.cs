...
namespace PowerPOS
{
	...
	public partial class Item : ActiveRecord<Item>, IActiveRecord
	{
		...
		{
			return new PowerPOS.AppointmentItemCollection().Where(AppointmentItem.Columns.ItemNo, ItemNo).Load();
		}
		...
		{
			return new PowerPOS.ItemBaseLevelCollection().Where(ItemBaseLevel.Columns.ItemNo, ItemNo).Load();
		}
		public PowerPOS.ItemBatchSummaryCollection ItemBatchSummaryRecords()
		{
			return new PowerPOS.ItemBatchSummaryCollection().Where(ItemBatchSummary.Columns.ItemNo, ItemNo).Load();
		}
		...
		public PowerPOS.QuotationDetCollection QuotationDetRecords()
		{
			return new PowerPOS.QuotationDetCollection().Where(QuotationDet.Columns.ItemNo, ItemNo).Load();
		}
		...
		{
			return new PowerPOS.StockTransferDetCollection().Where(StockTransferDet.Columns.ItemNo, ItemNo).Load();
		}
		...
		{
			return new PowerPOS.ItemTagStatusDetailCollection().Where(ItemTagStatusDetail.Columns.ItemNo, ItemNo).Load();
		}
		public PowerPOS.ItemTagSummaryCollection ItemTagSummaryRecords()
		{
			return new PowerPOS.ItemTagSummaryCollection().Where(ItemTagSummary.Columns.ItemNo, ItemNo).Load();
		}
		...
		{
			return new PowerPOS.ItemBatchSummaryArchiveCollection().Where(ItemBatchSummaryArchive.Columns.ItemNo, ItemNo).Load();
		}
		public PowerPOS.ItemCookHistoryCollection ItemCookHistoryRecords()
		{
			return new PowerPOS.ItemCookHistoryCollection().Where(ItemCookHistory.Columns.ItemNo, ItemNo).Load();
		}
		...
		public PowerPOS.ItemCostSummaryCollection ItemCostSummaryRecords()
		{
			return new PowerPOS.ItemCostSummaryCollection().Where(ItemCostSummary.Columns.ItemNo, ItemNo).Load();
		}
