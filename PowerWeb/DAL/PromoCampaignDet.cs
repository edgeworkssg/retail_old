...
namespace PowerPOS
{
	...
	public partial class PromoCampaignDet : ActiveRecord<PromoCampaignDet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varPromoCampaignHdrID,int? varItemGroupID,string varItemNo,string varCategoryName,int? varFromQuantity,int? varToQuantity,int varMinQuantity,int? varUnitQty,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,decimal? varPromoprice,int? varAnyQty,decimal? varDiscPercent,decimal? varDiscAmount)
		{
		...
		/// </summary>
		public static void Update(int varPromoCampaignDetID,int varPromoCampaignHdrID,int? varItemGroupID,string varItemNo,string varCategoryName,int? varFromQuantity,int? varToQuantity,int varMinQuantity,int? varUnitQty,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,decimal? varPromoprice,int? varAnyQty,decimal? varDiscPercent,decimal? varDiscAmount)
		{
			PromoCampaignDet item = new PromoCampaignDet();
