...
{
	/// <summary>
	/// Strongly-typed collection for the ResourceGroup class.
	/// </summary>
    [Serializable]
	public partial class ResourceGroupCollection : ActiveList<ResourceGroup, ResourceGroupCollection>
	{	   
        ...
        /// </summary>
        /// <returns>ResourceGroupCollection</returns>
		public ResourceGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ResourceGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ResourceGroup table.
	/// </summary>
	[Serializable]
	public partial class ResourceGroup : ActiveRecord<ResourceGroup>, IActiveRecord
	{
		...
		public ResourceGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ResourceGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ResourceGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ResourceGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarResourceGroupID.AutoIncrement = true;
				colvarResourceGroupID.IsNullable = false;
				colvarResourceGroupID.IsPrimaryKey = true;
				colvarResourceGroupID.IsForeignKey = false;
				colvarResourceGroupID.IsReadOnly = false;
				colvarResourceGroupID.DefaultSetting = @"";
				colvarResourceGroupID.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("ResourceGroup",schema);
			}
		}
		#endregion
		...
		public PowerPOS.ResourceCollection ResourceRecords()
		{
			return new PowerPOS.ResourceCollection().Where(Resource.Columns.ResourceGroupID, ResourceGroupID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varResourceGroupID,string varGroupName,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ResourceGroup item = new ResourceGroup();
