...
{
    /// <summary>
    /// Controller class for SalesCommissionSummary
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class SalesCommissionSummaryController
    {
        // Preload our schema..
        SalesCommissionSummary thisSchemaLoad = new SalesCommissionSummary();
        ...
        public SalesCommissionSummaryCollection FetchAll()
        {
            SalesCommissionSummaryCollection coll = new SalesCommissionSummaryCollection();
            Query qry = new Query(SalesCommissionSummary.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesCommissionSummaryCollection FetchByID(object Id)
        {
            SalesCommissionSummaryCollection coll = new SalesCommissionSummaryCollection().Where("ID", Id).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesCommissionSummaryCollection FetchByQuery(Query qry)
        {
            SalesCommissionSummaryCollection coll = new SalesCommissionSummaryCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (SalesCommissionSummary.Delete(Id) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Id)
        {
            return (SalesCommissionSummary.Destroy(Id) == 1);
        }
	    ...
	    public void Update(int Id,string MonthDate,string Month,string Staff,decimal? Salary,decimal? OtherAllowance,decimal? Commission,decimal? Total,string Status,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    SalesCommissionSummary item = new SalesCommissionSummary();
	        item.MarkOld();
	        item.IsLoaded = true;
