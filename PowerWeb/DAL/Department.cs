...
namespace PowerPOS
{
	...
	public partial class Department : ActiveRecord<Department>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Department", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarDepartmentName.DataType = DbType.AnsiString;
				...
				DataService.Providers["PowerPOS"].AddSchema("Department",schema);
			}
		}
		#endregion
		...
		{
			return new PowerPOS.InventoryHdrCollection().Where(InventoryHdr.Columns.DepartmentID, DepartmentID).Load();
		}
		public PowerPOS.PointOfSaleCollection PointOfSaleRecords()
		{
			return new PowerPOS.PointOfSaleCollection().Where(PointOfSale.Columns.DepartmentID, DepartmentID).Load();
		}
		public PowerPOS.PurchaseOrderHdrCollection PurchaseOrderHdrRecords()
		{
			return new PowerPOS.PurchaseOrderHdrCollection().Where(PurchaseOrderHdr.Columns.DepartmentID, DepartmentID).Load();
		}
		public PowerPOS.PurchaseOrderHeaderCollection PurchaseOrderHeaderRecords()
		{
			return new PowerPOS.PurchaseOrderHeaderCollection().Where(PurchaseOrderHeader.Columns.DepartmentID, DepartmentID).Load();
		}
		public PowerPOS.UserMstCollection UserMstRecords()
		{
			return new PowerPOS.UserMstCollection().Where(UserMst.Columns.DepartmentID, DepartmentID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varDepartmentID,string varDepartmentName,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Department item = new Department();
