    ...
    public partial class ViewAdjustedStockTake : ReadOnlyRecord<ViewAdjustedStockTake>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            if(!IsSchemaInitialized)
            {
                ...
                colvarStockTakeQty.DataType = DbType.Int32;
                colvarStockTakeQty.MaxLength = 0;
                colvarStockTakeQty.AutoIncrement = false;
                colvarStockTakeQty.IsNullable = false;
                ...
                colvarAdjustmentQty.DataType = DbType.Int32;
                colvarAdjustmentQty.MaxLength = 0;
                colvarAdjustmentQty.AutoIncrement = false;
                colvarAdjustmentQty.IsNullable = false;
                ...
                colvarBalQtyAtEntry.DataType = DbType.Int32;
                colvarBalQtyAtEntry.MaxLength = 0;
                colvarBalQtyAtEntry.AutoIncrement = false;
                colvarBalQtyAtEntry.IsNullable = false;
                ...
                colvarTotalDiscrepancyValue.DataType = DbType.Currency;
        ...
        [Bindable(true)]
        public int StockTakeQty 
	    {
		    get
		    {
			    return GetColumnValue<int>("StockTakeQty");
		    }
            set 
		    {
        ...
        public int AdjustmentQty 
	    {
		    get
		    {
			    return GetColumnValue<int>("AdjustmentQty");
		    }
            set 
		    {
        ...
        [Bindable(true)]
        public int BalQtyAtEntry 
	    {
		    get
		    {
			    return GetColumnValue<int>("BalQtyAtEntry");
		    }
            set 
		    {
