...
{
	/// <summary>
	/// Strongly-typed collection for the ItemCookHistory class.
	/// </summary>
    [Serializable]
	public partial class ItemCookHistoryCollection : ActiveList<ItemCookHistory, ItemCookHistoryCollection>
	{	   
		public ItemCookHistoryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemCookHistoryCollection</returns>
		public ItemCookHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemCookHistory o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemCookHistory table.
	/// </summary>
	[Serializable]
	public partial class ItemCookHistory : ActiveRecord<ItemCookHistory>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemCookHistory()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemCookHistory(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemCookHistory(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemCookHistory(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemCookHistory", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarItemCookHistoryID.AutoIncrement = true;
				colvarItemCookHistoryID.IsNullable = false;
				colvarItemCookHistoryID.IsPrimaryKey = true;
				colvarItemCookHistoryID.IsForeignKey = false;
				colvarItemCookHistoryID.IsReadOnly = false;
				colvarItemCookHistoryID.DefaultSetting = @"";
				colvarItemCookHistoryID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemCookHistoryID);
				
				TableSchema.TableColumn colvarCookDate = new TableSchema.TableColumn(schema);
				colvarCookDate.ColumnName = "CookDate";
				colvarCookDate.DataType = DbType.DateTime;
				colvarCookDate.MaxLength = 0;
				colvarCookDate.AutoIncrement = false;
				colvarCookDate.IsNullable = true;
				colvarCookDate.IsPrimaryKey = false;
				colvarCookDate.IsForeignKey = false;
				colvarCookDate.IsReadOnly = false;
				colvarCookDate.DefaultSetting = @"";
				colvarCookDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCookDate);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemCookHistory",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CookDate")]
		[Bindable(true)]
		public DateTime? CookDate 
		{
			get { return GetColumnValue<DateTime?>(Columns.CookDate); }
			set { SetColumnValue(Columns.CookDate, value); }
		}
		...
		public PowerPOS.ItemCookDetailCollection ItemCookDetailRecords()
		{
			return new PowerPOS.ItemCookDetailCollection().Where(ItemCookDetail.Columns.ItemCookHistoryID, ItemCookHistoryID).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this ItemCookHistory
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemCookHistory
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this ItemCookHistory
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varItemCookHistoryID,DateTime? varCookDate,string varItemNo,decimal? varQuantity,int? varPointOfSaleID,int? varInventoryLocationID,string varDescription,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool varDeleted,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemCookHistory item = new ItemCookHistory();
        ...
        public static TableSchema.TableColumn CookDateColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string CookDate = @"CookDate";
