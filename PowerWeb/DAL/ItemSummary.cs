...
{
	/// <summary>
	/// Strongly-typed collection for the ItemSummary class.
	/// </summary>
    [Serializable]
	public partial class ItemSummaryCollection : ActiveList<ItemSummary, ItemSummaryCollection>
	{	   
		public ItemSummaryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemSummaryCollection</returns>
		public ItemSummaryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemSummary o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemSummary table.
	/// </summary>
	[Serializable]
	public partial class ItemSummary : ActiveRecord<ItemSummary>, IActiveRecord
	{
		...
		public ItemSummary(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemSummary(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemSummary(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemSummary", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemSummaryID = new TableSchema.TableColumn(schema);
				colvarItemSummaryID.ColumnName = "ItemSummaryID";
				colvarItemSummaryID.DataType = DbType.AnsiString;
				colvarItemSummaryID.MaxLength = 50;
				colvarItemSummaryID.AutoIncrement = false;
				colvarItemSummaryID.IsNullable = false;
				colvarItemSummaryID.IsPrimaryKey = true;
				colvarItemSummaryID.IsForeignKey = false;
				colvarItemSummaryID.IsReadOnly = false;
				colvarItemSummaryID.DefaultSetting = @"";
				colvarItemSummaryID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemSummaryID);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemSummary",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemSummaryID")]
		[Bindable(true)]
		public string ItemSummaryID 
		{
			get { return GetColumnValue<string>(Columns.ItemSummaryID); }
			set { SetColumnValue(Columns.ItemSummaryID, value); }
		}
		...
		/// </summary>
		public static void Update(string varItemSummaryID,string varItemNo,int? varInventoryLocationID,double? varBalanceQty,decimal? varCostPrice,string varRemark,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemSummary item = new ItemSummary();
        ...
        public static TableSchema.TableColumn ItemSummaryIDColumn
        {
		...
		{
			 public static string ItemSummaryID = @"ItemSummaryID";
