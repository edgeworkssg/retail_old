...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailySalesTodaySrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesTodaySrcCollection : ReadOnlyList<ViewDWDailySalesTodaySrc, ViewDWDailySalesTodaySrcCollection>
    {        
        public ViewDWDailySalesTodaySrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailySales_today_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesTodaySrc : ReadOnlyRecord<ViewDWDailySalesTodaySrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailySales_today_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailySales_today_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailySalesTodaySrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailySalesTodaySrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailySalesTodaySrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailySalesTodaySrc(string columnName, object columnValue)
        {
            SetSQLProps();
