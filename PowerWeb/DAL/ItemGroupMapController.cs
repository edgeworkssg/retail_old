...
{
    /// <summary>
    /// Controller class for ItemGroupMap
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ItemGroupMapController
    {
        // Preload our schema..
        ItemGroupMap thisSchemaLoad = new ItemGroupMap();
        ...
        public ItemGroupMapCollection FetchAll()
        {
            ItemGroupMapCollection coll = new ItemGroupMapCollection();
            Query qry = new Query(ItemGroupMap.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemGroupMapCollection FetchByID(object ItemGroupMapID)
        {
            ItemGroupMapCollection coll = new ItemGroupMapCollection().Where("ItemGroupMapID", ItemGroupMapID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemGroupMapCollection FetchByQuery(Query qry)
        {
            ItemGroupMapCollection coll = new ItemGroupMapCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object ItemGroupMapID)
        {
            return (ItemGroupMap.Delete(ItemGroupMapID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ItemGroupMapID)
        {
            return (ItemGroupMap.Destroy(ItemGroupMapID) == 1);
        }
	    ...
	    public void Update(int ItemGroupMapID,int ItemGroupID,string ItemNo,int UnitQty,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    ItemGroupMap item = new ItemGroupMap();
	        item.MarkOld();
	        item.IsLoaded = true;
		    
			item.ItemGroupMapID = ItemGroupMapID;
