...
{
	/// <summary>
	/// Strongly-typed collection for the StockTransferDet class.
	/// </summary>
    [Serializable]
	public partial class StockTransferDetCollection : ActiveList<StockTransferDet, StockTransferDetCollection>
	{	   
		public StockTransferDetCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>StockTransferDetCollection</returns>
		public StockTransferDetCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                StockTransferDet o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the StockTransferDet table.
	/// </summary>
	[Serializable]
	public partial class StockTransferDet : ActiveRecord<StockTransferDet>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public StockTransferDet()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public StockTransferDet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public StockTransferDet(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public StockTransferDet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("StockTransferDet", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarStockTransferDetRefNo = new TableSchema.TableColumn(schema);
				colvarStockTransferDetRefNo.ColumnName = "StockTransferDetRefNo";
				colvarStockTransferDetRefNo.DataType = DbType.AnsiString;
				colvarStockTransferDetRefNo.MaxLength = 50;
				colvarStockTransferDetRefNo.AutoIncrement = false;
				colvarStockTransferDetRefNo.IsNullable = false;
				colvarStockTransferDetRefNo.IsPrimaryKey = true;
				colvarStockTransferDetRefNo.IsForeignKey = false;
				colvarStockTransferDetRefNo.IsReadOnly = false;
				colvarStockTransferDetRefNo.DefaultSetting = @"";
				colvarStockTransferDetRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStockTransferDetRefNo);
				...
				colvarStockTransferHdrRefNo.IsPrimaryKey = false;
				colvarStockTransferHdrRefNo.IsForeignKey = true;
				colvarStockTransferHdrRefNo.IsReadOnly = false;
				colvarStockTransferHdrRefNo.DefaultSetting = @"";
				
					colvarStockTransferHdrRefNo.ForeignKeyTableName = "StockTransferHdr";
				...
				TableSchema.TableColumn colvarFullFilledQuantity = new TableSchema.TableColumn(schema);
				colvarFullFilledQuantity.ColumnName = "FullFilledQuantity";
				colvarFullFilledQuantity.DataType = DbType.Double;
				colvarFullFilledQuantity.MaxLength = 0;
				colvarFullFilledQuantity.AutoIncrement = false;
				colvarFullFilledQuantity.IsNullable = true;
				colvarFullFilledQuantity.IsPrimaryKey = false;
				colvarFullFilledQuantity.IsForeignKey = false;
				colvarFullFilledQuantity.IsReadOnly = false;
				colvarFullFilledQuantity.DefaultSetting = @"";
				colvarFullFilledQuantity.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFullFilledQuantity);
				...
				DataService.Providers["PowerPOS"].AddSchema("StockTransferDet",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("StockTransferDetRefNo")]
		[Bindable(true)]
		public string StockTransferDetRefNo 
		{
			get { return GetColumnValue<string>(Columns.StockTransferDetRefNo); }
			set { SetColumnValue(Columns.StockTransferDetRefNo, value); }
		}
		...
		[XmlAttribute("FullFilledQuantity")]
		[Bindable(true)]
		public double? FullFilledQuantity 
		{
			get { return GetColumnValue<double?>(Columns.FullFilledQuantity); }
			set { SetColumnValue(Columns.FullFilledQuantity, value); }
		}
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this StockTransferDet
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a StockTransferHdr ActiveRecord object related to this StockTransferDet
		/// 
		/// </summary>
		public PowerPOS.StockTransferHdr StockTransferHdr
		{
			get { return PowerPOS.StockTransferHdr.FetchByID(this.StockTransferHdrRefNo); }
			set { SetColumnValue("StockTransferHdrRefNo", value.StockTransferHdrRefNo); }
		}
		...
		public static void Insert(string varStockTransferDetRefNo,string varStockTransferHdrRefNo,string varItemNo,double varQuantity,decimal varFactoryPrice,decimal varCostOfGoods,double? varFullFilledQuantity,string varRemark,string varStatus,bool? varDeleted,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.FullFilledQuantity = varFullFilledQuantity;
		...
		/// </summary>
		public static void Update(string varStockTransferDetRefNo,string varStockTransferHdrRefNo,string varItemNo,double varQuantity,decimal varFactoryPrice,decimal varCostOfGoods,double? varFullFilledQuantity,string varRemark,string varStatus,bool? varDeleted,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			StockTransferDet item = new StockTransferDet();
        ...
        public static TableSchema.TableColumn StockTransferDetRefNoColumn
        {
        ...
        public static TableSchema.TableColumn FullFilledQuantityColumn
        {
		...
		{
			 public static string StockTransferDetRefNo = @"StockTransferDetRefNo";
			 ...
			 public static string FullFilledQuantity = @"FullFilledQuantity";
