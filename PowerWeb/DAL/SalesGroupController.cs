...
{
    /// <summary>
    /// Controller class for SalesGroup
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class SalesGroupController
    {
        // Preload our schema..
        SalesGroup thisSchemaLoad = new SalesGroup();
        ...
        public SalesGroupCollection FetchAll()
        {
            SalesGroupCollection coll = new SalesGroupCollection();
            Query qry = new Query(SalesGroup.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesGroupCollection FetchByID(object SalesGroupId)
        {
            SalesGroupCollection coll = new SalesGroupCollection().Where("SalesGroupId", SalesGroupId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesGroupCollection FetchByQuery(Query qry)
        {
            SalesGroupCollection coll = new SalesGroupCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object SalesGroupId)
        {
            return (SalesGroup.Delete(SalesGroupId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object SalesGroupId)
        {
            return (SalesGroup.Destroy(SalesGroupId) == 1);
        }
	    ...
	    public void Update(int SalesGroupId,string GroupName,int ExpectedWorkingHours,string ModifiedBy,DateTime? ModifiedOn,string CreatedBy,DateTime? CreatedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    SalesGroup item = new SalesGroup();
	        item.MarkOld();
	        item.IsLoaded = true;
