...
{
	/// <summary>
	/// Strongly-typed collection for the AccessLog class.
	/// </summary>
    [Serializable]
	public partial class AccessLogCollection : ActiveList<AccessLog, AccessLogCollection>
	{	   
		public AccessLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AccessLogCollection</returns>
		public AccessLogCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AccessLog table.
	/// </summary>
	[Serializable]
	public partial class AccessLog : ActiveRecord<AccessLog>, IActiveRecord
	{
		...
		public AccessLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AccessLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AccessLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarAccessLogID = new TableSchema.TableColumn(schema);
				colvarAccessLogID.ColumnName = "AccessLogID";
				colvarAccessLogID.DataType = DbType.Guid;
				colvarAccessLogID.MaxLength = 0;
				colvarAccessLogID.AutoIncrement = false;
				colvarAccessLogID.IsNullable = false;
				colvarAccessLogID.IsPrimaryKey = true;
				colvarAccessLogID.IsForeignKey = false;
				colvarAccessLogID.IsReadOnly = false;
				colvarAccessLogID.DefaultSetting = @"";
				colvarAccessLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAccessLogID);
				...
				TableSchema.TableColumn colvarAccessDate = new TableSchema.TableColumn(schema);
				colvarAccessDate.ColumnName = "AccessDate";
				colvarAccessDate.DataType = DbType.DateTime;
				colvarAccessDate.MaxLength = 0;
				colvarAccessDate.AutoIncrement = false;
				colvarAccessDate.IsNullable = true;
				colvarAccessDate.IsPrimaryKey = false;
				colvarAccessDate.IsForeignKey = false;
				colvarAccessDate.IsReadOnly = false;
				colvarAccessDate.DefaultSetting = @"";
				colvarAccessDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAccessDate);
				...
				TableSchema.TableColumn colvarSecondLoginName = new TableSchema.TableColumn(schema);
				colvarSecondLoginName.ColumnName = "SecondLoginName";
				colvarSecondLoginName.DataType = DbType.String;
				colvarSecondLoginName.MaxLength = -1;
				colvarSecondLoginName.AutoIncrement = false;
				colvarSecondLoginName.IsNullable = true;
				colvarSecondLoginName.IsPrimaryKey = false;
				colvarSecondLoginName.IsForeignKey = false;
				colvarSecondLoginName.IsReadOnly = false;
				colvarSecondLoginName.DefaultSetting = @"";
				colvarSecondLoginName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSecondLoginName);
				
				TableSchema.TableColumn colvarAccessType = new TableSchema.TableColumn(schema);
				colvarAccessType.ColumnName = "AccessType";
				colvarAccessType.DataType = DbType.String;
				colvarAccessType.MaxLength = -1;
				colvarAccessType.AutoIncrement = false;
				colvarAccessType.IsNullable = true;
				colvarAccessType.IsPrimaryKey = false;
				colvarAccessType.IsForeignKey = false;
				colvarAccessType.IsReadOnly = false;
				colvarAccessType.DefaultSetting = @"";
				colvarAccessType.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAccessType);
				
				TableSchema.TableColumn colvarAccessSource = new TableSchema.TableColumn(schema);
				colvarAccessSource.ColumnName = "AccessSource";
				colvarAccessSource.DataType = DbType.String;
				colvarAccessSource.MaxLength = -1;
				colvarAccessSource.AutoIncrement = false;
				colvarAccessSource.IsNullable = true;
				colvarAccessSource.IsPrimaryKey = false;
				colvarAccessSource.IsForeignKey = false;
				colvarAccessSource.IsReadOnly = false;
				colvarAccessSource.DefaultSetting = @"";
				colvarAccessSource.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAccessSource);
				...
				DataService.Providers["PowerPOS"].AddSchema("AccessLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("AccessLogID")]
		[Bindable(true)]
		public Guid AccessLogID 
		{
			get { return GetColumnValue<Guid>(Columns.AccessLogID); }
			set { SetColumnValue(Columns.AccessLogID, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime?>(Columns.AccessDate); }
			set { SetColumnValue(Columns.AccessDate, value); }
		}
		...
		[XmlAttribute("SecondLoginName")]
		[Bindable(true)]
		public string SecondLoginName 
		{
			get { return GetColumnValue<string>(Columns.SecondLoginName); }
			set { SetColumnValue(Columns.SecondLoginName, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.AccessType); }
			set { SetColumnValue(Columns.AccessType, value); }
		}
		  
		[XmlAttribute("AccessSource")]
		[Bindable(true)]
		public string AccessSource 
		{
			get { return GetColumnValue<string>(Columns.AccessSource); }
			set { SetColumnValue(Columns.AccessSource, value); }
		}
		...
		/// </summary>
		public static void Update(Guid varAccessLogID,int? varPointOfSaleID,DateTime? varAccessDate,string varLoginName,string varSecondLoginName,string varAccessType,string varAccessSource,string varRemarks,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			AccessLog item = new AccessLog();
        ...
        public static TableSchema.TableColumn AccessLogIDColumn
        {
        ...
        public static TableSchema.TableColumn AccessDateColumn
        {
        ...
        public static TableSchema.TableColumn SecondLoginNameColumn
        {
        ...
        public static TableSchema.TableColumn AccessTypeColumn
        {
        ...
        public static TableSchema.TableColumn AccessSourceColumn
        {
		...
		{
			 public static string AccessLogID = @"AccessLogID";
			 public static string PointOfSaleID = @"PointOfSaleID";
			 public static string AccessDate = @"AccessDate";
			 public static string LoginName = @"LoginName";
			 public static string SecondLoginName = @"SecondLoginName";
			 public static string AccessType = @"AccessType";
			 public static string AccessSource = @"AccessSource";
