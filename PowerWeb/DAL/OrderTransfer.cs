...
{
	/// <summary>
	/// Strongly-typed collection for the OrderTransfer class.
	/// </summary>
    [Serializable]
	public partial class OrderTransferCollection : ActiveList<OrderTransfer, OrderTransferCollection>
	{	   
		public OrderTransferCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OrderTransferCollection</returns>
		public OrderTransferCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OrderTransfer o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OrderTransfer table.
	/// </summary>
	[Serializable]
	public partial class OrderTransfer : ActiveRecord<OrderTransfer>, IActiveRecord
	{
		...
		public OrderTransfer(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrderTransfer(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OrderTransfer(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OrderTransfer", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarOrderTransferID = new TableSchema.TableColumn(schema);
				colvarOrderTransferID.ColumnName = "OrderTransferID";
				colvarOrderTransferID.DataType = DbType.AnsiString;
				colvarOrderTransferID.MaxLength = 20;
				colvarOrderTransferID.AutoIncrement = false;
				colvarOrderTransferID.IsNullable = false;
				colvarOrderTransferID.IsPrimaryKey = true;
				colvarOrderTransferID.IsForeignKey = false;
				colvarOrderTransferID.IsReadOnly = false;
				colvarOrderTransferID.DefaultSetting = @"";
				colvarOrderTransferID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOrderTransferID);
				...
				colvarInventoryHdrRefNo.DataType = DbType.String;
				colvarInventoryHdrRefNo.MaxLength = 200;
				...
				DataService.Providers["PowerPOS"].AddSchema("OrderTransfer",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OrderTransferID")]
		[Bindable(true)]
		public string OrderTransferID 
		{
			get { return GetColumnValue<string>(Columns.OrderTransferID); }
			set { SetColumnValue(Columns.OrderTransferID, value); }
		}
		...
		/// <summary>
		/// Returns a OrderHdr ActiveRecord object related to this OrderTransfer
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(string varOrderTransferID,string varOrderHdrID,string varInventoryHdrRefNo,int? varTransferFrom,int? varTransferTo,string varItemNo,int? varQuantity,string varRemarks,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			OrderTransfer item = new OrderTransfer();
        ...
        public static TableSchema.TableColumn OrderTransferIDColumn
        {
		...
		{
			 public static string OrderTransferID = @"OrderTransferID";
