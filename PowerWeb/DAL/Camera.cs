...
{
	/// <summary>
	/// Strongly-typed collection for the Camera class.
	/// </summary>
    [Serializable]
	public partial class CameraCollection : ActiveList<Camera, CameraCollection>
	{	   
		...
		public CameraCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Camera table.
	/// </summary>
	[Serializable]
	public partial class Camera : ActiveRecord<Camera>, IActiveRecord
	{
		...
		public Camera(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Camera(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Camera", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarCameraId = new TableSchema.TableColumn(schema);
				colvarCameraId.ColumnName = "CameraId";
				colvarCameraId.DataType = DbType.Int32;
				colvarCameraId.MaxLength = 0;
				colvarCameraId.AutoIncrement = true;
				colvarCameraId.IsNullable = false;
				colvarCameraId.IsPrimaryKey = true;
				colvarCameraId.IsForeignKey = false;
				colvarCameraId.IsReadOnly = false;
				colvarCameraId.DefaultSetting = @"";
				colvarCameraId.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCameraId);
				
				TableSchema.TableColumn colvarCameraIp = new TableSchema.TableColumn(schema);
				colvarCameraIp.ColumnName = "CameraIp";
				colvarCameraIp.DataType = DbType.AnsiString;
				colvarCameraIp.MaxLength = 20;
				colvarCameraIp.AutoIncrement = false;
				colvarCameraIp.IsNullable = false;
				colvarCameraIp.IsPrimaryKey = false;
				colvarCameraIp.IsForeignKey = false;
				colvarCameraIp.IsReadOnly = false;
				colvarCameraIp.DefaultSetting = @"";
				colvarCameraIp.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCameraIp);
				
				TableSchema.TableColumn colvarCameraNo = new TableSchema.TableColumn(schema);
				colvarCameraNo.ColumnName = "CameraNo";
				colvarCameraNo.DataType = DbType.Int32;
				colvarCameraNo.MaxLength = 0;
				colvarCameraNo.AutoIncrement = false;
				colvarCameraNo.IsNullable = false;
				colvarCameraNo.IsPrimaryKey = false;
				colvarCameraNo.IsForeignKey = false;
				colvarCameraNo.IsReadOnly = false;
				colvarCameraNo.DefaultSetting = @"";
				colvarCameraNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCameraNo);
				...
				DataService.Providers["PowerPOS"].AddSchema("Camera",schema);
			}
		}
		#endregion
		...
		public int CameraId 
		{
			get { return GetColumnValue<int>(Columns.CameraId); }
			set { SetColumnValue(Columns.CameraId, value); }
		}
		  
		[XmlAttribute("CameraIp")]
		[Bindable(true)]
		public string CameraIp 
		{
			get { return GetColumnValue<string>(Columns.CameraIp); }
			set { SetColumnValue(Columns.CameraIp, value); }
		}
		...
		public int CameraNo 
		{
			get { return GetColumnValue<int>(Columns.CameraNo); }
			set { SetColumnValue(Columns.CameraNo, value); }
		}
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this Camera
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varCameraId,string varCameraIp,int varCameraNo,int varPointOfSaleID,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Camera item = new Camera();
			
				item.CameraId = varCameraId;
        ...
        public static TableSchema.TableColumn CameraIdColumn
        {
        ...
        public static TableSchema.TableColumn CameraIpColumn
        {
        ...
        public static TableSchema.TableColumn CameraNoColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string CameraNo = @"CameraNo";
