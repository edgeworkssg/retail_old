...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryStockOutReason class.
	/// </summary>
    [Serializable]
	public partial class InventoryStockOutReasonCollection : ActiveList<InventoryStockOutReason, InventoryStockOutReasonCollection>
	{	   
		public InventoryStockOutReasonCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryStockOutReasonCollection</returns>
		public InventoryStockOutReasonCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryStockOutReason o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryStockOutReason table.
	/// </summary>
	[Serializable]
	public partial class InventoryStockOutReason : ActiveRecord<InventoryStockOutReason>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InventoryStockOutReason()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InventoryStockOutReason(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryStockOutReason(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryStockOutReason(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryStockOutReason", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryStockOutReason",schema);
			}
		}
		#endregion
		...
		{
			return new PowerPOS.InventoryHdrCollection().Where(InventoryHdr.Columns.StockOutReasonID, ReasonID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varReasonID,string varReasonName,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryStockOutReason item = new InventoryStockOutReason();
