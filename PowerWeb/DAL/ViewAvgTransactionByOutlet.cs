...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewAvgTransactionByOutlet class.
    /// </summary>
    [Serializable]
    public partial class ViewAvgTransactionByOutletCollection : ReadOnlyList<ViewAvgTransactionByOutlet, ViewAvgTransactionByOutletCollection>
    {        
        public ViewAvgTransactionByOutletCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewAvgTransactionByOutlet view.
    /// </summary>
    [Serializable]
    public partial class ViewAvgTransactionByOutlet : ReadOnlyRecord<ViewAvgTransactionByOutlet>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewAvgTransactionByOutlet", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewAvgTransactionByOutlet",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewAvgTransactionByOutlet()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewAvgTransactionByOutlet(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewAvgTransactionByOutlet(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewAvgTransactionByOutlet(string columnName, object columnValue)
        {
            SetSQLProps();
