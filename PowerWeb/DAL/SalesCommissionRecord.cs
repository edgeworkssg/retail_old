...
{
	/// <summary>
	/// Strongly-typed collection for the SalesCommissionRecord class.
	/// </summary>
    [Serializable]
	public partial class SalesCommissionRecordCollection : ActiveList<SalesCommissionRecord, SalesCommissionRecordCollection>
	{	   
		public SalesCommissionRecordCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SalesCommissionRecordCollection</returns>
		public SalesCommissionRecordCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SalesCommissionRecord o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SalesCommissionRecord table.
	/// </summary>
	[Serializable]
	public partial class SalesCommissionRecord : ActiveRecord<SalesCommissionRecord>, IActiveRecord
	{
		...
		public SalesCommissionRecord(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SalesCommissionRecord(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SalesCommissionRecord(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SalesCommissionRecord", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("SalesCommissionRecord",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a OrderHdr ActiveRecord object related to this SalesCommissionRecord
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a UserMst ActiveRecord object related to this SalesCommissionRecord
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varCommissionRecordID,string varSalesPersonID,int varSalesGroupID,string varOrderHdrID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesCommissionRecord item = new SalesCommissionRecord();
			
				item.CommissionRecordID = varCommissionRecordID;
		...
		{
			 public static string CommissionRecordID = @"CommissionRecordID";
