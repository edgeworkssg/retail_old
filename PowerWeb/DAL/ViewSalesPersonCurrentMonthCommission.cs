...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewSalesPersonCurrentMonthCommission class.
    /// </summary>
    [Serializable]
    public partial class ViewSalesPersonCurrentMonthCommissionCollection : ReadOnlyList<ViewSalesPersonCurrentMonthCommission, ViewSalesPersonCurrentMonthCommissionCollection>
    {        
        public ViewSalesPersonCurrentMonthCommissionCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewSalesPersonCurrentMonthCommission view.
    /// </summary>
    [Serializable]
    public partial class ViewSalesPersonCurrentMonthCommission : ReadOnlyRecord<ViewSalesPersonCurrentMonthCommission>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewSalesPersonCurrentMonthCommission", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewSalesPersonCurrentMonthCommission",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewSalesPersonCurrentMonthCommission()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewSalesPersonCurrentMonthCommission(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewSalesPersonCurrentMonthCommission(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewSalesPersonCurrentMonthCommission(string columnName, object columnValue)
        {
            SetSQLProps();
