...
{
	/// <summary>
	/// Strongly-typed collection for the InstallmentDetail class.
	/// </summary>
    [Serializable]
	public partial class InstallmentDetailCollection : ActiveList<InstallmentDetail, InstallmentDetailCollection>
	{	   
		public InstallmentDetailCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InstallmentDetailCollection</returns>
		public InstallmentDetailCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InstallmentDetail o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InstallmentDetail table.
	/// </summary>
	[Serializable]
	public partial class InstallmentDetail : ActiveRecord<InstallmentDetail>, IActiveRecord
	{
		...
		public InstallmentDetail(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InstallmentDetail(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InstallmentDetail(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InstallmentDetail", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInstallmentDetRefNo.IsNullable = false;
				colvarInstallmentDetRefNo.IsPrimaryKey = true;
				colvarInstallmentDetRefNo.IsForeignKey = false;
				colvarInstallmentDetRefNo.IsReadOnly = false;
				colvarInstallmentDetRefNo.DefaultSetting = @"";
				colvarInstallmentDetRefNo.ForeignKeyTableName = "";
				...
				colvarInstallmentRefNo.IsForeignKey = true;
				colvarInstallmentRefNo.IsReadOnly = false;
				colvarInstallmentRefNo.DefaultSetting = @"";
				
					colvarInstallmentRefNo.ForeignKeyTableName = "Installment";
				...
				colvarInstallmentAmount.DefaultSetting = @"";
				colvarInstallmentAmount.ForeignKeyTableName = "";
				...
				colvarOutstandingAmount.DefaultSetting = @"";
				colvarOutstandingAmount.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("InstallmentDetail",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.InstallmentDetRefNo); }
			set { SetColumnValue(Columns.InstallmentDetRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.InstallmentRefNo); }
			set { SetColumnValue(Columns.InstallmentRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<decimal?>(Columns.InstallmentAmount); }
			set { SetColumnValue(Columns.InstallmentAmount, value); }
		}
		...
		{
			get { return GetColumnValue<decimal?>(Columns.OutstandingAmount); }
			set { SetColumnValue(Columns.OutstandingAmount, value); }
		}
		...
		/// <summary>
		/// Returns a Installment ActiveRecord object related to this InstallmentDetail
		/// 
		/// </summary>
		public PowerPOS.Installment Installment
		{
			get { return PowerPOS.Installment.FetchByID(this.InstallmentRefNo); }
			set { SetColumnValue("InstallmentRefNo", value.InstallmentRefNo); }
		}
		...
		/// </summary>
		public static void Insert(string varInstallmentDetRefNo,string varInstallmentRefNo,decimal? varInstallmentAmount,decimal? varOutstandingAmount,string varStatus,DateTime? varDueDate,string varRemark,bool? varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varOrderHdrID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InstallmentDetail item = new InstallmentDetail();
			
			item.InstallmentDetRefNo = varInstallmentDetRefNo;
			
			item.InstallmentRefNo = varInstallmentRefNo;
			
			item.InstallmentAmount = varInstallmentAmount;
			
			item.OutstandingAmount = varOutstandingAmount;
		...
		/// </summary>
		public static void Update(string varInstallmentDetRefNo,string varInstallmentRefNo,decimal? varInstallmentAmount,decimal? varOutstandingAmount,string varStatus,DateTime? varDueDate,string varRemark,bool? varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varOrderHdrID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InstallmentDetail item = new InstallmentDetail();
        ...
        public static TableSchema.TableColumn InstallmentDetRefNoColumn
        {
        ...
        public static TableSchema.TableColumn InstallmentRefNoColumn
        {
        ...
        public static TableSchema.TableColumn InstallmentAmountColumn
        {
        ...
        public static TableSchema.TableColumn OutstandingAmountColumn
        {
