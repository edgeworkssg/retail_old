...
{
    /// <summary>
    /// Controller class for ItemBatchSummaryArchive
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ItemBatchSummaryArchiveController
    {
        // Preload our schema..
        ItemBatchSummaryArchive thisSchemaLoad = new ItemBatchSummaryArchive();
        ...
        public ItemBatchSummaryArchiveCollection FetchAll()
        {
            ItemBatchSummaryArchiveCollection coll = new ItemBatchSummaryArchiveCollection();
            Query qry = new Query(ItemBatchSummaryArchive.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemBatchSummaryArchiveCollection FetchByID(object ItemBatchSummaryID)
        {
            ItemBatchSummaryArchiveCollection coll = new ItemBatchSummaryArchiveCollection().Where("ItemBatchSummaryID", ItemBatchSummaryID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemBatchSummaryArchiveCollection FetchByQuery(Query qry)
        {
            ItemBatchSummaryArchiveCollection coll = new ItemBatchSummaryArchiveCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (ItemBatchSummaryArchive.Delete(ItemBatchSummaryID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ItemBatchSummaryID)
        {
            return (ItemBatchSummaryArchive.Destroy(ItemBatchSummaryID) == 1);
        }
