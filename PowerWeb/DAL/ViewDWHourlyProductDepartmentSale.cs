...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWHourlyProductDepartmentSale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductDepartmentSaleCollection : ReadOnlyList<ViewDWHourlyProductDepartmentSale, ViewDWHourlyProductDepartmentSaleCollection>
    {        
        public ViewDWHourlyProductDepartmentSaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_HourlyProductDepartmentSales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductDepartmentSale : ReadOnlyRecord<ViewDWHourlyProductDepartmentSale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_HourlyProductDepartmentSales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_HourlyProductDepartmentSales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWHourlyProductDepartmentSale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWHourlyProductDepartmentSale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWHourlyProductDepartmentSale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWHourlyProductDepartmentSale(string columnName, object columnValue)
        {
            SetSQLProps();
