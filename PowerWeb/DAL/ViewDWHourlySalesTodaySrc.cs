...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWHourlySalesTodaySrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlySalesTodaySrcCollection : ReadOnlyList<ViewDWHourlySalesTodaySrc, ViewDWHourlySalesTodaySrcCollection>
    {        
        public ViewDWHourlySalesTodaySrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_HourlySales_today_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlySalesTodaySrc : ReadOnlyRecord<ViewDWHourlySalesTodaySrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_HourlySales_today_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_HourlySales_today_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWHourlySalesTodaySrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWHourlySalesTodaySrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWHourlySalesTodaySrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWHourlySalesTodaySrc(string columnName, object columnValue)
        {
            SetSQLProps();
