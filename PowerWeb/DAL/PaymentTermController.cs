...
{
    /// <summary>
    /// Controller class for PaymentTerm
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class PaymentTermController
    {
        // Preload our schema..
        PaymentTerm thisSchemaLoad = new PaymentTerm();
        ...
        public PaymentTermCollection FetchAll()
        {
            PaymentTermCollection coll = new PaymentTermCollection();
            Query qry = new Query(PaymentTerm.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public PaymentTermCollection FetchByID(object PaymentTermID)
        {
            PaymentTermCollection coll = new PaymentTermCollection().Where("PaymentTermID", PaymentTermID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public PaymentTermCollection FetchByQuery(Query qry)
        {
            PaymentTermCollection coll = new PaymentTermCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object PaymentTermID)
        {
            return (PaymentTerm.Delete(PaymentTermID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object PaymentTermID)
        {
            return (PaymentTerm.Destroy(PaymentTermID) == 1);
        }
	    ...
	    public void Update(int PaymentTermID,string PaymentTermName,string Remark,string CreatedBy,string ModifiedBy,DateTime? CreatedOn,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    PaymentTerm item = new PaymentTerm();
	        item.MarkOld();
	        item.IsLoaded = true;
