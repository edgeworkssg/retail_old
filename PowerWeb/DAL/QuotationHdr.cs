...
{
	/// <summary>
	/// Strongly-typed collection for the QuotationHdr class.
	/// </summary>
    [Serializable]
	public partial class QuotationHdrCollection : ActiveList<QuotationHdr, QuotationHdrCollection>
	{	   
		public QuotationHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>QuotationHdrCollection</returns>
		public QuotationHdrCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                QuotationHdr o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the QuotationHdr table.
	/// </summary>
	[Serializable]
	public partial class QuotationHdr : ActiveRecord<QuotationHdr>, IActiveRecord
	{
		...
		public QuotationHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public QuotationHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public QuotationHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("QuotationHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("QuotationHdr",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this QuotationHdr
		/// 
		/// </summary>
		...
		{
			QuotationHdr item = new QuotationHdr();
