...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryLocationGroup class.
	/// </summary>
    [Serializable]
	public partial class InventoryLocationGroupCollection : ActiveList<InventoryLocationGroup, InventoryLocationGroupCollection>
	{	   
		public InventoryLocationGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryLocationGroupCollection</returns>
		public InventoryLocationGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryLocationGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryLocationGroup table.
	/// </summary>
	[Serializable]
	public partial class InventoryLocationGroup : ActiveRecord<InventoryLocationGroup>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InventoryLocationGroup()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InventoryLocationGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryLocationGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryLocationGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryLocationGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInventoryLocationGroupID.AutoIncrement = true;
				colvarInventoryLocationGroupID.IsNullable = false;
				colvarInventoryLocationGroupID.IsPrimaryKey = true;
				...
				colvarInventoryLocationGroupName.DefaultSetting = @"";
				colvarInventoryLocationGroupName.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryLocationGroup",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.InventoryLocationGroupName); }
			set { SetColumnValue(Columns.InventoryLocationGroupName, value); }
		}
		...
		/// </summary>
		public static void Update(int varInventoryLocationGroupID,string varInventoryLocationGroupName,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryLocationGroup item = new InventoryLocationGroup();
        ...
        public static TableSchema.TableColumn InventoryLocationGroupNameColumn
        {
