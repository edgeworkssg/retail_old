...
{
    /// <summary>
    /// Controller class for FileAttachment
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class FileAttachmentController
    {
        // Preload our schema..
        FileAttachment thisSchemaLoad = new FileAttachment();
        ...
        public FileAttachmentCollection FetchAll()
        {
            FileAttachmentCollection coll = new FileAttachmentCollection();
            Query qry = new Query(FileAttachment.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public FileAttachmentCollection FetchByID(object AttachmentID)
        {
            FileAttachmentCollection coll = new FileAttachmentCollection().Where("AttachmentID", AttachmentID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public FileAttachmentCollection FetchByQuery(Query qry)
        {
            FileAttachmentCollection coll = new FileAttachmentCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (FileAttachment.Delete(AttachmentID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object AttachmentID)
        {
            return (FileAttachment.Destroy(AttachmentID) == 1);
        }
	    ...
	    public void Update(Guid AttachmentID,string FileName,long FileSize,string FileLocation,int PointOfSaleID,string ModuleName,string RefID,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    FileAttachment item = new FileAttachment();
	        item.MarkOld();
	        item.IsLoaded = true;
