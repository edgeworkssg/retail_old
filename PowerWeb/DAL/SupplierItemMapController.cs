...
{
    /// <summary>
    /// Controller class for SupplierItemMap
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class SupplierItemMapController
    {
        // Preload our schema..
        SupplierItemMap thisSchemaLoad = new SupplierItemMap();
        ...
        public SupplierItemMapCollection FetchAll()
        {
            SupplierItemMapCollection coll = new SupplierItemMapCollection();
            Query qry = new Query(SupplierItemMap.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public SupplierItemMapCollection FetchByID(object UniqueID)
        {
            SupplierItemMapCollection coll = new SupplierItemMapCollection().Where("UniqueID", UniqueID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public SupplierItemMapCollection FetchByQuery(Query qry)
        {
            SupplierItemMapCollection coll = new SupplierItemMapCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (SupplierItemMap.Delete(UniqueID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object UniqueID)
        {
            return (SupplierItemMap.Destroy(UniqueID) == 1);
        }
	    ...
	    public void Update(int? SupplierID,string ItemNo,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,Guid UniqueID,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    SupplierItemMap item = new SupplierItemMap();
	        item.MarkOld();
	        item.IsLoaded = true;
