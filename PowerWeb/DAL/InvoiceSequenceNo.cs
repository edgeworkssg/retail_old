...
{
	/// <summary>
	/// Strongly-typed collection for the InvoiceSequenceNo class.
	/// </summary>
    [Serializable]
	public partial class InvoiceSequenceNoCollection : ActiveList<InvoiceSequenceNo, InvoiceSequenceNoCollection>
	{	   
		public InvoiceSequenceNoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InvoiceSequenceNoCollection</returns>
		public InvoiceSequenceNoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InvoiceSequenceNo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InvoiceSequenceNo table.
	/// </summary>
	[Serializable]
	public partial class InvoiceSequenceNo : ActiveRecord<InvoiceSequenceNo>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InvoiceSequenceNo()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InvoiceSequenceNo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InvoiceSequenceNo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InvoiceSequenceNo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InvoiceSequenceNo", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarInvoiceNoID = new TableSchema.TableColumn(schema);
				colvarInvoiceNoID.ColumnName = "InvoiceNoID";
				colvarInvoiceNoID.DataType = DbType.Int32;
				colvarInvoiceNoID.MaxLength = 0;
				colvarInvoiceNoID.AutoIncrement = true;
				colvarInvoiceNoID.IsNullable = false;
				colvarInvoiceNoID.IsPrimaryKey = true;
				colvarInvoiceNoID.IsForeignKey = false;
				colvarInvoiceNoID.IsReadOnly = false;
				colvarInvoiceNoID.DefaultSetting = @"";
				colvarInvoiceNoID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInvoiceNoID);
				...
				TableSchema.TableColumn colvarInventoryLocationCode = new TableSchema.TableColumn(schema);
				colvarInventoryLocationCode.ColumnName = "InventoryLocationCode";
				colvarInventoryLocationCode.DataType = DbType.AnsiString;
				colvarInventoryLocationCode.MaxLength = 50;
				colvarInventoryLocationCode.AutoIncrement = false;
				colvarInventoryLocationCode.IsNullable = true;
				colvarInventoryLocationCode.IsPrimaryKey = false;
				colvarInventoryLocationCode.IsForeignKey = false;
				colvarInventoryLocationCode.IsReadOnly = false;
				colvarInventoryLocationCode.DefaultSetting = @"";
				colvarInventoryLocationCode.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInventoryLocationCode);
				
				TableSchema.TableColumn colvarCurrentNo = new TableSchema.TableColumn(schema);
				colvarCurrentNo.ColumnName = "CurrentNo";
				colvarCurrentNo.DataType = DbType.Int32;
				colvarCurrentNo.MaxLength = 0;
				colvarCurrentNo.AutoIncrement = false;
				colvarCurrentNo.IsNullable = true;
				colvarCurrentNo.IsPrimaryKey = false;
				colvarCurrentNo.IsForeignKey = false;
				colvarCurrentNo.IsReadOnly = false;
				colvarCurrentNo.DefaultSetting = @"";
				colvarCurrentNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCurrentNo);
				...
				DataService.Providers["PowerPOS"].AddSchema("InvoiceSequenceNo",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("InvoiceNoID")]
		[Bindable(true)]
		public int InvoiceNoID 
		{
			get { return GetColumnValue<int>(Columns.InvoiceNoID); }
			set { SetColumnValue(Columns.InvoiceNoID, value); }
		}
		...
		[XmlAttribute("InventoryLocationCode")]
		[Bindable(true)]
		public string InventoryLocationCode 
		{
			get { return GetColumnValue<string>(Columns.InventoryLocationCode); }
			set { SetColumnValue(Columns.InventoryLocationCode, value); }
		}
		  
		[XmlAttribute("CurrentNo")]
		[Bindable(true)]
		public int? CurrentNo 
		{
			get { return GetColumnValue<int?>(Columns.CurrentNo); }
			set { SetColumnValue(Columns.CurrentNo, value); }
		}
		...
		/// </summary>
		public static void Update(int varInvoiceNoID,int? varInventoryLocationID,string varInventoryLocationCode,int? varCurrentNo,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InvoiceSequenceNo item = new InvoiceSequenceNo();
			
				item.InvoiceNoID = varInvoiceNoID;
        ...
        public static TableSchema.TableColumn InvoiceNoIDColumn
        {
        ...
        public static TableSchema.TableColumn InventoryLocationCodeColumn
        {
        ...
        public static TableSchema.TableColumn CurrentNoColumn
        {
		...
		{
			 public static string InvoiceNoID = @"InvoiceNoID";
			 public static string InventoryLocationID = @"InventoryLocationID";
			 public static string InventoryLocationCode = @"InventoryLocationCode";
			 public static string CurrentNo = @"CurrentNo";
