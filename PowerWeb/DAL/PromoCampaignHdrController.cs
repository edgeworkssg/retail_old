...
namespace PowerPOS
{
    ...
    public partial class PromoCampaignHdrController
    {
	    ...
	    public void Insert(string PromoCampaignName,string CampaignType,DateTime DateFrom,DateTime DateTo,int? FreeQty,string FreeItemNo,decimal? PromoPrice,double PromoDiscount,string Remark,bool Enabled,bool? ForNonMembersAlso,bool? ForAllLocations,bool UsePrice,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5,int? Priority,string PromoCode,string Barcode,bool? IsRestricHour,DateTime? RestrictHourStart,DateTime? RestrictHourEnd)
	    {
	    ...
	    public void Update(int PromoCampaignHdrID,string PromoCampaignName,string CampaignType,DateTime DateFrom,DateTime DateTo,int? FreeQty,string FreeItemNo,decimal? PromoPrice,double PromoDiscount,string Remark,bool Enabled,bool? ForNonMembersAlso,bool? ForAllLocations,bool UsePrice,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5,int? Priority,string PromoCode,string Barcode,bool? IsRestricHour,DateTime? RestrictHourStart,DateTime? RestrictHourEnd)
	    {
		    PromoCampaignHdr item = new PromoCampaignHdr();
	        item.MarkOld();
	        item.IsLoaded = true;
