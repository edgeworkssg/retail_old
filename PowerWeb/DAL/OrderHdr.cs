...
{
	/// <summary>
	/// Strongly-typed collection for the OrderHdr class.
	/// </summary>
    [Serializable]
	public partial class OrderHdrCollection : ActiveList<OrderHdr, OrderHdrCollection>
	{	   
		public OrderHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OrderHdrCollection</returns>
		public OrderHdrCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OrderHdr table.
	/// </summary>
	[Serializable]
	public partial class OrderHdr : ActiveRecord<OrderHdr>, IActiveRecord
	{
		...
		public OrderHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrderHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OrderHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarOrderRefNo.DefaultSetting = @"";
				colvarOrderRefNo.ForeignKeyTableName = "";
				...
				colvarIsPointAllocated.IsReadOnly = false;
						...
						colvarIsPointAllocated.DefaultSetting = @"((0))";
				colvarIsPointAllocated.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("OrderHdr",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.OrderRefNo); }
			set { SetColumnValue(Columns.OrderRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<bool>(Columns.IsPointAllocated); }
			set { SetColumnValue(Columns.IsPointAllocated, value); }
		}
		...
		{
			return new PowerPOS.OrderDetCollection().Where(OrderDet.Columns.OrderHdrID, OrderHdrID).Load();
		}
		public PowerPOS.OrderTransferCollection OrderTransferRecords()
		{
			return new PowerPOS.OrderTransferCollection().Where(OrderTransfer.Columns.OrderHdrID, OrderHdrID).Load();
		}
		public PowerPOS.PackageHdrCollection PackageHdrRecords()
		{
			return new PowerPOS.PackageHdrCollection().Where(PackageHdr.Columns.OrderHdrId, OrderHdrID).Load();
		}
		public PowerPOS.ReceiptHdrCollection ReceiptHdrRecords()
		{
			return new PowerPOS.ReceiptHdrCollection().Where(ReceiptHdr.Columns.OrderHdrID, OrderHdrID).Load();
		}
		public PowerPOS.SalesCommissionRecordCollection SalesCommissionRecordRecords()
		{
			return new PowerPOS.SalesCommissionRecordCollection().Where(SalesCommissionRecord.Columns.OrderHdrID, OrderHdrID).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this OrderHdr
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varOrderHdrID,string varOrderRefNo,decimal varDiscount,string varInventoryHdrRefNo,string varCashierID,int varPointOfSaleID,DateTime varOrderDate,decimal varGrossAmount,decimal varNettAmount,decimal varDiscountAmount,double varGst,bool varIsVoided,string varMembershipNo,string varRemark,DateTime varCreatedOn,string varCreatedBy,DateTime varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varPromoCodeID,decimal? varGSTAmount,bool varIsPointAllocated,string varCashierSignature,long? varDataIndex)
		{
			OrderHdr item = new OrderHdr();
			
			item.OrderHdrID = varOrderHdrID;
			
			item.OrderRefNo = varOrderRefNo;
			...
			item.IsPointAllocated = varIsPointAllocated;
		...
		/// </summary>
		public static void Update(string varOrderHdrID,string varOrderRefNo,decimal varDiscount,string varInventoryHdrRefNo,string varCashierID,int varPointOfSaleID,DateTime varOrderDate,decimal varGrossAmount,decimal varNettAmount,decimal varDiscountAmount,double varGst,bool varIsVoided,string varMembershipNo,string varRemark,DateTime varCreatedOn,string varCreatedBy,DateTime varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varPromoCodeID,decimal? varGSTAmount,bool varIsPointAllocated,string varCashierSignature,long? varDataIndex)
		{
			OrderHdr item = new OrderHdr();
        ...
        public static TableSchema.TableColumn OrderRefNoColumn
        {
        ...
        public static TableSchema.TableColumn IsPointAllocatedColumn
        {
