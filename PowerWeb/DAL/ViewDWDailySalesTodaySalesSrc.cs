...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailySalesTodaySalesSrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesTodaySalesSrcCollection : ReadOnlyList<ViewDWDailySalesTodaySalesSrc, ViewDWDailySalesTodaySalesSrcCollection>
    {        
        public ViewDWDailySalesTodaySalesSrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailySales_today_sales_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesTodaySalesSrc : ReadOnlyRecord<ViewDWDailySalesTodaySalesSrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailySales_today_sales_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailySales_today_sales_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailySalesTodaySalesSrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailySalesTodaySalesSrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailySalesTodaySalesSrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailySalesTodaySalesSrc(string columnName, object columnValue)
        {
            SetSQLProps();
