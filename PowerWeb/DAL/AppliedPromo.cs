...
{
	/// <summary>
	/// Strongly-typed collection for the AppliedPromo class.
	/// </summary>
    [Serializable]
	public partial class AppliedPromoCollection : ActiveList<AppliedPromo, AppliedPromoCollection>
	{	   
		public AppliedPromoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AppliedPromoCollection</returns>
		public AppliedPromoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AppliedPromo o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AppliedPromo table.
	/// </summary>
	[Serializable]
	public partial class AppliedPromo : ActiveRecord<AppliedPromo>, IActiveRecord
	{
		...
		public AppliedPromo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AppliedPromo(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AppliedPromo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppliedPromo", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarAppliedPromoID.AutoIncrement = true;
				...
				colvarOrderHdrID.DataType = DbType.Int32;
				colvarOrderHdrID.MaxLength = 0;
				...
				DataService.Providers["PowerPOS"].AddSchema("AppliedPromo",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.OrderHdrID); }
		...
		/// </summary>
		public static void Update(int varAppliedPromoID,int varPromoCampaignHdrID,int varOrderHdrID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,DateTime? varLastEditDate,DateTime? varCreationDate)
		{
			AppliedPromo item = new AppliedPromo();
