...
{
	/// <summary>
	/// Strongly-typed collection for the SpecialEvent class.
	/// </summary>
    [Serializable]
	public partial class SpecialEventCollection : ActiveList<SpecialEvent, SpecialEventCollection>
	{	   
		public SpecialEventCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SpecialEventCollection</returns>
		public SpecialEventCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SpecialEvent o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SpecialEvent table.
	/// </summary>
	[Serializable]
	public partial class SpecialEvent : ActiveRecord<SpecialEvent>, IActiveRecord
	{
		...
		public SpecialEvent(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SpecialEvent(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SpecialEvent(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SpecialEvent", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarEventName.DataType = DbType.AnsiString;
				...
				DataService.Providers["PowerPOS"].AddSchema("SpecialEvent",schema);
			}
		}
		#endregion
		...
		{
			return new PowerPOS.EventAttendanceCollection().Where(EventAttendance.Columns.SpecialEventId, EventId).Load();
		}
		public PowerPOS.EventItemMapCollection EventItemMapRecords()
		{
			return new PowerPOS.EventItemMapCollection().Where(EventItemMap.Columns.EventId, EventId).Load();
		}
		public PowerPOS.EventLocationMapCollection EventLocationMapRecords()
		{
			return new PowerPOS.EventLocationMapCollection().Where(EventLocationMap.Columns.EventID, EventId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varEventId,string varEventName,DateTime? varStartDate,DateTime? varEndDate,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,Guid varUniqueID,string varUserFld1,string varUserFld2,string varUserFld3,string varUserFld4,string varUserFld5,string varUserFld6,string varUserFld7,string varUserFld8,string varUserFld9,string varUserFld10,decimal? varUserFloat1,decimal? varUserFloat2,decimal? varUserFloat3,decimal? varUserFloat4,decimal? varUserFloat5,bool? varUserFlag1,bool? varUserFlag2,bool? varUserFlag3,bool? varUserFlag4,bool? varUserFlag5,int? varUserInt1,int? varUserInt2,int? varUserInt3,int? varUserInt4,int? varUserInt5)
		{
			SpecialEvent item = new SpecialEvent();
