...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewVouchersSold class.
    /// </summary>
    [Serializable]
    public partial class ViewVouchersSoldCollection : ReadOnlyList<ViewVouchersSold, ViewVouchersSoldCollection>
    {        
        public ViewVouchersSoldCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewVouchersSold view.
    /// </summary>
    [Serializable]
    public partial class ViewVouchersSold : ReadOnlyRecord<ViewVouchersSold>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewVouchersSold", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewVouchersSold",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewVouchersSold()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewVouchersSold(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewVouchersSold(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewVouchersSold(string columnName, object columnValue)
        {
            SetSQLProps();
