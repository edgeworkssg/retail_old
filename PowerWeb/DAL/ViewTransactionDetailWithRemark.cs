...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewTransactionDetailWithRemark class.
    /// </summary>
    [Serializable]
    public partial class ViewTransactionDetailWithRemarkCollection : ReadOnlyList<ViewTransactionDetailWithRemark, ViewTransactionDetailWithRemarkCollection>
    {        
        public ViewTransactionDetailWithRemarkCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewTransactionDetailWithRemark view.
    /// </summary>
    [Serializable]
    public partial class ViewTransactionDetailWithRemark : ReadOnlyRecord<ViewTransactionDetailWithRemark>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewTransactionDetailWithRemark", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                colvarLineRemark.DataType = DbType.String;
                colvarLineRemark.MaxLength = -1;
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewTransactionDetailWithRemark",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewTransactionDetailWithRemark()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewTransactionDetailWithRemark(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewTransactionDetailWithRemark(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewTransactionDetailWithRemark(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string LineRemark 
	    {
		    get
		    {
			    return GetColumnValue<string>("LineRemark");
		    }
            set 
		    {
			    SetColumnValue("LineRemark", value);
            }
        }
