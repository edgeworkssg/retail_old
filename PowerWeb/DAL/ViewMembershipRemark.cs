...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewMembershipRemark class.
    /// </summary>
    [Serializable]
    public partial class ViewMembershipRemarkCollection : ReadOnlyList<ViewMembershipRemark, ViewMembershipRemarkCollection>
    {        
        public ViewMembershipRemarkCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewMembershipRemark view.
    /// </summary>
    [Serializable]
    public partial class ViewMembershipRemark : ReadOnlyRecord<ViewMembershipRemark>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewMembershipRemark", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                TableSchema.TableColumn colvarMemberRemark = new TableSchema.TableColumn(schema);
                colvarMemberRemark.ColumnName = "MemberRemark";
                colvarMemberRemark.DataType = DbType.String;
                colvarMemberRemark.MaxLength = -1;
                colvarMemberRemark.AutoIncrement = false;
                colvarMemberRemark.IsNullable = false;
                colvarMemberRemark.IsPrimaryKey = false;
                colvarMemberRemark.IsForeignKey = false;
                colvarMemberRemark.IsReadOnly = false;
                
                schema.Columns.Add(colvarMemberRemark);
                
                
                BaseSchema = schema;
                //add this schema to the provider
                //so we can query it later
                DataService.Providers["PowerPOS"].AddSchema("ViewMembershipRemark",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMembershipRemark()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMembershipRemark(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMembershipRemark(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMembershipRemark(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public DateTime RemarkDate 
	    {
		    get
		    {
			    return GetColumnValue<DateTime>("RemarkDate");
		    }
            set 
		    {
			    SetColumnValue("RemarkDate", value);
            }
        }
        ...
        public int RemarkCategoryId 
	    {
		    get
		    {
			    return GetColumnValue<int>("RemarkCategoryId");
		    }
            set 
		    {
			    SetColumnValue("RemarkCategoryId", value);
            }
        }
        ...
        public string RemarkCategoryName 
	    {
		    get
		    {
			    return GetColumnValue<string>("RemarkCategoryName");
		    }
            set 
		    {
			    SetColumnValue("RemarkCategoryName", value);
            }
        }
	      
        [XmlAttribute("MemberRemark")]
        [Bindable(true)]
        public string MemberRemark 
	    {
		    get
		    {
			    return GetColumnValue<string>("MemberRemark");
		    }
            set 
		    {
			    SetColumnValue("MemberRemark", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string MemberRemark = @"MemberRemark";
