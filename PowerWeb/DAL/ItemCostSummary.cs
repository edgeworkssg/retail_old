...
{
	/// <summary>
	/// Strongly-typed collection for the ItemCostSummary class.
	/// </summary>
    [Serializable]
	public partial class ItemCostSummaryCollection : ActiveList<ItemCostSummary, ItemCostSummaryCollection>
	{	   
		public ItemCostSummaryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemCostSummaryCollection</returns>
		public ItemCostSummaryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemCostSummary o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemCostSummary table.
	/// </summary>
	[Serializable]
	public partial class ItemCostSummary : ActiveRecord<ItemCostSummary>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemCostSummary()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemCostSummary(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemCostSummary(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemCostSummary(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemCostSummary", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemCostSummaryID = new TableSchema.TableColumn(schema);
				colvarItemCostSummaryID.ColumnName = "ItemCostSummaryID";
				colvarItemCostSummaryID.DataType = DbType.AnsiString;
				colvarItemCostSummaryID.MaxLength = 50;
				colvarItemCostSummaryID.AutoIncrement = false;
				colvarItemCostSummaryID.IsNullable = false;
				colvarItemCostSummaryID.IsPrimaryKey = true;
				colvarItemCostSummaryID.IsForeignKey = false;
				colvarItemCostSummaryID.IsReadOnly = false;
				colvarItemCostSummaryID.DefaultSetting = @"";
				colvarItemCostSummaryID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemCostSummaryID);
				...
				TableSchema.TableColumn colvarLastPurchasePrice = new TableSchema.TableColumn(schema);
				colvarLastPurchasePrice.ColumnName = "LastPurchasePrice";
				colvarLastPurchasePrice.DataType = DbType.Currency;
				colvarLastPurchasePrice.MaxLength = 0;
				colvarLastPurchasePrice.AutoIncrement = false;
				colvarLastPurchasePrice.IsNullable = true;
				colvarLastPurchasePrice.IsPrimaryKey = false;
				colvarLastPurchasePrice.IsForeignKey = false;
				colvarLastPurchasePrice.IsReadOnly = false;
				colvarLastPurchasePrice.DefaultSetting = @"";
				colvarLastPurchasePrice.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLastPurchasePrice);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemCostSummary",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemCostSummaryID")]
		[Bindable(true)]
		public string ItemCostSummaryID 
		{
			get { return GetColumnValue<string>(Columns.ItemCostSummaryID); }
			set { SetColumnValue(Columns.ItemCostSummaryID, value); }
		}
		...
		[XmlAttribute("LastPurchasePrice")]
		[Bindable(true)]
		public decimal? LastPurchasePrice 
		{
			get { return GetColumnValue<decimal?>(Columns.LastPurchasePrice); }
			set { SetColumnValue(Columns.LastPurchasePrice, value); }
		}
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemCostSummary
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varItemCostSummaryID,string varItemNo,double? varBalanceQuantity,decimal? varAvgCostPrice,decimal? varLastPurchasePrice,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemCostSummary item = new ItemCostSummary();
			
			item.ItemCostSummaryID = varItemCostSummaryID;
			...
			item.LastPurchasePrice = varLastPurchasePrice;
		...
		/// </summary>
		public static void Update(string varItemCostSummaryID,string varItemNo,double? varBalanceQuantity,decimal? varAvgCostPrice,decimal? varLastPurchasePrice,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemCostSummary item = new ItemCostSummary();
        ...
        public static TableSchema.TableColumn ItemCostSummaryIDColumn
        {
        ...
        public static TableSchema.TableColumn LastPurchasePriceColumn
        {
		...
		{
			 public static string ItemCostSummaryID = @"ItemCostSummaryID";
			 public static string ItemNo = @"ItemNo";
			 public static string BalanceQuantity = @"BalanceQuantity";
			 public static string AvgCostPrice = @"AvgCostPrice";
			 public static string LastPurchasePrice = @"LastPurchasePrice";
