...
{
	/// <summary>
	/// Strongly-typed collection for the OrderDetTransfer class.
	/// </summary>
    [Serializable]
	public partial class OrderDetTransferCollection : ActiveList<OrderDetTransfer, OrderDetTransferCollection>
	{	   
		public OrderDetTransferCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OrderDetTransferCollection</returns>
		public OrderDetTransferCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OrderDetTransfer o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OrderDetTransfer table.
	/// </summary>
	[Serializable]
	public partial class OrderDetTransfer : ActiveRecord<OrderDetTransfer>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public OrderDetTransfer()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public OrderDetTransfer(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OrderDetTransfer(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OrderDetTransfer(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OrderDetTransfer", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarOrderDetTransferID = new TableSchema.TableColumn(schema);
				colvarOrderDetTransferID.ColumnName = "OrderDetTransferID";
				colvarOrderDetTransferID.DataType = DbType.AnsiString;
				colvarOrderDetTransferID.MaxLength = 20;
				colvarOrderDetTransferID.AutoIncrement = false;
				colvarOrderDetTransferID.IsNullable = false;
				colvarOrderDetTransferID.IsPrimaryKey = true;
				colvarOrderDetTransferID.IsForeignKey = false;
				colvarOrderDetTransferID.IsReadOnly = false;
				colvarOrderDetTransferID.DefaultSetting = @"";
				colvarOrderDetTransferID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOrderDetTransferID);
				...
				DataService.Providers["PowerPOS"].AddSchema("OrderDetTransfer",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OrderDetTransferID")]
		[Bindable(true)]
		public string OrderDetTransferID 
		{
			get { return GetColumnValue<string>(Columns.OrderDetTransferID); }
			set { SetColumnValue(Columns.OrderDetTransferID, value); }
		}
		...
		/// <summary>
		/// Returns a OrderDet ActiveRecord object related to this OrderDetTransfer
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(string varOrderDetTransferID,string varOrderDetID,string varInventoryHdrRefNo,int? varTransferFrom,int? varTransferTo,string varItemNo,int? varQuantity,string varRemarks,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			OrderDetTransfer item = new OrderDetTransfer();
        ...
        public static TableSchema.TableColumn OrderDetTransferIDColumn
        {
		...
		{
			 public static string OrderDetTransferID = @"OrderDetTransferID";
