...
{
    /// <summary>
    /// Controller class for OutletGroup
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class OutletGroupController
    {
        // Preload our schema..
        OutletGroup thisSchemaLoad = new OutletGroup();
        ...
        public OutletGroupCollection FetchAll()
        {
            OutletGroupCollection coll = new OutletGroupCollection();
            Query qry = new Query(OutletGroup.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public OutletGroupCollection FetchByID(object OutletGroupID)
        {
            OutletGroupCollection coll = new OutletGroupCollection().Where("OutletGroupID", OutletGroupID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public OutletGroupCollection FetchByQuery(Query qry)
        {
            OutletGroupCollection coll = new OutletGroupCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object OutletGroupID)
        {
            return (OutletGroup.Delete(OutletGroupID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object OutletGroupID)
        {
            return (OutletGroup.Destroy(OutletGroupID) == 1);
        }
	    ...
	    public void Update(int OutletGroupID,string OutletGroupName,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    OutletGroup item = new OutletGroup();
	        item.MarkOld();
	        item.IsLoaded = true;
