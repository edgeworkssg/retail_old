...
{
	/// <summary>
	/// Strongly-typed collection for the CashRecording class.
	/// </summary>
    [Serializable]
	public partial class CashRecordingCollection : ActiveList<CashRecording, CashRecordingCollection>
	{	   
		public CashRecordingCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CashRecordingCollection</returns>
		public CashRecordingCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CashRecording o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CashRecording table.
	/// </summary>
	[Serializable]
	public partial class CashRecording : ActiveRecord<CashRecording>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public CashRecording()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public CashRecording(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CashRecording(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CashRecording(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CashRecording", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarCashRecID = new TableSchema.TableColumn(schema);
				colvarCashRecID.ColumnName = "CashRecID";
				colvarCashRecID.DataType = DbType.Int32;
				colvarCashRecID.MaxLength = 0;
				colvarCashRecID.AutoIncrement = true;
				colvarCashRecID.IsNullable = false;
				colvarCashRecID.IsPrimaryKey = true;
				colvarCashRecID.IsForeignKey = false;
				colvarCashRecID.IsReadOnly = false;
				colvarCashRecID.DefaultSetting = @"";
				colvarCashRecID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCashRecID);
				...
				colvarCashRecRefNo.DefaultSetting = @"";
				colvarCashRecRefNo.ForeignKeyTableName = "";
				...
				colvarCashRecordingTime.DefaultSetting = @"";
				colvarCashRecordingTime.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarCashRecordingTypeId = new TableSchema.TableColumn(schema);
				colvarCashRecordingTypeId.ColumnName = "CashRecordingTypeId";
				colvarCashRecordingTypeId.DataType = DbType.Int32;
				colvarCashRecordingTypeId.MaxLength = 0;
				colvarCashRecordingTypeId.AutoIncrement = false;
				colvarCashRecordingTypeId.IsNullable = false;
				colvarCashRecordingTypeId.IsPrimaryKey = false;
				colvarCashRecordingTypeId.IsForeignKey = true;
				colvarCashRecordingTypeId.IsReadOnly = false;
				colvarCashRecordingTypeId.DefaultSetting = @"";
				
					colvarCashRecordingTypeId.ForeignKeyTableName = "CashRecordingType";
				schema.Columns.Add(colvarCashRecordingTypeId);
				...
				colvarCashierName.DefaultSetting = @"";
				colvarCashierName.ForeignKeyTableName = "";
				...
				colvarSupervisorName.DefaultSetting = @"";
				colvarSupervisorName.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarCashierSignature = new TableSchema.TableColumn(schema);
				colvarCashierSignature.ColumnName = "CashierSignature";
				colvarCashierSignature.DataType = DbType.String;
				colvarCashierSignature.MaxLength = -1;
				colvarCashierSignature.AutoIncrement = false;
				colvarCashierSignature.IsNullable = true;
				colvarCashierSignature.IsPrimaryKey = false;
				colvarCashierSignature.IsForeignKey = false;
				colvarCashierSignature.IsReadOnly = false;
				colvarCashierSignature.DefaultSetting = @"";
				colvarCashierSignature.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCashierSignature);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["PowerPOS"].AddSchema("CashRecording",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CashRecID")]
		[Bindable(true)]
		public int CashRecID 
		{
			get { return GetColumnValue<int>(Columns.CashRecID); }
			set { SetColumnValue(Columns.CashRecID, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.CashRecRefNo); }
			set { SetColumnValue(Columns.CashRecRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime>(Columns.CashRecordingTime); }
			set { SetColumnValue(Columns.CashRecordingTime, value); }
		}
		...
		[XmlAttribute("CashRecordingTypeId")]
		[Bindable(true)]
		public int CashRecordingTypeId 
		{
			get { return GetColumnValue<int>(Columns.CashRecordingTypeId); }
			set { SetColumnValue(Columns.CashRecordingTypeId, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.CashierName); }
			set { SetColumnValue(Columns.CashierName, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.SupervisorName); }
			set { SetColumnValue(Columns.SupervisorName, value); }
		}
		...
		[XmlAttribute("CashierSignature")]
		[Bindable(true)]
		public string CashierSignature 
		{
			get { return GetColumnValue<string>(Columns.CashierSignature); }
			set { SetColumnValue(Columns.CashierSignature, value); }
		}
		...
		/// <summary>
		/// Returns a CashRecordingType ActiveRecord object related to this CashRecording
		/// 
		/// </summary>
		public PowerPOS.CashRecordingType CashRecordingType
		{
			get { return PowerPOS.CashRecordingType.FetchByID(this.CashRecordingTypeId); }
			set { SetColumnValue("CashRecordingTypeId", value.CashRecordingTypeId); }
		}
		
		
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this CashRecording
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varCashRecRefNo,DateTime varCashRecordingTime,decimal varAmount,int varCashRecordingTypeId,int varPointOfSaleID,string varCashierName,string varSupervisorName,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,string varCashierSignature)
		{
			CashRecording item = new CashRecording();
			
			item.CashRecRefNo = varCashRecRefNo;
			
			item.CashRecordingTime = varCashRecordingTime;
			
			item.Amount = varAmount;
			
			item.CashRecordingTypeId = varCashRecordingTypeId;
			
			item.PointOfSaleID = varPointOfSaleID;
			
			item.CashierName = varCashierName;
			
			item.SupervisorName = varSupervisorName;
			...
			item.CashierSignature = varCashierSignature;
		...
		/// </summary>
		public static void Update(int varCashRecID,string varCashRecRefNo,DateTime varCashRecordingTime,decimal varAmount,int varCashRecordingTypeId,int varPointOfSaleID,string varCashierName,string varSupervisorName,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,string varCashierSignature)
		{
			CashRecording item = new CashRecording();
			
				item.CashRecID = varCashRecID;
        ...
        public static TableSchema.TableColumn CashRecIDColumn
        {
        ...
        public static TableSchema.TableColumn CashRecRefNoColumn
        {
        ...
        public static TableSchema.TableColumn CashRecordingTimeColumn
        {
        ...
        public static TableSchema.TableColumn CashRecordingTypeIdColumn
        {
        ...
        public static TableSchema.TableColumn CashierNameColumn
        {
        ...
        public static TableSchema.TableColumn SupervisorNameColumn
        {
        ...
        public static TableSchema.TableColumn CashierSignatureColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string CashierSignature = @"CashierSignature";
