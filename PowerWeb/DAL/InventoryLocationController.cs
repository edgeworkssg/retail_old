...
{
    /// <summary>
    /// Controller class for InventoryLocation
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class InventoryLocationController
    {
        // Preload our schema..
        InventoryLocation thisSchemaLoad = new InventoryLocation();
        ...
        public InventoryLocationCollection FetchAll()
        {
            InventoryLocationCollection coll = new InventoryLocationCollection();
            Query qry = new Query(InventoryLocation.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public InventoryLocationCollection FetchByID(object InventoryLocationID)
        {
            InventoryLocationCollection coll = new InventoryLocationCollection().Where("InventoryLocationID", InventoryLocationID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public InventoryLocationCollection FetchByQuery(Query qry)
        {
            InventoryLocationCollection coll = new InventoryLocationCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object InventoryLocationID)
        {
            return (InventoryLocation.Delete(InventoryLocationID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object InventoryLocationID)
        {
            return (InventoryLocation.Destroy(InventoryLocationID) == 1);
        }
	    ...
	    public void Update(int InventoryLocationID,string InventoryLocationName,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    InventoryLocation item = new InventoryLocation();
	        item.MarkOld();
	        item.IsLoaded = true;
