...
{
	/// <summary>
	/// Strongly-typed collection for the SyncLog class.
	/// </summary>
    [Serializable]
	public partial class SyncLogCollection : ActiveList<SyncLog, SyncLogCollection>
	{	   
        ...
        /// </summary>
        /// <returns>SyncLogCollection</returns>
		public SyncLogCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SyncLog table.
	/// </summary>
	[Serializable]
	public partial class SyncLog : ActiveRecord<SyncLog>, IActiveRecord
	{
		...
		public SyncLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SyncLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SyncLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarSyncLogID = new TableSchema.TableColumn(schema);
				colvarSyncLogID.ColumnName = "SyncLogID";
				colvarSyncLogID.DataType = DbType.Int32;
				colvarSyncLogID.MaxLength = 0;
				colvarSyncLogID.AutoIncrement = true;
				colvarSyncLogID.IsNullable = false;
				colvarSyncLogID.IsPrimaryKey = true;
				colvarSyncLogID.IsForeignKey = false;
				colvarSyncLogID.IsReadOnly = false;
				colvarSyncLogID.DefaultSetting = @"";
				colvarSyncLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSyncLogID);
				
				TableSchema.TableColumn colvarSyncDateTime = new TableSchema.TableColumn(schema);
				colvarSyncDateTime.ColumnName = "SyncDateTime";
				colvarSyncDateTime.DataType = DbType.DateTime;
				colvarSyncDateTime.MaxLength = 0;
				colvarSyncDateTime.AutoIncrement = false;
				colvarSyncDateTime.IsNullable = false;
				colvarSyncDateTime.IsPrimaryKey = false;
				colvarSyncDateTime.IsForeignKey = false;
				colvarSyncDateTime.IsReadOnly = false;
				colvarSyncDateTime.DefaultSetting = @"";
				colvarSyncDateTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSyncDateTime);
				...
				DataService.Providers["PowerPOS"].AddSchema("SyncLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("SyncLogID")]
		[Bindable(true)]
		public int SyncLogID 
		{
			get { return GetColumnValue<int>(Columns.SyncLogID); }
			set { SetColumnValue(Columns.SyncLogID, value); }
		}
		  
		[XmlAttribute("SyncDateTime")]
		[Bindable(true)]
		public DateTime SyncDateTime 
		{
			get { return GetColumnValue<DateTime>(Columns.SyncDateTime); }
			set { SetColumnValue(Columns.SyncDateTime, value); }
		}
		...
		/// </summary>
		public static void Update(int varSyncLogID,DateTime varSyncDateTime,string varPointOfSaleID,string varOutletName,string varIPAddress,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SyncLog item = new SyncLog();
			
				item.SyncLogID = varSyncLogID;
        ...
        public static TableSchema.TableColumn SyncLogIDColumn
        {
        ...
        public static TableSchema.TableColumn SyncDateTimeColumn
        {
		...
		{
			 public static string SyncLogID = @"SyncLogID";
			 public static string SyncDateTime = @"SyncDateTime";
