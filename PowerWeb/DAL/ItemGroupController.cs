...
{
    /// <summary>
    /// Controller class for ItemGroup
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ItemGroupController
    {
        // Preload our schema..
        ItemGroup thisSchemaLoad = new ItemGroup();
        ...
        public ItemGroupCollection FetchAll()
        {
            ItemGroupCollection coll = new ItemGroupCollection();
            Query qry = new Query(ItemGroup.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemGroupCollection FetchByID(object ItemGroupId)
        {
            ItemGroupCollection coll = new ItemGroupCollection().Where("ItemGroupId", ItemGroupId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public ItemGroupCollection FetchByQuery(Query qry)
        {
            ItemGroupCollection coll = new ItemGroupCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object ItemGroupId)
        {
            return (ItemGroup.Delete(ItemGroupId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ItemGroupId)
        {
            return (ItemGroup.Destroy(ItemGroupId) == 1);
        }
	    ...
	    public void Update(int ItemGroupId,string ItemGroupName,string Barcode,bool? UniqueItems,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    ItemGroup item = new ItemGroup();
	        item.MarkOld();
	        item.IsLoaded = true;
