...
{
	/// <summary>
	/// Strongly-typed collection for the DwRegenerateDate class.
	/// </summary>
    [Serializable]
	public partial class DwRegenerateDateCollection : ActiveList<DwRegenerateDate, DwRegenerateDateCollection>
	{	   
		public DwRegenerateDateCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DwRegenerateDateCollection</returns>
		public DwRegenerateDateCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                DwRegenerateDate o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the DW_RegenerateDate table.
	/// </summary>
	[Serializable]
	public partial class DwRegenerateDate : ActiveRecord<DwRegenerateDate>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public DwRegenerateDate()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public DwRegenerateDate(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public DwRegenerateDate(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public DwRegenerateDate(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("DW_RegenerateDate", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarOutletName.DataType = DbType.String;
				colvarOutletName.MaxLength = 500;
				...
				DataService.Providers["PowerPOS"].AddSchema("DW_RegenerateDate",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(Guid varId,DateTime varOrderDate,string varOutletName,string varRemarks,string varCreatedBy,string varModifiedBy,DateTime? varCreatedOn,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			DwRegenerateDate item = new DwRegenerateDate();
