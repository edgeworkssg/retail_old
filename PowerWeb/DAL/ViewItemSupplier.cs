...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewItemSupplier class.
    /// </summary>
    [Serializable]
    public partial class ViewItemSupplierCollection : ReadOnlyList<ViewItemSupplier, ViewItemSupplierCollection>
    {        
        public ViewItemSupplierCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewItemSupplier view.
    /// </summary>
    [Serializable]
    public partial class ViewItemSupplier : ReadOnlyRecord<ViewItemSupplier>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewItemSupplier", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewItemSupplier",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewItemSupplier()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewItemSupplier(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewItemSupplier(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewItemSupplier(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public decimal CostPrice 
	    {
		    get
		    {
			    return GetColumnValue<decimal>("CostPrice");
		    }
            set 
		    {
			    SetColumnValue("CostPrice", value);
            }
        }
        ...
        public string SupplierName 
	    {
		    get
		    {
			    return GetColumnValue<string>("SupplierName");
		    }
            set 
		    {
