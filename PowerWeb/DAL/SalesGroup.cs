...
{
	/// <summary>
	/// Strongly-typed collection for the SalesGroup class.
	/// </summary>
    [Serializable]
	public partial class SalesGroupCollection : ActiveList<SalesGroup, SalesGroupCollection>
	{	   
		public SalesGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SalesGroupCollection</returns>
		public SalesGroupCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SalesGroup table.
	/// </summary>
	[Serializable]
	public partial class SalesGroup : ActiveRecord<SalesGroup>, IActiveRecord
	{
		...
		public SalesGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SalesGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SalesGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SalesGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarSalesGroupId.AutoIncrement = true;
				colvarSalesGroupId.IsNullable = false;
				colvarSalesGroupId.IsPrimaryKey = true;
				...
				colvarExpectedWorkingHours.DefaultSetting = @"";
				colvarExpectedWorkingHours.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("SalesGroup",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.ExpectedWorkingHours); }
			set { SetColumnValue(Columns.ExpectedWorkingHours, value); }
		}
		...
		public PowerPOS.CommissionStructureCollection CommissionStructureRecords()
		{
			return new PowerPOS.CommissionStructureCollection().Where(CommissionStructure.Columns.SalesGroupID, SalesGroupId).Load();
		}
		public PowerPOS.SalesPersonCollection SalesPersonRecords()
		{
			return new PowerPOS.SalesPersonCollection().Where(SalesPerson.Columns.SalesPersonGroupID, SalesGroupId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varSalesGroupId,string varGroupName,int varExpectedWorkingHours,string varModifiedBy,DateTime? varModifiedOn,string varCreatedBy,DateTime? varCreatedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesGroup item = new SalesGroup();
        ...
        public static TableSchema.TableColumn ExpectedWorkingHoursColumn
        {
