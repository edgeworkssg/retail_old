...
{
	/// <summary>
	/// Strongly-typed collection for the OutletGroupItemMap class.
	/// </summary>
    [Serializable]
	public partial class OutletGroupItemMapCollection : ActiveList<OutletGroupItemMap, OutletGroupItemMapCollection>
	{	   
		public OutletGroupItemMapCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OutletGroupItemMapCollection</returns>
		public OutletGroupItemMapCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OutletGroupItemMap o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OutletGroupItemMap table.
	/// </summary>
	[Serializable]
	public partial class OutletGroupItemMap : ActiveRecord<OutletGroupItemMap>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public OutletGroupItemMap()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public OutletGroupItemMap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OutletGroupItemMap(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OutletGroupItemMap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OutletGroupItemMap", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarOutletGroupItemMapID = new TableSchema.TableColumn(schema);
				colvarOutletGroupItemMapID.ColumnName = "OutletGroupItemMapID";
				colvarOutletGroupItemMapID.DataType = DbType.Int32;
				colvarOutletGroupItemMapID.MaxLength = 0;
				colvarOutletGroupItemMapID.AutoIncrement = true;
				colvarOutletGroupItemMapID.IsNullable = false;
				colvarOutletGroupItemMapID.IsPrimaryKey = true;
				colvarOutletGroupItemMapID.IsForeignKey = false;
				colvarOutletGroupItemMapID.IsReadOnly = false;
				colvarOutletGroupItemMapID.DefaultSetting = @"";
				colvarOutletGroupItemMapID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOutletGroupItemMapID);
				
				TableSchema.TableColumn colvarOutletGroupID = new TableSchema.TableColumn(schema);
				colvarOutletGroupID.ColumnName = "OutletGroupID";
				colvarOutletGroupID.DataType = DbType.Int32;
				colvarOutletGroupID.MaxLength = 0;
				colvarOutletGroupID.AutoIncrement = false;
				colvarOutletGroupID.IsNullable = true;
				colvarOutletGroupID.IsPrimaryKey = false;
				colvarOutletGroupID.IsForeignKey = false;
				colvarOutletGroupID.IsReadOnly = false;
				colvarOutletGroupID.DefaultSetting = @"";
				colvarOutletGroupID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOutletGroupID);
				...
				colvarCostPrice.IsReadOnly = false;
						...
						colvarCostPrice.DefaultSetting = @"((0))";
				...
				TableSchema.TableColumn colvarIsItemDeleted = new TableSchema.TableColumn(schema);
				colvarIsItemDeleted.ColumnName = "IsItemDeleted";
				colvarIsItemDeleted.DataType = DbType.Boolean;
				colvarIsItemDeleted.MaxLength = 0;
				colvarIsItemDeleted.AutoIncrement = false;
				colvarIsItemDeleted.IsNullable = true;
				colvarIsItemDeleted.IsPrimaryKey = false;
				colvarIsItemDeleted.IsForeignKey = false;
				colvarIsItemDeleted.IsReadOnly = false;
				colvarIsItemDeleted.DefaultSetting = @"";
				colvarIsItemDeleted.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsItemDeleted);
				...
				DataService.Providers["PowerPOS"].AddSchema("OutletGroupItemMap",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OutletGroupItemMapID")]
		[Bindable(true)]
		public int OutletGroupItemMapID 
		{
			get { return GetColumnValue<int>(Columns.OutletGroupItemMapID); }
			set { SetColumnValue(Columns.OutletGroupItemMapID, value); }
		}
		  
		[XmlAttribute("OutletGroupID")]
		[Bindable(true)]
		public int? OutletGroupID 
		{
			get { return GetColumnValue<int?>(Columns.OutletGroupID); }
			set { SetColumnValue(Columns.OutletGroupID, value); }
		}
		...
		[XmlAttribute("IsItemDeleted")]
		[Bindable(true)]
		public bool? IsItemDeleted 
		{
			get { return GetColumnValue<bool?>(Columns.IsItemDeleted); }
			set { SetColumnValue(Columns.IsItemDeleted, value); }
		}
		...
		public static void Insert(int? varOutletGroupID,string varOutletName,string varItemNo,decimal varRetailPrice,decimal varCostPrice,bool varDeleted,DateTime? varModifiedOn,string varModifiedBy,DateTime? varCreatedOn,string varCreatedBy,bool? varIsItemDeleted,decimal? varP1,decimal? varP2,decimal? varP3,decimal? varP4,decimal? varP5,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.IsItemDeleted = varIsItemDeleted;
		...
		/// </summary>
		public static void Update(int varOutletGroupItemMapID,int? varOutletGroupID,string varOutletName,string varItemNo,decimal varRetailPrice,decimal varCostPrice,bool varDeleted,DateTime? varModifiedOn,string varModifiedBy,DateTime? varCreatedOn,string varCreatedBy,bool? varIsItemDeleted,decimal? varP1,decimal? varP2,decimal? varP3,decimal? varP4,decimal? varP5,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			OutletGroupItemMap item = new OutletGroupItemMap();
			
				item.OutletGroupItemMapID = varOutletGroupItemMapID;
        ...
        public static TableSchema.TableColumn OutletGroupItemMapIDColumn
        {
        ...
        public static TableSchema.TableColumn OutletGroupIDColumn
        {
        ...
        public static TableSchema.TableColumn IsItemDeletedColumn
        {
		...
		{
			 public static string OutletGroupItemMapID = @"OutletGroupItemMapID";
			 public static string OutletGroupID = @"OutletGroupID";
			 ...
			 public static string IsItemDeleted = @"IsItemDeleted";
