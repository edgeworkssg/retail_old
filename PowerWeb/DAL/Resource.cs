...
namespace PowerPOS
{
	...
	public partial class Resource : ActiveRecord<Resource>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Resource", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarResourceID.IsNullable = false;
				colvarResourceID.IsPrimaryKey = true;
				...
				TableSchema.TableColumn colvarResourceName = new TableSchema.TableColumn(schema);
				colvarResourceName.ColumnName = "ResourceName";
				colvarResourceName.DataType = DbType.String;
				colvarResourceName.MaxLength = 255;
				colvarResourceName.AutoIncrement = false;
				colvarResourceName.IsNullable = true;
				colvarResourceName.IsPrimaryKey = false;
				colvarResourceName.IsForeignKey = false;
				colvarResourceName.IsReadOnly = false;
				colvarResourceName.DefaultSetting = @"";
				colvarResourceName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarResourceName);
				
				TableSchema.TableColumn colvarResourceGroupID = new TableSchema.TableColumn(schema);
				colvarResourceGroupID.ColumnName = "ResourceGroupID";
				colvarResourceGroupID.DataType = DbType.Int32;
				colvarResourceGroupID.MaxLength = 0;
				colvarResourceGroupID.AutoIncrement = false;
				colvarResourceGroupID.IsNullable = true;
				colvarResourceGroupID.IsPrimaryKey = false;
				colvarResourceGroupID.IsForeignKey = true;
				colvarResourceGroupID.IsReadOnly = false;
				colvarResourceGroupID.DefaultSetting = @"";
				
					colvarResourceGroupID.ForeignKeyTableName = "ResourceGroup";
				schema.Columns.Add(colvarResourceGroupID);
				...
				TableSchema.TableColumn colvarRoomCharge = new TableSchema.TableColumn(schema);
				colvarRoomCharge.ColumnName = "RoomCharge";
				colvarRoomCharge.DataType = DbType.Currency;
				colvarRoomCharge.MaxLength = 0;
				colvarRoomCharge.AutoIncrement = false;
				colvarRoomCharge.IsNullable = true;
				colvarRoomCharge.IsPrimaryKey = false;
				colvarRoomCharge.IsForeignKey = false;
				colvarRoomCharge.IsReadOnly = false;
				colvarRoomCharge.DefaultSetting = @"";
				colvarRoomCharge.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRoomCharge);
				
				TableSchema.TableColumn colvarMinSpending = new TableSchema.TableColumn(schema);
				colvarMinSpending.ColumnName = "MinSpending";
				colvarMinSpending.DataType = DbType.Currency;
				colvarMinSpending.MaxLength = 0;
				colvarMinSpending.AutoIncrement = false;
				colvarMinSpending.IsNullable = true;
				colvarMinSpending.IsPrimaryKey = false;
				colvarMinSpending.IsForeignKey = false;
				colvarMinSpending.IsReadOnly = false;
				colvarMinSpending.DefaultSetting = @"";
				colvarMinSpending.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMinSpending);
				
				TableSchema.TableColumn colvarMinSpendingCharge = new TableSchema.TableColumn(schema);
				colvarMinSpendingCharge.ColumnName = "MinSpendingCharge";
				colvarMinSpendingCharge.DataType = DbType.Currency;
				colvarMinSpendingCharge.MaxLength = 0;
				colvarMinSpendingCharge.AutoIncrement = false;
				colvarMinSpendingCharge.IsNullable = true;
				colvarMinSpendingCharge.IsPrimaryKey = false;
				colvarMinSpendingCharge.IsForeignKey = false;
				colvarMinSpendingCharge.IsReadOnly = false;
				colvarMinSpendingCharge.DefaultSetting = @"";
				colvarMinSpendingCharge.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMinSpendingCharge);
				
				TableSchema.TableColumn colvarShowHide = new TableSchema.TableColumn(schema);
				colvarShowHide.ColumnName = "ShowHide";
				colvarShowHide.DataType = DbType.Boolean;
				colvarShowHide.MaxLength = 0;
				colvarShowHide.AutoIncrement = false;
				colvarShowHide.IsNullable = true;
				colvarShowHide.IsPrimaryKey = false;
				colvarShowHide.IsForeignKey = false;
				colvarShowHide.IsReadOnly = false;
				colvarShowHide.DefaultSetting = @"";
				colvarShowHide.ForeignKeyTableName = "";
				schema.Columns.Add(colvarShowHide);
				...
				DataService.Providers["PowerPOS"].AddSchema("Resource",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.ResourceName); }
			set { SetColumnValue(Columns.ResourceName, value); }
		}
		  
		[XmlAttribute("ResourceGroupID")]
		[Bindable(true)]
		public int? ResourceGroupID 
		{
			get { return GetColumnValue<int?>(Columns.ResourceGroupID); }
			set { SetColumnValue(Columns.ResourceGroupID, value); }
		}
		...
		[XmlAttribute("RoomCharge")]
		[Bindable(true)]
		public decimal? RoomCharge 
		{
			get { return GetColumnValue<decimal?>(Columns.RoomCharge); }
			set { SetColumnValue(Columns.RoomCharge, value); }
		}
		  
		[XmlAttribute("MinSpending")]
		[Bindable(true)]
		public decimal? MinSpending 
		{
			get { return GetColumnValue<decimal?>(Columns.MinSpending); }
			set { SetColumnValue(Columns.MinSpending, value); }
		}
		  
		[XmlAttribute("MinSpendingCharge")]
		[Bindable(true)]
		public decimal? MinSpendingCharge 
		{
			get { return GetColumnValue<decimal?>(Columns.MinSpendingCharge); }
			set { SetColumnValue(Columns.MinSpendingCharge, value); }
		}
		  
		[XmlAttribute("ShowHide")]
		[Bindable(true)]
		public bool? ShowHide 
		{
			get { return GetColumnValue<bool?>(Columns.ShowHide); }
			set { SetColumnValue(Columns.ShowHide, value); }
		}
		...
		/// <summary>
		/// Returns a ResourceGroup ActiveRecord object related to this Resource
		/// 
		/// </summary>
		public PowerPOS.ResourceGroup ResourceGroup
		{
			get { return PowerPOS.ResourceGroup.FetchByID(this.ResourceGroupID); }
			set { SetColumnValue("ResourceGroupID", value.ResourceGroupID); }
		}
		...
		/// </summary>
		public static void Insert(string varResourceID,string varResourceName,int? varResourceGroupID,bool? varStatus,int? varCapacity,decimal? varRoomCharge,decimal? varMinSpending,decimal? varMinSpendingCharge,bool? varShowHide,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Resource item = new Resource();
			
			item.ResourceID = varResourceID;
			
			item.ResourceName = varResourceName;
			
			item.ResourceGroupID = varResourceGroupID;
			
			item.Status = varStatus;
			
			item.Capacity = varCapacity;
			
			item.RoomCharge = varRoomCharge;
			
			item.MinSpending = varMinSpending;
			
			item.MinSpendingCharge = varMinSpendingCharge;
			
			item.ShowHide = varShowHide;
		...
		/// </summary>
		public static void Update(string varResourceID,string varResourceName,int? varResourceGroupID,bool? varStatus,int? varCapacity,decimal? varRoomCharge,decimal? varMinSpending,decimal? varMinSpendingCharge,bool? varShowHide,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Resource item = new Resource();
        ...
        public static TableSchema.TableColumn ResourceNameColumn
        {
        ...
        public static TableSchema.TableColumn ResourceGroupIDColumn
        {
        ...
        public static TableSchema.TableColumn RoomChargeColumn
        {
        ...
        public static TableSchema.TableColumn MinSpendingColumn
        {
        ...
        public static TableSchema.TableColumn MinSpendingChargeColumn
        {
        ...
        public static TableSchema.TableColumn ShowHideColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string ResourceGroupID = @"ResourceGroupID";
			 public static string Status = @"Status";
			 public static string Capacity = @"Capacity";
			 public static string RoomCharge = @"RoomCharge";
			 public static string MinSpending = @"MinSpending";
			 public static string MinSpendingCharge = @"MinSpendingCharge";
			 public static string ShowHide = @"ShowHide";
