...
{
	/// <summary>
	/// Strongly-typed collection for the PaymentTerm class.
	/// </summary>
    [Serializable]
	public partial class PaymentTermCollection : ActiveList<PaymentTerm, PaymentTermCollection>
	{	   
        ...
        /// </summary>
        /// <returns>PaymentTermCollection</returns>
		public PaymentTermCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PaymentTerm o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PaymentTerm table.
	/// </summary>
	[Serializable]
	public partial class PaymentTerm : ActiveRecord<PaymentTerm>, IActiveRecord
	{
		...
		public PaymentTerm(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PaymentTerm(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PaymentTerm(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PaymentTerm", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarPaymentTermID.AutoIncrement = true;
				colvarPaymentTermID.IsNullable = false;
				colvarPaymentTermID.IsPrimaryKey = true;
				...
				TableSchema.TableColumn colvarPaymentTermName = new TableSchema.TableColumn(schema);
				colvarPaymentTermName.ColumnName = "PaymentTermName";
				colvarPaymentTermName.DataType = DbType.AnsiString;
				colvarPaymentTermName.MaxLength = 50;
				colvarPaymentTermName.AutoIncrement = false;
				colvarPaymentTermName.IsNullable = false;
				colvarPaymentTermName.IsPrimaryKey = false;
				colvarPaymentTermName.IsForeignKey = false;
				colvarPaymentTermName.IsReadOnly = false;
				colvarPaymentTermName.DefaultSetting = @"";
				colvarPaymentTermName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPaymentTermName);
				...
				DataService.Providers["PowerPOS"].AddSchema("PaymentTerm",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("PaymentTermName")]
		[Bindable(true)]
		public string PaymentTermName 
		{
			get { return GetColumnValue<string>(Columns.PaymentTermName); }
			set { SetColumnValue(Columns.PaymentTermName, value); }
		}
		...
		{
			return new PowerPOS.PurchaseOrderHeaderCollection().Where(PurchaseOrderHeader.Columns.PaymentTermID, PaymentTermID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varPaymentTermID,string varPaymentTermName,string varRemark,string varCreatedBy,string varModifiedBy,DateTime? varCreatedOn,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			PaymentTerm item = new PaymentTerm();
        ...
        public static TableSchema.TableColumn PaymentTermNameColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string PaymentTermName = @"PaymentTermName";
