...
{
	/// <summary>
	/// Strongly-typed collection for the ExchangeLog class.
	/// </summary>
    [Serializable]
	public partial class ExchangeLogCollection : ActiveList<ExchangeLog, ExchangeLogCollection>
	{	   
		public ExchangeLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ExchangeLogCollection</returns>
		public ExchangeLogCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ExchangeLog o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ExchangeLog table.
	/// </summary>
	[Serializable]
	public partial class ExchangeLog : ActiveRecord<ExchangeLog>, IActiveRecord
	{
		...
		public ExchangeLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ExchangeLog(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ExchangeLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ExchangeLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarExchangeLogID = new TableSchema.TableColumn(schema);
				colvarExchangeLogID.ColumnName = "ExchangeLogID";
				colvarExchangeLogID.DataType = DbType.Int32;
				colvarExchangeLogID.MaxLength = 0;
				colvarExchangeLogID.AutoIncrement = true;
				colvarExchangeLogID.IsNullable = false;
				colvarExchangeLogID.IsPrimaryKey = true;
				colvarExchangeLogID.IsForeignKey = false;
				colvarExchangeLogID.IsReadOnly = false;
				colvarExchangeLogID.DefaultSetting = @"";
				colvarExchangeLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarExchangeLogID);
				
				TableSchema.TableColumn colvarExchangeDateTime = new TableSchema.TableColumn(schema);
				colvarExchangeDateTime.ColumnName = "ExchangeDateTime";
				colvarExchangeDateTime.DataType = DbType.DateTime;
				colvarExchangeDateTime.MaxLength = 0;
				colvarExchangeDateTime.AutoIncrement = false;
				colvarExchangeDateTime.IsNullable = false;
				colvarExchangeDateTime.IsPrimaryKey = false;
				colvarExchangeDateTime.IsForeignKey = false;
				colvarExchangeDateTime.IsReadOnly = false;
				colvarExchangeDateTime.DefaultSetting = @"";
				colvarExchangeDateTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarExchangeDateTime);
				...
				TableSchema.TableColumn colvarNewOrderHdrID = new TableSchema.TableColumn(schema);
				colvarNewOrderHdrID.ColumnName = "NewOrderHdrID";
				colvarNewOrderHdrID.DataType = DbType.AnsiString;
				colvarNewOrderHdrID.MaxLength = 50;
				colvarNewOrderHdrID.AutoIncrement = false;
				colvarNewOrderHdrID.IsNullable = false;
				colvarNewOrderHdrID.IsPrimaryKey = false;
				colvarNewOrderHdrID.IsForeignKey = false;
				colvarNewOrderHdrID.IsReadOnly = false;
				colvarNewOrderHdrID.DefaultSetting = @"";
				colvarNewOrderHdrID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarNewOrderHdrID);
				
				TableSchema.TableColumn colvarNewItemNo = new TableSchema.TableColumn(schema);
				colvarNewItemNo.ColumnName = "NewItemNo";
				colvarNewItemNo.DataType = DbType.AnsiString;
				colvarNewItemNo.MaxLength = 50;
				colvarNewItemNo.AutoIncrement = false;
				colvarNewItemNo.IsNullable = false;
				colvarNewItemNo.IsPrimaryKey = false;
				colvarNewItemNo.IsForeignKey = false;
				colvarNewItemNo.IsReadOnly = false;
				colvarNewItemNo.DefaultSetting = @"";
				colvarNewItemNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarNewItemNo);
				
				TableSchema.TableColumn colvarNewQty = new TableSchema.TableColumn(schema);
				colvarNewQty.ColumnName = "NewQty";
				colvarNewQty.DataType = DbType.Int32;
				colvarNewQty.MaxLength = 0;
				colvarNewQty.AutoIncrement = false;
				colvarNewQty.IsNullable = false;
				colvarNewQty.IsPrimaryKey = false;
				colvarNewQty.IsForeignKey = false;
				colvarNewQty.IsReadOnly = false;
				colvarNewQty.DefaultSetting = @"";
				colvarNewQty.ForeignKeyTableName = "";
				schema.Columns.Add(colvarNewQty);
				...
				colvarCashierID.DefaultSetting = @"";
				colvarCashierID.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarUndoStockOut = new TableSchema.TableColumn(schema);
				colvarUndoStockOut.ColumnName = "UndoStockOut";
				colvarUndoStockOut.DataType = DbType.Boolean;
				colvarUndoStockOut.MaxLength = 0;
				colvarUndoStockOut.AutoIncrement = false;
				colvarUndoStockOut.IsNullable = false;
				colvarUndoStockOut.IsPrimaryKey = false;
				colvarUndoStockOut.IsForeignKey = false;
				colvarUndoStockOut.IsReadOnly = false;
				colvarUndoStockOut.DefaultSetting = @"";
				colvarUndoStockOut.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUndoStockOut);
				...
				TableSchema.TableColumn colvarIsInventoryUpdated = new TableSchema.TableColumn(schema);
				colvarIsInventoryUpdated.ColumnName = "IsInventoryUpdated";
				colvarIsInventoryUpdated.DataType = DbType.Boolean;
				colvarIsInventoryUpdated.MaxLength = 0;
				colvarIsInventoryUpdated.AutoIncrement = false;
				colvarIsInventoryUpdated.IsNullable = true;
				colvarIsInventoryUpdated.IsPrimaryKey = false;
				colvarIsInventoryUpdated.IsForeignKey = false;
				colvarIsInventoryUpdated.IsReadOnly = false;
				colvarIsInventoryUpdated.DefaultSetting = @"";
				colvarIsInventoryUpdated.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsInventoryUpdated);
				...
				DataService.Providers["PowerPOS"].AddSchema("ExchangeLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ExchangeLogID")]
		[Bindable(true)]
		public int ExchangeLogID 
		{
			get { return GetColumnValue<int>(Columns.ExchangeLogID); }
			set { SetColumnValue(Columns.ExchangeLogID, value); }
		}
		  
		[XmlAttribute("ExchangeDateTime")]
		[Bindable(true)]
		public DateTime ExchangeDateTime 
		{
			get { return GetColumnValue<DateTime>(Columns.ExchangeDateTime); }
			set { SetColumnValue(Columns.ExchangeDateTime, value); }
		}
		...
		[XmlAttribute("NewOrderHdrID")]
		[Bindable(true)]
		public string NewOrderHdrID 
		{
			get { return GetColumnValue<string>(Columns.NewOrderHdrID); }
			set { SetColumnValue(Columns.NewOrderHdrID, value); }
		}
		  
		[XmlAttribute("NewItemNo")]
		[Bindable(true)]
		public string NewItemNo 
		{
			get { return GetColumnValue<string>(Columns.NewItemNo); }
			set { SetColumnValue(Columns.NewItemNo, value); }
		}
		...
		public int NewQty 
		{
			get { return GetColumnValue<int>(Columns.NewQty); }
			set { SetColumnValue(Columns.NewQty, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.CashierID); }
			set { SetColumnValue(Columns.CashierID, value); }
		}
		...
		[XmlAttribute("UndoStockOut")]
		[Bindable(true)]
		public bool UndoStockOut 
		{
			get { return GetColumnValue<bool>(Columns.UndoStockOut); }
			set { SetColumnValue(Columns.UndoStockOut, value); }
		}
		...
		[XmlAttribute("IsInventoryUpdated")]
		[Bindable(true)]
		public bool? IsInventoryUpdated 
		{
			get { return GetColumnValue<bool?>(Columns.IsInventoryUpdated); }
			set { SetColumnValue(Columns.IsInventoryUpdated, value); }
		}
		...
		/// </summary>
		public static void Insert(DateTime varExchangeDateTime,string varOrderHdrID,string varItemNo,int varQty,string varNewOrderHdrID,string varNewItemNo,int varNewQty,string varCashierID,string varOutletName,int varPointOfSaleID,bool varUndoStockOut,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,bool? varIsInventoryUpdated,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ExchangeLog item = new ExchangeLog();
			
			item.ExchangeDateTime = varExchangeDateTime;
			...
			item.NewOrderHdrID = varNewOrderHdrID;
			
			item.NewItemNo = varNewItemNo;
			
			item.NewQty = varNewQty;
			
			item.CashierID = varCashierID;
			
			item.OutletName = varOutletName;
			
			item.PointOfSaleID = varPointOfSaleID;
			
			item.UndoStockOut = varUndoStockOut;
			...
			item.IsInventoryUpdated = varIsInventoryUpdated;
		...
		/// </summary>
		public static void Update(int varExchangeLogID,DateTime varExchangeDateTime,string varOrderHdrID,string varItemNo,int varQty,string varNewOrderHdrID,string varNewItemNo,int varNewQty,string varCashierID,string varOutletName,int varPointOfSaleID,bool varUndoStockOut,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,bool? varIsInventoryUpdated,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ExchangeLog item = new ExchangeLog();
			
				item.ExchangeLogID = varExchangeLogID;
        ...
        public static TableSchema.TableColumn ExchangeLogIDColumn
        {
        ...
        public static TableSchema.TableColumn ExchangeDateTimeColumn
        {
        ...
        public static TableSchema.TableColumn NewOrderHdrIDColumn
        {
        ...
        public static TableSchema.TableColumn NewItemNoColumn
        {
        ...
        public static TableSchema.TableColumn NewQtyColumn
        {
        ...
        public static TableSchema.TableColumn CashierIDColumn
        {
        ...
        public static TableSchema.TableColumn UndoStockOutColumn
        {
        ...
        public static TableSchema.TableColumn IsInventoryUpdatedColumn
        {
		...
		{
			 public static string ExchangeLogID = @"ExchangeLogID";
			 public static string ExchangeDateTime = @"ExchangeDateTime";
			 public static string OrderHdrID = @"OrderHdrID";
			 public static string ItemNo = @"ItemNo";
			 public static string Qty = @"Qty";
			 public static string NewOrderHdrID = @"NewOrderHdrID";
			 public static string NewItemNo = @"NewItemNo";
			 public static string NewQty = @"NewQty";
			 ...
			 public static string UndoStockOut = @"UndoStockOut";
			 public static string CreatedOn = @"CreatedOn";
			 public static string CreatedBy = @"CreatedBy";
			 public static string ModifiedOn = @"ModifiedOn";
			 public static string ModifiedBy = @"ModifiedBy";
			 public static string UniqueID = @"UniqueID";
			 public static string IsInventoryUpdated = @"IsInventoryUpdated";
