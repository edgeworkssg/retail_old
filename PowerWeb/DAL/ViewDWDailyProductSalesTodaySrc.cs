...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailyProductSalesTodaySrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductSalesTodaySrcCollection : ReadOnlyList<ViewDWDailyProductSalesTodaySrc, ViewDWDailyProductSalesTodaySrcCollection>
    {        
        public ViewDWDailyProductSalesTodaySrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailyProductSales_today_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductSalesTodaySrc : ReadOnlyRecord<ViewDWDailyProductSalesTodaySrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailyProductSales_today_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailyProductSales_today_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailyProductSalesTodaySrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailyProductSalesTodaySrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailyProductSalesTodaySrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailyProductSalesTodaySrc(string columnName, object columnValue)
        {
            SetSQLProps();
