...
{
	/// <summary>
	/// Strongly-typed collection for the ItemBatchSummary class.
	/// </summary>
    [Serializable]
	public partial class ItemBatchSummaryCollection : ActiveList<ItemBatchSummary, ItemBatchSummaryCollection>
	{	   
		public ItemBatchSummaryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemBatchSummaryCollection</returns>
		public ItemBatchSummaryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemBatchSummary o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemBatchSummary table.
	/// </summary>
	[Serializable]
	public partial class ItemBatchSummary : ActiveRecord<ItemBatchSummary>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemBatchSummary()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemBatchSummary(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemBatchSummary(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemBatchSummary(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemBatchSummary", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemBatchSummary",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this ItemBatchSummary
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemBatchSummary
		/// 
		/// </summary>
