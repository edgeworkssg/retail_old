...
namespace PowerPOS
{
	...
	public partial class HoldTransaction : ActiveRecord<HoldTransaction>, IActiveRecord
	{
		...
		/// </summary>
		public static void Update(Guid varHoldGuid,DateTime varAppTime,string varMembershipNo,string varMembershipName,string varNric,string varLineInfo,byte[] varPOSControllerObject,bool? varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			HoldTransaction item = new HoldTransaction();
