...
namespace PowerPOS
{
    ...
    public partial class ResourceController
    {
        ...
        public ResourceCollection FetchByID(object ResourceID)
        {
            ResourceCollection coll = new ResourceCollection().Where("ResourceID", ResourceID).Load();
            return coll;
        }
        ...
        public bool Delete(object ResourceID)
        {
            return (Resource.Delete(ResourceID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ResourceID)
        {
            return (Resource.Destroy(ResourceID) == 1);
        }
	    ...
	    public void Insert(string ResourceID,string ResourceName,int? ResourceGroupID,bool? Status,int? Capacity,decimal? RoomCharge,decimal? MinSpending,decimal? MinSpendingCharge,bool? ShowHide,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
            ...
            item.RoomCharge = RoomCharge;
            
            item.MinSpending = MinSpending;
            
            item.MinSpendingCharge = MinSpendingCharge;
            
            item.ShowHide = ShowHide;
	    ...
	    public void Update(string ResourceID,string ResourceName,int? ResourceGroupID,bool? Status,int? Capacity,decimal? RoomCharge,decimal? MinSpending,decimal? MinSpendingCharge,bool? ShowHide,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    Resource item = new Resource();
	        item.MarkOld();
	        item.IsLoaded = true;
