...
{
	/// <summary>
	/// Strongly-typed collection for the AttachedParticular class.
	/// </summary>
    [Serializable]
	public partial class AttachedParticularCollection : ActiveList<AttachedParticular, AttachedParticularCollection>
	{	   
		public AttachedParticularCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AttachedParticularCollection</returns>
		public AttachedParticularCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                AttachedParticular o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AttachedParticular table.
	/// </summary>
	[Serializable]
	public partial class AttachedParticular : ActiveRecord<AttachedParticular>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public AttachedParticular()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public AttachedParticular(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public AttachedParticular(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public AttachedParticular(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AttachedParticular", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarAttachedParticularID = new TableSchema.TableColumn(schema);
				colvarAttachedParticularID.ColumnName = "AttachedParticularID";
				colvarAttachedParticularID.DataType = DbType.Int32;
				colvarAttachedParticularID.MaxLength = 0;
				colvarAttachedParticularID.AutoIncrement = true;
				colvarAttachedParticularID.IsNullable = false;
				colvarAttachedParticularID.IsPrimaryKey = true;
				colvarAttachedParticularID.IsForeignKey = false;
				colvarAttachedParticularID.IsReadOnly = false;
				colvarAttachedParticularID.DefaultSetting = @"";
				colvarAttachedParticularID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAttachedParticularID);
				...
				DataService.Providers["PowerPOS"].AddSchema("AttachedParticular",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("AttachedParticularID")]
		[Bindable(true)]
		public int AttachedParticularID 
		{
			get { return GetColumnValue<int>(Columns.AttachedParticularID); }
			set { SetColumnValue(Columns.AttachedParticularID, value); }
		}
		...
		/// </summary>
		public static void Update(int varAttachedParticularID,string varMembershipNo,string varFirstName,string varLastName,string varChristianName,string varChineseName,string varGender,string varOccupation,DateTime? varDateOfBirth,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			AttachedParticular item = new AttachedParticular();
			
				item.AttachedParticularID = varAttachedParticularID;
        ...
        public static TableSchema.TableColumn AttachedParticularIDColumn
        {
		...
		{
			 public static string AttachedParticularID = @"AttachedParticularID";
