...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewMembershipTapsLog class.
    /// </summary>
    [Serializable]
    public partial class ViewMembershipTapsLogCollection : ReadOnlyList<ViewMembershipTapsLog, ViewMembershipTapsLogCollection>
    {        
        public ViewMembershipTapsLogCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewMembershipTapsLog view.
    /// </summary>
    [Serializable]
    public partial class ViewMembershipTapsLog : ReadOnlyRecord<ViewMembershipTapsLog>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewMembershipTapsLog", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                TableSchema.TableColumn colvarActivityDate = new TableSchema.TableColumn(schema);
                colvarActivityDate.ColumnName = "ActivityDate";
                colvarActivityDate.DataType = DbType.DateTime;
                colvarActivityDate.MaxLength = 0;
                colvarActivityDate.AutoIncrement = false;
                colvarActivityDate.IsNullable = false;
                colvarActivityDate.IsPrimaryKey = false;
                colvarActivityDate.IsForeignKey = false;
                colvarActivityDate.IsReadOnly = false;
                
                schema.Columns.Add(colvarActivityDate);
                
                
                BaseSchema = schema;
                //add this schema to the provider
                //so we can query it later
                DataService.Providers["PowerPOS"].AddSchema("ViewMembershipTapsLog",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMembershipTapsLog()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMembershipTapsLog(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMembershipTapsLog(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMembershipTapsLog(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        [XmlAttribute("ActivityDate")]
        [Bindable(true)]
        public DateTime ActivityDate 
	    {
		    get
		    {
			    return GetColumnValue<DateTime>("ActivityDate");
		    }
            set 
		    {
			    SetColumnValue("ActivityDate", value);
            }
        }
