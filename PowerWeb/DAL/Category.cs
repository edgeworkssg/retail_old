...
namespace PowerPOS
{
	...
	public partial class Category : ActiveRecord<Category>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Category", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarCategoryName.IsPrimaryKey = true;
				...
				colvarIsDiscountable.DefaultSetting = @"";
				colvarIsDiscountable.ForeignKeyTableName = "";
				...
				colvarIsForSale.DefaultSetting = @"";
				colvarIsForSale.ForeignKeyTableName = "";
				...
				colvarAccountCategory.DefaultSetting = @"";
				colvarAccountCategory.ForeignKeyTableName = "";
				...
				colvarItemDepartmentId.IsForeignKey = true;
				colvarItemDepartmentId.IsReadOnly = false;
				colvarItemDepartmentId.DefaultSetting = @"";
				
					colvarItemDepartmentId.ForeignKeyTableName = "ItemDepartment";
				...
				DataService.Providers["PowerPOS"].AddSchema("Category",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<bool>(Columns.IsDiscountable); }
			set { SetColumnValue(Columns.IsDiscountable, value); }
		}
		...
		{
			get { return GetColumnValue<bool>(Columns.IsForSale); }
			set { SetColumnValue(Columns.IsForSale, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.AccountCategory); }
			set { SetColumnValue(Columns.AccountCategory, value); }
		}
		...
		{
			return new PowerPOS.ItemCollection().Where(Item.Columns.CategoryName, CategoryName).Load();
		}
		public PowerPOS.PromoCampaignDetCollection PromoCampaignDetRecords()
		{
			return new PowerPOS.PromoCampaignDetCollection().Where(PromoCampaignDet.Columns.CategoryName, CategoryName).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a ItemDepartment ActiveRecord object related to this Category
		/// 
		/// </summary>
		public PowerPOS.ItemDepartment ItemDepartment
		{
			get { return PowerPOS.ItemDepartment.FetchByID(this.ItemDepartmentId); }
			set { SetColumnValue("ItemDepartmentId", value.ItemDepartmentID); }
		}
		...
		public static void Insert(string varCategoryName,string varRemarks,string varCategoryId,bool varIsDiscountable,bool varIsForSale,bool varIsGST,string varAccountCategory,string varItemDepartmentId,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.IsDiscountable = varIsDiscountable;
			
			item.IsForSale = varIsForSale;
			
			item.IsGST = varIsGST;
			
			item.AccountCategory = varAccountCategory;
		...
		/// </summary>
		public static void Update(string varCategoryName,string varRemarks,string varCategoryId,bool varIsDiscountable,bool varIsForSale,bool varIsGST,string varAccountCategory,string varItemDepartmentId,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Category item = new Category();
        ...
        public static TableSchema.TableColumn IsDiscountableColumn
        {
        ...
        public static TableSchema.TableColumn IsForSaleColumn
        {
        ...
        public static TableSchema.TableColumn AccountCategoryColumn
        {
