...
{
	/// <summary>
	/// Strongly-typed collection for the ItemTagSummary class.
	/// </summary>
    [Serializable]
	public partial class ItemTagSummaryCollection : ActiveList<ItemTagSummary, ItemTagSummaryCollection>
	{	   
		public ItemTagSummaryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemTagSummaryCollection</returns>
		public ItemTagSummaryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemTagSummary o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemTagSummary table.
	/// </summary>
	[Serializable]
	public partial class ItemTagSummary : ActiveRecord<ItemTagSummary>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemTagSummary()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemTagSummary(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemTagSummary(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemTagSummary(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemTagSummary", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemTagSummaryID = new TableSchema.TableColumn(schema);
				colvarItemTagSummaryID.ColumnName = "ItemTagSummaryID";
				colvarItemTagSummaryID.DataType = DbType.AnsiString;
				colvarItemTagSummaryID.MaxLength = 500;
				colvarItemTagSummaryID.AutoIncrement = false;
				colvarItemTagSummaryID.IsNullable = false;
				colvarItemTagSummaryID.IsPrimaryKey = true;
				colvarItemTagSummaryID.IsForeignKey = false;
				colvarItemTagSummaryID.IsReadOnly = false;
				colvarItemTagSummaryID.DefaultSetting = @"";
				colvarItemTagSummaryID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemTagSummaryID);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemTagSummary",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemTagSummaryID")]
		[Bindable(true)]
		public string ItemTagSummaryID 
		{
			get { return GetColumnValue<string>(Columns.ItemTagSummaryID); }
			set { SetColumnValue(Columns.ItemTagSummaryID, value); }
		}
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this ItemTagSummary
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemTagSummary
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(string varItemTagSummaryID,string varItemNo,string varSerialNo,int? varInventoryLocationID,bool? varIsAvailable,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemTagSummary item = new ItemTagSummary();
        ...
        public static TableSchema.TableColumn ItemTagSummaryIDColumn
        {
		...
		{
			 public static string ItemTagSummaryID = @"ItemTagSummaryID";
