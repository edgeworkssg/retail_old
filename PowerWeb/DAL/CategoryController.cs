...
namespace PowerPOS
{
    ...
    public partial class CategoryController
    {
        ...
        public CategoryCollection FetchByID(object CategoryName)
        {
            CategoryCollection coll = new CategoryCollection().Where("CategoryName", CategoryName).Load();
            return coll;
        }
        ...
        public bool Delete(object CategoryName)
        {
            return (Category.Delete(CategoryName) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object CategoryName)
        {
            return (Category.Destroy(CategoryName) == 1);
        }
	    ...
	    public void Insert(string CategoryName,string Remarks,string CategoryId,bool IsDiscountable,bool IsForSale,bool IsGST,string AccountCategory,string ItemDepartmentId,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
            ...
            item.IsDiscountable = IsDiscountable;
            
            item.IsForSale = IsForSale;
            
            item.IsGST = IsGST;
            
            item.AccountCategory = AccountCategory;
	    ...
	    public void Update(string CategoryName,string Remarks,string CategoryId,bool IsDiscountable,bool IsForSale,bool IsGST,string AccountCategory,string ItemDepartmentId,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    Category item = new Category();
	        item.MarkOld();
	        item.IsLoaded = true;
