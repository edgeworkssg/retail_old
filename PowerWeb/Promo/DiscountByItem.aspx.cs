...
public partial class DiscountByItem : PageBase
{
    ...
    protected void btnCreate_Click1(object sender, EventArgs e)
    {
        ...
        if (PromotionAdminController.InsertDiscountByItem(
            txtCampaignName.Text,
            startDate, endDate, 
            ddsItemNo.SelectedValue,Double.Parse(txtDiscount.Text), ForNonMembersAlso)
            )
        {
