...
public partial class DiscountByCategory : PageBase
{
    ...
    protected void btnCreate_Click1(object sender, EventArgs e)
    {
        ...
        if (PromotionAdminController.InsertDiscountByCategory(
            txtCampaignName.Text,
            startDate, endDate, 
            ddsCategory.SelectedItem.Text,
            Double.Parse(txtDiscount.Text), ForNonMembersAlso)
            )
        {
