<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true"
    Inherits="DiscountByItem" Title="<%$Resources:dictionary,Discount By Item %>"
    CodeBehind="DiscountByItem.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="600">
        ...
        <tr>
            <td colspan="4" class="wl_pageheaderSub">
                <asp:Literal ID="Literal5" runat="server" Text="<%$Resources:dictionary,Item to Assign Discount to %>"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Literal ID="Literal6" runat="server" Text="<%$Resources:dictionary,Item Name %>"></asp:Literal>
            </td>
            <td colspan="3">
                <subsonic:DropDown ID="ddsItemNo" runat="server" ValueField="ItemNo" TextField="ItemName"
                    TableName="Item" DataValueField="Remarks" DataTextField="ItemName" Width="400px">
                </subsonic:DropDown>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="wl_pageheaderSub">
                <asp:Literal ID="Literal7" runat="server" Text="<%$Resources:dictionary,Discount %>"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td style="height: 26px">
                <asp:Literal ID="Literal8" runat="server" Text="<%$Resources:dictionary,Discount %>"></asp:Literal>
            </td>
    ...
    <asp:ObjectDataSource ID="odsView" runat="server" DeleteMethod="DeletePromotionCampaign"
        SelectMethod="ViewDiscountByItemName" TypeName="PowerPOS.PromotionAdminController">
        <DeleteParameters>
