<%@ Page Theme="Default" Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="QuickAccessCategoryScaffold" Title="<%$Resources:dictionary,Quick Access Category Setup %>" Codebehind="QuickAccessCategoryScaffold.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <subsonic:Scaffold ID="Scaffold1" runat="server" 
    TableName="QuickAccessCategory" 
