<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" Theme="Default" AutoEventWireup="true" Inherits="QuickAccessGroupScaffold" Title="<%$Resources:dictionary,Quick Access Group Setup %>" Codebehind="QuickAccessGroupScaffold.aspx.cs" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <subsonic:Scaffold ID="Scaffold1" runat="server" TableName="QuickAccessGroup"
