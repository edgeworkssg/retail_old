...
public partial class InventoryLocationGroupScaffolds : PageBase
{
    ...
    void LoadEditor(string id)
    {
        ...
        if (!string.IsNullOrEmpty(id) && id != "0")
        {
            ...
            //pull the record
            InventoryLocationGroup item = new InventoryLocationGroup(id);
            txtLocationName.Text = item.InventoryLocationGroupName;
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        AccessLogController.AddLog(AccessSource.WEB, Session["UserName"] + "", "-", string.Format("DELETE InventoryLocationGroup : {0}", Utility.GetParameter("id")), "");
        //redirect
    ...
    {
        InventoryLocationGroup ct = new InventoryLocationGroup((id + "").GetIntValue());
        bool isNew = ct.IsNew;
        ct.InventoryLocationGroupName = txtLocationName.Text;
        ct.Deleted = false;
    ...
    {
        DataTable dt = new InventoryLocationGroupController().FetchAll().ToDataTable();
