<%@ Page Title="<%$Resources:dictionary,Resource Group Setup %>" Language="C#" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" CodeBehind="ResourceGroupScaffold.aspx.cs" Inherits="PowerWeb.Scaffolds.ResourceGroupScaffold" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="pnlGrid" runat="server">
        <input id="btnAddNew" runat="server" class="classname" onclick="location.href='ResourceGroupScaffold.aspx?id=0'"
        ...
        <asp:GridView ID="GridView1" SkinID="scaffold" runat="server" AllowPaging="True"
            ...
            DataKeyNames="ResourceGroupID" PageSize="20">
            <Columns>
                <asp:HyperLinkField Text="<%$Resources:dictionary, Edit%>" DataNavigateUrlFields="ResourceGroupID" DataNavigateUrlFormatString="ResourceGroupScaffold.aspx?id={0}" />
                <asp:BoundField DataField="ResourceGroupID" HeaderText="<%$Resources:dictionary, Resource Group ID%>" SortExpression="ResourceGroupID">
                </asp:BoundField>
                <asp:BoundField DataField="GroupName" HeaderText="<%$Resources:dictionary, Resource Group Name%>" SortExpression="GroupName">
                </asp:BoundField>
                <asp:BoundField DataField="CreatedOn" HeaderText="<%$Resources:dictionary, Created On%>" SortExpression="CreatedOn">
                </asp:BoundField>
                <asp:BoundField DataField="ModifiedOn" HeaderText="<%$Resources:dictionary, Modified On%>" SortExpression="ModifiedOn">
                </asp:BoundField>
                <asp:BoundField DataField="CreatedBy" HeaderText="<%$Resources:dictionary, Created By%>" SortExpression="CreatedBy">
                </asp:BoundField>
                <asp:BoundField DataField="ModifiedBy" HeaderText="<%$Resources:dictionary, Modified By%>" SortExpression="ModifiedBy">
                </asp:BoundField>
                <asp:BoundField DataField="Deleted" HeaderText="<%$Resources:dictionary, Deleted%>" SortExpression="Deleted">
                </asp:BoundField>
            </Columns>
            <EmptyDataTemplate>
                <asp:Literal ID="ltr00"  runat="server" Text="<%$Resources:dictionary, No Resource Group%>" />
            </EmptyDataTemplate>
            <PagerTemplate>
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table id="FieldsTable" cellpadding="5" cellspacing="0" width="600px">
            <tr>
                <td>
                    <asp:Literal ID="Literal6"  runat="server" Text="<%$Resources:dictionary, Resource Group ID%>" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Literal ID="Literal5"  runat="server" Text="<%$Resources:dictionary, Resource Group Name%>" />
                </td>
                <td>
                    <asp:TextBox ID="ctrlResourceGroupName" runat="server" MaxLength="50"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2" align="left">
                    ...
                    <input id="btnReturn" runat="server" type="button" class="classname" onclick="location.href='ResourceGroupScaffold.aspx'"
