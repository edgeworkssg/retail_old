<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" Theme="Default" AutoEventWireup="true"
    Inherits="InventoryStockOutReasonScaffold" Title="<%$Resources:dictionary,Inventory Stock Out Reason Setup %>"
    CodeBehind="InventoryStockOutReasonScaffold.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <input id="btnAddNew" runat="server" class="classname" onclick="location.href='InventoryStockOutReasonScaffold.aspx?id=0'"
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="ReasonID" PageSize="50"
            SkinID="scaffold">
            <Columns>
                <asp:HyperLinkField Text="<%$Resources:dictionary, Edit%>" DataNavigateUrlFields="ReasonID"
                    DataNavigateUrlFormatString="InventoryStockOutReasonScaffold.aspx?id={0}" />
                <asp:BoundField DataField="ReasonID" HeaderText="<%$Resources:dictionary, Reason ID%>" />
                <asp:BoundField DataField="ReasonName" HeaderText="<%$Resources:dictionary, Reason Name%>" />
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table id="FieldsTable" cellpadding="5" cellspacing="0" width="600px">
            <tr>
                <td>
                    <asp:Literal ID="ltr00" runat="server" Text="<%$Resources:dictionary, Reason ID%>" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:dictionary, Reason Name%>" />
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:dictionary, Type%>" />
                </td>
                <td>
                    <asp:DropDownList ID="ddlType" runat="server">
                        <asp:ListItem Text="" Value=""></asp:ListItem>
                        <asp:ListItem Text="Adjustment In" Value="Adjustment In"></asp:ListItem>
                        <asp:ListItem Text="Adjustment Out" Value="Adjustment Out"></asp:ListItem>
            ...
            <tr>
                <td align="left" colspan="2">
                    ...
                    &nbsp;
                    <input id="btnReturn" runat="server" class="classname" onclick="location.href='InventoryStockOutReasonScaffold.aspx'"
