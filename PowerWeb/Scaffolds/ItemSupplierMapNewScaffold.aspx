<%@ Page Theme="Default" Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true"
    Inherits="ItemSupplierMapNewScaffold" Title="<%$Resources:dictionary,Item Supplier Setup %>"
    CodeBehind="ItemSupplierMapNewScaffold.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        ...
        <table width="700px" id="FilterTable">
            ...
            <tr>
                <td colspan="4">
                    <input id="btnAdd" runat="server" style="width:80px" class="classname" onclick="location.href='ItemSupplierMapNewScaffold.aspx?id=0'"
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" Width="700px"
            ...
            <Columns>
                <asp:HyperLinkField Text="<%$Resources:dictionary, Edit%>" DataNavigateUrlFields="ItemSupplierMapID" DataNavigateUrlFormatString="ItemSupplierMapNewScaffold.aspx?id={0}" />
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table id="FieldsTable" cellpadding="5" cellspacing="0" width="900px">
            ...
            <tr id="rowSearchItem" runat="server">
                <td>
...
<%--            <tr>
            ...
            <tr>
                <td>
                    <asp:Literal ID="Literal26"  runat="server" Text="<%$Resources:dictionary, Minimum Order Quantity%>" />
                </td>
                <td>
                    <asp:TextBox ID="txtMOQ" runat="server" MaxLength="250" Width="150px"></asp:TextBox>
                </td>
            </tr>
            <!--<tr>
            <td >
            ...
            <tr id="rowPS1" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo1" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS2" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo2" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS3" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo3" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS4" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo4" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS5" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo5" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS6" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo6" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS7" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo7" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS8" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo8" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS9" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo9" runat="server" />
                    &nbsp;
            ...
            <tr id="rowPS10" runat="server">
                ...
                <td>
                    ...
                    <asp:HiddenField ID="ItemNo10" runat="server" />
                    &nbsp;
            ...
            <tr>
                <td align="left" colspan="2">
                    ...
                    <input id="btnReturn" runat="server" class="classname" onclick="location.href='ItemSupplierMapNewScaffold.aspx'" type="button"
                    ...
                    <input type="button" id="btnAddItem" value="Add NIP Item" class="classname" />
                </td>
            </tr>
        </table>
    </asp:Panel>
    <div id="tempPanel" runat="server" style="display: none;">
        <asp:Button ID="btnAddNIP" runat="server" OnClick="btnAddNIP_Click" CausesValidation="false" />
        <asp:HiddenField ID="MainItemNo" runat="server" value="" />
        <asp:HiddenField ID="MainItemName" runat="server" value="" />
        <asp:HiddenField ID="MainItemBarcode" runat="server" value="" />
    </div>
    <div id="dialog_AddNewNIP" title=" Add new NIP Product" style="display: none;">
        <div class="panel" id="panelCopyPromo">
            <fieldset>
                ...
                <div class="form-group" style="padding: 5px;">
                    ...
                    <input type="text" id="txtItemNoNIP" />
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">
                        Item Name &nbsp;
                    </div>
                    <input type="text" id="txtItemNameNIP" style="width: 200px"/>
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">                       
                        Barcode &nbsp;
                    </div>
                    <input type="text" id="txtBarcodeNIP" />                   
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">
                        Packing Size UOM &nbsp;
                    </div>
                    <input type="text" id="txtUOMNIP" />                   
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">
                        Packing Size Conversion &nbsp;
                    </div>
                    <select id="SizeConvType">
                        <option value="Up">Up</option>
                        <option value="Down">Down</option>
                    </select>
                    <input type="text" id="txtSizeConvNIP" />                   
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">
                        Retail Price &nbsp;
                    </div>
                    <input type="text" id="txtRetailPriceNIP" />
                </div>
                <div class="form-group" style="padding: 5px;">
                    <div style="width: 200px; float: left;">
                        Cost Price &nbsp;
                    </div>
                    <input type="text" id="txtCostPriceNIP" />
                </div>
            </fieldset>
            &nbsp;<label id="lblWarningItemForm" style="display: none; font-size: smaller; color: Red;" ></label>
        </div>
    </div>
    ...
    <script type="text/javascript" src="<%= ResolveUrl("~/Scripts/Applications/Product/ItemSupplier.js")%>"></script>
</asp:Content>
