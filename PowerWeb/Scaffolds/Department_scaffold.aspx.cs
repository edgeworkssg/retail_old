...
using PowerPOS;
	...
	public partial class Department_scaffold : System.Web.UI.Page 
	{
		...
		{
			Department.Delete(Utility.GetParameter("id"));
			//redirect
		...
		void BindAndSave(string id) 
		{
			...
			else 
			{
				...
				item = new Department();
						...
						object valctrlDepartmentName = Utility.GetDefaultControlValue(Department.Schema.GetColumn("DepartmentName"), ctrlDepartmentName, isAdd, false);
						
							item.DepartmentName = Convert.ToString(valctrlDepartmentName);
						
						object valctrlRemark = Utility.GetDefaultControlValue(Department.Schema.GetColumn("Remark"), ctrlRemark, isAdd, false);
						...
						object valctrlCreatedBy = Utility.GetDefaultControlValue(Department.Schema.GetColumn("CreatedBy"), ctrlCreatedBy, isAdd, false);
						...
						object valctrlCreatedOn = Utility.GetDefaultControlValue(Department.Schema.GetColumn("CreatedOn"), ctrlCreatedOn, isAdd, false);
						...
						object valctrlModifiedBy = Utility.GetDefaultControlValue(Department.Schema.GetColumn("ModifiedBy"), ctrlModifiedBy, isAdd, false);
						...
						object valctrlModifiedOn = Utility.GetDefaultControlValue(Department.Schema.GetColumn("ModifiedOn"), ctrlModifiedOn, isAdd, false);
						...
						object valctrlDeleted = Utility.GetDefaultControlValue(Department.Schema.GetColumn("Deleted"), ctrlDeleted, isAdd, false);
        ...
        {
		    TableSchema.Table tblSchema = DataService.GetTableSchema("Department", "PowerPOS");
