<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" Theme="Default" AutoEventWireup="true" Inherits="InventoryLocationGroupScaffolds" Title="Inventory Location Group Setup" Codebehind="InventoryLocationGroupScaffolds.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlGrid" runat="server">
        <input id="btnAddNew" runat="server" class="classname" onclick="location.href='InventoryLocationGroupScaffolds.aspx?id=0'"
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="InventoryLocationGroupID" PageSize="50"
            SkinID="scaffold">
            <Columns>
                <asp:HyperLinkField Text="<%$Resources:dictionary, Edit%>" DataNavigateUrlFields="InventoryLocationGroupID" DataNavigateUrlFormatString="InventoryLocationGroupScaffolds.aspx?id={0}" />
                <asp:BoundField DataField="InventoryLocationGroupID" HeaderText="Inventory Location Group ID" />
                <asp:BoundField DataField="InventoryLocationGroupName" HeaderText="Inventory Location Group Name" />
    ...
    <asp:Panel ID="pnlEdit" runat="server">
        ...
        <table id="FieldsTable" cellpadding="5" cellspacing="0" width="600px">
            <tr>
                <td>
                    <asp:Literal ID="ltr00" runat="server" Text="Inventory Location Group ID" />
                </td>
                <td>
            ...
            <tr>
                <td align="left" colspan="2">
                    ...
                    &nbsp;
                    <input id="btnReturn" runat="server" class="classname" onclick="location.href='InventoryLocationGroupScaffolds.aspx'"
