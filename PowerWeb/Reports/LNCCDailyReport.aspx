<%@ Page Title="<%$Resources:dictionary,LN C&C Daily Report  %>" Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true"
    CodeBehind="LNCCDailyReport.aspx.cs" Inherits="PowerWeb.Reports.LNCCDailyReport" %>
