...
public partial class ProductSalesReportWithoutRedeem : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = 
            ReportController.FetchProductSalesReportWithoutRedeem(
            startDate, endDate.AddSeconds(86399),
            txtItemName.Text, OutletDropdownList.GetDdlPOSSelectedItemText, OutletDropdownList.GetDdlOutletSelectedItemText, 
    ...
    {        
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            if (dt != null)
            {
                ...
                e.Row.Cells[QTY].Text = dt.Compute("SUM(Quantity)", "").ToString();
                Amount = decimal.Parse(dt.Compute("SUM(Amount)", "").ToString());
