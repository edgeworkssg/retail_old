...
public partial class SpecialActivityReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = ReportController.FetchSpecialActivityReport(
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            if (e.Row.Cells[12].Text.Replace("&nbsp;","") != "")
                e.Row.Cells[12].Text = CommonUILib.GetYesOrNoFromBool(bool.Parse(e.Row.Cells[12].Text));
            /*
