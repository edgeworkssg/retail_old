<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="CategorySalesReport" Title="<%$Resources:dictionary,Category Sales Report %>"
    CodeBehind="CategorySalesReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            ...
            <td style="width: 200px">
                <subsonic:DropDown ID="ddDept" runat="server" PromptValue="" TableName="ItemDepartment"
                    TextField="DepartmentName" ValueField="ItemDepartmentID" Width="178px" OnInit="ddDept_Init"
            ...
            <td>
                <uc1:MultiCheckCombo ID="mccCategory" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Literal ID="Literal13" runat="server" Text="<%$Resources:dictionary,Outlet %>"></asp:Literal>
            </td>
            <td style="width: 200px">
                <asp:DropDownList ID="ddlOutlet" runat="server" Width="178px" DataTextField="OutletName"
                    DataValueField="OutletName" OnInit="ddlOutlet_Init">
                </asp:DropDownList>
            </td>
            <td>
    ...
    <table id="search_ExportTable" style="vertical-align: middle; width: 600px; height: 40px;"
        ...
        <tr>
            <td style="background-color: #FFFFFF; vertical-align: middle;" class="style4">
            ...
            <td align="right" style="background-color: #FFFFFF; padding-right: 0px; vertical-align: middle;"
                class="style5">
