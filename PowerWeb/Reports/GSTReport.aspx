<%@ Page Language="C#" EnableEventValidation="true"  MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="GSTReport" Title="<%$Resources:dictionary,GST Report %>" Codebehind="GSTReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="gvReport"
        ...
        <Columns>            
            <asp:BoundField DataField="GSTPayable" HeaderText="<%$Resources:dictionary,SEARCH %>" />
            <asp:BoundField DataField="GSTPaid" HeaderText="<%$Resources:dictionary,GST Paid %>" />
            <asp:BoundField HeaderText="<%$Resources:dictionary,GST Nett %>" />
        </Columns>
         <PagerTemplate>
