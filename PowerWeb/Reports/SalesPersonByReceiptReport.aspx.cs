...
public partial class SalesPersonByReceiptReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        */
        DataTable dt =
             ...
             (startDate, endDate.AddSeconds(86399), cbIsService.Checked,
             cbIsProduct.Checked);
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            e.Row.Cells[0].Text = LanguageManager.GetTranslation("Date");

            e.Row.Cells[1].Text = LanguageManager.GetTranslation("Receipt No");
