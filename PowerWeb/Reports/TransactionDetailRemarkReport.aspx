<%@ Page Language="C#" EnableEventValidation="true"  MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="TransactionDetailRemarkReport" Title="Remark Report" Codebehind="TransactionDetailRemarkReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <asp:GridView ID="gvReport"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="LineRemark" SortExpression="LineRemark" HeaderText="Line Remark" />    
