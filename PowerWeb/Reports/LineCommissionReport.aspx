<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="LineCommissionReport" Title="<%$Resources:dictionary, Sales Person Performance Report%>"
    CodeBehind="LineCommissionReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="600px" id="FilterTable">
        ...
        <tr>
            <td style="width: 102px; height: 3px">
                <asp:RadioButton ID="rdbRange" runat="server" GroupName="DateSearch" Text="<%$ Resources:dictionary, Start Date %>" />
            </td>
            <td style="height: 3px">
        ...
        <tr>
            <td style="width: 102px">
                <asp:RadioButton ID="rdbMonth" Checked="True" runat="server" GroupName="DateSearch"
                    Text="<%$ Resources:dictionary, Month %>" Width="68px" />
            </td>
            <td>
    ...
    <asp:GridView ID="gvReport" ShowFooter="True" Width="100%" runat="server" AllowPaging="True"
        ...
        DataKeyNames="UserName" AutoGenerateColumns="False" SkinID="scaffold" OnRowDataBound="gvReport_RowDataBound"
        PageSize="20">
        <Columns>
            <asp:BoundField DataField="username" HeaderText="<%$Resources:dictionary, Sales Person%>" />
            <asp:BoundField DataField="Service" HeaderText="<%$Resources:dictionary, Service%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="Product" HeaderText="<%$Resources:dictionary, Product%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="OpenPriceProduct" HeaderText="<%$Resources:dictionary, O.P Product%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="SystemItem" HeaderText="<%$Resources:dictionary, System Item%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="NonCommission" HeaderText="<%$Resources:dictionary, Non Commission%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="TotalProductAndService" HeaderText="<%$Resources:dictionary, Total%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#80FF80" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="PointSold" HeaderText="<%$Resources:dictionary, Point Sold%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#8080FF" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="PointSoldValue" HeaderText="<%$Resources:dictionary, Point Value%>" DataFormatString="{0:N}">
                <ItemStyle BackColor="#8080FF" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="PackageSold" HeaderText="<%$Resources:dictionary, Package Sold%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#FF80FF" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="PackageRedeemed" HeaderText="<%$Resources:dictionary, Package Redeem%>" DataFormatString="{0:N}">
                <ItemStyle BackColor="#FF80FF" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
            <asp:BoundField DataField="PackageRedeemedValue" HeaderText="<%$Resources:dictionary, Package Redeem Value%>" DataFormatString="{0:N2}">
                <ItemStyle BackColor="#FF80FF" />
                <HeaderStyle BackColor="#004000" />
            </asp:BoundField>
        </Columns>
