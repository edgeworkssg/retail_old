...
public partial class PreviousMonthCommissionReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DateTime selectedMonth = new DateTime(int.Parse(ddlYear.SelectedValue.ToString()), int.Parse(ddlMonth.SelectedValue), 1);
      DataTable dt = 
            ReportController.FetchPreviousMonthsCommissionReport(selectedMonth,
    ...
    protected void gvReport_DataBound(Object sender, EventArgs e)
    {
        ...
        decimal totalComm = 0, totalAmt = 0;
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            totalAmt += decimal.Parse(dt.Rows[i]["TotalSales"].ToString());
            totalComm += decimal.Parse(dt.Rows[i]["Commission"].ToString());
        }
        lblTotalSales.Text = totalAmt.ToString("N2");
        lblTotalComm.Text = totalComm.ToString("N2");
    }
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {           
            e.Row.Cells[2].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[2].Text));
            e.Row.Cells[3].Text = String.Format("{0:#0.00}", Decimal.Parse(e.Row.Cells[3].Text)) + "%";
            e.Row.Cells[4].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[4].Text));
        }
    }
