<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="UndeductedSalesReport" Title="<%$Resources:dictionary, Undeducted Sales Report%>"
    CodeBehind="UndeductedSalesReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="600px">
        ...
        <tr>
            <td>
                <asp:Literal ID="Literal1" runat="server" Visible="false" Text="<%$Resources:dictionary,Search %>"></asp:Literal>
            </td>
            <td>
                <asp:TextBox ID="txtSearch" Visible="false" runat="server" Width="172px"></asp:TextBox>
            </td>
            <td>
                &nbsp;
            </td>
    ...
    <asp:GridView ID="gvReport" Width="800px" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="OnHand" SortExpression="OnHand" HeaderText="<%$Resources:dictionary,Bal Qty %>" />
        </Columns>
        <PagerTemplate>
    ...
    &nbsp;<asp:Button ID="btnDeduct" runat="server" Text="<%$Resources:dictionary, Deduct Quantity From Inventory%>"
        OnClick="btnDeductInventory_Click" />
</asp:Content>
