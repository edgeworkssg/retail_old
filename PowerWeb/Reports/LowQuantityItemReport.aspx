<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="LowQuantityItemReport" Title="<%$Resources:dictionary, Low Quantity Items%>"
    CodeBehind="LowQuantityItemReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="600px">
        ...
        <tr>
            <td style="width: 102px; height: 3px">
                <asp:Literal ID="Label1" runat="server" Text="<%$Resources:dictionary, Search%>"></asp:Literal>
            </td>
            <td style="height: 3px">
        ...
        <tr>
            <td colspan=2><asp:Label ID="lblMsg" runat="server" CssClass="LabelMessage"></asp:Label></td>
        </tr>--%>
    </table>
    ...
    <asp:GridView ID="gvReport" ShowFooter="True" Width="100%" runat="server" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Attributes1" SortExpression="Attributes1" HeaderText="" />
            <asp:BoundField DataField="On Hand" SortExpression="On Hand" HeaderText="<%$Resources:dictionary, On Hand%>" />
            <asp:BoundField DataField="MinQty" SortExpression="MinQty" HeaderText="<%$Resources:dictionary, Minimum Qty%>" />
        </Columns>
        <PagerTemplate>
