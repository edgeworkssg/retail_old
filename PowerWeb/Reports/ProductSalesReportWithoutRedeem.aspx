<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="ProductSalesReportWithoutRedeem" Title="<%$Resources:dictionary,Product Sales Report %>"
    CodeBehind="ProductSalesReportWithoutRedeem.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="600px" id="FilterTable">
        ...
        <tr>
             <uc1:outletdropdownlist ID="OutletDropdownList" runat="server">
             </uc1:outletdropdownlist>
        </tr>
        <tr>
            <td style="width: 102px">
    ...
    <asp:GridView ID="gvReport" ShowFooter="True" Width="100%" runat="server" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Quantity" SortExpression="Quantity" HeaderText="<%$Resources:dictionary,Total Qty %>" />
            <asp:BoundField DataField="Amount" SortExpression="Amount" HeaderText="<%$Resources:dictionary, Nett Sales%>" />
