<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="ProductSalesByDayReport" Title="<%$Resources:dictionary, Product Sales By Day Report%>"
    CodeBehind="ProductSalesByDayReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="600px" id="FilterTable">
        ...
        <tr>
            <td style="width: 102px">
                <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:dictionary, Point Of Sale%>"></asp:Literal>
            </td>
            <td>
                <asp:DropDownList ID="ddPOS" runat="server" Width="180px">
                </asp:DropDownList>
            </td>
            <td>
                &nbsp;
    ...
    <b><asp:Literal ID="ltr00"  runat="server" Text="<%$Resources:dictionary, Date format on the report columns are MM_DD_YYYY%>" /></b>
