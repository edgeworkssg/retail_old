<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" CodeBehind="OutletTransactionHourlyReport.aspx.cs" Inherits="PowerWeb.Reports.OutletTransactionHourlyReport" Title="Outlet Hourly Report" %>
        ...
        <table width="900px" id="FilterTable">
            ...
            <tr>
                ...
                <td colspan="2" align="right">
                    <asp:LinkButton ID="lnkExport" runat="server" OnClick="lnkExport_Click" Text="<%$ Resources:dictionary, Export %>" CssClass="classBlue"></asp:LinkButton>
                </td>
            </tr>
        </table>
        <br />
        <asp:GridView ID="gvReport" Width="900px" runat="server" AllowPaging="True" AllowSorting="True"
