<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="ProductSalesReport" Title="<%$Resources:dictionary,Product Sales Report %>"
    CodeBehind="ProductSalesReport.aspx.cs" %>
        ...
        <tr>
            <td style="width: 102px">
                <asp:Literal ID="Literal13" runat="server" 
                    Text="<%$Resources:dictionary,Outlet %>"></asp:Literal>
            </td>
            <td>
                <asp:DropDownList ID="ddlOutlet" runat="server" Width="179px" 
                    DataTextField="OutletName" DataValueField="OutletName" oninit="ddlOutlet_Init">
                </asp:DropDownList>
            <td>
                <asp:Literal ID="Literal12" runat="server" 
                    Text="<%$ Resources:dictionary,Supplier %>"></asp:Literal>
            </td>
                <td>
                <asp:DropDownList ID="ddlSupplier" runat="server" Width="172px"
...
<%--            <uc1:OutletDropdownList ID="OutletDropdownList" runat="server"></uc1:OutletDropdownList>--%>
        ...
        <tr>
            <td style="height: 30px; width: 50%; background-color: #FFFFFF; left: 0; vertical-align: middle;">
                ...
                <asp:LinkButton ID="LinkButton4" class="classname" runat="server">
                    <asp:Literal ID="Literal7" runat="server" Text="<%$ Resources:dictionary, Clear%>" /></asp:LinkButton></td><td align="right" style="height: 30px; width: 50%; background-color: #FFFFFF; padding-right: 0px;
    ...
    <asp:GridView ID="gvReport" ShowFooter="True" Width="100%" runat="server" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Barcode" SortExpression="Barcode" HeaderText="<%$Resources:dictionary,Barcode %>" />
            <asp:BoundField DataField="TotalQuantity" SortExpression="TotalQuantity" HeaderText="<%$Resources:dictionary,Total Qty %>" />
            <asp:BoundField DataField="TotalAmount" SortExpression="TotalAmount" HeaderText="<%$Resources:dictionary, Nett Sales%>" />
<%--            <asp:BoundField Visible="false" DataField="GSTAmount" SortExpression="GSTAmount"
                HeaderText="<%$Resources:dictionary,GST Amount %>" />
            <asp:BoundField Visible="false" DataField="TotalAmountWithoutGST" SortExpression="TotalAmountWithoutGST"
                HeaderText="<%$Resources:dictionary,Nett Sales (Without GST) %>" />
            <asp:BoundField Visible="false" DataField="TotalCostOfGoodsSold" HeaderText="<%$Resources:dictionary,Cost Of Goods %>"
                SortExpression="TotalCostOfGoodsSold" />
            <asp:BoundField Visible="false" DataField="ProfitLoss" HeaderText="<%$Resources:dictionary,P/L %>"
                SortExpression="ProfitLoss" />
            <asp:BoundField Visible="false" DataField="ProfitLossPercentage" HeaderText="<%$Resources:dictionary,P/L(%) %>"
                SortExpression="ProfitLossPercentage" />--%> <asp:BoundField DataField="Attributes1" SortExpression="Attributes1" HeaderText="<%$Resources:dictionary, Attributes1%>" />
...
<%--            <asp:BoundField DataField="PointOfSaleName" SortExpression="PointOfSaleName" HeaderText="<%$Resources:dictionary,Point Of Sale %>" />--%> <asp:BoundField DataField="OutletName" SortExpression="OutletName" HeaderText="<%$Resources:dictionary,Outlet %>" />
