<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="SumarizedProductSalesReport" Title="<%$Resources:dictionary, Attributes Product Sales Report%>"
    CodeBehind="SumarizedProductSalesReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" id="FilterTable">
        ...
        <tr>
            <td>
                <asp:Literal ID="lblRefName" runat="server" Text="<%$Resources:dictionary, Search%>"></asp:Literal>
            </td>
            <td>
                <asp:TextBox ID="tSearch" runat="server" Width="179px"></asp:TextBox>
                <td>
                    <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:dictionary,Sumarized By %>"></asp:Literal>
                </td>
                <td>
                    <!-- Loaded in the code -->
                    <asp:DropDownList ID="cmbSumarizeMode" AppendDataBoundItems="true" runat="server"
                        Width="178px" />
                </td>
        </tr>
    </table>
    ...
    <asp:GridView ID="gvReport" Width="100%" ShowFooter="true" runat="server" AllowPaging="True"
        ...
        <Columns>
            <asp:BoundField DataField="RefID" SortExpression="RefID" HeaderText="<%$Resources:dictionary, RefID%>" />
            <asp:BoundField DataField="TotalQuantity" SortExpression="TotalQuantity" HeaderText="<%$Resources:dictionary,Total Qty %>" />
            <asp:BoundField DataFormatString="{0:N2}" DataField="TotalAmount" SortExpression="TotalAmount"
                HeaderText="<%$Resources:dictionary,Total Amount %>" />
