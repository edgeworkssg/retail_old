...
public partial class InventoryTransactionReport : PageBase
{    
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = ReportController.FetchInventoryActivityReport(
            cbUseStartDate.Checked, cbUseStartDate.Checked,
            startDate, endDate.AddSeconds(86399), 
            txtItemName.Text, txtUserName.Text,
            ddLocation.SelectedValue, ddlMovementType.SelectedValue, txtRemark.Text, txtLineRemark.Text,
    ...
    {       
        ...
        {            
            //e.Row.Cells[10].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[10].Text));
