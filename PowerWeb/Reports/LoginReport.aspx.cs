...
public partial class LoginReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = ReportController.FetchLoginReport(
            cbUseStartDate.Checked, cbUseStartDate.Checked,
            startDate, endDate.AddSeconds(86399),
            (ddlType.SelectedValue+""), txtUserName.Text, 0, SelectedPOS, 
            selectedOutlet,ddDept.SelectedValue.ToString(), ViewState["sortBy"].ToString(), ViewState[SORT_DIRECTION].ToString());        
