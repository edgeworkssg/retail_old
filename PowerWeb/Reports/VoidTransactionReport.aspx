<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="VoidTransactionReport" Title="<%$Resources:dictionary, Void Transaction Report%>"
    CodeBehind="VoidTransactionReport.aspx.cs" %>
    ...
    <table width="600px" id="FilterTable">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlStartTimeHour" runat="server" /><asp:DropDownList ID="ddlStartTimeMinute" runat="server" /><asp:DropDownList ID="ddlStartTimeSecond" runat="server" /><br />
            ...
            <td>
                ...
                <asp:DropDownList ID="ddlEndTimeHour" runat="server" /><asp:DropDownList ID="ddlEndTimeMinute" runat="server" /><asp:DropDownList ID="ddlEndTimeSecond" runat="server" /><br />
