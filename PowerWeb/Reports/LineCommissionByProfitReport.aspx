<%@ Page Language="C#" EnableEventValidation="true"  MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="LineCommissionByProfitReport" Title="Sales Person Sales By Profit Report" Codebehind="LineCommissionByProfitReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="gvReport"
        ...
        <Columns>            
            <asp:BoundField DataField="username" HeaderText="Sales Person"  />
            <asp:BoundField DataField="TotalAmount" HeaderText="Sales"  DataFormatString="{0:N2}" />
            <asp:BoundField DataField="Cogs" HeaderText="Cost"  DataFormatString="{0:N2}" />
            <asp:BoundField DataField="Profit" HeaderText="Profit"  DataFormatString="{0:N2}" />
