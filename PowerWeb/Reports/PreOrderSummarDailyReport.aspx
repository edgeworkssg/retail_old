<%@ Page Language="C#" MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" CodeBehind="PreOrderSummarDailyReport.aspx.cs" Inherits="PowerWeb.Reports.PreOrderSummarDailyReport" Title="<%$Resources:dictionary, Pre Order Summary (Daily) %>" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript" src="<%= ResolveUrl("~/Scripts/Applications/Report/PreOrder/pre-order-summary-daily.js") %>"></script>
