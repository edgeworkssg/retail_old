<%@ Page Language="C#" EnableEventValidation="true" MasterPageFile="~/PowerPOSMst.master"
    AutoEventWireup="true" Inherits="StockCardDetailedReport" Title="<%$Resources:dictionary, Stock Card Report (Detailed)%>"
    CodeBehind="StockCardDetailedReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="gvReport" Width="800px" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        AutoGenerateColumns="True" PageSize="20" ShowFooter="true" SkinID="scaffold"
