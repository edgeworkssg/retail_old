<%@ Page Language="C#" EnableEventValidation="true"  MasterPageFile="~/PowerPOSMst.master" AutoEventWireup="true" Inherits="MemberProjectTransactionDetailedReport" Title="<%$Resources:dictionary,Member Project Transaction Detailed Report %>" Codebehind="MemberProjectTransactionDetailedReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <cc1:CalendarExtender ID="cldEndDate" runat="server" Animated="False" Format="dd MMM yyyy"
        PopupButtonID="ImageButton2" TargetControlID="txtEndDate">
          ...
          <div style="height:20px;" class="wl_pageheaderSub"> <asp:Literal ID = "SEARCHLbl" runat="server" Text="<%$Resources:dictionary,SEARCH %>"></asp:Literal> </div>
    <table width="700px" id="FilterTable">        
        <tr>
            ...
            <td>
             ...
             <tr><td >
            <asp:Literal ID = "Literal4" runat="server" Text="<%$Resources:dictionary,Membership No %>"></asp:Literal></td><td><asp:TextBox ID="txtMembershipNo" runat="server" Width="170px"></asp:TextBox></td>
        <td >
            <asp:Literal ID = "Literal10" runat="server" Text="Project Name "></asp:Literal></td><td>
            <asp:TextBox ID="txtProjectName" runat="server" Width="170px"></asp:TextBox></td></tr>
        <tr><td >
            <asp:Literal ID = "Literal11" runat="server" Text="<%$Resources:dictionary,First Name %>"></asp:Literal></td><td>
            <asp:TextBox ID="txtFirstName" runat="server" Width="170px"></asp:TextBox></td>
        <td >
            <asp:Literal ID = "Literal12" runat="server" Text="<%$Resources:dictionary,Last Name %>"></asp:Literal></td><td>
            <asp:TextBox ID="txtLastName" runat="server" Width="170px"></asp:TextBox></td></tr>
        <tr>
            <td >
            ...
            <td>
                <asp:TextBox ID="txtNameToAppear" runat="server" Width="170px"></asp:TextBox></td>
        </tr>
        <tr><td  style="width: 102px"> <asp:Literal ID = "Literal8" runat="server" Text="<%$Resources:dictionary,Item Name %>"></asp:Literal></td><td><asp:TextBox ID="txtItemName" runat="server" Width="170px"></asp:TextBox></td>
        <td >
            <asp:Literal ID = "Literal9" runat="server" Text="<%$Resources:dictionary,Category %>"></asp:Literal></td><td>
        ...
        <tr>
            ...
            <td>
                <subsonic:DropDown ID="ddDept" runat="server" OnInit="ddDept_Init" PromptValue=""
                    TableName="Department" TextField="DepartmentName" ValueField="DepartmentID" Width="170px">
                </subsonic:DropDown></td>
            <td >
            <asp:Literal ID = "Literal3" runat="server" Text="<%$Resources:dictionary,Order Ref No %>"></asp:Literal></td>
            <td>
            <asp:TextBox ID="txtOrderNo" runat="server" Width="170px"></asp:TextBox></td>
        </tr>
