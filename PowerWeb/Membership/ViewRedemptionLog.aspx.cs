...
public partial class ViewRedemptionLog : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = MembershipController.FetchAHAVARedemptionLog(
            cbUseStartDate.Checked, cbUseEndDate.Checked,
            startDate, endDate.AddSeconds(86399),
            txtMembershipNo.Text.Trim(' '), selectedGroup, 
            txtNameToAppear.Text,txtFirstName.Text,txtLastName.Text,txtNRIC.Text,
            SelectedPOS,selectedOutlet,        
