...
public partial class ProjectOutstandingInstallmentReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = ReportController.FetchOutstandingInstallmentReport(txtSearch.Text);
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Credit = Decimal.Parse(e.Row.Cells[CREDIT - 1].Text);
            e.Row.Cells[CREDIT - 1].Text = String.Format("{0:N2}", Credit);

            Debit = Decimal.Parse(e.Row.Cells[DEBIT - 1].Text);
            e.Row.Cells[DEBIT - 1].Text = String.Format("{0:N2}", Debit);

            Balance = Decimal.Parse(e.Row.Cells[BALANCE - 1].Text);
