...
public partial class ViewCurrentMembersPoints : PageBase
{
    private const int COL_TOTALPOINTS = 11;
    private const int COL_POINTTYPE = 12;
    private const int COL_BREAKDOWNPRICE = 13;
    private const int COL_TOTALVALUE = 14;
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = MembershipController.FetchValidMembersPointsByDate(            
            ...
            ViewState[SORT_DIRECTION].ToString(), chkIncludeZeroPoints.Checked);        
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            if (e.Row.Cells[COL_POINTTYPE].Text.ToLower() == "d")
            {
                e.Row.Cells[COL_TOTALPOINTS].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[COL_TOTALPOINTS].Text));
                e.Row.Cells[COL_BREAKDOWNPRICE].Text = "--";
                e.Row.Cells[COL_TOTALVALUE].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[COL_TOTALVALUE].Text));
            }
            else
            {
                e.Row.Cells[COL_TOTALPOINTS].Text = Decimal.Parse(e.Row.Cells[COL_TOTALPOINTS].Text).ToString("N0");
                e.Row.Cells[COL_BREAKDOWNPRICE].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[COL_BREAKDOWNPRICE].Text));
                e.Row.Cells[COL_TOTALVALUE].Text = String.Format("{0:N2}", Decimal.Parse(e.Row.Cells[COL_TOTALVALUE].Text));


            }
            
            e.Row.Cells[COL_POINTTYPE].Text = "";
        }
    }
