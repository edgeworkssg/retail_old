...
public partial class MemberProjectTransactionDetailedReport : PageBase
{
    ...
    private void BindGrid()
    {
        ...
        DataTable dt = ReportController.FetchMembershipProjectTransactionDetailedReport(
            ...
            txtProjectName.Text,txtFirstName.Text,txtLastName.Text,txtNameToAppear.Text,txtOrderNo.Text,            
    ...
    protected void gvReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[AMOUNT].Text = String.Format("{0:N}", Decimal.Parse(e.Row.Cells[AMOUNT].Text));
        }
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            DataTable dt = (DataTable)gvReport.DataSource;            
            e.Row.Cells[AMOUNT].Text = String.Format("{0:N}", calculateSum());
        }   
    }
