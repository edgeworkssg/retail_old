/****** Object:  Table [dbo].[Category]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
...
END
/****** Object:  StoredProcedure [dbo].[GetNewCashRecRefNoByPointOfSaleID]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  Table [dbo].[CashRecordingType]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[ItemGroup]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[ItemGroup](
	...
	[ItemGroupName] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[UniqueItems] [bit] NULL,
	[CreatedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedOn] [datetime] NULL,
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
...
END
/****** Object:  Table [dbo].[UserGroup]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[Supplier]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[Supplier](
	...
	[CustomerAddress] [varchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ShipToAddress] [varchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[BillToAddress] [varchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ContactNo1] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ContactNo2] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ContactNo3] [varchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[ContactPerson3] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
END
/****** Object:  Table [dbo].[Department]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  View [dbo].[ViewLoginActivityReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  StoredProcedure [dbo].[GetNewCounterCloseIDByPointOfSaleID]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  Table [dbo].[PaymentTerm]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[PaymentTerm](
	...
	[PaymentTermName] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Remark] [varchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedOn] [datetime] NULL,
...
END
/****** Object:  StoredProcedure [dbo].[FetchItemByName]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  StoredProcedure [dbo].[FetchItemByBarcode]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  Table [dbo].[ScheduledDiscount]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ScheduledDiscount]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[ScheduledDiscount](
	[ScheduledDiscountID] [int] IDENTITY(1,1) NOT NULL,
	[ItemNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Category] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ItemGroupHdrID] [int] NULL,
	...
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
 CONSTRAINT [PK_ScheduledDiscount] PRIMARY KEY CLUSTERED 
(
	[ScheduledDiscountID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  View [dbo].[ViewReceiptSummary]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  StoredProcedure [dbo].[GetNewInventoryRefNoByPointOfSaleID]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  Table [dbo].[UserPrivilege]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[InventoryHdr]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[Outlet]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  StoredProcedure [dbo].[GetMaxItemRefNo]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  Table [dbo].[EditInvLog]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[EditBillLog]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[PaymentType]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[Item]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[PromoCampaignDet]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PromoCampaignDet]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PromoCampaignDet](
	[PromoCampaignDetID] [int] IDENTITY(1,1) NOT NULL,
	[PromoCampaignHdrID] [int] NOT NULL,
	...
	[CreatedOn] [datetime] NULL,
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
 CONSTRAINT [PK_PromoCampaignDet] PRIMARY KEY CLUSTERED 
(
	[PromoCampaignDetID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  Table [dbo].[CashRecording]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[ItemGroupMap]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ItemGroupMap]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[ItemGroupMap](
	[ItemGroupMapID] [int] IDENTITY(1,1) NOT NULL,
	...
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
 CONSTRAINT [PK_ItemGroupMap] PRIMARY KEY CLUSTERED 
(
	[ItemGroupMapID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  Table [dbo].[UserMst]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[GroupUserPrivilege]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[PurchaseOrderDetail]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PurchaseOrderDetail]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PurchaseOrderDetail](
	[PurchaseOrderDetailID] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[ItemNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[PurchaseOrderNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Quantity] [int] NOT NULL,
	[Price] [money] NOT NULL,
	[Discount] [money] NOT NULL,
	[IsNonGst] [bit] NOT NULL,
	[CreatedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedOn] [datetime] NULL,
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
 CONSTRAINT [PK_PODET] PRIMARY KEY CLUSTERED 
(
	[PurchaseOrderDetailID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  Table [dbo].[PurchaseOrderHeader]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PurchaseOrderHeader]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PurchaseOrderHeader](
	...
	[ShipVia] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
 CONSTRAINT [PK_POHDR_1] PRIMARY KEY CLUSTERED 
(
	[PurchaseOrderNo] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  Table [dbo].[InventoryDet]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[InventoryDet](
	...
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ModifiedOn] [datetime] NULL,
	[UniqueID] [uniqueidentifier] NOT NULL CONSTRAINT [DF_InventoryDet_UniqueID]  DEFAULT (newid()),
...
END
/****** Object:  Table [dbo].[ReceiptDet]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[LoginActivity]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[OrderHdr]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[CounterCloseLog]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[CounterCloseLog](
	...
	[SystemCollected] [money] NOT NULL,
	[CashCollected] [money] NOT NULL,
	[NetsCollected] [money] NOT NULL,
	[NetsTerminalID] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[VisaCollected] [money] NOT NULL,
	[VisaBatchNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[AmexCollected] [money] NOT NULL,
	[AmexBatchNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[DepositBagNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
END
/****** Object:  Table [dbo].[Camera]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[ReceiptHdr]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
CREATE TABLE [dbo].[ReceiptHdr](
	...
	[OrderHdrID] [varchar](14) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[Amount] [money] NOT NULL,
	[AmountBeforeRounding] [money] NOT NULL,
	[Tax] [float] NULL,
...
END
/****** Object:  Table [dbo].[OrderDet]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[PointOfSale]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  Table [dbo].[PromoCampaignHdr]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PromoCampaignHdr]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[PromoCampaignHdr](
	[PromoCampaignHdrID] [int] IDENTITY(1,1) NOT NULL,
	[PromoCampaignName] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[CampaignType] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[DateFrom] [datetime] NOT NULL,
	[DateTo] [datetime] NOT NULL,
	[PromoPrice] [money] NULL,
	[PromoDiscount] [float] NULL,
	[FreeQty] [int] NULL,
	[FreeItemNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Remark] [varchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[CreatedOn] [datetime] NULL,
	[ModifiedBy] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
(
	[PromoCampaignHdrID] ASC
)WITH (IGNORE_DUP_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
END
/****** Object:  StoredProcedure [dbo].[FetchItemNameListByPointOfSaleID]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  StoredProcedure [dbo].[FetchCategoryNameByPointOfSaleId]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  View [dbo].[ViewCashRecording]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  View [dbo].[ViewGroupPrivileges]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  View [dbo].[ViewInventoryActivity]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  StoredProcedure [dbo].[FetchStockReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  View [dbo].[ViewCostOfGoods]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[ViewCostOfGoods]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.ViewCostOfGoods
AS
SELECT     dbo.InventoryDet.CostOfGoods * dbo.InventoryDet.Quantity AS CostWithQty, dbo.InventoryDet.CostOfGoods, dbo.InventoryDet.Quantity, 
                      MONTH(dbo.InventoryHdr.InventoryDate) AS InventoryMonth, dbo.InventoryHdr.PointOfSaleId, dbo.InventoryDet.ItemNo
FROM         dbo.PointOfSale INNER JOIN
                      dbo.Outlet ON dbo.PointOfSale.OutletName = dbo.Outlet.OutletName INNER JOIN
                      dbo.InventoryDet INNER JOIN
                      dbo.InventoryHdr ON dbo.InventoryDet.InventoryHdrRefNo = dbo.InventoryHdr.InventoryHdrRefNo ON dbo.PointOfSale.PointOfSaleID = dbo.InventoryHdr.PointOfSaleId
' 
/****** Object:  View [dbo].[ViewInventoryItemOnHandQty]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  StoredProcedure [dbo].[FetchProfitLossReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FetchProfitLossReport]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'-- =============================================
-- Author:		<Author,,Name>
-- Create date: <Create Date,,>
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE FetchProfitLossReport
	-- Add the parameters for the stored procedure here
	@startdate datetime,
	@enddate datetime,
	@PointOfSaleName varchar(50),
...
BEGIN
	...
	Begin				
		SELECT	
				isnull(SUM(ReceiptHdr.Amount * (1-(Tax/100))),0) AS NettSales,
				isnull(SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity),0) AS CostOfGoods,
			   isnull((SUM(ReceiptHdr.Amount * (1-(Tax/100))) - SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity)),0) as ProfitLoss, 				
		...
		FROM  OrderDet INNER JOIN
			  ...
			  ReceiptHdr ON OrderDet.OrderHdrID = ReceiptHdr.OrderHdrID INNER JOIN
		...
		WHERE  (OrderHdr.OrderDate BETWEEN @startdate AND @enddate)			  
			   AND OrderDet.IsVoided = 0
			   AND OrderHdr.IsVoided = 0		
		ORDER BY
		CASE    WHEN @sortby = ''NettSales'' and @sortdir = ''DESC'' 
				THEN rank() over (order by SUM(ReceiptHdr.Amount * (1-(Tax/100))) desc)
				WHEN @sortby = ''NettSales'' and @sortdir = ''ASC'' 
				THEN rank() over (order by SUM(ReceiptHdr.Amount * (1-(Tax/100))) asc)
				WHEN @sortby = ''CostOfGoods'' and @sortdir = ''DESC'' 
				THEN rank() over (order by SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity) desc)
				WHEN @sortby = ''CostOfGoods'' and @sortdir = ''ASC'' 
				THEN rank() over (order by SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity) asc)
				WHEN @sortby = ''ProfitLoss'' and @sortdir = ''DESC'' 
				THEN rank() over (order by (SUM(ReceiptHdr.Amount * (1-(Tax/100))) - SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity)) desc)
				WHEN @sortby = ''ProfitLoss'' and @sortdir = ''ASC'' 
				THEN rank() over (order by (SUM(ReceiptHdr.Amount * (1-(Tax/100))) - SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity)) asc)
				ELSE rank() over (order by (SUM(ReceiptHdr.Amount * (1-(Tax/100))) - SUM(OrderDet.CostOfGoodSold*OrderDet.Quantity)) desc)
		END 
	End
	Else if (@PointOfSaleName = ''ALL'' and @OutletName != ''ALL'')  --See total amt for PointOfSales at one outlet
	Begin
	...
	begin
		...
		WHERE  (OrderHdr.OrderDate BETWEEN @startdate AND @enddate)			  
			   ...
			   AND OrderDet.IsVoided = 0
			   AND OrderHdr.IsVoided = 0		
		GROUP BY Outlet.OutletName,PointOfSale.PointOfSaleName
		ORDER BY
		CASE    WHEN @sortby = ''NettSales'' and @sortdir = ''DESC'' 
				THEN rank() over (order by SUM(ReceiptHdr.Amount * (1-(Tax/100))) desc)
				WHEN @sortby = ''NettSales'' and @sortdir = ''ASC'' 
...
' 
END
/****** Object:  StoredProcedure [dbo].[FetchCollectionReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
BEGIN
	...
	if (@OutletName = ''ALL'' AND @PointOfSaleName = ''ALL'') --See total amt for all outlets 
	Begin				
		SELECT isNull(SUM(CounterCloseLog.CashCollected),0) AS TotalCashCollected, 
			   isNull(SUM(CounterCloseLog.NetsCollected),0) AS TotalNetsCollected, 
			   isNull(SUM(CounterCloseLog.VisaCollected),0) AS TotalVisaCollected, 
			   isNull(SUM(CounterCloseLog.AmexCollected),0) AS TotalAmexCollected, 			   
			   isNull(SUM(CounterCloseLog.TotalActualCollected),0) AS TotalCollected,			   
			   ''ALL'' as PointOfSaleName, ''ALL'' as OutletName		   
		FROM  CounterCloseLog INNER JOIN			  
			  PointOfSale ON CounterCloseLog.PointOfSaleID = PointOfSale.PointOfSaleID INNER JOIN
			  Outlet ON PointOfSale.OutletName = Outlet.OutletName
		WHERE  (CounterCloseLog.EndTime BETWEEN @startdate AND @enddate)			  		
		ORDER BY
		CASE    
				WHEN @sortby = ''TotalCashCollected'' and @sortdir = ''DESC'' 
				THEN rank() over (order by sum(CounterCloseLog.CashCollected) desc)
				WHEN @sortby = ''TotalCashCollected'' and @sortdir = ''ASC'' 
				THEN rank() over (order by sum(CounterCloseLog.CashCollected) asc)
				WHEN @sortby = ''TotalNetsCollected'' and @sortdir = ''DESC'' 
				THEN rank() over (order by sum(CounterCloseLog.NetsCollected) desc)
				WHEN @sortby = ''TotalNetsCollected'' and @sortdir = ''ASC'' 
				THEN rank() over (order by sum(CounterCloseLog.NetsCollected) asc)
				WHEN @sortby = ''TotalVisaCollected'' and @sortdir = ''DESC'' 
				THEN rank() over (order by sum(CounterCloseLog.VisaCollected) desc)
				WHEN @sortby = ''TotalVisaCollected'' and @sortdir = ''ASC'' 
				THEN rank() over (order by sum(CounterCloseLog.VisaCollected) asc)
				WHEN @sortby = ''TotalAmexCollected'' and @sortdir = ''DESC'' 
				THEN rank() over (order by sum(CounterCloseLog.AmexCollected) desc)
				WHEN @sortby = ''TotalAmexCollected'' and @sortdir = ''ASC'' 
				THEN rank() over (order by sum(CounterCloseLog.AmexCollected) asc)												
				ELSE rank() over (order by sum(CounterCloseLog.CashCollected) asc)
		END 
	End
	Else if (@PointOfSaleName = ''ALL'' and @OutletName != ''ALL'')  --See total amt for PointOfSales at one outlet
	Begin
		...
		ORDER BY
			CASE    
				...
				THEN rank() over (order by sum(CounterCloseLog.TotalActualCollected) desc)
				WHEN @sortby = ''TotalCollected'' and @sortdir = ''ASC'' 
				THEN rank() over (order by sum(CounterCloseLog.TotalActualCollected) asc)				
				ELSE rank() over (order by sum(CounterCloseLog.TotalActualCollected) desc)
			END 
	End
	Else if (@PointOfSaleName != ''ALL'' and @OutletName = ''ALL'')  
		--See total amt for a PointOfSale without particular outlet
...
END
/****** Object:  View [dbo].[ViewCloseCounterReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
AS
SELECT     dbo.CounterCloseLog.CounterCloseID, dbo.CounterCloseLog.StartTime, dbo.CounterCloseLog.EndTime, dbo.CounterCloseLog.Cashier, 
                      dbo.CounterCloseLog.TotalActualCollected, dbo.CounterCloseLog.Variance, dbo.CounterCloseLog.CashCollected, dbo.CounterCloseLog.NetsCollected, 
                      dbo.CounterCloseLog.VisaCollected, dbo.CounterCloseLog.AmexCollected, dbo.CounterCloseLog.ClosingCashOut, 
                      dbo.CounterCloseLog.DepositBagNo, dbo.CounterCloseLog.Supervisor, dbo.CounterCloseLog.OpeningBalance, dbo.CounterCloseLog.CashIn, 
                      dbo.CounterCloseLog.CashOut, dbo.CounterCloseLog.PointOfSaleID, dbo.PointOfSale.PointOfSaleName, dbo.Outlet.OutletName, dbo.CounterCloseLog.NetsTerminalID, 
                      dbo.CounterCloseLog.VisaBatchNo, dbo.CounterCloseLog.AmexBatchNo, dbo.CounterCloseLog.FloatBalance, 
                      dbo.CounterCloseLog.SystemCollected
FROM         dbo.CounterCloseLog INNER JOIN
                      ...
                      dbo.Outlet ON dbo.PointOfSale.OutletName = dbo.Outlet.OutletName
' 
/****** Object:  View [dbo].[ViewSalesDetail]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
/****** Object:  View [dbo].[ViewTransactions]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
FROM         dbo.OrderHdr INNER JOIN
                      ...
                      dbo.Outlet ON dbo.PointOfSale.OutletName = dbo.Outlet.OutletName
' 
/****** Object:  StoredProcedure [dbo].[FetchProductSalesReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
END
/****** Object:  StoredProcedure [dbo].[FetchProductCategorySalesReport]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
' 
END
/****** Object:  StoredProcedure [dbo].[GetNewOrderHdrNoByPointOfSaleId]    Script Date: 05/23/2007 06:19:23 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignDet_Category]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignDet]'))
ALTER TABLE [dbo].[PromoCampaignDet]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignDet_Category] FOREIGN KEY([CategoryName])
REFERENCES [Category] ([CategoryName])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignDet_Item]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignDet]'))
ALTER TABLE [dbo].[PromoCampaignDet]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignDet_Item] FOREIGN KEY([ItemNo])
REFERENCES [Item] ([ItemNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignDet_ItemGroupID]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignDet]'))
ALTER TABLE [dbo].[PromoCampaignDet]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignDet_ItemGroupID] FOREIGN KEY([ItemGroupID])
REFERENCES [ItemGroup] ([ItemGroupId])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignDet_PromoCampaignHdr]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignDet]'))
ALTER TABLE [dbo].[PromoCampaignDet]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignDet_PromoCampaignHdr] FOREIGN KEY([PromoCampaignHdrID])
REFERENCES [PromoCampaignHdr] ([PromoCampaignHdrID])
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ItemGroupMap_Item]') AND parent_object_id = OBJECT_ID(N'[dbo].[ItemGroupMap]'))
ALTER TABLE [dbo].[ItemGroupMap]  WITH CHECK ADD  CONSTRAINT [FK_ItemGroupMap_Item] FOREIGN KEY([ItemNo])
REFERENCES [Item] ([ItemNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ItemGroupMap_ItemGroup]') AND parent_object_id = OBJECT_ID(N'[dbo].[ItemGroupMap]'))
ALTER TABLE [dbo].[ItemGroupMap]  WITH CHECK ADD  CONSTRAINT [FK_ItemGroupMap_ItemGroup] FOREIGN KEY([ItemGroupID])
REFERENCES [ItemGroup] ([ItemGroupId])
...
ALTER TABLE [dbo].[PurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderDetail_Item] FOREIGN KEY([ItemNo])
REFERENCES [Item] ([ItemNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderDetail_PurchaseOrderDetail]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderDetail]'))
ALTER TABLE [dbo].[PurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderDetail_PurchaseOrderDetail] FOREIGN KEY([PurchaseOrderDetailID])
REFERENCES [PurchaseOrderDetail] ([PurchaseOrderDetailID])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderDetail_PurchaseOrderHeader]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderDetail]'))
ALTER TABLE [dbo].[PurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderDetail_PurchaseOrderHeader] FOREIGN KEY([PurchaseOrderNo])
REFERENCES [PurchaseOrderHeader] ([PurchaseOrderNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderHeader_Department]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderHeader]'))
ALTER TABLE [dbo].[PurchaseOrderHeader]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderHeader_Department] FOREIGN KEY([DepartmentID])
REFERENCES [Department] ([DepartmentID])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderHeader_PaymentTerms]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderHeader]'))
ALTER TABLE [dbo].[PurchaseOrderHeader]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderHeader_PaymentTerms] FOREIGN KEY([PaymentTermID])
REFERENCES [PaymentTerm] ([PaymentTermID])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderHeader_PurchaseOrderHeader]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderHeader]'))
ALTER TABLE [dbo].[PurchaseOrderHeader]  WITH CHECK ADD  CONSTRAINT [FK_PurchaseOrderHeader_PurchaseOrderHeader] FOREIGN KEY([PurchaseOrderNo])
REFERENCES [PurchaseOrderHeader] ([PurchaseOrderNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PurchaseOrderHeader_Supplier]') AND parent_object_id = OBJECT_ID(N'[dbo].[PurchaseOrderHeader]'))
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignHdr_Item]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignHdr]'))
ALTER TABLE [dbo].[PromoCampaignHdr]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignHdr_Item] FOREIGN KEY([FreeItemNo])
REFERENCES [Item] ([ItemNo])
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_PromoCampaignHdr_PromoCampaignDet]') AND parent_object_id = OBJECT_ID(N'[dbo].[PromoCampaignHdr]'))
ALTER TABLE [dbo].[PromoCampaignHdr]  WITH CHECK ADD  CONSTRAINT [FK_PromoCampaignHdr_PromoCampaignDet] FOREIGN KEY([PromoCampaignHdrID])
REFERENCES [PromoCampaignHdr] ([PromoCampaignHdrID])
