IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[VoucherHeader]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[VoucherHeader](
	[VoucherHeaderID] [int] IDENTITY(1,1) NOT NULL,
	[VoucherHeaderName] [varchar](50) NOT NULL,
	...
	[CanceledQuantity] [int] NULL,
	[RedeemedQuantityWithoutVoucherNo] [int] NULL,
	[Outlet] [varchar](max) NULL,
	[VoucherPrefix] [varchar](50) NULL,
	[StartNumber] [int] NOT NULL,
	[EndNumber] [int] NOT NULL,
	[VoucherSuffix] [varchar](50) NULL,
	[NumOfDigit] [int] NOT NULL,
