IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REPORT_NewCommissionReport]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[REPORT_NewCommissionReport]

SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON

IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[REPORT_NewCommissionReport]') AND type in (N'P', N'PC'))
BEGIN
