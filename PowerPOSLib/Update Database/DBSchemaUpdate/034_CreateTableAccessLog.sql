IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[AccessLog]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[AccessLog](
	[AccessLogID] [uniqueidentifier] NOT NULL,
	[PointOfSaleID] [int] NULL,
	[AccessDate] [datetime] NULL,	
	[LoginName] [nvarchar](max) NULL,
	[SecondLoginName] [nvarchar](max) NULL,	
	[AccessType] [nvarchar](max) NULL,
	[AccessSource] [nvarchar](max) NULL,
