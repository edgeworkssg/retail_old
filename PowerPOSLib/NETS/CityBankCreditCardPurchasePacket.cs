...
namespace PowerPOS.Nets
{
    ...
    /// </summary>
    class CityBankCreditCardPurchasePacket : Packet
    {
        ...
        public CityBankCreditCardPurchasePacket()
        {
            init();
        }
        ...
        {
            byte[] content = generateMessageHeader(NETSConstants.MessageHeader.FunctionCode.CITYBANK_CREDITCARD_PURCHASE);
           ...
           // byte[] msgData2 = new byte[NETSConstants.MessageData.CASH_BACK_AMOUNT.Len + 5]; //2 bytes field code, 2 bytes len, 1 byte separator
            ...
            packet = Utilities.asciiStrToBytesArray("02005236303030303030303030313032303030301c343000123030303030303030373030301c343200123030303030303030353030301c0378");
