...
namespace PowerPOS.Nets
{
    ...
    class NETSConstants
    {
        ...
        public class tBVStatusInfo
        {
            char cCashState;
            int iCashCount;
        }

        public class tCBStatusInfo
        {
            char cCBState;
            char acCashUnitName;
            char acCashUnitIDEx;
        ...
        public class tCIMCapabilities
        {
            ...
            bool bInterStacker;
            bool bInterBuffer;
            bool bItemTakenSensor; // is note taken
            string cDevType;
            string cDevVersion;
            string cDLLVersion;
        ...
        public class MessageHeader
        {
            ...
            public class FunctionCode
            {
                ...
                */
                ...
                //Credit Card
                public const string CREDITCARD_PURCHASE = "I0";
                public const string CITYBANK_CREDITCARD_PURCHASE = "20";
            }
        }
        ...
        public class MessageData
        {
            ...
            public static ResponseMessageData ECR_REFERENCE_NUMBER = new ResponseMessageData("ECR Reference Number", "H4", 10);
