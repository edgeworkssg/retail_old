...
{
	/// <summary>
	/// Strongly-typed collection for the Gst class.
	/// </summary>
    [Serializable]
	public partial class GstCollection : ActiveList<Gst, GstCollection>
	{	   
        ...
        /// </summary>
        /// <returns>GstCollection</returns>
		public GstCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the GST table.
	/// </summary>
	[Serializable]
	public partial class Gst : ActiveRecord<Gst>, IActiveRecord
	{
		...
		public Gst(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Gst(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("GST", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarGstid = new TableSchema.TableColumn(schema);
				colvarGstid.ColumnName = "GSTID";
				colvarGstid.DataType = DbType.Int32;
				colvarGstid.MaxLength = 0;
				colvarGstid.AutoIncrement = true;
				colvarGstid.IsNullable = false;
				colvarGstid.IsPrimaryKey = true;
				colvarGstid.IsForeignKey = false;
				colvarGstid.IsReadOnly = false;
				colvarGstid.DefaultSetting = @"";
				colvarGstid.ForeignKeyTableName = "";
				schema.Columns.Add(colvarGstid);
				
				TableSchema.TableColumn colvarGSTRate = new TableSchema.TableColumn(schema);
				colvarGSTRate.ColumnName = "GSTRate";
				colvarGSTRate.DataType = DbType.Double;
				colvarGSTRate.MaxLength = 0;
				colvarGSTRate.AutoIncrement = false;
				colvarGSTRate.IsNullable = false;
				colvarGSTRate.IsPrimaryKey = false;
				colvarGSTRate.IsForeignKey = false;
				colvarGSTRate.IsReadOnly = false;
				colvarGSTRate.DefaultSetting = @"";
				colvarGSTRate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarGSTRate);
				
				TableSchema.TableColumn colvarCommenceDate = new TableSchema.TableColumn(schema);
				colvarCommenceDate.ColumnName = "CommenceDate";
				colvarCommenceDate.DataType = DbType.DateTime;
				colvarCommenceDate.MaxLength = 0;
				colvarCommenceDate.AutoIncrement = false;
				colvarCommenceDate.IsNullable = false;
				colvarCommenceDate.IsPrimaryKey = false;
				colvarCommenceDate.IsForeignKey = false;
				colvarCommenceDate.IsReadOnly = false;
				colvarCommenceDate.DefaultSetting = @"";
				colvarCommenceDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCommenceDate);
				...
				DataService.Providers["PowerPOS"].AddSchema("GST",schema);
			}
		}
		#endregion
		...
		public int Gstid 
		{
			get { return GetColumnValue<int>(Columns.Gstid); }
			set { SetColumnValue(Columns.Gstid, value); }
		}
		  
		[XmlAttribute("GSTRate")]
		[Bindable(true)]
		public double GSTRate 
		{
			get { return GetColumnValue<double>(Columns.GSTRate); }
			set { SetColumnValue(Columns.GSTRate, value); }
		}
		  
		[XmlAttribute("CommenceDate")]
		[Bindable(true)]
		public DateTime CommenceDate 
		{
			get { return GetColumnValue<DateTime>(Columns.CommenceDate); }
			set { SetColumnValue(Columns.CommenceDate, value); }
		}
		...
		/// </summary>
		public static void Update(int varGstid,double varGSTRate,DateTime varCommenceDate,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Gst item = new Gst();
        ...
        public static TableSchema.TableColumn GstidColumn
        {
        ...
        public static TableSchema.TableColumn GSTRateColumn
        {
        ...
        public static TableSchema.TableColumn CommenceDateColumn
        {
		...
		{
			 public static string Gstid = @"GSTID";
			 public static string GSTRate = @"GSTRate";
			 public static string CommenceDate = @"CommenceDate";
