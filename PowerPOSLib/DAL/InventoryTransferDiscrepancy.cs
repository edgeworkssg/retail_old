...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryTransferDiscrepancy class.
	/// </summary>
    [Serializable]
	public partial class InventoryTransferDiscrepancyCollection : ActiveList<InventoryTransferDiscrepancy, InventoryTransferDiscrepancyCollection>
	{	   
		public InventoryTransferDiscrepancyCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryTransferDiscrepancyCollection</returns>
		public InventoryTransferDiscrepancyCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryTransferDiscrepancy o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryTransferDiscrepancy table.
	/// </summary>
	[Serializable]
	public partial class InventoryTransferDiscrepancy : ActiveRecord<InventoryTransferDiscrepancy>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public InventoryTransferDiscrepancy()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public InventoryTransferDiscrepancy(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryTransferDiscrepancy(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryTransferDiscrepancy(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryTransferDiscrepancy", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarDiscrepancyID.AutoIncrement = true;
				colvarDiscrepancyID.IsNullable = false;
				colvarDiscrepancyID.IsPrimaryKey = true;
				colvarDiscrepancyID.IsForeignKey = false;
				colvarDiscrepancyID.IsReadOnly = false;
				colvarDiscrepancyID.DefaultSetting = @"";
				colvarDiscrepancyID.ForeignKeyTableName = "";
				...
				colvarDiscrepancyReason.DefaultSetting = @"";
				colvarDiscrepancyReason.ForeignKeyTableName = "";
				...
				colvarDiscrepancyQuantity.DefaultSetting = @"";
				colvarDiscrepancyQuantity.ForeignKeyTableName = "";
				...
				colvarLocationTransferID.IsNullable = true;
				colvarLocationTransferID.IsPrimaryKey = false;
				colvarLocationTransferID.IsForeignKey = true;
				colvarLocationTransferID.IsReadOnly = false;
				colvarLocationTransferID.DefaultSetting = @"";
				
					colvarLocationTransferID.ForeignKeyTableName = "LocationTransfer";
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryTransferDiscrepancy",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.DiscrepancyID); }
			set { SetColumnValue(Columns.DiscrepancyID, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.DiscrepancyReason); }
			set { SetColumnValue(Columns.DiscrepancyReason, value); }
		}
		...
		{
			get { return GetColumnValue<int>(Columns.DiscrepancyQuantity); }
			set { SetColumnValue(Columns.DiscrepancyQuantity, value); }
		}
		...
		{
			get { return GetColumnValue<bool?>(Columns.IsClosed); }
		...
		{
			get { return GetColumnValue<int?>(Columns.LocationTransferID); }
			set { SetColumnValue(Columns.LocationTransferID, value); }
		}
		...
		/// <summary>
		/// Returns a LocationTransfer ActiveRecord object related to this InventoryTransferDiscrepancy
		/// 
		/// </summary>
		public PowerPOS.LocationTransfer LocationTransfer
		{
			get { return PowerPOS.LocationTransfer.FetchByID(this.LocationTransferID); }
			set { SetColumnValue("LocationTransferID", value.LocationTransferID); }
		}
		...
		/// </summary>
		public static void Insert(string varDiscrepancyReason,string varRemark,string varItemNo,int varDiscrepancyQuantity,decimal? varCostOfGoods,bool? varIsClosed,int? varLocationTransferID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryTransferDiscrepancy item = new InventoryTransferDiscrepancy();
			
			item.DiscrepancyReason = varDiscrepancyReason;
			
			item.Remark = varRemark;
			
			item.ItemNo = varItemNo;
			
			item.DiscrepancyQuantity = varDiscrepancyQuantity;
			
			item.CostOfGoods = varCostOfGoods;
			
			item.IsClosed = varIsClosed;
			
			item.LocationTransferID = varLocationTransferID;
		...
		/// </summary>
		public static void Update(int varDiscrepancyID,string varDiscrepancyReason,string varRemark,string varItemNo,int varDiscrepancyQuantity,decimal? varCostOfGoods,bool? varIsClosed,int? varLocationTransferID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryTransferDiscrepancy item = new InventoryTransferDiscrepancy();
			
				item.DiscrepancyID = varDiscrepancyID;
        ...
        public static TableSchema.TableColumn DiscrepancyIDColumn
        {
        ...
        public static TableSchema.TableColumn DiscrepancyReasonColumn
        {
        ...
        public static TableSchema.TableColumn DiscrepancyQuantityColumn
        {
        ...
        public static TableSchema.TableColumn LocationTransferIDColumn
        {
