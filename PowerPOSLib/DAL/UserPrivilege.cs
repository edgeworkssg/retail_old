...
{
	/// <summary>
	/// Strongly-typed collection for the UserPrivilege class.
	/// </summary>
    [Serializable]
	public partial class UserPrivilegeCollection : ActiveList<UserPrivilege, UserPrivilegeCollection>
	{	   
        ...
        /// </summary>
        /// <returns>UserPrivilegeCollection</returns>
		public UserPrivilegeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                UserPrivilege o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the UserPrivilege table.
	/// </summary>
	[Serializable]
	public partial class UserPrivilege : ActiveRecord<UserPrivilege>, IActiveRecord
	{
		...
		public UserPrivilege(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public UserPrivilege(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public UserPrivilege(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("UserPrivilege", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarUserPrivilegeID.AutoIncrement = true;
				colvarUserPrivilegeID.IsNullable = false;
				colvarUserPrivilegeID.IsPrimaryKey = true;
				...
				colvarPrivilegeName.DefaultSetting = @"";
				colvarPrivilegeName.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("UserPrivilege",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.PrivilegeName); }
			set { SetColumnValue(Columns.PrivilegeName, value); }
		}
		...
		public PowerPOS.GroupUserPrivilegeCollection GroupUserPrivilegeRecords()
		{
			return new PowerPOS.GroupUserPrivilegeCollection().Where(GroupUserPrivilege.Columns.UserPrivilegeID, UserPrivilegeID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varUserPrivilegeID,string varPrivilegeName,string varFormName,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			UserPrivilege item = new UserPrivilege();
        ...
        public static TableSchema.TableColumn PrivilegeNameColumn
        {
