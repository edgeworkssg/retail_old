...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWHourlySale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlySaleCollection : ReadOnlyList<ViewDWHourlySale, ViewDWHourlySaleCollection>
    {        
        public ViewDWHourlySaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_HourlySales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlySale : ReadOnlyRecord<ViewDWHourlySale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_HourlySales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_HourlySales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWHourlySale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWHourlySale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWHourlySale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWHourlySale(string columnName, object columnValue)
        {
            SetSQLProps();
