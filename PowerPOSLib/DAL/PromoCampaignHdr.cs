...
{
	/// <summary>
	/// Strongly-typed collection for the PromoCampaignHdr class.
	/// </summary>
    [Serializable]
	public partial class PromoCampaignHdrCollection : ActiveList<PromoCampaignHdr, PromoCampaignHdrCollection>
	{	   
		public PromoCampaignHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PromoCampaignHdrCollection</returns>
		public PromoCampaignHdrCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PromoCampaignHdr o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PromoCampaignHdr table.
	/// </summary>
	[Serializable]
	public partial class PromoCampaignHdr : ActiveRecord<PromoCampaignHdr>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public PromoCampaignHdr()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public PromoCampaignHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PromoCampaignHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PromoCampaignHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PromoCampaignHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarPromoCampaignHdrID.AutoIncrement = true;
				colvarPromoCampaignHdrID.IsNullable = false;
				colvarPromoCampaignHdrID.IsPrimaryKey = true;
				...
				colvarPromoCampaignName.DefaultSetting = @"";
				colvarPromoCampaignName.ForeignKeyTableName = "";
				...
				colvarPromoCode.DataType = DbType.AnsiString;
				colvarPromoCode.MaxLength = 50;
				colvarPromoCode.AutoIncrement = false;
				colvarPromoCode.IsNullable = false;
				...
				colvarCampaignType.DefaultSetting = @"";
				colvarCampaignType.ForeignKeyTableName = "";
				...
				colvarFreeQty.DefaultSetting = @"";
				colvarFreeQty.ForeignKeyTableName = "";
				...
				colvarFreeItemNo.IsForeignKey = true;
				colvarFreeItemNo.IsReadOnly = false;
				colvarFreeItemNo.DefaultSetting = @"";
				
					colvarFreeItemNo.ForeignKeyTableName = "Item";
				...
				colvarPromoDiscount.IsReadOnly = false;
						...
						colvarPromoDiscount.DefaultSetting = @"((0))";
				...
				colvarForNonMembersAlso.DefaultSetting = @"";
				colvarForNonMembersAlso.ForeignKeyTableName = "";
				...
				colvarForAllLocations.IsReadOnly = false;
						...
						colvarForAllLocations.DefaultSetting = @"((0))";
				colvarForAllLocations.ForeignKeyTableName = "";
				...
				colvarUsePrice.IsReadOnly = false;
						...
						colvarUsePrice.DefaultSetting = @"((0))";
				colvarUsePrice.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarIsRestricHour = new TableSchema.TableColumn(schema);
				colvarIsRestricHour.ColumnName = "IsRestricHour";
				colvarIsRestricHour.DataType = DbType.Boolean;
				colvarIsRestricHour.MaxLength = 0;
				colvarIsRestricHour.AutoIncrement = false;
				colvarIsRestricHour.IsNullable = true;
				colvarIsRestricHour.IsPrimaryKey = false;
				colvarIsRestricHour.IsForeignKey = false;
				colvarIsRestricHour.IsReadOnly = false;
				colvarIsRestricHour.DefaultSetting = @"";
				colvarIsRestricHour.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsRestricHour);
				
				TableSchema.TableColumn colvarRestrictHourStart = new TableSchema.TableColumn(schema);
				colvarRestrictHourStart.ColumnName = "RestrictHourStart";
				colvarRestrictHourStart.DataType = DbType.DateTime;
				colvarRestrictHourStart.MaxLength = 0;
				colvarRestrictHourStart.AutoIncrement = false;
				colvarRestrictHourStart.IsNullable = true;
				colvarRestrictHourStart.IsPrimaryKey = false;
				colvarRestrictHourStart.IsForeignKey = false;
				colvarRestrictHourStart.IsReadOnly = false;
				colvarRestrictHourStart.DefaultSetting = @"";
				colvarRestrictHourStart.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRestrictHourStart);
				
				TableSchema.TableColumn colvarRestrictHourEnd = new TableSchema.TableColumn(schema);
				colvarRestrictHourEnd.ColumnName = "RestrictHourEnd";
				colvarRestrictHourEnd.DataType = DbType.DateTime;
				colvarRestrictHourEnd.MaxLength = 0;
				colvarRestrictHourEnd.AutoIncrement = false;
				colvarRestrictHourEnd.IsNullable = true;
				colvarRestrictHourEnd.IsPrimaryKey = false;
				colvarRestrictHourEnd.IsForeignKey = false;
				colvarRestrictHourEnd.IsReadOnly = false;
				colvarRestrictHourEnd.DefaultSetting = @"";
				colvarRestrictHourEnd.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRestrictHourEnd);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["PowerPOS"].AddSchema("PromoCampaignHdr",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.PromoCampaignName); }
			set { SetColumnValue(Columns.PromoCampaignName, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.CampaignType); }
			set { SetColumnValue(Columns.CampaignType, value); }
		}
		...
		public int? FreeQty 
		{
			get { return GetColumnValue<int?>(Columns.FreeQty); }
			set { SetColumnValue(Columns.FreeQty, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.FreeItemNo); }
			set { SetColumnValue(Columns.FreeItemNo, value); }
		}
		...
		{
			get { return GetColumnValue<bool?>(Columns.ForNonMembersAlso); }
			set { SetColumnValue(Columns.ForNonMembersAlso, value); }
		}
		...
		{
			get { return GetColumnValue<bool?>(Columns.ForAllLocations); }
			set { SetColumnValue(Columns.ForAllLocations, value); }
		}
		...
		{
			get { return GetColumnValue<bool>(Columns.UsePrice); }
			set { SetColumnValue(Columns.UsePrice, value); }
		}
		...
		[XmlAttribute("IsRestricHour")]
		[Bindable(true)]
		public bool? IsRestricHour 
		{
			get { return GetColumnValue<bool?>(Columns.IsRestricHour); }
			set { SetColumnValue(Columns.IsRestricHour, value); }
		}
		  
		[XmlAttribute("RestrictHourStart")]
		[Bindable(true)]
		public DateTime? RestrictHourStart 
		{
			get { return GetColumnValue<DateTime?>(Columns.RestrictHourStart); }
			set { SetColumnValue(Columns.RestrictHourStart, value); }
		}
		  
		[XmlAttribute("RestrictHourEnd")]
		[Bindable(true)]
		public DateTime? RestrictHourEnd 
		{
			get { return GetColumnValue<DateTime?>(Columns.RestrictHourEnd); }
			set { SetColumnValue(Columns.RestrictHourEnd, value); }
		}
		...
		{
			return new PowerPOS.PromoCampaignDetCollection().Where(PromoCampaignDet.Columns.PromoCampaignHdrID, PromoCampaignHdrID).Load();
		}
		public PowerPOS.PromoDiscountTierCollection PromoDiscountTierRecords()
		{
			return new PowerPOS.PromoDiscountTierCollection().Where(PromoDiscountTier.Columns.PromoCampaignHdrID, PromoCampaignHdrID).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this PromoCampaignHdr
		/// 
		/// </summary>
		public PowerPOS.Item Item
		{
			get { return PowerPOS.Item.FetchByID(this.FreeItemNo); }
			set { SetColumnValue("FreeItemNo", value.ItemNo); }
		}
		...
		/// </summary>
		public static void Insert(string varPromoCampaignName,string varPromoCode,string varBarcode,string varCampaignType,DateTime varDateFrom,DateTime varDateTo,int? varFreeQty,int? varPriority,string varFreeItemNo,decimal? varPromoPrice,double varPromoDiscount,string varRemark,bool varEnabled,bool? varForNonMembersAlso,bool? varForAllLocations,bool varUsePrice,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,bool? varIsRestricHour,DateTime? varRestrictHourStart,DateTime? varRestrictHourEnd)
		{
			PromoCampaignHdr item = new PromoCampaignHdr();
			
			item.PromoCampaignName = varPromoCampaignName;
			
			item.PromoCode = varPromoCode;
			
			item.Barcode = varBarcode;
			
			item.CampaignType = varCampaignType;
			
			item.DateFrom = varDateFrom;
			
			item.DateTo = varDateTo;
			
			item.FreeQty = varFreeQty;
			
			item.Priority = varPriority;
			
			item.FreeItemNo = varFreeItemNo;
			...
			item.ForNonMembersAlso = varForNonMembersAlso;
			
			item.ForAllLocations = varForAllLocations;
			
			item.UsePrice = varUsePrice;
			...
			item.IsRestricHour = varIsRestricHour;
			
			item.RestrictHourStart = varRestrictHourStart;
			
			item.RestrictHourEnd = varRestrictHourEnd;
		...
		/// </summary>
		public static void Update(int varPromoCampaignHdrID,string varPromoCampaignName,string varPromoCode,string varBarcode,string varCampaignType,DateTime varDateFrom,DateTime varDateTo,int? varFreeQty,int? varPriority,string varFreeItemNo,decimal? varPromoPrice,double varPromoDiscount,string varRemark,bool varEnabled,bool? varForNonMembersAlso,bool? varForAllLocations,bool varUsePrice,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,bool? varIsRestricHour,DateTime? varRestrictHourStart,DateTime? varRestrictHourEnd)
		{
			PromoCampaignHdr item = new PromoCampaignHdr();
        ...
        public static TableSchema.TableColumn PromoCampaignNameColumn
        {
        ...
        public static TableSchema.TableColumn CampaignTypeColumn
        {
        ...
        public static TableSchema.TableColumn FreeQtyColumn
        {
        ...
        public static TableSchema.TableColumn FreeItemNoColumn
        {
        ...
        public static TableSchema.TableColumn ForNonMembersAlsoColumn
        {
        ...
        public static TableSchema.TableColumn ForAllLocationsColumn
        {
        ...
        public static TableSchema.TableColumn UsePriceColumn
        {
        ...
        public static TableSchema.TableColumn IsRestricHourColumn
        {
        ...
        public static TableSchema.TableColumn RestrictHourStartColumn
        {
        ...
        public static TableSchema.TableColumn RestrictHourEndColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string IsRestricHour = @"IsRestricHour";
			 public static string RestrictHourStart = @"RestrictHourStart";
			 public static string RestrictHourEnd = @"RestrictHourEnd";
