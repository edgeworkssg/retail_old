...
{
	/// <summary>
	/// Strongly-typed collection for the SalesCommissionDetail class.
	/// </summary>
    [Serializable]
	public partial class SalesCommissionDetailCollection : ActiveList<SalesCommissionDetail, SalesCommissionDetailCollection>
	{	   
		public SalesCommissionDetailCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SalesCommissionDetailCollection</returns>
		public SalesCommissionDetailCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SalesCommissionDetail o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SalesCommissionDetails table.
	/// </summary>
	[Serializable]
	public partial class SalesCommissionDetail : ActiveRecord<SalesCommissionDetail>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public SalesCommissionDetail()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public SalesCommissionDetail(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SalesCommissionDetail(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SalesCommissionDetail(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SalesCommissionDetails", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarCommissionType.MaxLength = 200;
				...
				colvarTotalQty.ColumnName = "TotalQty";
				colvarTotalQty.DataType = DbType.Double;
				...
				DataService.Providers["PowerPOS"].AddSchema("SalesCommissionDetails",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<double?>(Columns.TotalQty); }
		...
		public static void Insert(string varMonthDate,string varMonth,string varStaff,string varCommissionType,double? varTotalQty,decimal? varTotalSales,decimal? varTotalCommission,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.TotalCommission = varTotalCommission;
		...
		/// </summary>
		public static void Update(int varId,string varMonthDate,string varMonth,string varStaff,string varCommissionType,double? varTotalQty,decimal? varTotalSales,decimal? varTotalCommission,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesCommissionDetail item = new SalesCommissionDetail();
		...
		public struct Columns
		{
			 ...
			 public static string TotalCommission = @"TotalCommission";
