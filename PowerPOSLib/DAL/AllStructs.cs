...
namespace PowerPOS
{
	...
	public partial struct Tables
	{
		...
		public static string CashDeviceInfo = @"CashDeviceInfo";
        
		public static string CashMachineAction = @"CashMachineAction";
        
		public static string CashMachineSnapshot = @"CashMachineSnapshot";
        
		public static string CashMachineSnapshotHistory = @"CashMachineSnapshotHistory";
        
		public static string CashMachineTransaction = @"CashMachineTransaction";
        
		public static string CashRecording = @"CashRecording";
        
		public static string CashRecordingType = @"CashRecordingType";
        
		public static string CashRecyclerDeviceSnapshot = @"CashRecyclerDeviceSnapshot";
        
		public static string CashTransactionLog = @"CashTransactionLog";
		...
		public static string RecyclerCoinsBalance = @"RecyclerCoinsBalance";
        
		public static string RecyclerNotesBalance = @"RecyclerNotesBalance";
    ...
    public partial class Schemas {
		...
		public static TableSchema.Table CashDeviceInfo{
            get { return DataService.GetSchema("CashDeviceInfo","PowerPOS"); }
		}
        
		public static TableSchema.Table CashMachineAction{
            get { return DataService.GetSchema("CashMachineAction","PowerPOS"); }
		}
        
		public static TableSchema.Table CashMachineSnapshot{
            get { return DataService.GetSchema("CashMachineSnapshot","PowerPOS"); }
		}
        
		public static TableSchema.Table CashMachineSnapshotHistory{
            get { return DataService.GetSchema("CashMachineSnapshotHistory","PowerPOS"); }
		}
        
		public static TableSchema.Table CashMachineTransaction{
            get { return DataService.GetSchema("CashMachineTransaction","PowerPOS"); }
		}
		...
		public static TableSchema.Table CashRecyclerDeviceSnapshot{
            get { return DataService.GetSchema("CashRecyclerDeviceSnapshot","PowerPOS"); }
		}
        
		public static TableSchema.Table CashTransactionLog{
            get { return DataService.GetSchema("CashTransactionLog","PowerPOS"); }
		}
		...
		public static TableSchema.Table RecyclerCoinsBalance{
            get { return DataService.GetSchema("RecyclerCoinsBalance","PowerPOS"); }
		}
        
		public static TableSchema.Table RecyclerNotesBalance{
            get { return DataService.GetSchema("RecyclerNotesBalance","PowerPOS"); }
		}
    ...
    public partial struct Views 
    {
		...
		public static string ViewOrderSummary = @"ViewOrderSummary";
