...
{
	/// <summary>
	/// Strongly-typed collection for the UnpaidWIP class.
	/// </summary>
    [Serializable]
	public partial class UnpaidWIPCollection : ActiveList<UnpaidWIP, UnpaidWIPCollection>
	{	   
		public UnpaidWIPCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>UnpaidWIPCollection</returns>
		public UnpaidWIPCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the UnpaidWIP table.
	/// </summary>
	[Serializable]
	public partial class UnpaidWIP : ActiveRecord<UnpaidWIP>, IActiveRecord
	{
		...
		public UnpaidWIP(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public UnpaidWIP(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("UnpaidWIP", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarUnpaidWipID = new TableSchema.TableColumn(schema);
				colvarUnpaidWipID.ColumnName = "UnpaidWipID";
				colvarUnpaidWipID.DataType = DbType.Int64;
				colvarUnpaidWipID.MaxLength = 0;
				colvarUnpaidWipID.AutoIncrement = true;
				colvarUnpaidWipID.IsNullable = false;
				colvarUnpaidWipID.IsPrimaryKey = true;
				colvarUnpaidWipID.IsForeignKey = false;
				colvarUnpaidWipID.IsReadOnly = false;
				colvarUnpaidWipID.DefaultSetting = @"";
				colvarUnpaidWipID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUnpaidWipID);
				
				TableSchema.TableColumn colvarOrderNo = new TableSchema.TableColumn(schema);
				colvarOrderNo.ColumnName = "OrderNo";
				colvarOrderNo.DataType = DbType.AnsiString;
				...
				colvarKioskID.DataType = DbType.Int32;
				...
				DataService.Providers["PowerPOS"].AddSchema("UnpaidWIP",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("UnpaidWipID")]
		[Bindable(true)]
		public long UnpaidWipID 
		{
			get { return GetColumnValue<long>(Columns.UnpaidWipID); }
			set { SetColumnValue(Columns.UnpaidWipID, value); }
		}
		...
		public int? KioskID 
		{
			get { return GetColumnValue<int?>(Columns.KioskID); }
		...
		/// </summary>
		public static void Update(long varUnpaidWipID,string varOrderNo,int? varKioskID,bool? varDeleted,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			UnpaidWIP item = new UnpaidWIP();
			
				item.UnpaidWipID = varUnpaidWipID;
        ...
        public static TableSchema.TableColumn UnpaidWipIDColumn
        {
		...
		{
			 public static string UnpaidWipID = @"UnpaidWipID";
