...
{
    /// <summary>
    /// Controller class for Installment
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class InstallmentController
    {
        // Preload our schema..
        Installment thisSchemaLoad = new Installment();
        ...
        public InstallmentCollection FetchAll()
        {
            InstallmentCollection coll = new InstallmentCollection();
            Query qry = new Query(Installment.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public InstallmentCollection FetchByID(object InstallmentRefNo)
        {
            InstallmentCollection coll = new InstallmentCollection().Where("InstallmentRefNo", InstallmentRefNo).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public InstallmentCollection FetchByQuery(Query qry)
        {
            InstallmentCollection coll = new InstallmentCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object InstallmentRefNo)
        {
            return (Installment.Delete(InstallmentRefNo) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object InstallmentRefNo)
        {
            return (Installment.Destroy(InstallmentRefNo) == 1);
        }
	    ...
	    public void Update(string InstallmentRefNo,string OrderHdrId,string MembershipNo,DateTime? InstallmentCreatedDate,decimal TotalAmount,string Remark,string CreatedBy,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,DateTime? CreatedOn,decimal? CurrentBalance,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    Installment item = new Installment();
	        item.MarkOld();
	        item.IsLoaded = true;
