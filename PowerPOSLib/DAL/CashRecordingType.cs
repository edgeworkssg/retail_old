...
{
	/// <summary>
	/// Strongly-typed collection for the CashRecordingType class.
	/// </summary>
    [Serializable]
	public partial class CashRecordingTypeCollection : ActiveList<CashRecordingType, CashRecordingTypeCollection>
	{	   
		public CashRecordingTypeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CashRecordingTypeCollection</returns>
		public CashRecordingTypeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CashRecordingType o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CashRecordingType table.
	/// </summary>
	[Serializable]
	public partial class CashRecordingType : ActiveRecord<CashRecordingType>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public CashRecordingType()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public CashRecordingType(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CashRecordingType(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CashRecordingType(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CashRecordingType", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarCashRecordingTypeId.AutoIncrement = true;
				colvarCashRecordingTypeId.IsNullable = false;
				colvarCashRecordingTypeId.IsPrimaryKey = true;
				colvarCashRecordingTypeId.IsForeignKey = false;
				colvarCashRecordingTypeId.IsReadOnly = false;
				colvarCashRecordingTypeId.DefaultSetting = @"";
				colvarCashRecordingTypeId.ForeignKeyTableName = "";
				...
				colvarCashRecordingTypeName.DefaultSetting = @"";
				colvarCashRecordingTypeName.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("CashRecordingType",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.CashRecordingTypeName); }
			set { SetColumnValue(Columns.CashRecordingTypeName, value); }
		}
		...
		{
			return new PowerPOS.CashRecordingCollection().Where(CashRecording.Columns.CashRecordingTypeId, CashRecordingTypeId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varCashRecordingTypeId,string varCashRecordingTypeName,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			CashRecordingType item = new CashRecordingType();
        ...
        public static TableSchema.TableColumn CashRecordingTypeNameColumn
        {
