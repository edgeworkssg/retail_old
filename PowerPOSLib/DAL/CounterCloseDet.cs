...
{
	/// <summary>
	/// Strongly-typed collection for the CounterCloseDet class.
	/// </summary>
    [Serializable]
	public partial class CounterCloseDetCollection : ActiveList<CounterCloseDet, CounterCloseDetCollection>
	{	   
		public CounterCloseDetCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CounterCloseDetCollection</returns>
		public CounterCloseDetCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CounterCloseDet o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CounterCloseDet table.
	/// </summary>
	[Serializable]
	public partial class CounterCloseDet : ActiveRecord<CounterCloseDet>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public CounterCloseDet()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public CounterCloseDet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CounterCloseDet(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CounterCloseDet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CounterCloseDet", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarCounterCloseDetID = new TableSchema.TableColumn(schema);
				colvarCounterCloseDetID.ColumnName = "CounterCloseDetID";
				colvarCounterCloseDetID.DataType = DbType.AnsiString;
				colvarCounterCloseDetID.MaxLength = 50;
				colvarCounterCloseDetID.AutoIncrement = false;
				colvarCounterCloseDetID.IsNullable = false;
				colvarCounterCloseDetID.IsPrimaryKey = true;
				colvarCounterCloseDetID.IsForeignKey = false;
				colvarCounterCloseDetID.IsReadOnly = false;
				colvarCounterCloseDetID.DefaultSetting = @"";
				colvarCounterCloseDetID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCounterCloseDetID);
				...
				colvarCounterCloseID.MaxLength = 50;
				...
				TableSchema.TableColumn colvarUnitValue = new TableSchema.TableColumn(schema);
				colvarUnitValue.ColumnName = "UnitValue";
				colvarUnitValue.DataType = DbType.Currency;
				colvarUnitValue.MaxLength = 0;
				colvarUnitValue.AutoIncrement = false;
				colvarUnitValue.IsNullable = false;
				colvarUnitValue.IsPrimaryKey = false;
				colvarUnitValue.IsForeignKey = false;
				colvarUnitValue.IsReadOnly = false;
				colvarUnitValue.DefaultSetting = @"";
				colvarUnitValue.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUnitValue);
				
				TableSchema.TableColumn colvarUnitDisplayedName = new TableSchema.TableColumn(schema);
				colvarUnitDisplayedName.ColumnName = "UnitDisplayedName";
				colvarUnitDisplayedName.DataType = DbType.String;
				colvarUnitDisplayedName.MaxLength = 200;
				colvarUnitDisplayedName.AutoIncrement = false;
				colvarUnitDisplayedName.IsNullable = true;
				colvarUnitDisplayedName.IsPrimaryKey = false;
				colvarUnitDisplayedName.IsForeignKey = false;
				colvarUnitDisplayedName.IsReadOnly = false;
				colvarUnitDisplayedName.DefaultSetting = @"";
				colvarUnitDisplayedName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUnitDisplayedName);
				
				TableSchema.TableColumn colvarTotalCount = new TableSchema.TableColumn(schema);
				colvarTotalCount.ColumnName = "TotalCount";
				...
				DataService.Providers["PowerPOS"].AddSchema("CounterCloseDet",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CounterCloseDetID")]
		[Bindable(true)]
		public string CounterCloseDetID 
		{
			get { return GetColumnValue<string>(Columns.CounterCloseDetID); }
			set { SetColumnValue(Columns.CounterCloseDetID, value); }
		}
		...
		[XmlAttribute("UnitValue")]
		[Bindable(true)]
		public decimal UnitValue 
		{
			get { return GetColumnValue<decimal>(Columns.UnitValue); }
			set { SetColumnValue(Columns.UnitValue, value); }
		}
		  
		[XmlAttribute("UnitDisplayedName")]
		[Bindable(true)]
		public string UnitDisplayedName 
		{
			get { return GetColumnValue<string>(Columns.UnitDisplayedName); }
			set { SetColumnValue(Columns.UnitDisplayedName, value); }
		}
		...
		/// </summary>
		public static void Update(string varCounterCloseDetID,string varCounterCloseID,string varPaymentType,decimal varUnitValue,string varUnitDisplayedName,int varTotalCount,decimal varTotalAmount,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			CounterCloseDet item = new CounterCloseDet();
        ...
        public static TableSchema.TableColumn CounterCloseDetIDColumn
        {
        ...
        public static TableSchema.TableColumn UnitValueColumn
        {
        ...
        public static TableSchema.TableColumn UnitDisplayedNameColumn
        {
		...
		{
			 public static string CounterCloseDetID = @"CounterCloseDetID";
			 public static string CounterCloseID = @"CounterCloseID";
			 public static string PaymentType = @"PaymentType";
			 public static string UnitValue = @"UnitValue";
			 public static string UnitDisplayedName = @"UnitDisplayedName";
