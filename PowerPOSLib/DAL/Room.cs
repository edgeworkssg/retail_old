...
namespace PowerPOS
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Rooms table.
	/// </summary>
	[Serializable]
	public partial class Room : ActiveRecord<Room>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Rooms", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("Rooms",schema);
			}
		}
		#endregion
		...
		{
			return new PowerPOS.CourseCollection().Where(Course.Columns.Place, RoomID).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Outlet ActiveRecord object related to this Room
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varRoomID,string varRoomName,string varOutletName,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Room item = new Room();
