...
{
	/// <summary>
	/// Strongly-typed collection for the PurchaseOrderHdr class.
	/// </summary>
    [Serializable]
	public partial class PurchaseOrderHdrCollection : ActiveList<PurchaseOrderHdr, PurchaseOrderHdrCollection>
	{	   
		public PurchaseOrderHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PurchaseOrderHdrCollection</returns>
		public PurchaseOrderHdrCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PurchaseOrderHdr o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PurchaseOrderHdr table.
	/// </summary>
	[Serializable]
	public partial class PurchaseOrderHdr : ActiveRecord<PurchaseOrderHdr>, IActiveRecord
	{
		...
		public PurchaseOrderHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PurchaseOrderHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PurchaseOrderHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PurchaseOrderHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarPurchaseOrderHdrRefNo.IsPrimaryKey = true;
				colvarPurchaseOrderHdrRefNo.IsForeignKey = false;
				colvarPurchaseOrderHdrRefNo.IsReadOnly = false;
				colvarPurchaseOrderHdrRefNo.DefaultSetting = @"";
				colvarPurchaseOrderHdrRefNo.ForeignKeyTableName = "";
				...
				colvarFreightCharge.DefaultSetting = @"";
				...
				TableSchema.TableColumn colvarCustomRefNo = new TableSchema.TableColumn(schema);
				colvarCustomRefNo.ColumnName = "CustomRefNo";
				colvarCustomRefNo.DataType = DbType.AnsiString;
				colvarCustomRefNo.MaxLength = 50;
				colvarCustomRefNo.AutoIncrement = false;
				colvarCustomRefNo.IsNullable = true;
				colvarCustomRefNo.IsPrimaryKey = false;
				colvarCustomRefNo.IsForeignKey = false;
				colvarCustomRefNo.IsReadOnly = false;
				colvarCustomRefNo.DefaultSetting = @"";
				colvarCustomRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCustomRefNo);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["PowerPOS"].AddSchema("PurchaseOrderHdr",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CustomRefNo")]
		[Bindable(true)]
		public string CustomRefNo 
		{
			get { return GetColumnValue<string>(Columns.CustomRefNo); }
			set { SetColumnValue(Columns.CustomRefNo, value); }
		}
		...
		{
			return new PowerPOS.PurchaseOrderDetCollection().Where(PurchaseOrderDet.Columns.PurchaseOrderHdrRefNo, PurchaseOrderHdrRefNo).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Currency ActiveRecord object related to this PurchaseOrderHdr
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Department ActiveRecord object related to this PurchaseOrderHdr
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this PurchaseOrderHdr
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varPurchaseOrderHdrRefNo,DateTime varPurchaseOrderDate,string varUserName,double varExchangeRate,string varSupplier,decimal? varFreightCharge,decimal? varDeliveryCharge,decimal? varTax,decimal? varDiscount,string varRemark,int? varInventoryLocationID,int? varDepartmentID,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varCurrencyId,int? varTmpSavedData,bool? varDeleted,string varCustomRefNo)
		{
			PurchaseOrderHdr item = new PurchaseOrderHdr();
			...
			item.CustomRefNo = varCustomRefNo;
		...
		/// </summary>
		public static void Update(string varPurchaseOrderHdrRefNo,DateTime varPurchaseOrderDate,string varUserName,double varExchangeRate,string varSupplier,decimal? varFreightCharge,decimal? varDeliveryCharge,decimal? varTax,decimal? varDiscount,string varRemark,int? varInventoryLocationID,int? varDepartmentID,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varCurrencyId,int? varTmpSavedData,bool? varDeleted,string varCustomRefNo)
		{
			PurchaseOrderHdr item = new PurchaseOrderHdr();
        ...
        public static TableSchema.TableColumn CustomRefNoColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string CustomRefNo = @"CustomRefNo";
