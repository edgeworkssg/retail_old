...
{
	/// <summary>
	/// Strongly-typed collection for the ItemGroupMap class.
	/// </summary>
    [Serializable]
	public partial class ItemGroupMapCollection : ActiveList<ItemGroupMap, ItemGroupMapCollection>
	{	   
		public ItemGroupMapCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemGroupMapCollection</returns>
		public ItemGroupMapCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemGroupMap o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemGroupMap table.
	/// </summary>
	[Serializable]
	public partial class ItemGroupMap : ActiveRecord<ItemGroupMap>, IActiveRecord
	{
		...
		public ItemGroupMap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemGroupMap(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemGroupMap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemGroupMap", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarItemGroupMapID.AutoIncrement = true;
				colvarItemGroupMapID.IsNullable = false;
				colvarItemGroupMapID.IsPrimaryKey = true;
				colvarItemGroupMapID.IsForeignKey = false;
				colvarItemGroupMapID.IsReadOnly = false;
				colvarItemGroupMapID.DefaultSetting = @"";
				colvarItemGroupMapID.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemGroupMap",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.ItemGroupMapID); }
			set { SetColumnValue(Columns.ItemGroupMapID, value); }
		}
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemGroupMap
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a ItemGroup ActiveRecord object related to this ItemGroupMap
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varItemGroupMapID,int varItemGroupID,string varItemNo,int varUnitQty,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemGroupMap item = new ItemGroupMap();
			
				item.ItemGroupMapID = varItemGroupMapID;
        ...
        public static TableSchema.TableColumn ItemGroupMapIDColumn
        {
