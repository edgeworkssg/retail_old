...
{
    /// <summary>
    /// Controller class for UnpaidWIP
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class UnpaidWIPController
    {
        // Preload our schema..
        UnpaidWIP thisSchemaLoad = new UnpaidWIP();
        ...
        public UnpaidWIPCollection FetchAll()
        {
            UnpaidWIPCollection coll = new UnpaidWIPCollection();
            Query qry = new Query(UnpaidWIP.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public UnpaidWIPCollection FetchByID(object UnpaidWipID)
        {
            UnpaidWIPCollection coll = new UnpaidWIPCollection().Where("UnpaidWipID", UnpaidWipID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public UnpaidWIPCollection FetchByQuery(Query qry)
        {
            UnpaidWIPCollection coll = new UnpaidWIPCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object UnpaidWipID)
        {
            return (UnpaidWIP.Delete(UnpaidWipID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object UnpaidWipID)
        {
            return (UnpaidWIP.Destroy(UnpaidWipID) == 1);
        }
	    ...
	    public void Update(long UnpaidWipID,string OrderNo,int? KioskID,bool? Deleted,DateTime? CreatedOn,DateTime? ModifiedOn,string CreatedBy,string ModifiedBy,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    UnpaidWIP item = new UnpaidWIP();
	        item.MarkOld();
	        item.IsLoaded = true;
		    
			item.UnpaidWipID = UnpaidWipID;
