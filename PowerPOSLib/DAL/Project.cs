...
namespace PowerPOS
{
	...
	public partial class Project : ActiveRecord<Project>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Project", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				TableSchema.TableColumn colvarMembershipNumber = new TableSchema.TableColumn(schema);
				colvarMembershipNumber.ColumnName = "MembershipNumber";
				colvarMembershipNumber.DataType = DbType.String;
				colvarMembershipNumber.MaxLength = 100;
				colvarMembershipNumber.AutoIncrement = false;
				colvarMembershipNumber.IsNullable = true;
				colvarMembershipNumber.IsPrimaryKey = false;
				colvarMembershipNumber.IsForeignKey = false;
				colvarMembershipNumber.IsReadOnly = false;
				colvarMembershipNumber.DefaultSetting = @"";
				colvarMembershipNumber.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMembershipNumber);
				...
				DataService.Providers["PowerPOS"].AddSchema("Project",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("MembershipNumber")]
		[Bindable(true)]
		public string MembershipNumber 
		{
			get { return GetColumnValue<string>(Columns.MembershipNumber); }
			set { SetColumnValue(Columns.MembershipNumber, value); }
		}
		...
		/// </summary>
		public static void Insert(string varProjectName,string varMembershipNumber,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Project item = new Project();
			
			item.ProjectName = varProjectName;
			
			item.MembershipNumber = varMembershipNumber;
		...
		/// </summary>
		public static void Update(int varId,string varProjectName,string varMembershipNumber,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Project item = new Project();
        ...
        public static TableSchema.TableColumn MembershipNumberColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string MembershipNumber = @"MembershipNumber";
