...
{
	/// <summary>
	/// Strongly-typed collection for the EventLocationMap class.
	/// </summary>
    [Serializable]
	public partial class EventLocationMapCollection : ActiveList<EventLocationMap, EventLocationMapCollection>
	{	   
		public EventLocationMapCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>EventLocationMapCollection</returns>
		public EventLocationMapCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                EventLocationMap o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the EventLocationMap table.
	/// </summary>
	[Serializable]
	public partial class EventLocationMap : ActiveRecord<EventLocationMap>, IActiveRecord
	{
		...
		public EventLocationMap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public EventLocationMap(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public EventLocationMap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("EventLocationMap", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarEventLocationMapID.AutoIncrement = true;
				colvarEventLocationMapID.IsNullable = false;
				colvarEventLocationMapID.IsPrimaryKey = true;
				colvarEventLocationMapID.IsForeignKey = false;
				colvarEventLocationMapID.IsReadOnly = false;
				colvarEventLocationMapID.DefaultSetting = @"";
				colvarEventLocationMapID.ForeignKeyTableName = "";
				...
				colvarEventID.DefaultSetting = @"";
					...
					colvarEventID.ForeignKeyTableName = "SpecialEvent";
				...
				DataService.Providers["PowerPOS"].AddSchema("EventLocationMap",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.EventLocationMapID); }
			set { SetColumnValue(Columns.EventLocationMapID, value); }
		}
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this EventLocationMap
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a SpecialEvent ActiveRecord object related to this EventLocationMap
		/// 
		/// </summary>
		public PowerPOS.SpecialEvent SpecialEvent
		{
			get { return PowerPOS.SpecialEvent.FetchByID(this.EventID); }
			set { SetColumnValue("EventID", value.EventId); }
		}
		...
		/// </summary>
		public static void Insert(int varPointOfSaleID,int varEventID,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,Guid varUniqueID,string varUserFld1,string varUserFld2,string varUserFld3,string varUserFld4,string varUserFld5,string varUserFld6,string varUserFld7,string varUserFld8,string varUserFld9,string varUserFld10,decimal? varUserFloat1,decimal? varUserFloat2,decimal? varUserFloat3,decimal? varUserFloat4,decimal? varUserFloat5,int? varUserInt1,int? varUserInt2,int? varUserInt3,int? varUserInt4,int? varUserInt5,bool? varUserFlag1,bool? varUserFlag2,bool? varUserFlag3,bool? varUserFlag4,bool? varUserFlag5)
		{
		...
		/// </summary>
		public static void Update(int varEventLocationMapID,int varPointOfSaleID,int varEventID,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,Guid varUniqueID,string varUserFld1,string varUserFld2,string varUserFld3,string varUserFld4,string varUserFld5,string varUserFld6,string varUserFld7,string varUserFld8,string varUserFld9,string varUserFld10,decimal? varUserFloat1,decimal? varUserFloat2,decimal? varUserFloat3,decimal? varUserFloat4,decimal? varUserFloat5,int? varUserInt1,int? varUserInt2,int? varUserInt3,int? varUserInt4,int? varUserInt5,bool? varUserFlag1,bool? varUserFlag2,bool? varUserFlag3,bool? varUserFlag4,bool? varUserFlag5)
		{
			EventLocationMap item = new EventLocationMap();
			
				item.EventLocationMapID = varEventLocationMapID;
        ...
        public static TableSchema.TableColumn EventLocationMapIDColumn
        {
