...
{
	/// <summary>
	/// Strongly-typed collection for the SalesCommissionHistory class.
	/// </summary>
    [Serializable]
	public partial class SalesCommissionHistoryCollection : ActiveList<SalesCommissionHistory, SalesCommissionHistoryCollection>
	{	   
		public SalesCommissionHistoryCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SalesCommissionHistoryCollection</returns>
		public SalesCommissionHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SalesCommissionHistory o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SalesCommissionHistory table.
	/// </summary>
	[Serializable]
	public partial class SalesCommissionHistory : ActiveRecord<SalesCommissionHistory>, IActiveRecord
	{
		...
		public SalesCommissionHistory(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SalesCommissionHistory(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SalesCommissionHistory(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SalesCommissionHistory", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarSalesCommissionHistoryX = new TableSchema.TableColumn(schema);
				colvarSalesCommissionHistoryX.ColumnName = "SalesCommissionHistory";
				colvarSalesCommissionHistoryX.DataType = DbType.Int32;
				colvarSalesCommissionHistoryX.MaxLength = 0;
				colvarSalesCommissionHistoryX.AutoIncrement = true;
				colvarSalesCommissionHistoryX.IsNullable = false;
				colvarSalesCommissionHistoryX.IsPrimaryKey = true;
				colvarSalesCommissionHistoryX.IsForeignKey = false;
				colvarSalesCommissionHistoryX.IsReadOnly = false;
				colvarSalesCommissionHistoryX.DefaultSetting = @"";
				colvarSalesCommissionHistoryX.ForeignKeyTableName = "";
				schema.Columns.Add(colvarSalesCommissionHistoryX);
				
				TableSchema.TableColumn colvarMonthYear = new TableSchema.TableColumn(schema);
				colvarMonthYear.ColumnName = "MonthYear";
				colvarMonthYear.DataType = DbType.DateTime;
				colvarMonthYear.MaxLength = 0;
				colvarMonthYear.AutoIncrement = false;
				colvarMonthYear.IsNullable = false;
				colvarMonthYear.IsPrimaryKey = false;
				colvarMonthYear.IsForeignKey = false;
				colvarMonthYear.IsReadOnly = false;
				...
				colvarSalesPersonName.DefaultSetting = @"";
				colvarSalesPersonName.ForeignKeyTableName = "";
				...
				colvarTotalSales.IsNullable = false;
				...
				TableSchema.TableColumn colvarCommissionRate = new TableSchema.TableColumn(schema);
				colvarCommissionRate.ColumnName = "CommissionRate";
				colvarCommissionRate.DataType = DbType.Double;
				colvarCommissionRate.MaxLength = 0;
				colvarCommissionRate.AutoIncrement = false;
				colvarCommissionRate.IsNullable = false;
				colvarCommissionRate.IsPrimaryKey = false;
				colvarCommissionRate.IsForeignKey = false;
				colvarCommissionRate.IsReadOnly = false;
				colvarCommissionRate.DefaultSetting = @"";
				colvarCommissionRate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCommissionRate);
				...
				DataService.Providers["PowerPOS"].AddSchema("SalesCommissionHistory",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("SalesCommissionHistoryX")]
		[Bindable(true)]
		public int SalesCommissionHistoryX 
		{
			get { return GetColumnValue<int>(Columns.SalesCommissionHistoryX); }
			set { SetColumnValue(Columns.SalesCommissionHistoryX, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime>(Columns.MonthYear); }
		...
		{
			get { return GetColumnValue<string>(Columns.SalesPersonName); }
			set { SetColumnValue(Columns.SalesPersonName, value); }
		}
		...
		{
			get { return GetColumnValue<decimal>(Columns.TotalSales); }
			set { SetColumnValue(Columns.TotalSales, value); }
		}
		  
		[XmlAttribute("CommissionRate")]
		[Bindable(true)]
		public double CommissionRate 
		{
			get { return GetColumnValue<double>(Columns.CommissionRate); }
			set { SetColumnValue(Columns.CommissionRate, value); }
		}
		...
		/// </summary>
		public static void Insert(DateTime varMonthYear,string varSalesPersonName,int varHours,string varGroupName,decimal varTotalSales,double varCommissionRate,decimal varCommission,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesCommissionHistory item = new SalesCommissionHistory();
			
			item.MonthYear = varMonthYear;
			
			item.SalesPersonName = varSalesPersonName;
			
			item.Hours = varHours;
			
			item.GroupName = varGroupName;
			
			item.TotalSales = varTotalSales;
			
			item.CommissionRate = varCommissionRate;
		...
		/// </summary>
		public static void Update(int varSalesCommissionHistoryX,DateTime varMonthYear,string varSalesPersonName,int varHours,string varGroupName,decimal varTotalSales,double varCommissionRate,decimal varCommission,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SalesCommissionHistory item = new SalesCommissionHistory();
			
				item.SalesCommissionHistoryX = varSalesCommissionHistoryX;
        ...
        public static TableSchema.TableColumn SalesCommissionHistoryXColumn
        {
        ...
        public static TableSchema.TableColumn SalesPersonNameColumn
        {
        ...
        public static TableSchema.TableColumn CommissionRateColumn
        {
		...
		{
			 public static string SalesCommissionHistoryX = @"SalesCommissionHistory";
