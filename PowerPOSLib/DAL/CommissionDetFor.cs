...
{
	/// <summary>
	/// Strongly-typed collection for the CommissionDetFor class.
	/// </summary>
    [Serializable]
	public partial class CommissionDetForCollection : ActiveList<CommissionDetFor, CommissionDetForCollection>
	{	   
		public CommissionDetForCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CommissionDetForCollection</returns>
		public CommissionDetForCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CommissionDetFor o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CommissionDetFor table.
	/// </summary>
	[Serializable]
	public partial class CommissionDetFor : ActiveRecord<CommissionDetFor>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public CommissionDetFor()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public CommissionDetFor(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CommissionDetFor(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CommissionDetFor(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CommissionDetFor", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarCommissionDetForID = new TableSchema.TableColumn(schema);
				colvarCommissionDetForID.ColumnName = "CommissionDetForID";
				colvarCommissionDetForID.DataType = DbType.Int32;
				colvarCommissionDetForID.MaxLength = 0;
				colvarCommissionDetForID.AutoIncrement = true;
				colvarCommissionDetForID.IsNullable = false;
				colvarCommissionDetForID.IsPrimaryKey = true;
				colvarCommissionDetForID.IsForeignKey = false;
				colvarCommissionDetForID.IsReadOnly = false;
				colvarCommissionDetForID.DefaultSetting = @"";
				colvarCommissionDetForID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCommissionDetForID);
				...
				DataService.Providers["PowerPOS"].AddSchema("CommissionDetFor",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CommissionDetForID")]
		[Bindable(true)]
		public int CommissionDetForID 
		{
			get { return GetColumnValue<int>(Columns.CommissionDetForID); }
			set { SetColumnValue(Columns.CommissionDetForID, value); }
		}
		...
		/// </summary>
		public static void Update(int varCommissionDetForID,int? varCommissionHdrID,string varCategoryName,string varItemNo,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			CommissionDetFor item = new CommissionDetFor();
			
				item.CommissionDetForID = varCommissionDetForID;
        ...
        public static TableSchema.TableColumn CommissionDetForIDColumn
        {
		...
		{
			 public static string CommissionDetForID = @"CommissionDetForID";
