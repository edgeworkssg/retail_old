...
{
	/// <summary>
	/// Strongly-typed collection for the OutletGroup class.
	/// </summary>
    [Serializable]
	public partial class OutletGroupCollection : ActiveList<OutletGroup, OutletGroupCollection>
	{	   
		public OutletGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OutletGroupCollection</returns>
		public OutletGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                OutletGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the OutletGroup table.
	/// </summary>
	[Serializable]
	public partial class OutletGroup : ActiveRecord<OutletGroup>, IActiveRecord
	{
		...
		public OutletGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public OutletGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public OutletGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("OutletGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarOutletGroupID.AutoIncrement = true;
				colvarOutletGroupID.IsNullable = false;
				colvarOutletGroupID.IsPrimaryKey = true;
				...
				TableSchema.TableColumn colvarOutletGroupName = new TableSchema.TableColumn(schema);
				colvarOutletGroupName.ColumnName = "OutletGroupName";
				colvarOutletGroupName.DataType = DbType.AnsiString;
				colvarOutletGroupName.MaxLength = 50;
				colvarOutletGroupName.AutoIncrement = false;
				colvarOutletGroupName.IsNullable = false;
				colvarOutletGroupName.IsPrimaryKey = false;
				colvarOutletGroupName.IsForeignKey = false;
				colvarOutletGroupName.IsReadOnly = false;
				colvarOutletGroupName.DefaultSetting = @"";
				colvarOutletGroupName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOutletGroupName);
				...
				DataService.Providers["PowerPOS"].AddSchema("OutletGroup",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OutletGroupName")]
		[Bindable(true)]
		public string OutletGroupName 
		{
			get { return GetColumnValue<string>(Columns.OutletGroupName); }
			set { SetColumnValue(Columns.OutletGroupName, value); }
		}
		...
		/// </summary>
		public static void Update(int varOutletGroupID,string varOutletGroupName,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			OutletGroup item = new OutletGroup();
        ...
        public static TableSchema.TableColumn OutletGroupNameColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string OutletGroupName = @"OutletGroupName";
