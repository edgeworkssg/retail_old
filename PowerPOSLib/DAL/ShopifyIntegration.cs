...
{
	/// <summary>
	/// Strongly-typed collection for the ShopifyIntegration class.
	/// </summary>
    [Serializable]
	public partial class ShopifyIntegrationCollection : ActiveList<ShopifyIntegration, ShopifyIntegrationCollection>
	{	   
		public ShopifyIntegrationCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ShopifyIntegrationCollection</returns>
		public ShopifyIntegrationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ShopifyIntegration o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ShopifyIntegration table.
	/// </summary>
	[Serializable]
	public partial class ShopifyIntegration : ActiveRecord<ShopifyIntegration>, IActiveRecord
	{
		...
		public ShopifyIntegration(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ShopifyIntegration(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ShopifyIntegration(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ShopifyIntegration", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarShopifyIntegrationID = new TableSchema.TableColumn(schema);
				colvarShopifyIntegrationID.ColumnName = "ShopifyIntegrationID";
				colvarShopifyIntegrationID.DataType = DbType.Int32;
				colvarShopifyIntegrationID.MaxLength = 0;
				colvarShopifyIntegrationID.AutoIncrement = true;
				colvarShopifyIntegrationID.IsNullable = false;
				colvarShopifyIntegrationID.IsPrimaryKey = true;
				colvarShopifyIntegrationID.IsForeignKey = false;
				colvarShopifyIntegrationID.IsReadOnly = false;
				colvarShopifyIntegrationID.DefaultSetting = @"";
				colvarShopifyIntegrationID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarShopifyIntegrationID);
				
				TableSchema.TableColumn colvarRequestDate = new TableSchema.TableColumn(schema);
				colvarRequestDate.ColumnName = "RequestDate";
				...
				TableSchema.TableColumn colvarRequestHeader = new TableSchema.TableColumn(schema);
				colvarRequestHeader.ColumnName = "RequestHeader";
				colvarRequestHeader.DataType = DbType.String;
				colvarRequestHeader.MaxLength = -1;
				colvarRequestHeader.AutoIncrement = false;
				colvarRequestHeader.IsNullable = true;
				colvarRequestHeader.IsPrimaryKey = false;
				colvarRequestHeader.IsForeignKey = false;
				colvarRequestHeader.IsReadOnly = false;
				colvarRequestHeader.DefaultSetting = @"";
				colvarRequestHeader.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRequestHeader);
				
				TableSchema.TableColumn colvarRequestData = new TableSchema.TableColumn(schema);
				colvarRequestData.ColumnName = "RequestData";
				colvarRequestData.DataType = DbType.String;
				colvarRequestData.MaxLength = -1;
				colvarRequestData.AutoIncrement = false;
				colvarRequestData.IsNullable = true;
				colvarRequestData.IsPrimaryKey = false;
				colvarRequestData.IsForeignKey = false;
				colvarRequestData.IsReadOnly = false;
				colvarRequestData.DefaultSetting = @"";
				colvarRequestData.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRequestData);
				
				TableSchema.TableColumn colvarStatus = new TableSchema.TableColumn(schema);
				colvarStatus.ColumnName = "Status";
				colvarStatus.DataType = DbType.String;
				colvarStatus.MaxLength = 60;
				...
				DataService.Providers["PowerPOS"].AddSchema("ShopifyIntegration",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ShopifyIntegrationID")]
		[Bindable(true)]
		public int ShopifyIntegrationID 
		{
			get { return GetColumnValue<int>(Columns.ShopifyIntegrationID); }
			set { SetColumnValue(Columns.ShopifyIntegrationID, value); }
		}
		...
		[XmlAttribute("RequestHeader")]
		[Bindable(true)]
		public string RequestHeader 
		{
			get { return GetColumnValue<string>(Columns.RequestHeader); }
			set { SetColumnValue(Columns.RequestHeader, value); }
		}
		  
		[XmlAttribute("RequestData")]
		[Bindable(true)]
		public string RequestData 
		{
			get { return GetColumnValue<string>(Columns.RequestData); }
			set { SetColumnValue(Columns.RequestData, value); }
		}
		...
		public static void Insert(DateTime? varRequestDate,string varEventName,string varRequestHeader,string varRequestData,string varStatus,string varRemarks,string varCreatedBy,string varModifiedBy,DateTime? varCreatedOn,DateTime? varModifiedOn,bool? varDeleted,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.RequestHeader = varRequestHeader;
			
			item.RequestData = varRequestData;
		...
		/// </summary>
		public static void Update(int varShopifyIntegrationID,DateTime? varRequestDate,string varEventName,string varRequestHeader,string varRequestData,string varStatus,string varRemarks,string varCreatedBy,string varModifiedBy,DateTime? varCreatedOn,DateTime? varModifiedOn,bool? varDeleted,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ShopifyIntegration item = new ShopifyIntegration();
			
				item.ShopifyIntegrationID = varShopifyIntegrationID;
        ...
        public static TableSchema.TableColumn ShopifyIntegrationIDColumn
        {
        ...
        public static TableSchema.TableColumn RequestHeaderColumn
        {
        ...
        public static TableSchema.TableColumn RequestDataColumn
        {
		...
		{
			 public static string ShopifyIntegrationID = @"ShopifyIntegrationID";
