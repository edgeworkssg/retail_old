...
{
	/// <summary>
	/// Strongly-typed collection for the KioskTransaction class.
	/// </summary>
    [Serializable]
	public partial class KioskTransactionCollection : ActiveList<KioskTransaction, KioskTransactionCollection>
	{	   
		public KioskTransactionCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>KioskTransactionCollection</returns>
		public KioskTransactionCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                KioskTransaction o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the KioskTransaction table.
	/// </summary>
	[Serializable]
	public partial class KioskTransaction : ActiveRecord<KioskTransaction>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public KioskTransaction()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public KioskTransaction(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public KioskTransaction(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public KioskTransaction(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("KioskTransaction", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarKioskID.AutoIncrement = false;
				colvarKioskID.IsNullable = true;
				colvarKioskID.IsPrimaryKey = false;
				...
				TableSchema.TableColumn colvarTransactionCode = new TableSchema.TableColumn(schema);
				colvarTransactionCode.ColumnName = "TransactionCode";
				colvarTransactionCode.DataType = DbType.AnsiString;
				colvarTransactionCode.MaxLength = 50;
				colvarTransactionCode.AutoIncrement = false;
				colvarTransactionCode.IsNullable = true;
				colvarTransactionCode.IsPrimaryKey = false;
				colvarTransactionCode.IsForeignKey = false;
				colvarTransactionCode.IsReadOnly = false;
				colvarTransactionCode.DefaultSetting = @"";
				colvarTransactionCode.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTransactionCode);
				
				TableSchema.TableColumn colvarInventoryID = new TableSchema.TableColumn(schema);
				colvarInventoryID.ColumnName = "InventoryID";
				colvarInventoryID.DataType = DbType.AnsiString;
				colvarInventoryID.MaxLength = 50;
				colvarInventoryID.AutoIncrement = false;
				colvarInventoryID.IsNullable = true;
				...
				TableSchema.TableColumn colvarLabelID = new TableSchema.TableColumn(schema);
				colvarLabelID.ColumnName = "LabelID";
				colvarLabelID.DataType = DbType.AnsiString;
				colvarLabelID.MaxLength = 50;
				colvarLabelID.AutoIncrement = false;
				colvarLabelID.IsNullable = true;
				colvarLabelID.IsPrimaryKey = false;
				colvarLabelID.IsForeignKey = false;
				colvarLabelID.IsReadOnly = false;
				colvarLabelID.DefaultSetting = @"";
				colvarLabelID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLabelID);
				...
				DataService.Providers["PowerPOS"].AddSchema("KioskTransaction",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.TransactionCode); }
			set { SetColumnValue(Columns.TransactionCode, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.InventoryID); }
		...
		{
			get { return GetColumnValue<string>(Columns.LabelID); }
			set { SetColumnValue(Columns.LabelID, value); }
		}
		...
		/// </summary>
		public static void Update(long varTransactionID,long? varKioskID,DateTime? varTransactionDate,string varTransactionCode,string varInventoryID,string varLabelID,decimal? varQuantity,bool? varIsSent,string varOrderHdrID,bool? varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			KioskTransaction item = new KioskTransaction();
        ...
        public static TableSchema.TableColumn TransactionCodeColumn
        {
        ...
        public static TableSchema.TableColumn LabelIDColumn
        {
