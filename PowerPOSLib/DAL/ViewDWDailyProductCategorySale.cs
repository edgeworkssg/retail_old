...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailyProductCategorySale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductCategorySaleCollection : ReadOnlyList<ViewDWDailyProductCategorySale, ViewDWDailyProductCategorySaleCollection>
    {        
        public ViewDWDailyProductCategorySaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailyProductCategorySales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductCategorySale : ReadOnlyRecord<ViewDWDailyProductCategorySale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailyProductCategorySales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailyProductCategorySales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailyProductCategorySale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailyProductCategorySale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailyProductCategorySale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailyProductCategorySale(string columnName, object columnValue)
        {
            SetSQLProps();
