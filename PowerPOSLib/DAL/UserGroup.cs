...
namespace PowerPOS
{
	...
	public partial class UserGroup : ActiveRecord<UserGroup>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("UserGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarGroupDescription.DefaultSetting = @"";
				colvarGroupDescription.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("UserGroup",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.GroupDescription); }
			set { SetColumnValue(Columns.GroupDescription, value); }
		}
		...
		{
			return new PowerPOS.GroupUserPrivilegeCollection().Where(GroupUserPrivilege.Columns.GroupID, GroupID).Load();
		}
		public PowerPOS.UserMstCollection UserMstRecords()
		{
			return new PowerPOS.UserMstCollection().Where(UserMst.Columns.GroupName, GroupID).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varGroupID,string varGroupName,string varGroupDescription,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			UserGroup item = new UserGroup();
        ...
        public static TableSchema.TableColumn GroupDescriptionColumn
        {
