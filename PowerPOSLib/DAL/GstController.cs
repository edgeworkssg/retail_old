...
namespace PowerPOS
{
    ...
    public partial class GstController
    {
        // Preload our schema..
        Gst thisSchemaLoad = new Gst();
        ...
        public GstCollection FetchAll()
        {
            GstCollection coll = new GstCollection();
            Query qry = new Query(Gst.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public GstCollection FetchByID(object Gstid)
        {
            GstCollection coll = new GstCollection().Where("GSTID", Gstid).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public GstCollection FetchByQuery(Query qry)
        {
            GstCollection coll = new GstCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object Gstid)
        {
            return (Gst.Delete(Gstid) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Gstid)
        {
            return (Gst.Destroy(Gstid) == 1);
        }
	    ...
	    public void Update(int Gstid,double GSTRate,DateTime CommenceDate,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    Gst item = new Gst();
	        item.MarkOld();
	        item.IsLoaded = true;
