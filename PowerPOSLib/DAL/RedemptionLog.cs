...
{
	/// <summary>
	/// Strongly-typed collection for the RedemptionLog class.
	/// </summary>
    [Serializable]
	public partial class RedemptionLogCollection : ActiveList<RedemptionLog, RedemptionLogCollection>
	{	   
		public RedemptionLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>RedemptionLogCollection</returns>
		public RedemptionLogCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                RedemptionLog o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the RedemptionLog table.
	/// </summary>
	[Serializable]
	public partial class RedemptionLog : ActiveRecord<RedemptionLog>, IActiveRecord
	{
		...
		public RedemptionLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public RedemptionLog(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public RedemptionLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RedemptionLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarRedemptionLogID = new TableSchema.TableColumn(schema);
				colvarRedemptionLogID.ColumnName = "RedemptionLogID";
				colvarRedemptionLogID.DataType = DbType.Int32;
				colvarRedemptionLogID.MaxLength = 0;
				colvarRedemptionLogID.AutoIncrement = true;
				colvarRedemptionLogID.IsNullable = false;
				colvarRedemptionLogID.IsPrimaryKey = true;
				colvarRedemptionLogID.IsForeignKey = false;
				colvarRedemptionLogID.IsReadOnly = false;
				colvarRedemptionLogID.DefaultSetting = @"";
				colvarRedemptionLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRedemptionLogID);
				...
				colvarRedemptionDate.DefaultSetting = @"";
				colvarRedemptionDate.ForeignKeyTableName = "";
				...
				colvarUpdated.DataType = DbType.Boolean;
				colvarUpdated.MaxLength = 0;
				colvarUpdated.AutoIncrement = false;
				colvarUpdated.IsNullable = false;
				...
				DataService.Providers["PowerPOS"].AddSchema("RedemptionLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("RedemptionLogID")]
		[Bindable(true)]
		public int RedemptionLogID 
		{
			get { return GetColumnValue<int>(Columns.RedemptionLogID); }
			set { SetColumnValue(Columns.RedemptionLogID, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime?>(Columns.RedemptionDate); }
			set { SetColumnValue(Columns.RedemptionDate, value); }
		}
		...
		public bool Updated 
		{
			get { return GetColumnValue<bool>(Columns.Updated); }
		...
		/// </summary>
		public static void Update(int varRedemptionLogID,DateTime? varRedemptionDate,string varRemark,string varOrderHdrID,string varMembershipNo,decimal varPoints,bool varUpdated,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			RedemptionLog item = new RedemptionLog();
			
				item.RedemptionLogID = varRedemptionLogID;
        ...
        public static TableSchema.TableColumn RedemptionLogIDColumn
        {
        ...
        public static TableSchema.TableColumn RedemptionDateColumn
        {
		...
		{
			 public static string RedemptionLogID = @"RedemptionLogID";
