...
{
	/// <summary>
	/// Strongly-typed collection for the ManualSalesUpdate class.
	/// </summary>
    [Serializable]
	public partial class ManualSalesUpdateCollection : ActiveList<ManualSalesUpdate, ManualSalesUpdateCollection>
	{	   
		public ManualSalesUpdateCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ManualSalesUpdateCollection</returns>
		public ManualSalesUpdateCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ManualSalesUpdate o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ManualSalesUpdate table.
	/// </summary>
	[Serializable]
	public partial class ManualSalesUpdate : ActiveRecord<ManualSalesUpdate>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ManualSalesUpdate()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ManualSalesUpdate(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ManualSalesUpdate(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ManualSalesUpdate(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ManualSalesUpdate", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarManualSalesUpdateID = new TableSchema.TableColumn(schema);
				colvarManualSalesUpdateID.ColumnName = "ManualSalesUpdateID";
				colvarManualSalesUpdateID.DataType = DbType.Int32;
				colvarManualSalesUpdateID.MaxLength = 0;
				colvarManualSalesUpdateID.AutoIncrement = true;
				colvarManualSalesUpdateID.IsNullable = false;
				colvarManualSalesUpdateID.IsPrimaryKey = true;
				colvarManualSalesUpdateID.IsForeignKey = false;
				colvarManualSalesUpdateID.IsReadOnly = false;
				colvarManualSalesUpdateID.DefaultSetting = @"";
				colvarManualSalesUpdateID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarManualSalesUpdateID);
				...
				TableSchema.TableColumn colvarMallCode = new TableSchema.TableColumn(schema);
				colvarMallCode.ColumnName = "MallCode";
				colvarMallCode.DataType = DbType.String;
				colvarMallCode.MaxLength = 200;
				colvarMallCode.AutoIncrement = false;
				colvarMallCode.IsNullable = true;
				colvarMallCode.IsPrimaryKey = false;
				colvarMallCode.IsForeignKey = false;
				colvarMallCode.IsReadOnly = false;
				colvarMallCode.DefaultSetting = @"";
				colvarMallCode.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMallCode);
				
				TableSchema.TableColumn colvarTenantCode = new TableSchema.TableColumn(schema);
				colvarTenantCode.ColumnName = "TenantCode";
				colvarTenantCode.DataType = DbType.String;
				colvarTenantCode.MaxLength = 200;
				colvarTenantCode.AutoIncrement = false;
				colvarTenantCode.IsNullable = true;
				colvarTenantCode.IsPrimaryKey = false;
				colvarTenantCode.IsForeignKey = false;
				colvarTenantCode.IsReadOnly = false;
				colvarTenantCode.DefaultSetting = @"";
				colvarTenantCode.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTenantCode);
				...
				TableSchema.TableColumn colvarTransactionCount = new TableSchema.TableColumn(schema);
				colvarTransactionCount.ColumnName = "TransactionCount";
				colvarTransactionCount.DataType = DbType.Int32;
				colvarTransactionCount.MaxLength = 0;
				colvarTransactionCount.AutoIncrement = false;
				colvarTransactionCount.IsNullable = true;
				colvarTransactionCount.IsPrimaryKey = false;
				colvarTransactionCount.IsForeignKey = false;
				colvarTransactionCount.IsReadOnly = false;
				colvarTransactionCount.DefaultSetting = @"";
				colvarTransactionCount.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTransactionCount);
				
				TableSchema.TableColumn colvarTotalSalesAfterTax = new TableSchema.TableColumn(schema);
				colvarTotalSalesAfterTax.ColumnName = "TotalSalesAfterTax";
				colvarTotalSalesAfterTax.DataType = DbType.Currency;
				colvarTotalSalesAfterTax.MaxLength = 0;
				colvarTotalSalesAfterTax.AutoIncrement = false;
				colvarTotalSalesAfterTax.IsNullable = true;
				colvarTotalSalesAfterTax.IsPrimaryKey = false;
				colvarTotalSalesAfterTax.IsForeignKey = false;
				colvarTotalSalesAfterTax.IsReadOnly = false;
				colvarTotalSalesAfterTax.DefaultSetting = @"";
				colvarTotalSalesAfterTax.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTotalSalesAfterTax);
				
				TableSchema.TableColumn colvarTotalSalesBeforeTax = new TableSchema.TableColumn(schema);
				colvarTotalSalesBeforeTax.ColumnName = "TotalSalesBeforeTax";
				colvarTotalSalesBeforeTax.DataType = DbType.Currency;
				colvarTotalSalesBeforeTax.MaxLength = 0;
				colvarTotalSalesBeforeTax.AutoIncrement = false;
				colvarTotalSalesBeforeTax.IsNullable = true;
				colvarTotalSalesBeforeTax.IsPrimaryKey = false;
				colvarTotalSalesBeforeTax.IsForeignKey = false;
				colvarTotalSalesBeforeTax.IsReadOnly = false;
				colvarTotalSalesBeforeTax.DefaultSetting = @"";
				colvarTotalSalesBeforeTax.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTotalSalesBeforeTax);
				
				TableSchema.TableColumn colvarTotalTax = new TableSchema.TableColumn(schema);
				colvarTotalTax.ColumnName = "TotalTax";
				colvarTotalTax.DataType = DbType.Currency;
				colvarTotalTax.MaxLength = 0;
				colvarTotalTax.AutoIncrement = false;
				colvarTotalTax.IsNullable = true;
				colvarTotalTax.IsPrimaryKey = false;
				colvarTotalTax.IsForeignKey = false;
				colvarTotalTax.IsReadOnly = false;
				colvarTotalTax.DefaultSetting = @"";
				colvarTotalTax.ForeignKeyTableName = "";
				schema.Columns.Add(colvarTotalTax);
				...
				DataService.Providers["PowerPOS"].AddSchema("ManualSalesUpdate",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ManualSalesUpdateID")]
		[Bindable(true)]
		public int ManualSalesUpdateID 
		{
			get { return GetColumnValue<int>(Columns.ManualSalesUpdateID); }
			set { SetColumnValue(Columns.ManualSalesUpdateID, value); }
		}
		...
		[XmlAttribute("MallCode")]
		[Bindable(true)]
		public string MallCode 
		{
			get { return GetColumnValue<string>(Columns.MallCode); }
			set { SetColumnValue(Columns.MallCode, value); }
		}
		  
		[XmlAttribute("TenantCode")]
		[Bindable(true)]
		public string TenantCode 
		{
			get { return GetColumnValue<string>(Columns.TenantCode); }
			set { SetColumnValue(Columns.TenantCode, value); }
		}
		...
		{
			get { return GetColumnValue<int?>(Columns.TransactionCount); }
			set { SetColumnValue(Columns.TransactionCount, value); }
		}
		  
		[XmlAttribute("TotalSalesAfterTax")]
		[Bindable(true)]
		public decimal? TotalSalesAfterTax 
		{
			get { return GetColumnValue<decimal?>(Columns.TotalSalesAfterTax); }
			set { SetColumnValue(Columns.TotalSalesAfterTax, value); }
		}
		  
		[XmlAttribute("TotalSalesBeforeTax")]
		[Bindable(true)]
		public decimal? TotalSalesBeforeTax 
		{
			get { return GetColumnValue<decimal?>(Columns.TotalSalesBeforeTax); }
			set { SetColumnValue(Columns.TotalSalesBeforeTax, value); }
		}
		  
		[XmlAttribute("TotalTax")]
		[Bindable(true)]
		public decimal? TotalTax 
		{
			get { return GetColumnValue<decimal?>(Columns.TotalTax); }
			set { SetColumnValue(Columns.TotalTax, value); }
		}
		...
		/// </summary>
		public static void Insert(int? varPointOfSaleID,string varMallCode,string varTenantCode,string varDateX,string varHour,int? varTransactionCount,decimal? varTotalSalesAfterTax,decimal? varTotalSalesBeforeTax,decimal? varTotalTax,string varRemarks,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ManualSalesUpdate item = new ManualSalesUpdate();
			
			item.PointOfSaleID = varPointOfSaleID;
			
			item.MallCode = varMallCode;
			
			item.TenantCode = varTenantCode;
			
			item.DateX = varDateX;
			
			item.Hour = varHour;
			
			item.TransactionCount = varTransactionCount;
			
			item.TotalSalesAfterTax = varTotalSalesAfterTax;
			
			item.TotalSalesBeforeTax = varTotalSalesBeforeTax;
			
			item.TotalTax = varTotalTax;
		...
		/// </summary>
		public static void Update(int varManualSalesUpdateID,int? varPointOfSaleID,string varMallCode,string varTenantCode,string varDateX,string varHour,int? varTransactionCount,decimal? varTotalSalesAfterTax,decimal? varTotalSalesBeforeTax,decimal? varTotalTax,string varRemarks,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ManualSalesUpdate item = new ManualSalesUpdate();
			
				item.ManualSalesUpdateID = varManualSalesUpdateID;
        ...
        public static TableSchema.TableColumn ManualSalesUpdateIDColumn
        {
        ...
        public static TableSchema.TableColumn MallCodeColumn
        {
        ...
        public static TableSchema.TableColumn TenantCodeColumn
        {
        ...
        public static TableSchema.TableColumn TransactionCountColumn
        {
        ...
        public static TableSchema.TableColumn TotalSalesAfterTaxColumn
        {
        ...
        public static TableSchema.TableColumn TotalSalesBeforeTaxColumn
        {
        ...
        public static TableSchema.TableColumn TotalTaxColumn
        {
		...
		{
			 public static string ManualSalesUpdateID = @"ManualSalesUpdateID";
			 public static string PointOfSaleID = @"PointOfSaleID";
			 public static string MallCode = @"MallCode";
			 ...
			 public static string TotalSalesAfterTax = @"TotalSalesAfterTax";
			 public static string TotalSalesBeforeTax = @"TotalSalesBeforeTax";
