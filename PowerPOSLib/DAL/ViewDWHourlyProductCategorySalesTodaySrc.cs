...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWHourlyProductCategorySalesTodaySrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductCategorySalesTodaySrcCollection : ReadOnlyList<ViewDWHourlyProductCategorySalesTodaySrc, ViewDWHourlyProductCategorySalesTodaySrcCollection>
    {        
        public ViewDWHourlyProductCategorySalesTodaySrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_HourlyProductCategorySales_today_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductCategorySalesTodaySrc : ReadOnlyRecord<ViewDWHourlyProductCategorySalesTodaySrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_HourlyProductCategorySales_today_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_HourlyProductCategorySales_today_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWHourlyProductCategorySalesTodaySrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWHourlyProductCategorySalesTodaySrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWHourlyProductCategorySalesTodaySrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWHourlyProductCategorySalesTodaySrc(string columnName, object columnValue)
        {
            SetSQLProps();
