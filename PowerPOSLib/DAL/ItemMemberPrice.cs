...
{
	/// <summary>
	/// Strongly-typed collection for the ItemMemberPrice class.
	/// </summary>
    [Serializable]
	public partial class ItemMemberPriceCollection : ActiveList<ItemMemberPrice, ItemMemberPriceCollection>
	{	   
		public ItemMemberPriceCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemMemberPriceCollection</returns>
		public ItemMemberPriceCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemMemberPrice o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemMemberPrice table.
	/// </summary>
	[Serializable]
	public partial class ItemMemberPrice : ActiveRecord<ItemMemberPrice>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemMemberPrice()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemMemberPrice(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemMemberPrice(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemMemberPrice(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemMemberPrice", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemMemberPriceID = new TableSchema.TableColumn(schema);
				colvarItemMemberPriceID.ColumnName = "ItemMemberPriceID";
				colvarItemMemberPriceID.DataType = DbType.String;
				colvarItemMemberPriceID.MaxLength = 200;
				colvarItemMemberPriceID.AutoIncrement = false;
				colvarItemMemberPriceID.IsNullable = false;
				colvarItemMemberPriceID.IsPrimaryKey = true;
				colvarItemMemberPriceID.IsForeignKey = false;
				colvarItemMemberPriceID.IsReadOnly = false;
				colvarItemMemberPriceID.DefaultSetting = @"";
				colvarItemMemberPriceID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemMemberPriceID);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemMemberPrice",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemMemberPriceID")]
		[Bindable(true)]
		public string ItemMemberPriceID 
		{
			get { return GetColumnValue<string>(Columns.ItemMemberPriceID); }
			set { SetColumnValue(Columns.ItemMemberPriceID, value); }
		}
		...
		/// </summary>
		public static void Insert(string varItemMemberPriceID,string varItemNo,string varMembershipNo,string varOrderDetID,DateTime? varOrderDate,decimal? varUnitPrice,decimal? varQty,decimal? varAmount,string varRemark,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemMemberPrice item = new ItemMemberPrice();
			
			item.ItemMemberPriceID = varItemMemberPriceID;
		...
		/// </summary>
		public static void Update(string varItemMemberPriceID,string varItemNo,string varMembershipNo,string varOrderDetID,DateTime? varOrderDate,decimal? varUnitPrice,decimal? varQty,decimal? varAmount,string varRemark,DateTime? varModifiedOn,string varModifiedBy,string varCreatedBy,DateTime? varCreatedOn,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemMemberPrice item = new ItemMemberPrice();
        ...
        public static TableSchema.TableColumn ItemMemberPriceIDColumn
        {
		...
		{
			 public static string ItemMemberPriceID = @"ItemMemberPriceID";
