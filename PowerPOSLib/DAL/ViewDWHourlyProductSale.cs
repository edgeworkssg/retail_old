...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWHourlyProductSale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductSaleCollection : ReadOnlyList<ViewDWHourlyProductSale, ViewDWHourlyProductSaleCollection>
    {        
        public ViewDWHourlyProductSaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_HourlyProductSales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWHourlyProductSale : ReadOnlyRecord<ViewDWHourlyProductSale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_HourlyProductSales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_HourlyProductSales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWHourlyProductSale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWHourlyProductSale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWHourlyProductSale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWHourlyProductSale(string columnName, object columnValue)
        {
            SetSQLProps();
