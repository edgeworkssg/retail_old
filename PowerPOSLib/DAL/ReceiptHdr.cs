...
{
	/// <summary>
	/// Strongly-typed collection for the ReceiptHdr class.
	/// </summary>
    [Serializable]
	public partial class ReceiptHdrCollection : ActiveList<ReceiptHdr, ReceiptHdrCollection>
	{	   
		public ReceiptHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ReceiptHdrCollection</returns>
		public ReceiptHdrCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ReceiptHdr table.
	/// </summary>
	[Serializable]
	public partial class ReceiptHdr : ActiveRecord<ReceiptHdr>, IActiveRecord
	{
		...
		public ReceiptHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ReceiptHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ReceiptHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ReceiptHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarReceiptRefNo.DefaultSetting = @"";
				colvarReceiptRefNo.ForeignKeyTableName = "";
				...
				colvarReceiptDate.DefaultSetting = @"";
				colvarReceiptDate.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarAmountBeforeRounding = new TableSchema.TableColumn(schema);
				colvarAmountBeforeRounding.ColumnName = "AmountBeforeRounding";
				colvarAmountBeforeRounding.DataType = DbType.Currency;
				colvarAmountBeforeRounding.MaxLength = 0;
				colvarAmountBeforeRounding.AutoIncrement = false;
				colvarAmountBeforeRounding.IsNullable = false;
				colvarAmountBeforeRounding.IsPrimaryKey = false;
				colvarAmountBeforeRounding.IsForeignKey = false;
				colvarAmountBeforeRounding.IsReadOnly = false;
				colvarAmountBeforeRounding.DefaultSetting = @"";
				colvarAmountBeforeRounding.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAmountBeforeRounding);
				...
				DataService.Providers["PowerPOS"].AddSchema("ReceiptHdr",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.ReceiptRefNo); }
			set { SetColumnValue(Columns.ReceiptRefNo, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime>(Columns.ReceiptDate); }
			set { SetColumnValue(Columns.ReceiptDate, value); }
		}
		...
		[XmlAttribute("AmountBeforeRounding")]
		[Bindable(true)]
		public decimal AmountBeforeRounding 
		{
			get { return GetColumnValue<decimal>(Columns.AmountBeforeRounding); }
			set { SetColumnValue(Columns.AmountBeforeRounding, value); }
		}
		...
		public PowerPOS.ReceiptDetCollection ReceiptDetRecords()
		{
			return new PowerPOS.ReceiptDetCollection().Where(ReceiptDet.Columns.ReceiptHdrID, ReceiptHdrID).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a OrderHdr ActiveRecord object related to this ReceiptHdr
		/// 
		/// </summary>
		...
		public static void Insert(string varReceiptHdrID,string varReceiptRefNo,DateTime varReceiptDate,string varCashierID,int varPointOfSaleID,string varOrderHdrID,decimal varAmount,decimal varAmountBeforeRounding,bool varIsVoided,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.AmountBeforeRounding = varAmountBeforeRounding;
		...
		/// </summary>
		public static void Update(string varReceiptHdrID,string varReceiptRefNo,DateTime varReceiptDate,string varCashierID,int varPointOfSaleID,string varOrderHdrID,decimal varAmount,decimal varAmountBeforeRounding,bool varIsVoided,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ReceiptHdr item = new ReceiptHdr();
        ...
        public static TableSchema.TableColumn ReceiptRefNoColumn
        {
        ...
        public static TableSchema.TableColumn ReceiptDateColumn
        {
        ...
        public static TableSchema.TableColumn AmountBeforeRoundingColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string AmountBeforeRounding = @"AmountBeforeRounding";
