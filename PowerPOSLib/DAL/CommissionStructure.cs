...
{
	/// <summary>
	/// Strongly-typed collection for the CommissionStructure class.
	/// </summary>
    [Serializable]
	public partial class CommissionStructureCollection : ActiveList<CommissionStructure, CommissionStructureCollection>
	{	   
		public CommissionStructureCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CommissionStructureCollection</returns>
		public CommissionStructureCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                CommissionStructure o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CommissionStructure table.
	/// </summary>
	[Serializable]
	public partial class CommissionStructure : ActiveRecord<CommissionStructure>, IActiveRecord
	{
		...
		public CommissionStructure(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public CommissionStructure(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public CommissionStructure(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CommissionStructure", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarCommissionStructureID = new TableSchema.TableColumn(schema);
				colvarCommissionStructureID.ColumnName = "CommissionStructureID";
				colvarCommissionStructureID.DataType = DbType.Int32;
				colvarCommissionStructureID.MaxLength = 0;
				colvarCommissionStructureID.AutoIncrement = true;
				colvarCommissionStructureID.IsNullable = false;
				colvarCommissionStructureID.IsPrimaryKey = true;
				colvarCommissionStructureID.IsForeignKey = false;
				colvarCommissionStructureID.IsReadOnly = false;
				colvarCommissionStructureID.DefaultSetting = @"";
				colvarCommissionStructureID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCommissionStructureID);
				...
				colvarSalesGroupID.DefaultSetting = @"";
					...
					colvarSalesGroupID.ForeignKeyTableName = "SalesGroup";
				...
				colvarCommission.DataType = DbType.Double;
				...
				DataService.Providers["PowerPOS"].AddSchema("CommissionStructure",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("CommissionStructureID")]
		[Bindable(true)]
		public int CommissionStructureID 
		{
			get { return GetColumnValue<int>(Columns.CommissionStructureID); }
			set { SetColumnValue(Columns.CommissionStructureID, value); }
		}
		...
		{
			get { return GetColumnValue<double>(Columns.Commission); }
		...
		/// <summary>
		/// Returns a SalesGroup ActiveRecord object related to this CommissionStructure
		/// 
		/// </summary>
		public PowerPOS.SalesGroup SalesGroup
		{
			get { return PowerPOS.SalesGroup.FetchByID(this.SalesGroupID); }
			set { SetColumnValue("SalesGroupID", value.SalesGroupId); }
		}
		...
		/// </summary>
		public static void Update(int varCommissionStructureID,int varSalesGroupID,decimal varSalesQuota,double varCommission,DateTime? varModifiedOn,string varModifiedBy,DateTime? varCreatedOn,string varCreatedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			CommissionStructure item = new CommissionStructure();
			
				item.CommissionStructureID = varCommissionStructureID;
        ...
        public static TableSchema.TableColumn CommissionStructureIDColumn
        {
		...
		{
			 public static string CommissionStructureID = @"CommissionStructureID";
