...
{
	/// <summary>
	/// Strongly-typed collection for the EventItemMap class.
	/// </summary>
    [Serializable]
	public partial class EventItemMapCollection : ActiveList<EventItemMap, EventItemMapCollection>
	{	   
		public EventItemMapCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>EventItemMapCollection</returns>
		public EventItemMapCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                EventItemMap o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the EventItemMap table.
	/// </summary>
	[Serializable]
	public partial class EventItemMap : ActiveRecord<EventItemMap>, IActiveRecord
	{
		...
		public EventItemMap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public EventItemMap(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public EventItemMap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("EventItemMap", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarEventItemMapID.AutoIncrement = true;
				colvarEventItemMapID.IsNullable = false;
				colvarEventItemMapID.IsPrimaryKey = true;
				colvarEventItemMapID.IsForeignKey = false;
				colvarEventItemMapID.IsReadOnly = false;
				colvarEventItemMapID.DefaultSetting = @"";
				colvarEventItemMapID.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("EventItemMap",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.EventItemMapID); }
			set { SetColumnValue(Columns.EventItemMapID, value); }
		}
		...
		/// <summary>
		/// Returns a SpecialEvent ActiveRecord object related to this EventItemMap
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this EventItemMap
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varEventItemMapID,int varEventId,string varItemNo,decimal? varItemPrice,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,Guid varUniqueID,string varUserFld1,string varUserFld2,string varUserFld3,string varUserFld4,string varUserFld5,string varUserFld6,string varUserFld7,string varUserFld8,string varUserFld9,string varUserFld10,decimal? varUserFloat1,decimal? varUserFloat2,decimal? varUserFloat3,decimal? varUserFloat4,decimal? varUserFloat5,bool? varUserFlag1,bool? varUserFlag2,bool? varUserFlag3,bool? varUserFlag4,bool? varUserFlag5,int? varUserInt1,int? varUserInt2,int? varUserInt3,int? varUserInt4,int? varUserInt5)
		{
			EventItemMap item = new EventItemMap();
			
				item.EventItemMapID = varEventItemMapID;
        ...
        public static TableSchema.TableColumn EventItemMapIDColumn
        {
