...
{
	/// <summary>
	/// Strongly-typed collection for the EZlinkMessage class.
	/// </summary>
    [Serializable]
	public partial class EZlinkMessageCollection : ActiveList<EZlinkMessage, EZlinkMessageCollection>
	{	   
		public EZlinkMessageCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>EZlinkMessageCollection</returns>
		public EZlinkMessageCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                EZlinkMessage o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the EZlinkMessage table.
	/// </summary>
	[Serializable]
	public partial class EZlinkMessage : ActiveRecord<EZlinkMessage>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public EZlinkMessage()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public EZlinkMessage(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public EZlinkMessage(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public EZlinkMessage(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("EZlinkMessage", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarMsgName.IsPrimaryKey = true;
				...
				DataService.Providers["PowerPOS"].AddSchema("EZlinkMessage",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varMsgName,string varMsgContent,bool varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID)
		{
		...
		/// </summary>
		public static void Update(string varMsgName,string varMsgContent,bool varDeleted,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID)
		{
			EZlinkMessage item = new EZlinkMessage();
