...
{
	/// <summary>
	/// Strongly-typed collection for the FileAttachment class.
	/// </summary>
    [Serializable]
	public partial class FileAttachmentCollection : ActiveList<FileAttachment, FileAttachmentCollection>
	{	   
        ...
        /// </summary>
        /// <returns>FileAttachmentCollection</returns>
		public FileAttachmentCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                FileAttachment o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the FileAttachment table.
	/// </summary>
	[Serializable]
	public partial class FileAttachment : ActiveRecord<FileAttachment>, IActiveRecord
	{
		...
		public FileAttachment(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public FileAttachment(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public FileAttachment(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("FileAttachment", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarAttachmentID.DataType = DbType.Guid;
				...
				TableSchema.TableColumn colvarFileLocation = new TableSchema.TableColumn(schema);
				colvarFileLocation.ColumnName = "FileLocation";
				colvarFileLocation.DataType = DbType.String;
				colvarFileLocation.MaxLength = -1;
				colvarFileLocation.AutoIncrement = false;
				colvarFileLocation.IsNullable = false;
				colvarFileLocation.IsPrimaryKey = false;
				colvarFileLocation.IsForeignKey = false;
				colvarFileLocation.IsReadOnly = false;
				colvarFileLocation.DefaultSetting = @"";
				colvarFileLocation.ForeignKeyTableName = "";
				schema.Columns.Add(colvarFileLocation);
				...
				colvarRefID.DataType = DbType.AnsiString;
				colvarRefID.MaxLength = 50;
				...
				DataService.Providers["PowerPOS"].AddSchema("FileAttachment",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("AttachmentID")]
		[Bindable(true)]
		public Guid AttachmentID 
		{
			get { return GetColumnValue<Guid>(Columns.AttachmentID); }
			set { SetColumnValue(Columns.AttachmentID, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.FileLocation); }
			set { SetColumnValue(Columns.FileLocation, value); }
		}
		...
		/// </summary>
		public static void Update(Guid varAttachmentID,string varFileName,long varFileSize,string varFileLocation,int varPointOfSaleID,string varModuleName,string varRefID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			FileAttachment item = new FileAttachment();
        ...
        public static TableSchema.TableColumn FileLocationColumn
        {
