...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryUpdateLog class.
	/// </summary>
    [Serializable]
	public partial class InventoryUpdateLogCollection : ActiveList<InventoryUpdateLog, InventoryUpdateLogCollection>
	{	   
		public InventoryUpdateLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryUpdateLogCollection</returns>
		public InventoryUpdateLogCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryUpdateLog o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryUpdateLog table.
	/// </summary>
	[Serializable]
	public partial class InventoryUpdateLog : ActiveRecord<InventoryUpdateLog>, IActiveRecord
	{
		...
		public InventoryUpdateLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryUpdateLog(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryUpdateLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryUpdateLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarInventoryUpdateLogID = new TableSchema.TableColumn(schema);
				colvarInventoryUpdateLogID.ColumnName = "InventoryUpdateLogID";
				colvarInventoryUpdateLogID.DataType = DbType.Int32;
				colvarInventoryUpdateLogID.MaxLength = 0;
				colvarInventoryUpdateLogID.AutoIncrement = true;
				colvarInventoryUpdateLogID.IsNullable = false;
				colvarInventoryUpdateLogID.IsPrimaryKey = true;
				colvarInventoryUpdateLogID.IsForeignKey = false;
				colvarInventoryUpdateLogID.IsReadOnly = false;
				colvarInventoryUpdateLogID.DefaultSetting = @"";
				colvarInventoryUpdateLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarInventoryUpdateLogID);
				...
				colvarUpdateTime.IsNullable = false;
				...
				TableSchema.TableColumn colvarStartRefNo = new TableSchema.TableColumn(schema);
				colvarStartRefNo.ColumnName = "StartRefNo";
				colvarStartRefNo.DataType = DbType.AnsiString;
				colvarStartRefNo.MaxLength = 50;
				colvarStartRefNo.AutoIncrement = false;
				colvarStartRefNo.IsNullable = false;
				colvarStartRefNo.IsPrimaryKey = false;
				colvarStartRefNo.IsForeignKey = false;
				colvarStartRefNo.IsReadOnly = false;
				colvarStartRefNo.DefaultSetting = @"";
				colvarStartRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStartRefNo);
				
				TableSchema.TableColumn colvarEndRefNo = new TableSchema.TableColumn(schema);
				colvarEndRefNo.ColumnName = "EndRefNo";
				colvarEndRefNo.DataType = DbType.AnsiString;
				colvarEndRefNo.MaxLength = 50;
				colvarEndRefNo.AutoIncrement = false;
				colvarEndRefNo.IsNullable = false;
				colvarEndRefNo.IsPrimaryKey = false;
				colvarEndRefNo.IsForeignKey = false;
				colvarEndRefNo.IsReadOnly = false;
				colvarEndRefNo.DefaultSetting = @"";
				colvarEndRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarEndRefNo);
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryUpdateLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("InventoryUpdateLogID")]
		[Bindable(true)]
		public int InventoryUpdateLogID 
		{
			get { return GetColumnValue<int>(Columns.InventoryUpdateLogID); }
			set { SetColumnValue(Columns.InventoryUpdateLogID, value); }
		}
		...
		[XmlAttribute("StartRefNo")]
		[Bindable(true)]
		public string StartRefNo 
		{
			get { return GetColumnValue<string>(Columns.StartRefNo); }
			set { SetColumnValue(Columns.StartRefNo, value); }
		}
		  
		[XmlAttribute("EndRefNo")]
		[Bindable(true)]
		public string EndRefNo 
		{
			get { return GetColumnValue<string>(Columns.EndRefNo); }
			set { SetColumnValue(Columns.EndRefNo, value); }
		}
		...
		/// </summary>
		public static void Update(int varInventoryUpdateLogID,DateTime varUpdateTime,string varStartRefNo,string varEndRefNo,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			InventoryUpdateLog item = new InventoryUpdateLog();
			
				item.InventoryUpdateLogID = varInventoryUpdateLogID;
        ...
        public static TableSchema.TableColumn InventoryUpdateLogIDColumn
        {
        ...
        public static TableSchema.TableColumn StartRefNoColumn
        {
        ...
        public static TableSchema.TableColumn EndRefNoColumn
        {
		...
		{
			 public static string InventoryUpdateLogID = @"InventoryUpdateLogID";
			 public static string UpdateTime = @"UpdateTime";
			 public static string StartRefNo = @"StartRefNo";
			 public static string EndRefNo = @"EndRefNo";
