...
{
	/// <summary>
	/// Strongly-typed collection for the UserMst class.
	/// </summary>
    [Serializable]
	public partial class UserMstCollection : ActiveList<UserMst, UserMstCollection>
	{	   
		public UserMstCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>UserMstCollection</returns>
		public UserMstCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the UserMst table.
	/// </summary>
	[Serializable]
	public partial class UserMst : ActiveRecord<UserMst>, IActiveRecord
	{
		...
		public UserMst(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public UserMst(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("UserMst", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarIsASalesPerson.IsReadOnly = false;
						...
						colvarIsASalesPerson.DefaultSetting = @"((0))";
				colvarIsASalesPerson.ForeignKeyTableName = "";
				...
				colvarSalesPersonGroupID.IsReadOnly = false;
						...
						colvarSalesPersonGroupID.DefaultSetting = @"((0))";
				colvarSalesPersonGroupID.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarImageData = new TableSchema.TableColumn(schema);
				colvarImageData.ColumnName = "ImageData";
				colvarImageData.DataType = DbType.Binary;
				colvarImageData.MaxLength = -1;
				colvarImageData.AutoIncrement = false;
				colvarImageData.IsNullable = true;
				colvarImageData.IsPrimaryKey = false;
				colvarImageData.IsForeignKey = false;
				colvarImageData.IsReadOnly = false;
				colvarImageData.DefaultSetting = @"";
				colvarImageData.ForeignKeyTableName = "";
				schema.Columns.Add(colvarImageData);
				
				TableSchema.TableColumn colvarSalesCommission = new TableSchema.TableColumn(schema);
				colvarSalesCommission.ColumnName = "SalesCommission";
				colvarSalesCommission.DataType = DbType.Guid;
				...
				DataService.Providers["PowerPOS"].AddSchema("UserMst",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<int>(Columns.GroupName); }
		...
		{
			get { return GetColumnValue<bool>(Columns.IsASalesPerson); }
			set { SetColumnValue(Columns.IsASalesPerson, value); }
		}
		...
		{
			get { return GetColumnValue<int>(Columns.SalesPersonGroupID); }
			set { SetColumnValue(Columns.SalesPersonGroupID, value); }
		}
		...
		{
			get { return GetColumnValue<byte[]>(Columns.ImageData); }
			set { SetColumnValue(Columns.ImageData, value); }
		}
		  
		[XmlAttribute("SalesCommission")]
		[Bindable(true)]
		public Guid? SalesCommission 
		{
			get { return GetColumnValue<Guid?>(Columns.SalesCommission); }
		...
		public PowerPOS.MembershipCollection MembershipRecords()
		{
			return new PowerPOS.MembershipCollection().Where(Membership.Columns.SalesPersonID, UserName).Load();
		}
		public PowerPOS.SalesCommissionRecordCollection SalesCommissionRecordRecords()
		{
			return new PowerPOS.SalesCommissionRecordCollection().Where(SalesCommissionRecord.Columns.SalesPersonID, UserName).Load();
		}
		public PowerPOS.AppointmentCollection AppointmentRecords()
		{
			return new PowerPOS.AppointmentCollection().Where(Appointment.Columns.SalesPersonID, UserName).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a UserGroup ActiveRecord object related to this UserMst
		/// 
		/// </summary>
		public PowerPOS.UserGroup UserGroup
		{
			get { return PowerPOS.UserGroup.FetchByID(this.GroupName); }
			set { SetColumnValue("GroupName", value.GroupID); }
		}
		
		
		/// <summary>
		/// Returns a Department ActiveRecord object related to this UserMst
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varUserName,string varDisplayName,string varPassword,string varRemark,int varGroupName,int? varDepartmentID,bool varIsASalesPerson,int varSalesPersonGroupID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,bool? varGender,byte[] varImageData,Guid? varSalesCommission)
		{
			UserMst item = new UserMst();
			...
			item.IsASalesPerson = varIsASalesPerson;
			
			item.SalesPersonGroupID = varSalesPersonGroupID;
			...
			item.ImageData = varImageData;
			
			item.SalesCommission = varSalesCommission;
		...
		/// </summary>
		public static void Update(string varUserName,string varDisplayName,string varPassword,string varRemark,int varGroupName,int? varDepartmentID,bool varIsASalesPerson,int varSalesPersonGroupID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,bool? varGender,byte[] varImageData,Guid? varSalesCommission)
		{
			UserMst item = new UserMst();
        ...
        public static TableSchema.TableColumn IsASalesPersonColumn
        {
        ...
        public static TableSchema.TableColumn SalesPersonGroupIDColumn
        {
        ...
        public static TableSchema.TableColumn ImageDataColumn
        {
