...
{
	/// <summary>
	/// Strongly-typed collection for the ItemGroup class.
	/// </summary>
    [Serializable]
	public partial class ItemGroupCollection : ActiveList<ItemGroup, ItemGroupCollection>
	{	   
        ...
        /// </summary>
        /// <returns>ItemGroupCollection</returns>
		public ItemGroupCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemGroup table.
	/// </summary>
	[Serializable]
	public partial class ItemGroup : ActiveRecord<ItemGroup>, IActiveRecord
	{
		...
		public ItemGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarItemGroupName.DefaultSetting = @"";
				colvarItemGroupName.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarUniqueItems = new TableSchema.TableColumn(schema);
				colvarUniqueItems.ColumnName = "UniqueItems";
				colvarUniqueItems.DataType = DbType.Boolean;
				colvarUniqueItems.MaxLength = 0;
				colvarUniqueItems.AutoIncrement = false;
				colvarUniqueItems.IsNullable = true;
				colvarUniqueItems.IsPrimaryKey = false;
				colvarUniqueItems.IsForeignKey = false;
				colvarUniqueItems.IsReadOnly = false;
				colvarUniqueItems.DefaultSetting = @"";
				colvarUniqueItems.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUniqueItems);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemGroup",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<string>(Columns.ItemGroupName); }
			set { SetColumnValue(Columns.ItemGroupName, value); }
		}
		...
		[XmlAttribute("UniqueItems")]
		[Bindable(true)]
		public bool? UniqueItems 
		{
			get { return GetColumnValue<bool?>(Columns.UniqueItems); }
			set { SetColumnValue(Columns.UniqueItems, value); }
		}
		...
		{
			return new PowerPOS.ItemGroupMapCollection().Where(ItemGroupMap.Columns.ItemGroupID, ItemGroupId).Load();
		}
		public PowerPOS.PromoCampaignDetCollection PromoCampaignDetRecords()
		{
			return new PowerPOS.PromoCampaignDetCollection().Where(PromoCampaignDet.Columns.ItemGroupID, ItemGroupId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varItemGroupId,string varItemGroupName,string varBarcode,bool? varUniqueItems,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemGroup item = new ItemGroup();
        ...
        public static TableSchema.TableColumn ItemGroupNameColumn
        {
        ...
        public static TableSchema.TableColumn UniqueItemsColumn
        {
