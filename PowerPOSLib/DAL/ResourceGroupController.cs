...
{
    /// <summary>
    /// Controller class for ResourceGroup
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class ResourceGroupController
    {
        // Preload our schema..
        ResourceGroup thisSchemaLoad = new ResourceGroup();
        ...
        public ResourceGroupCollection FetchAll()
        {
            ResourceGroupCollection coll = new ResourceGroupCollection();
            Query qry = new Query(ResourceGroup.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public ResourceGroupCollection FetchByID(object ResourceGroupID)
        {
            ResourceGroupCollection coll = new ResourceGroupCollection().Where("ResourceGroupID", ResourceGroupID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public ResourceGroupCollection FetchByQuery(Query qry)
        {
            ResourceGroupCollection coll = new ResourceGroupCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object ResourceGroupID)
        {
            return (ResourceGroup.Delete(ResourceGroupID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object ResourceGroupID)
        {
            return (ResourceGroup.Destroy(ResourceGroupID) == 1);
        }
	    ...
	    public void Update(int ResourceGroupID,string GroupName,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    ResourceGroup item = new ResourceGroup();
	        item.MarkOld();
	        item.IsLoaded = true;
