...
{
	/// <summary>
	/// Strongly-typed collection for the SupplierItemMap class.
	/// </summary>
    [Serializable]
	public partial class SupplierItemMapCollection : ActiveList<SupplierItemMap, SupplierItemMapCollection>
	{	   
		public SupplierItemMapCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SupplierItemMapCollection</returns>
		public SupplierItemMapCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SupplierItemMap o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the SupplierItemMap table.
	/// </summary>
	[Serializable]
	public partial class SupplierItemMap : ActiveRecord<SupplierItemMap>, IActiveRecord
	{
		...
		public SupplierItemMap(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SupplierItemMap(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SupplierItemMap(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SupplierItemMap", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				DataService.Providers["PowerPOS"].AddSchema("SupplierItemMap",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int? varSupplierID,string varItemNo,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,Guid varUniqueID,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			SupplierItemMap item = new SupplierItemMap();
