...
{
	/// <summary>
	/// Strongly-typed collection for the KioskMaster class.
	/// </summary>
    [Serializable]
	public partial class KioskMasterCollection : ActiveList<KioskMaster, KioskMasterCollection>
	{	   
		public KioskMasterCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>KioskMasterCollection</returns>
		public KioskMasterCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                KioskMaster o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the KioskMaster table.
	/// </summary>
	[Serializable]
	public partial class KioskMaster : ActiveRecord<KioskMaster>, IActiveRecord
	{
		...
		public KioskMaster(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public KioskMaster(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public KioskMaster(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("KioskMaster", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarKioskID = new TableSchema.TableColumn(schema);
				colvarKioskID.ColumnName = "KioskID";
				colvarKioskID.DataType = DbType.Int64;
				colvarKioskID.MaxLength = 0;
				colvarKioskID.AutoIncrement = true;
				colvarKioskID.IsNullable = false;
				colvarKioskID.IsPrimaryKey = true;
				colvarKioskID.IsForeignKey = false;
				colvarKioskID.IsReadOnly = false;
				colvarKioskID.DefaultSetting = @"";
				colvarKioskID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarKioskID);
				
				TableSchema.TableColumn colvarKioskName = new TableSchema.TableColumn(schema);
				colvarKioskName.ColumnName = "KioskName";
				colvarKioskName.DataType = DbType.AnsiString;
				colvarKioskName.MaxLength = 50;
				colvarKioskName.AutoIncrement = false;
				colvarKioskName.IsNullable = true;
				colvarKioskName.IsPrimaryKey = false;
				colvarKioskName.IsForeignKey = false;
				colvarKioskName.IsReadOnly = false;
				colvarKioskName.DefaultSetting = @"";
				colvarKioskName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarKioskName);
				...
				TableSchema.TableColumn colvarIsCashSupported = new TableSchema.TableColumn(schema);
				colvarIsCashSupported.ColumnName = "IsCashSupported";
				colvarIsCashSupported.DataType = DbType.Boolean;
				colvarIsCashSupported.MaxLength = 0;
				colvarIsCashSupported.AutoIncrement = false;
				colvarIsCashSupported.IsNullable = true;
				colvarIsCashSupported.IsPrimaryKey = false;
				colvarIsCashSupported.IsForeignKey = false;
				colvarIsCashSupported.IsReadOnly = false;
				colvarIsCashSupported.DefaultSetting = @"";
				colvarIsCashSupported.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsCashSupported);
				
				TableSchema.TableColumn colvarIsCardSupported = new TableSchema.TableColumn(schema);
				colvarIsCardSupported.ColumnName = "IsCardSupported";
				colvarIsCardSupported.DataType = DbType.Boolean;
				colvarIsCardSupported.MaxLength = 0;
				colvarIsCardSupported.AutoIncrement = false;
				colvarIsCardSupported.IsNullable = true;
				colvarIsCardSupported.IsPrimaryKey = false;
				colvarIsCardSupported.IsForeignKey = false;
				colvarIsCardSupported.IsReadOnly = false;
				colvarIsCardSupported.DefaultSetting = @"";
				colvarIsCardSupported.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsCardSupported);
				...
				TableSchema.TableColumn colvarPendingCount = new TableSchema.TableColumn(schema);
				colvarPendingCount.ColumnName = "PendingCount";
				colvarPendingCount.DataType = DbType.Int32;
				colvarPendingCount.MaxLength = 0;
				colvarPendingCount.AutoIncrement = false;
				colvarPendingCount.IsNullable = true;
				colvarPendingCount.IsPrimaryKey = false;
				colvarPendingCount.IsForeignKey = false;
				colvarPendingCount.IsReadOnly = false;
				colvarPendingCount.DefaultSetting = @"";
				colvarPendingCount.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPendingCount);
				...
				DataService.Providers["PowerPOS"].AddSchema("KioskMaster",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("KioskID")]
		[Bindable(true)]
		public long KioskID 
		{
			get { return GetColumnValue<long>(Columns.KioskID); }
			set { SetColumnValue(Columns.KioskID, value); }
		}
		  
		[XmlAttribute("KioskName")]
		[Bindable(true)]
		public string KioskName 
		{
			get { return GetColumnValue<string>(Columns.KioskName); }
			set { SetColumnValue(Columns.KioskName, value); }
		}
		...
		[XmlAttribute("IsCashSupported")]
		[Bindable(true)]
		public bool? IsCashSupported 
		{
			get { return GetColumnValue<bool?>(Columns.IsCashSupported); }
			set { SetColumnValue(Columns.IsCashSupported, value); }
		}
		  
		[XmlAttribute("IsCardSupported")]
		[Bindable(true)]
		public bool? IsCardSupported 
		{
			get { return GetColumnValue<bool?>(Columns.IsCardSupported); }
			set { SetColumnValue(Columns.IsCardSupported, value); }
		}
		...
		[XmlAttribute("PendingCount")]
		[Bindable(true)]
		public int? PendingCount 
		{
			get { return GetColumnValue<int?>(Columns.PendingCount); }
			set { SetColumnValue(Columns.PendingCount, value); }
		}
		...
		/// </summary>
		public static void Update(long varKioskID,string varKioskName,string varIp,bool? varIsCashSupported,bool? varIsCardSupported,bool? varIsActive,int? varPendingCount,string varType,bool? varDeleted,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			KioskMaster item = new KioskMaster();
			
				item.KioskID = varKioskID;
        ...
        public static TableSchema.TableColumn KioskIDColumn
        {
        ...
        public static TableSchema.TableColumn KioskNameColumn
        {
        ...
        public static TableSchema.TableColumn IsCashSupportedColumn
        {
        ...
        public static TableSchema.TableColumn IsCardSupportedColumn
        {
        ...
        public static TableSchema.TableColumn PendingCountColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string IsCashSupported = @"IsCashSupported";
			 public static string IsCardSupported = @"IsCardSupported";
			 public static string IsActive = @"IsActive";
			 public static string PendingCount = @"PendingCount";
