...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryDet class.
	/// </summary>
    [Serializable]
	public partial class InventoryDetCollection : ActiveList<InventoryDet, InventoryDetCollection>
	{	   
		public InventoryDetCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryDetCollection</returns>
		public InventoryDetCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryDet o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryDet table.
	/// </summary>
	[Serializable]
	public partial class InventoryDet : ActiveRecord<InventoryDet>, IActiveRecord
	{
		...
		public InventoryDet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryDet(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryDet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryDet", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInventoryDetRefNo.IsPrimaryKey = true;
				...
				colvarInventoryHdrRefNo.IsForeignKey = true;
				colvarInventoryHdrRefNo.IsReadOnly = false;
				colvarInventoryHdrRefNo.DefaultSetting = @"";
				
					colvarInventoryHdrRefNo.ForeignKeyTableName = "InventoryHdr";
				...
				colvarGSTAmount.DataType = DbType.Double;
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryDet",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<double?>(Columns.GSTAmount); }
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this InventoryDet
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InventoryHdr ActiveRecord object related to this InventoryDet
		/// 
		/// </summary>
		public PowerPOS.InventoryHdr InventoryHdr
		{
			get { return PowerPOS.InventoryHdr.FetchByID(this.InventoryHdrRefNo); }
			set { SetColumnValue("InventoryHdrRefNo", value.InventoryHdrRefNo); }
		}
		...
		/// </summary>
		public static void Insert(string varInventoryDetRefNo,string varItemNo,string varInventoryHdrRefNo,DateTime? varExpiryDate,decimal? varQuantity,decimal? varRemainingQty,decimal varFactoryPrice,double varGst,decimal varCostOfGoods,string varStockInRefNo,bool varIsDiscrepancy,string varRemark,decimal? varDiscount,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int varBalanceBefore,int varBalanceAfter,bool? varDeleted,decimal? varCostPriceByItemInvLoc,decimal? varCostPriceByItem,double? varGSTAmount,decimal? varCostPriceByItemInvGroup)
		{
		...
		/// </summary>
		public static void Update(string varInventoryDetRefNo,string varItemNo,string varInventoryHdrRefNo,DateTime? varExpiryDate,decimal? varQuantity,decimal? varRemainingQty,decimal varFactoryPrice,double varGst,decimal varCostOfGoods,string varStockInRefNo,bool varIsDiscrepancy,string varRemark,decimal? varDiscount,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int varBalanceBefore,int varBalanceAfter,bool? varDeleted,decimal? varCostPriceByItemInvLoc,decimal? varCostPriceByItem,double? varGSTAmount,decimal? varCostPriceByItemInvGroup)
		{
			InventoryDet item = new InventoryDet();
