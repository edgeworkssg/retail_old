...
{
	/// <summary>
	/// Strongly-typed collection for the LoginActivity class.
	/// </summary>
    [Serializable]
	public partial class LoginActivityCollection : ActiveList<LoginActivity, LoginActivityCollection>
	{	   
		public LoginActivityCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LoginActivityCollection</returns>
		public LoginActivityCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the LoginActivity table.
	/// </summary>
	[Serializable]
	public partial class LoginActivity : ActiveRecord<LoginActivity>, IActiveRecord
	{
		...
		public LoginActivity(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LoginActivity(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LoginActivity(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LoginActivity", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarLoginActivityID.IsPrimaryKey = true;
				colvarLoginActivityID.IsForeignKey = false;
				colvarLoginActivityID.IsReadOnly = false;
				
						colvarLoginActivityID.DefaultSetting = @"(newid())";
				colvarLoginActivityID.ForeignKeyTableName = "";
				...
				colvarLoginType.DefaultSetting = @"";
				colvarLoginType.ForeignKeyTableName = "";
				...
				colvarLoginDateTime.DefaultSetting = @"";
				colvarLoginDateTime.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("LoginActivity",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<Guid>(Columns.LoginActivityID); }
			set { SetColumnValue(Columns.LoginActivityID, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.LoginType); }
			set { SetColumnValue(Columns.LoginType, value); }
		}
		...
		{
			get { return GetColumnValue<DateTime>(Columns.LoginDateTime); }
			set { SetColumnValue(Columns.LoginDateTime, value); }
		}
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this LoginActivity
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(Guid varLoginActivityID,string varUserName,string varLoginType,DateTime varLoginDateTime,int varPointOfSaleID,string varCreatedBy,DateTime varCreatedOn,string varModifiedBy,DateTime varModifiedOn,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			LoginActivity item = new LoginActivity();
        ...
        public static TableSchema.TableColumn LoginActivityIDColumn
        {
        ...
        public static TableSchema.TableColumn LoginTypeColumn
        {
        ...
        public static TableSchema.TableColumn LoginDateTimeColumn
        {
