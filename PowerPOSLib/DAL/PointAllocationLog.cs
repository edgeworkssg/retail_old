...
{
	/// <summary>
	/// Strongly-typed collection for the PointAllocationLog class.
	/// </summary>
    [Serializable]
	public partial class PointAllocationLogCollection : ActiveList<PointAllocationLog, PointAllocationLogCollection>
	{	   
		public PointAllocationLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PointAllocationLogCollection</returns>
		public PointAllocationLogCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PointAllocationLog o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PointAllocationLog table.
	/// </summary>
	[Serializable]
	public partial class PointAllocationLog : ActiveRecord<PointAllocationLog>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public PointAllocationLog()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public PointAllocationLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PointAllocationLog(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PointAllocationLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PointAllocationLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarPointAllocID = new TableSchema.TableColumn(schema);
				colvarPointAllocID.ColumnName = "PointAllocID";
				colvarPointAllocID.DataType = DbType.Int32;
				colvarPointAllocID.MaxLength = 0;
				colvarPointAllocID.AutoIncrement = true;
				colvarPointAllocID.IsNullable = false;
				colvarPointAllocID.IsPrimaryKey = true;
				colvarPointAllocID.IsForeignKey = false;
				colvarPointAllocID.IsReadOnly = false;
				colvarPointAllocID.DefaultSetting = @"";
				colvarPointAllocID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPointAllocID);
				
				TableSchema.TableColumn colvarAllocationDate = new TableSchema.TableColumn(schema);
				colvarAllocationDate.ColumnName = "AllocationDate";
				colvarAllocationDate.DataType = DbType.DateTime;
				colvarAllocationDate.MaxLength = 0;
				colvarAllocationDate.AutoIncrement = false;
				colvarAllocationDate.IsNullable = false;
				colvarAllocationDate.IsPrimaryKey = false;
				colvarAllocationDate.IsForeignKey = false;
				colvarAllocationDate.IsReadOnly = false;
				colvarAllocationDate.DefaultSetting = @"";
				colvarAllocationDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAllocationDate);
				...
				DataService.Providers["PowerPOS"].AddSchema("PointAllocationLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("PointAllocID")]
		[Bindable(true)]
		public int PointAllocID 
		{
			get { return GetColumnValue<int>(Columns.PointAllocID); }
			set { SetColumnValue(Columns.PointAllocID, value); }
		}
		  
		[XmlAttribute("AllocationDate")]
		[Bindable(true)]
		public DateTime AllocationDate 
		{
			get { return GetColumnValue<DateTime>(Columns.AllocationDate); }
			set { SetColumnValue(Columns.AllocationDate, value); }
		}
		...
		/// </summary>
		public static void Update(int varPointAllocID,DateTime varAllocationDate,string varOrderHdrID,string varMembershipNo,decimal varPointAllocated,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid? varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			PointAllocationLog item = new PointAllocationLog();
			
				item.PointAllocID = varPointAllocID;
        ...
        public static TableSchema.TableColumn PointAllocIDColumn
        {
        ...
        public static TableSchema.TableColumn AllocationDateColumn
        {
		...
		{
			 public static string PointAllocID = @"PointAllocID";
			 public static string AllocationDate = @"AllocationDate";
