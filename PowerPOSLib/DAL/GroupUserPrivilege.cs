...
{
	/// <summary>
	/// Strongly-typed collection for the GroupUserPrivilege class.
	/// </summary>
    [Serializable]
	public partial class GroupUserPrivilegeCollection : ActiveList<GroupUserPrivilege, GroupUserPrivilegeCollection>
	{	   
		public GroupUserPrivilegeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>GroupUserPrivilegeCollection</returns>
		public GroupUserPrivilegeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                GroupUserPrivilege o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the GroupUserPrivilege table.
	/// </summary>
	[Serializable]
	public partial class GroupUserPrivilege : ActiveRecord<GroupUserPrivilege>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public GroupUserPrivilege()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public GroupUserPrivilege(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public GroupUserPrivilege(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public GroupUserPrivilege(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("GroupUserPrivilege", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarGroupUserPrivilegeID = new TableSchema.TableColumn(schema);
				colvarGroupUserPrivilegeID.ColumnName = "GroupUserPrivilegeID";
				colvarGroupUserPrivilegeID.DataType = DbType.Int32;
				colvarGroupUserPrivilegeID.MaxLength = 0;
				colvarGroupUserPrivilegeID.AutoIncrement = true;
				colvarGroupUserPrivilegeID.IsNullable = false;
				colvarGroupUserPrivilegeID.IsPrimaryKey = true;
				colvarGroupUserPrivilegeID.IsForeignKey = false;
				colvarGroupUserPrivilegeID.IsReadOnly = false;
				colvarGroupUserPrivilegeID.DefaultSetting = @"";
				colvarGroupUserPrivilegeID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarGroupUserPrivilegeID);
				...
				colvarGroupID.DefaultSetting = @"";
					...
					colvarGroupID.ForeignKeyTableName = "UserGroup";
				schema.Columns.Add(colvarGroupID);
				
				TableSchema.TableColumn colvarUserPrivilegeID = new TableSchema.TableColumn(schema);
				colvarUserPrivilegeID.ColumnName = "UserPrivilegeID";
				colvarUserPrivilegeID.DataType = DbType.Int32;
				colvarUserPrivilegeID.MaxLength = 0;
				colvarUserPrivilegeID.AutoIncrement = false;
				colvarUserPrivilegeID.IsNullable = false;
				colvarUserPrivilegeID.IsPrimaryKey = false;
				colvarUserPrivilegeID.IsForeignKey = true;
				colvarUserPrivilegeID.IsReadOnly = false;
				colvarUserPrivilegeID.DefaultSetting = @"";
				
					colvarUserPrivilegeID.ForeignKeyTableName = "UserPrivilege";
				schema.Columns.Add(colvarUserPrivilegeID);
				...
				DataService.Providers["PowerPOS"].AddSchema("GroupUserPrivilege",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("GroupUserPrivilegeID")]
		[Bindable(true)]
		public int GroupUserPrivilegeID 
		{
			get { return GetColumnValue<int>(Columns.GroupUserPrivilegeID); }
			set { SetColumnValue(Columns.GroupUserPrivilegeID, value); }
		}
		...
		[XmlAttribute("UserPrivilegeID")]
		[Bindable(true)]
		public int UserPrivilegeID 
		{
			get { return GetColumnValue<int>(Columns.UserPrivilegeID); }
			set { SetColumnValue(Columns.UserPrivilegeID, value); }
		}
		...
		/// <summary>
		/// Returns a UserGroup ActiveRecord object related to this GroupUserPrivilege
		/// 
		/// </summary>
		public PowerPOS.UserGroup UserGroup
		{
			get { return PowerPOS.UserGroup.FetchByID(this.GroupID); }
			set { SetColumnValue("GroupID", value.GroupID); }
		}
		
		
		/// <summary>
		/// Returns a UserPrivilege ActiveRecord object related to this GroupUserPrivilege
		/// 
		/// </summary>
		public PowerPOS.UserPrivilege UserPrivilege
		{
			get { return PowerPOS.UserPrivilege.FetchByID(this.UserPrivilegeID); }
			set { SetColumnValue("UserPrivilegeID", value.UserPrivilegeID); }
		}
		...
		/// </summary>
		public static void Update(int varGroupUserPrivilegeID,int varGroupID,int varUserPrivilegeID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			GroupUserPrivilege item = new GroupUserPrivilege();
			
				item.GroupUserPrivilegeID = varGroupUserPrivilegeID;
        ...
        public static TableSchema.TableColumn GroupUserPrivilegeIDColumn
        {
        ...
        public static TableSchema.TableColumn UserPrivilegeIDColumn
        {
		...
		{
			 public static string GroupUserPrivilegeID = @"GroupUserPrivilegeID";
			 public static string GroupID = @"GroupID";
			 public static string UserPrivilegeID = @"UserPrivilegeID";
