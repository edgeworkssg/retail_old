...
namespace PowerPOS
{
    ...
    public partial class UserGroupController
    {
        ...
        public UserGroupCollection FetchByID(object GroupID)
        {
            UserGroupCollection coll = new UserGroupCollection().Where("GroupID", GroupID).Load();
            return coll;
        }
        ...
        {
            return (UserGroup.Delete(GroupID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object GroupID)
        {
            return (UserGroup.Destroy(GroupID) == 1);
        }
	    ...
	    public void Update(int GroupID,string GroupName,string GroupDescription,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    UserGroup item = new UserGroup();
	        item.MarkOld();
	        item.IsLoaded = true;
