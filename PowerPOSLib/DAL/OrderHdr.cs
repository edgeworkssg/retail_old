...
namespace PowerPOS
{
	...
	public partial class OrderHdr : ActiveRecord<OrderHdr>, IActiveRecord
	{
		...
		public PowerPOS.InstallmentCollection InstallmentRecords()
		{
			return new PowerPOS.InstallmentCollection().Where(Installment.Columns.OrderHdrId, OrderHdrID).Load();
		}
