...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailyProductSale class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductSaleCollection : ReadOnlyList<ViewDWDailyProductSale, ViewDWDailyProductSaleCollection>
    {        
        public ViewDWDailyProductSaleCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailyProductSales view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailyProductSale : ReadOnlyRecord<ViewDWDailyProductSale>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailyProductSales", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailyProductSales",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailyProductSale()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailyProductSale(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailyProductSale(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailyProductSale(string columnName, object columnValue)
        {
            SetSQLProps();
