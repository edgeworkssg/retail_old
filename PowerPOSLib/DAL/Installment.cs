...
{
	/// <summary>
	/// Strongly-typed collection for the Installment class.
	/// </summary>
    [Serializable]
	public partial class InstallmentCollection : ActiveList<Installment, InstallmentCollection>
	{	   
		public InstallmentCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InstallmentCollection</returns>
		public InstallmentCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                Installment o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Installment table.
	/// </summary>
	[Serializable]
	public partial class Installment : ActiveRecord<Installment>, IActiveRecord
	{
		...
		public Installment(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Installment(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Installment(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Installment", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInstallmentRefNo.IsNullable = false;
				colvarInstallmentRefNo.IsPrimaryKey = true;
				colvarInstallmentRefNo.IsForeignKey = false;
				colvarInstallmentRefNo.IsReadOnly = false;
				colvarInstallmentRefNo.DefaultSetting = @"";
				colvarInstallmentRefNo.ForeignKeyTableName = "";
				...
				colvarInstallmentCreatedDate.DefaultSetting = @"";
				colvarInstallmentCreatedDate.ForeignKeyTableName = "";
				...
				TableSchema.TableColumn colvarCurrentBalance = new TableSchema.TableColumn(schema);
				colvarCurrentBalance.ColumnName = "CurrentBalance";
				colvarCurrentBalance.DataType = DbType.Currency;
				colvarCurrentBalance.MaxLength = 0;
				colvarCurrentBalance.AutoIncrement = false;
				colvarCurrentBalance.IsNullable = true;
				colvarCurrentBalance.IsPrimaryKey = false;
				colvarCurrentBalance.IsForeignKey = false;
				colvarCurrentBalance.IsReadOnly = false;
				colvarCurrentBalance.DefaultSetting = @"";
				colvarCurrentBalance.ForeignKeyTableName = "";
				schema.Columns.Add(colvarCurrentBalance);
				...
				DataService.Providers["PowerPOS"].AddSchema("Installment",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<DateTime?>(Columns.InstallmentCreatedDate); }
			set { SetColumnValue(Columns.InstallmentCreatedDate, value); }
		}
		...
		{
			get { return GetColumnValue<decimal?>(Columns.CurrentBalance); }
			set { SetColumnValue(Columns.CurrentBalance, value); }
		}
		...
		public PowerPOS.InstallmentDetailCollection InstallmentDetailRecords()
		{
			return new PowerPOS.InstallmentDetailCollection().Where(InstallmentDetail.Columns.InstallmentRefNo, InstallmentRefNo).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a OrderHdr ActiveRecord object related to this Installment
		/// 
		/// </summary>
		...
		public static void Insert(string varInstallmentRefNo,string varOrderHdrId,string varMembershipNo,DateTime? varInstallmentCreatedDate,decimal varTotalAmount,string varRemark,string varCreatedBy,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,DateTime? varCreatedOn,decimal? varCurrentBalance,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.InstallmentCreatedDate = varInstallmentCreatedDate;
			...
			item.CurrentBalance = varCurrentBalance;
		...
		/// </summary>
		public static void Update(string varInstallmentRefNo,string varOrderHdrId,string varMembershipNo,DateTime? varInstallmentCreatedDate,decimal varTotalAmount,string varRemark,string varCreatedBy,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,DateTime? varCreatedOn,decimal? varCurrentBalance,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			Installment item = new Installment();
        ...
        public static TableSchema.TableColumn InstallmentCreatedDateColumn
        {
        ...
        public static TableSchema.TableColumn CurrentBalanceColumn
        {
