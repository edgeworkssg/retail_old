...
{
	/// <summary>
	/// Strongly-typed collection for the PromoDiscountTier class.
	/// </summary>
    [Serializable]
	public partial class PromoDiscountTierCollection : ActiveList<PromoDiscountTier, PromoDiscountTierCollection>
	{	   
		public PromoDiscountTierCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>PromoDiscountTierCollection</returns>
		public PromoDiscountTierCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                PromoDiscountTier o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the PromoDiscountTier table.
	/// </summary>
	[Serializable]
	public partial class PromoDiscountTier : ActiveRecord<PromoDiscountTier>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public PromoDiscountTier()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public PromoDiscountTier(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public PromoDiscountTier(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public PromoDiscountTier(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PromoDiscountTier", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarDiscountTierID = new TableSchema.TableColumn(schema);
				colvarDiscountTierID.ColumnName = "DiscountTierID";
				colvarDiscountTierID.DataType = DbType.Int32;
				colvarDiscountTierID.MaxLength = 0;
				colvarDiscountTierID.AutoIncrement = true;
				colvarDiscountTierID.IsNullable = false;
				colvarDiscountTierID.IsPrimaryKey = true;
				colvarDiscountTierID.IsForeignKey = false;
				colvarDiscountTierID.IsReadOnly = false;
				colvarDiscountTierID.DefaultSetting = @"";
				colvarDiscountTierID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarDiscountTierID);
				...
				TableSchema.TableColumn colvarWhichQty = new TableSchema.TableColumn(schema);
				colvarWhichQty.ColumnName = "WhichQty";
				colvarWhichQty.DataType = DbType.Int32;
				colvarWhichQty.MaxLength = 0;
				colvarWhichQty.AutoIncrement = false;
				colvarWhichQty.IsNullable = false;
				colvarWhichQty.IsPrimaryKey = false;
				colvarWhichQty.IsForeignKey = false;
				colvarWhichQty.IsReadOnly = false;
				colvarWhichQty.DefaultSetting = @"";
				colvarWhichQty.ForeignKeyTableName = "";
				schema.Columns.Add(colvarWhichQty);
				...
				DataService.Providers["PowerPOS"].AddSchema("PromoDiscountTier",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("DiscountTierID")]
		[Bindable(true)]
		public int DiscountTierID 
		{
			get { return GetColumnValue<int>(Columns.DiscountTierID); }
			set { SetColumnValue(Columns.DiscountTierID, value); }
		}
		...
		[XmlAttribute("WhichQty")]
		[Bindable(true)]
		public int WhichQty 
		{
			get { return GetColumnValue<int>(Columns.WhichQty); }
			set { SetColumnValue(Columns.WhichQty, value); }
		}
		...
		/// <summary>
		/// Returns a PromoCampaignHdr ActiveRecord object related to this PromoDiscountTier
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varDiscountTierID,int varPromoCampaignHdrID,int varWhichQty,double varDiscount,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			PromoDiscountTier item = new PromoDiscountTier();
			
				item.DiscountTierID = varDiscountTierID;
        ...
        public static TableSchema.TableColumn DiscountTierIDColumn
        {
        ...
        public static TableSchema.TableColumn WhichQtyColumn
        {
		...
		{
			 public static string DiscountTierID = @"DiscountTierID";
			 public static string PromoCampaignHdrID = @"PromoCampaignHdrID";
			 public static string WhichQty = @"WhichQty";
