...
{
	/// <summary>
	/// Strongly-typed collection for the ActivePaymentSetting class.
	/// </summary>
    [Serializable]
	public partial class ActivePaymentSettingCollection : ActiveList<ActivePaymentSetting, ActivePaymentSettingCollection>
	{	   
		public ActivePaymentSettingCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ActivePaymentSettingCollection</returns>
		public ActivePaymentSettingCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ActivePaymentSetting o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ActivePaymentSetting table.
	/// </summary>
	[Serializable]
	public partial class ActivePaymentSetting : ActiveRecord<ActivePaymentSetting>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ActivePaymentSetting()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ActivePaymentSetting(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ActivePaymentSetting(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ActivePaymentSetting(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ActivePaymentSetting", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarActivePaymentSettingID = new TableSchema.TableColumn(schema);
				colvarActivePaymentSettingID.ColumnName = "ActivePaymentSettingID";
				colvarActivePaymentSettingID.DataType = DbType.Int32;
				colvarActivePaymentSettingID.MaxLength = 0;
				colvarActivePaymentSettingID.AutoIncrement = true;
				colvarActivePaymentSettingID.IsNullable = false;
				colvarActivePaymentSettingID.IsPrimaryKey = true;
				colvarActivePaymentSettingID.IsForeignKey = false;
				colvarActivePaymentSettingID.IsReadOnly = false;
				colvarActivePaymentSettingID.DefaultSetting = @"";
				colvarActivePaymentSettingID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarActivePaymentSettingID);
				...
				colvarPaymentID.DefaultSetting = @"";
					...
					colvarPaymentID.ForeignKeyTableName = "ActivePayment";
				...
				colvarSettingName.MaxLength = 500;
				...
				colvarSettingValue.MaxLength = 500;
				colvarSettingValue.AutoIncrement = false;
				colvarSettingValue.IsNullable = true;
				...
				DataService.Providers["PowerPOS"].AddSchema("ActivePaymentSetting",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ActivePaymentSettingID")]
		[Bindable(true)]
		public int ActivePaymentSettingID 
		{
			get { return GetColumnValue<int>(Columns.ActivePaymentSettingID); }
			set { SetColumnValue(Columns.ActivePaymentSettingID, value); }
		}
		...
		/// <summary>
		/// Returns a ActivePayment ActiveRecord object related to this ActivePaymentSetting
		/// 
		/// </summary>
		public PowerPOS.ActivePayment ActivePayment
		{
			get { return PowerPOS.ActivePayment.FetchByID(this.PaymentID); }
			set { SetColumnValue("PaymentID", value.PaymentID); }
		}
		
		
		/// <summary>
		/// Returns a Outlet ActiveRecord object related to this ActivePaymentSetting
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a PointOfSale ActiveRecord object related to this ActivePaymentSetting
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Update(int varActivePaymentSettingID,int? varPaymentID,string varPaymentName,int? varPointOfSaleID,string varOutletName,string varSettingName,string varSettingValue,string varRemarks,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ActivePaymentSetting item = new ActivePaymentSetting();
			
				item.ActivePaymentSettingID = varActivePaymentSettingID;
        ...
        public static TableSchema.TableColumn ActivePaymentSettingIDColumn
        {
		...
		{
			 public static string ActivePaymentSettingID = @"ActivePaymentSettingID";
