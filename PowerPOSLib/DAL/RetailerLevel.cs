...
{
	/// <summary>
	/// Strongly-typed collection for the RetailerLevel class.
	/// </summary>
    [Serializable]
	public partial class RetailerLevelCollection : ActiveList<RetailerLevel, RetailerLevelCollection>
	{	   
		public RetailerLevelCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>RetailerLevelCollection</returns>
		public RetailerLevelCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                RetailerLevel o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the RetailerLevel table.
	/// </summary>
	[Serializable]
	public partial class RetailerLevel : ActiveRecord<RetailerLevel>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public RetailerLevel()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public RetailerLevel(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public RetailerLevel(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public RetailerLevel(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RetailerLevel", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarRetailerLevelID = new TableSchema.TableColumn(schema);
				colvarRetailerLevelID.ColumnName = "RetailerLevelID";
				colvarRetailerLevelID.DataType = DbType.Int32;
				colvarRetailerLevelID.MaxLength = 0;
				colvarRetailerLevelID.AutoIncrement = true;
				colvarRetailerLevelID.IsNullable = false;
				colvarRetailerLevelID.IsPrimaryKey = true;
				colvarRetailerLevelID.IsForeignKey = false;
				colvarRetailerLevelID.IsReadOnly = false;
				colvarRetailerLevelID.DefaultSetting = @"";
				colvarRetailerLevelID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarRetailerLevelID);
				
				TableSchema.TableColumn colvarShopLevel = new TableSchema.TableColumn(schema);
				colvarShopLevel.ColumnName = "ShopLevel";
				colvarShopLevel.DataType = DbType.String;
				colvarShopLevel.MaxLength = 500;
				colvarShopLevel.AutoIncrement = false;
				colvarShopLevel.IsNullable = false;
				colvarShopLevel.IsPrimaryKey = false;
				colvarShopLevel.IsForeignKey = false;
				colvarShopLevel.IsReadOnly = false;
				colvarShopLevel.DefaultSetting = @"";
				colvarShopLevel.ForeignKeyTableName = "";
				schema.Columns.Add(colvarShopLevel);
				...
				DataService.Providers["PowerPOS"].AddSchema("RetailerLevel",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("RetailerLevelID")]
		[Bindable(true)]
		public int RetailerLevelID 
		{
			get { return GetColumnValue<int>(Columns.RetailerLevelID); }
			set { SetColumnValue(Columns.RetailerLevelID, value); }
		}
		  
		[XmlAttribute("ShopLevel")]
		[Bindable(true)]
		public string ShopLevel 
		{
			get { return GetColumnValue<string>(Columns.ShopLevel); }
			set { SetColumnValue(Columns.ShopLevel, value); }
		}
		...
		/// </summary>
		public static void Update(int varRetailerLevelID,string varShopLevel,string varShopNo,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			RetailerLevel item = new RetailerLevel();
			
				item.RetailerLevelID = varRetailerLevelID;
        ...
        public static TableSchema.TableColumn RetailerLevelIDColumn
        {
        ...
        public static TableSchema.TableColumn ShopLevelColumn
        {
		...
		{
			 public static string RetailerLevelID = @"RetailerLevelID";
			 public static string ShopLevel = @"ShopLevel";
