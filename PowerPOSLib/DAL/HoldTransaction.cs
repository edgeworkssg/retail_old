...
{
	/// <summary>
	/// Strongly-typed collection for the HoldTransaction class.
	/// </summary>
    [Serializable]
	public partial class HoldTransactionCollection : ActiveList<HoldTransaction, HoldTransactionCollection>
	{	   
		public HoldTransactionCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>HoldTransactionCollection</returns>
		public HoldTransactionCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                HoldTransaction o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the HoldTransaction table.
	/// </summary>
	[Serializable]
	public partial class HoldTransaction : ActiveRecord<HoldTransaction>, IActiveRecord
	{
		...
		public HoldTransaction(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public HoldTransaction(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public HoldTransaction(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("HoldTransaction", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarHoldGuid = new TableSchema.TableColumn(schema);
				colvarHoldGuid.ColumnName = "HoldGuid";
				colvarHoldGuid.DataType = DbType.Guid;
				colvarHoldGuid.MaxLength = 0;
				colvarHoldGuid.AutoIncrement = false;
				colvarHoldGuid.IsNullable = false;
				colvarHoldGuid.IsPrimaryKey = true;
				colvarHoldGuid.IsForeignKey = false;
				colvarHoldGuid.IsReadOnly = false;
				colvarHoldGuid.DefaultSetting = @"";
				colvarHoldGuid.ForeignKeyTableName = "";
				schema.Columns.Add(colvarHoldGuid);
				
				TableSchema.TableColumn colvarAppTime = new TableSchema.TableColumn(schema);
				colvarAppTime.ColumnName = "AppTime";
				colvarAppTime.DataType = DbType.DateTime;
				colvarAppTime.MaxLength = 0;
				colvarAppTime.AutoIncrement = false;
				colvarAppTime.IsNullable = false;
				colvarAppTime.IsPrimaryKey = false;
				colvarAppTime.IsForeignKey = false;
				colvarAppTime.IsReadOnly = false;
				colvarAppTime.DefaultSetting = @"";
				colvarAppTime.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAppTime);
				...
				TableSchema.TableColumn colvarMembershipName = new TableSchema.TableColumn(schema);
				colvarMembershipName.ColumnName = "MembershipName";
				colvarMembershipName.DataType = DbType.String;
				colvarMembershipName.MaxLength = 200;
				colvarMembershipName.AutoIncrement = false;
				colvarMembershipName.IsNullable = true;
				colvarMembershipName.IsPrimaryKey = false;
				colvarMembershipName.IsForeignKey = false;
				colvarMembershipName.IsReadOnly = false;
				colvarMembershipName.DefaultSetting = @"";
				colvarMembershipName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarMembershipName);
				...
				TableSchema.TableColumn colvarLineInfo = new TableSchema.TableColumn(schema);
				colvarLineInfo.ColumnName = "LineInfo";
				colvarLineInfo.DataType = DbType.String;
				colvarLineInfo.MaxLength = 100;
				colvarLineInfo.AutoIncrement = false;
				colvarLineInfo.IsNullable = true;
				colvarLineInfo.IsPrimaryKey = false;
				colvarLineInfo.IsForeignKey = false;
				colvarLineInfo.IsReadOnly = false;
				colvarLineInfo.DefaultSetting = @"";
				colvarLineInfo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarLineInfo);
				
				TableSchema.TableColumn colvarPOSControllerObject = new TableSchema.TableColumn(schema);
				colvarPOSControllerObject.ColumnName = "POSControllerObject";
				colvarPOSControllerObject.DataType = DbType.Binary;
				colvarPOSControllerObject.MaxLength = 2147483647;
				colvarPOSControllerObject.AutoIncrement = false;
				colvarPOSControllerObject.IsNullable = true;
				colvarPOSControllerObject.IsPrimaryKey = false;
				colvarPOSControllerObject.IsForeignKey = false;
				colvarPOSControllerObject.IsReadOnly = false;
				colvarPOSControllerObject.DefaultSetting = @"";
				colvarPOSControllerObject.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPOSControllerObject);
				...
				DataService.Providers["PowerPOS"].AddSchema("HoldTransaction",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("HoldGuid")]
		[Bindable(true)]
		public Guid HoldGuid 
		{
			get { return GetColumnValue<Guid>(Columns.HoldGuid); }
			set { SetColumnValue(Columns.HoldGuid, value); }
		}
		  
		[XmlAttribute("AppTime")]
		[Bindable(true)]
		public DateTime AppTime 
		{
			get { return GetColumnValue<DateTime>(Columns.AppTime); }
			set { SetColumnValue(Columns.AppTime, value); }
		}
		...
		[XmlAttribute("MembershipName")]
		[Bindable(true)]
		public string MembershipName 
		{
			get { return GetColumnValue<string>(Columns.MembershipName); }
			set { SetColumnValue(Columns.MembershipName, value); }
		}
		...
		[XmlAttribute("LineInfo")]
		[Bindable(true)]
		public string LineInfo 
		{
			get { return GetColumnValue<string>(Columns.LineInfo); }
			set { SetColumnValue(Columns.LineInfo, value); }
		}
		  
		[XmlAttribute("POSControllerObject")]
		[Bindable(true)]
		public byte[] POSControllerObject 
		{
			get { return GetColumnValue<byte[]>(Columns.POSControllerObject); }
			set { SetColumnValue(Columns.POSControllerObject, value); }
		}
		...
		/// </summary>
		public static void Update(Guid varHoldGuid,DateTime varAppTime,string varMembershipNo,string varMembershipName,string varNric,string varLineInfo,byte[] varPOSControllerObject,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			HoldTransaction item = new HoldTransaction();
        ...
        public static TableSchema.TableColumn HoldGuidColumn
        {
        ...
        public static TableSchema.TableColumn AppTimeColumn
        {
        ...
        public static TableSchema.TableColumn MembershipNameColumn
        {
        ...
        public static TableSchema.TableColumn LineInfoColumn
        {
        ...
        public static TableSchema.TableColumn POSControllerObjectColumn
        {
