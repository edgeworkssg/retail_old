...
{
	/// <summary>
	/// Strongly-typed collection for the MembershipPoint class.
	/// </summary>
    [Serializable]
	public partial class MembershipPointCollection : ActiveList<MembershipPoint, MembershipPointCollection>
	{	   
		public MembershipPointCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MembershipPointCollection</returns>
		public MembershipPointCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                MembershipPoint o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MembershipPoints table.
	/// </summary>
	[Serializable]
	public partial class MembershipPoint : ActiveRecord<MembershipPoint>, IActiveRecord
	{
		...
		public MembershipPoint(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MembershipPoint(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MembershipPoint(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MembershipPoints", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarPointID = new TableSchema.TableColumn(schema);
				colvarPointID.ColumnName = "PointID";
				colvarPointID.DataType = DbType.Int32;
				colvarPointID.MaxLength = 0;
				colvarPointID.AutoIncrement = true;
				colvarPointID.IsNullable = false;
				colvarPointID.IsPrimaryKey = true;
				colvarPointID.IsForeignKey = false;
				colvarPointID.IsReadOnly = false;
				colvarPointID.DefaultSetting = @"";
				colvarPointID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarPointID);
				
				TableSchema.TableColumn colvarStartValidPeriod = new TableSchema.TableColumn(schema);
				colvarStartValidPeriod.ColumnName = "StartValidPeriod";
				colvarStartValidPeriod.DataType = DbType.DateTime;
				colvarStartValidPeriod.MaxLength = 0;
				colvarStartValidPeriod.AutoIncrement = false;
				colvarStartValidPeriod.IsNullable = false;
				colvarStartValidPeriod.IsPrimaryKey = false;
				colvarStartValidPeriod.IsForeignKey = false;
				colvarStartValidPeriod.IsReadOnly = false;
				colvarStartValidPeriod.DefaultSetting = @"";
				colvarStartValidPeriod.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStartValidPeriod);
				
				TableSchema.TableColumn colvarEndValidPeriod = new TableSchema.TableColumn(schema);
				colvarEndValidPeriod.ColumnName = "EndValidPeriod";
				colvarEndValidPeriod.DataType = DbType.DateTime;
				colvarEndValidPeriod.MaxLength = 0;
				colvarEndValidPeriod.AutoIncrement = false;
				colvarEndValidPeriod.IsNullable = false;
				colvarEndValidPeriod.IsPrimaryKey = false;
				colvarEndValidPeriod.IsForeignKey = false;
				colvarEndValidPeriod.IsReadOnly = false;
				colvarEndValidPeriod.DefaultSetting = @"";
				colvarEndValidPeriod.ForeignKeyTableName = "";
				schema.Columns.Add(colvarEndValidPeriod);
				...
				colvarMembershipNo.MaxLength = 15;
				...
				DataService.Providers["PowerPOS"].AddSchema("MembershipPoints",schema);
			}
		}
		#endregion
		...
		public int PointID 
		{
			get { return GetColumnValue<int>(Columns.PointID); }
			set { SetColumnValue(Columns.PointID, value); }
		}
		  
		[XmlAttribute("StartValidPeriod")]
		[Bindable(true)]
		public DateTime StartValidPeriod 
		{
			get { return GetColumnValue<DateTime>(Columns.StartValidPeriod); }
			set { SetColumnValue(Columns.StartValidPeriod, value); }
		}
		  
		[XmlAttribute("EndValidPeriod")]
		[Bindable(true)]
		public DateTime EndValidPeriod 
		{
			get { return GetColumnValue<DateTime>(Columns.EndValidPeriod); }
			set { SetColumnValue(Columns.EndValidPeriod, value); }
		}
		...
		/// </summary>
		public static void Update(int varPointID,DateTime varStartValidPeriod,DateTime varEndValidPeriod,string varMembershipNo,decimal varPoints,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			MembershipPoint item = new MembershipPoint();
			
				item.PointID = varPointID;
        ...
        public static TableSchema.TableColumn PointIDColumn
        {
        ...
        public static TableSchema.TableColumn StartValidPeriodColumn
        {
        ...
        public static TableSchema.TableColumn EndValidPeriodColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string StartValidPeriod = @"StartValidPeriod";
			 public static string EndValidPeriod = @"EndValidPeriod";
