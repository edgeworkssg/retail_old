...
namespace PowerPOS
{
	...
	public partial class Rating : ActiveRecord<Rating>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int? varPosid,int? varRatingX,string varStaff,DateTime? varTimestamp,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUniqueId)
		{
		...
		/// </summary>
		public static void Update(int varRatingID,int? varPosid,int? varRatingX,string varStaff,DateTime? varTimestamp,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUniqueId)
		{
			Rating item = new Rating();
