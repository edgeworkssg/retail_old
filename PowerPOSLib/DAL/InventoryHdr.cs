...
{
	/// <summary>
	/// Strongly-typed collection for the InventoryHdr class.
	/// </summary>
    [Serializable]
	public partial class InventoryHdrCollection : ActiveList<InventoryHdr, InventoryHdrCollection>
	{	   
		public InventoryHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>InventoryHdrCollection</returns>
		public InventoryHdrCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                InventoryHdr o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the InventoryHdr table.
	/// </summary>
	[Serializable]
	public partial class InventoryHdr : ActiveRecord<InventoryHdr>, IActiveRecord
	{
		...
		public InventoryHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public InventoryHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public InventoryHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("InventoryHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarInventoryHdrRefNo.IsPrimaryKey = true;
				...
				colvarStockOutReasonID.IsForeignKey = true;
				colvarStockOutReasonID.IsReadOnly = false;
				colvarStockOutReasonID.DefaultSetting = @"";
				
					colvarStockOutReasonID.ForeignKeyTableName = "InventoryStockOutReason";
				...
				colvarPurchaseOrderNo.DefaultSetting = @"";
				colvarPurchaseOrderNo.ForeignKeyTableName = "";
				...
				colvarDeliveryOrderNo.DefaultSetting = @"";
				colvarDeliveryOrderNo.ForeignKeyTableName = "";
				...
				colvarSupplier.DefaultSetting = @"";
				colvarSupplier.ForeignKeyTableName = "";
				...
				colvarFreightCharge.IsReadOnly = false;
						...
						colvarFreightCharge.DefaultSetting = @"((0))";
				colvarFreightCharge.ForeignKeyTableName = "";
				...
				colvarDeliveryCharge.IsReadOnly = false;
						...
						colvarDeliveryCharge.DefaultSetting = @"((0))";
				...
				colvarTmpSavedData.DefaultSetting = @"";
				colvarTmpSavedData.ForeignKeyTableName = "";
				...
				DataService.Providers["PowerPOS"].AddSchema("InventoryHdr",schema);
			}
		}
		#endregion
		...
		{
			get { return GetColumnValue<double>(Columns.ExchangeRate); }
		...
		{
			get { return GetColumnValue<string>(Columns.PurchaseOrderNo); }
			set { SetColumnValue(Columns.PurchaseOrderNo, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.DeliveryOrderNo); }
			set { SetColumnValue(Columns.DeliveryOrderNo, value); }
		}
		...
		{
			get { return GetColumnValue<string>(Columns.Supplier); }
			set { SetColumnValue(Columns.Supplier, value); }
		}
		...
		{
			get { return GetColumnValue<decimal?>(Columns.FreightCharge); }
			set { SetColumnValue(Columns.FreightCharge, value); }
		}
		...
		public decimal? DeliveryCharge 
		{
			...
			set { SetColumnValue(Columns.DeliveryCharge, value); }
		}
		...
		{
			get { return GetColumnValue<int?>(Columns.TmpSavedData); }
			set { SetColumnValue(Columns.TmpSavedData, value); }
		}
		...
		{
			return new PowerPOS.InventoryDetCollection().Where(InventoryDet.Columns.InventoryHdrRefNo, InventoryHdrRefNo).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a Currency ActiveRecord object related to this InventoryHdr
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Department ActiveRecord object related to this InventoryHdr
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this InventoryHdr
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a InventoryStockOutReason ActiveRecord object related to this InventoryHdr
		/// 
		/// </summary>
		public PowerPOS.InventoryStockOutReason InventoryStockOutReason
		{
			get { return PowerPOS.InventoryStockOutReason.FetchByID(this.StockOutReasonID); }
			set { SetColumnValue("StockOutReasonID", value.ReasonID); }
		}
		...
		/// </summary>
		public static void Insert(string varInventoryHdrRefNo,DateTime varInventoryDate,string varUserName,string varMovementType,int? varStockOutReasonID,double varExchangeRate,string varPurchaseOrderNo,string varInvoiceNo,string varDeliveryOrderNo,string varSupplier,decimal? varFreightCharge,decimal? varDeliveryCharge,decimal? varTax,decimal? varDiscount,string varRemark,int? varInventoryLocationID,int? varDepartmentID,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varCurrencyId,int? varTmpSavedData,bool? varDeleted)
		{
			InventoryHdr item = new InventoryHdr();
			...
			item.PurchaseOrderNo = varPurchaseOrderNo;
			
			item.InvoiceNo = varInvoiceNo;
			
			item.DeliveryOrderNo = varDeliveryOrderNo;
			
			item.Supplier = varSupplier;
			
			item.FreightCharge = varFreightCharge;
			
			item.DeliveryCharge = varDeliveryCharge;
			...
			item.TmpSavedData = varTmpSavedData;
		...
		/// </summary>
		public static void Update(string varInventoryHdrRefNo,DateTime varInventoryDate,string varUserName,string varMovementType,int? varStockOutReasonID,double varExchangeRate,string varPurchaseOrderNo,string varInvoiceNo,string varDeliveryOrderNo,string varSupplier,decimal? varFreightCharge,decimal? varDeliveryCharge,decimal? varTax,decimal? varDiscount,string varRemark,int? varInventoryLocationID,int? varDepartmentID,DateTime? varCreatedOn,DateTime? varModifiedOn,string varCreatedBy,string varModifiedBy,Guid varUniqueID,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varCurrencyId,int? varTmpSavedData,bool? varDeleted)
		{
			InventoryHdr item = new InventoryHdr();
        ...
        public static TableSchema.TableColumn PurchaseOrderNoColumn
        {
        ...
        public static TableSchema.TableColumn DeliveryOrderNoColumn
        {
        ...
        public static TableSchema.TableColumn SupplierColumn
        {
        ...
        public static TableSchema.TableColumn FreightChargeColumn
        {
        ...
        public static TableSchema.TableColumn TmpSavedDataColumn
        {
