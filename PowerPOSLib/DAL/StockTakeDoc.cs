...
{
	/// <summary>
	/// Strongly-typed collection for the StockTakeDoc class.
	/// </summary>
    [Serializable]
	public partial class StockTakeDocCollection : ActiveList<StockTakeDoc, StockTakeDocCollection>
	{	   
		public StockTakeDocCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>StockTakeDocCollection</returns>
		public StockTakeDocCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                StockTakeDoc o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the StockTakeDoc table.
	/// </summary>
	[Serializable]
	public partial class StockTakeDoc : ActiveRecord<StockTakeDoc>, IActiveRecord
	{
		...
		public StockTakeDoc(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public StockTakeDoc(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public StockTakeDoc(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("StockTakeDoc", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarStockTakeDocRefNo = new TableSchema.TableColumn(schema);
				colvarStockTakeDocRefNo.ColumnName = "StockTakeDocRefNo";
				colvarStockTakeDocRefNo.DataType = DbType.AnsiString;
				colvarStockTakeDocRefNo.MaxLength = 50;
				colvarStockTakeDocRefNo.AutoIncrement = false;
				colvarStockTakeDocRefNo.IsNullable = false;
				colvarStockTakeDocRefNo.IsPrimaryKey = true;
				colvarStockTakeDocRefNo.IsForeignKey = false;
				colvarStockTakeDocRefNo.IsReadOnly = false;
				colvarStockTakeDocRefNo.DefaultSetting = @"";
				colvarStockTakeDocRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStockTakeDocRefNo);
				
				TableSchema.TableColumn colvarStockTakeDocDate = new TableSchema.TableColumn(schema);
				colvarStockTakeDocDate.ColumnName = "StockTakeDocDate";
				colvarStockTakeDocDate.DataType = DbType.DateTime;
				colvarStockTakeDocDate.MaxLength = 0;
				colvarStockTakeDocDate.AutoIncrement = false;
				colvarStockTakeDocDate.IsNullable = false;
				colvarStockTakeDocDate.IsPrimaryKey = false;
				colvarStockTakeDocDate.IsForeignKey = false;
				colvarStockTakeDocDate.IsReadOnly = false;
				colvarStockTakeDocDate.DefaultSetting = @"";
				colvarStockTakeDocDate.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStockTakeDocDate);
				
				TableSchema.TableColumn colvarStockTakeType = new TableSchema.TableColumn(schema);
				colvarStockTakeType.ColumnName = "StockTakeType";
				colvarStockTakeType.DataType = DbType.AnsiString;
				colvarStockTakeType.MaxLength = 50;
				colvarStockTakeType.AutoIncrement = false;
				colvarStockTakeType.IsNullable = false;
				colvarStockTakeType.IsPrimaryKey = false;
				colvarStockTakeType.IsForeignKey = false;
				colvarStockTakeType.IsReadOnly = false;
				colvarStockTakeType.DefaultSetting = @"";
				colvarStockTakeType.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStockTakeType);
				...
				DataService.Providers["PowerPOS"].AddSchema("StockTakeDoc",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("StockTakeDocRefNo")]
		[Bindable(true)]
		public string StockTakeDocRefNo 
		{
			get { return GetColumnValue<string>(Columns.StockTakeDocRefNo); }
			set { SetColumnValue(Columns.StockTakeDocRefNo, value); }
		}
		  
		[XmlAttribute("StockTakeDocDate")]
		[Bindable(true)]
		public DateTime StockTakeDocDate 
		{
			get { return GetColumnValue<DateTime>(Columns.StockTakeDocDate); }
			set { SetColumnValue(Columns.StockTakeDocDate, value); }
		}
		  
		[XmlAttribute("StockTakeType")]
		[Bindable(true)]
		public string StockTakeType 
		{
			get { return GetColumnValue<string>(Columns.StockTakeType); }
			set { SetColumnValue(Columns.StockTakeType, value); }
		}
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this StockTakeDoc
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varStockTakeDocRefNo,DateTime varStockTakeDocDate,string varStockTakeType,int? varInventoryLocationID,string varStatus,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			StockTakeDoc item = new StockTakeDoc();
			
			item.StockTakeDocRefNo = varStockTakeDocRefNo;
			
			item.StockTakeDocDate = varStockTakeDocDate;
			
			item.StockTakeType = varStockTakeType;
		...
		/// </summary>
		public static void Update(string varStockTakeDocRefNo,DateTime varStockTakeDocDate,string varStockTakeType,int? varInventoryLocationID,string varStatus,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			StockTakeDoc item = new StockTakeDoc();
        ...
        public static TableSchema.TableColumn StockTakeDocRefNoColumn
        {
        ...
        public static TableSchema.TableColumn StockTakeDocDateColumn
        {
        ...
        public static TableSchema.TableColumn StockTakeTypeColumn
        {
		...
		{
			 public static string StockTakeDocRefNo = @"StockTakeDocRefNo";
			 public static string StockTakeDocDate = @"StockTakeDocDate";
			 public static string StockTakeType = @"StockTakeType";
