...
{
    /// <summary>
    /// Controller class for InvoiceSequenceNo
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class InvoiceSequenceNoController
    {
        // Preload our schema..
        InvoiceSequenceNo thisSchemaLoad = new InvoiceSequenceNo();
        ...
        public InvoiceSequenceNoCollection FetchAll()
        {
            InvoiceSequenceNoCollection coll = new InvoiceSequenceNoCollection();
            Query qry = new Query(InvoiceSequenceNo.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public InvoiceSequenceNoCollection FetchByID(object InvoiceNoID)
        {
            InvoiceSequenceNoCollection coll = new InvoiceSequenceNoCollection().Where("InvoiceNoID", InvoiceNoID).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public InvoiceSequenceNoCollection FetchByQuery(Query qry)
        {
            InvoiceSequenceNoCollection coll = new InvoiceSequenceNoCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object InvoiceNoID)
        {
            return (InvoiceSequenceNo.Delete(InvoiceNoID) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object InvoiceNoID)
        {
            return (InvoiceSequenceNo.Destroy(InvoiceNoID) == 1);
        }
	    ...
	    public void Update(int InvoiceNoID,int? InventoryLocationID,string InventoryLocationCode,int? CurrentNo,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn,bool? Deleted,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    InvoiceSequenceNo item = new InvoiceSequenceNo();
	        item.MarkOld();
	        item.IsLoaded = true;
		    
			item.InvoiceNoID = InvoiceNoID;
