...
{
	/// <summary>
	/// Strongly-typed collection for the Outlet class.
	/// </summary>
    [Serializable]
	public partial class OutletCollection : ActiveList<Outlet, OutletCollection>
	{	   
		public OutletCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>OutletCollection</returns>
		public OutletCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Outlet table.
	/// </summary>
	[Serializable]
	public partial class Outlet : ActiveRecord<Outlet>, IActiveRecord
	{
		...
		public Outlet(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Outlet(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Outlet", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarOutletName.IsPrimaryKey = true;
				...
				TableSchema.TableColumn colvarOutletAddress = new TableSchema.TableColumn(schema);
				colvarOutletAddress.ColumnName = "OutletAddress";
				colvarOutletAddress.DataType = DbType.AnsiString;
				colvarOutletAddress.MaxLength = 250;
				colvarOutletAddress.AutoIncrement = false;
				colvarOutletAddress.IsNullable = false;
				colvarOutletAddress.IsPrimaryKey = false;
				colvarOutletAddress.IsForeignKey = false;
				colvarOutletAddress.IsReadOnly = false;
				colvarOutletAddress.DefaultSetting = @"";
				colvarOutletAddress.ForeignKeyTableName = "";
				schema.Columns.Add(colvarOutletAddress);
				...
				DataService.Providers["PowerPOS"].AddSchema("Outlet",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("OutletAddress")]
		[Bindable(true)]
		public string OutletAddress 
		{
			get { return GetColumnValue<string>(Columns.OutletAddress); }
			set { SetColumnValue(Columns.OutletAddress, value); }
		}
		...
		public PowerPOS.AppSettingCollection AppSettingRecords()
		{
			return new PowerPOS.AppSettingCollection().Where(AppSetting.Columns.OutletName, OutletName).Load();
		}
		public PowerPOS.RoomCollection Rooms()
		{
			return new PowerPOS.RoomCollection().Where(Room.Columns.OutletName, OutletName).Load();
		}
		public PowerPOS.PointOfSaleCollection PointOfSaleRecords()
		{
			return new PowerPOS.PointOfSaleCollection().Where(PointOfSale.Columns.OutletName, OutletName).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this Outlet
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varOutletName,string varOutletAddress,int? varInventoryLocationID,string varPhoneNo,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varOutletGroupID)
		{
			Outlet item = new Outlet();
			
			item.OutletName = varOutletName;
			
			item.OutletAddress = varOutletAddress;
		...
		/// </summary>
		public static void Update(string varOutletName,string varOutletAddress,int? varInventoryLocationID,string varPhoneNo,string varRemark,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5,int? varOutletGroupID)
		{
			Outlet item = new Outlet();
        ...
        public static TableSchema.TableColumn OutletAddressColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string OutletAddress = @"OutletAddress";
