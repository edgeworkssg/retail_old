...
{
	/// <summary>
	/// Strongly-typed collection for the StockTransferHdr class.
	/// </summary>
    [Serializable]
	public partial class StockTransferHdrCollection : ActiveList<StockTransferHdr, StockTransferHdrCollection>
	{	   
		public StockTransferHdrCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>StockTransferHdrCollection</returns>
		public StockTransferHdrCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                StockTransferHdr o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the StockTransferHdr table.
	/// </summary>
	[Serializable]
	public partial class StockTransferHdr : ActiveRecord<StockTransferHdr>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public StockTransferHdr()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public StockTransferHdr(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public StockTransferHdr(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public StockTransferHdr(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("StockTransferHdr", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarStockTransferHdrRefNo = new TableSchema.TableColumn(schema);
				colvarStockTransferHdrRefNo.ColumnName = "StockTransferHdrRefNo";
				colvarStockTransferHdrRefNo.DataType = DbType.AnsiString;
				colvarStockTransferHdrRefNo.MaxLength = 50;
				colvarStockTransferHdrRefNo.AutoIncrement = false;
				colvarStockTransferHdrRefNo.IsNullable = false;
				colvarStockTransferHdrRefNo.IsPrimaryKey = true;
				colvarStockTransferHdrRefNo.IsForeignKey = false;
				colvarStockTransferHdrRefNo.IsReadOnly = false;
				colvarStockTransferHdrRefNo.DefaultSetting = @"";
				colvarStockTransferHdrRefNo.ForeignKeyTableName = "";
				schema.Columns.Add(colvarStockTransferHdrRefNo);
				...
				colvarTransferDate.IsNullable = false;
				...
				colvarRequiredDate.IsNullable = false;
				...
				TableSchema.TableColumn colvarTransferFromLocationID = new TableSchema.TableColumn(schema);
				colvarTransferFromLocationID.ColumnName = "TransferFromLocationID";
				colvarTransferFromLocationID.DataType = DbType.Int32;
				colvarTransferFromLocationID.MaxLength = 0;
				colvarTransferFromLocationID.AutoIncrement = false;
				colvarTransferFromLocationID.IsNullable = true;
				colvarTransferFromLocationID.IsPrimaryKey = false;
				colvarTransferFromLocationID.IsForeignKey = true;
				colvarTransferFromLocationID.IsReadOnly = false;
				colvarTransferFromLocationID.DefaultSetting = @"";
				
					colvarTransferFromLocationID.ForeignKeyTableName = "InventoryLocation";
				schema.Columns.Add(colvarTransferFromLocationID);
				
				TableSchema.TableColumn colvarTransferToLocationID = new TableSchema.TableColumn(schema);
				colvarTransferToLocationID.ColumnName = "TransferToLocationID";
				colvarTransferToLocationID.DataType = DbType.Int32;
				colvarTransferToLocationID.MaxLength = 0;
				colvarTransferToLocationID.AutoIncrement = false;
				colvarTransferToLocationID.IsNullable = true;
				colvarTransferToLocationID.IsPrimaryKey = false;
				colvarTransferToLocationID.IsForeignKey = true;
				colvarTransferToLocationID.IsReadOnly = false;
				colvarTransferToLocationID.DefaultSetting = @"";
				
					colvarTransferToLocationID.ForeignKeyTableName = "InventoryLocation";
				schema.Columns.Add(colvarTransferToLocationID);
				...
				DataService.Providers["PowerPOS"].AddSchema("StockTransferHdr",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("StockTransferHdrRefNo")]
		[Bindable(true)]
		public string StockTransferHdrRefNo 
		{
			get { return GetColumnValue<string>(Columns.StockTransferHdrRefNo); }
			set { SetColumnValue(Columns.StockTransferHdrRefNo, value); }
		}
		...
		[XmlAttribute("TransferFromLocationID")]
		[Bindable(true)]
		public int? TransferFromLocationID 
		{
			get { return GetColumnValue<int?>(Columns.TransferFromLocationID); }
			set { SetColumnValue(Columns.TransferFromLocationID, value); }
		}
		  
		[XmlAttribute("TransferToLocationID")]
		[Bindable(true)]
		public int? TransferToLocationID 
		{
			get { return GetColumnValue<int?>(Columns.TransferToLocationID); }
			set { SetColumnValue(Columns.TransferToLocationID, value); }
		}
		...
		public PowerPOS.StockTransferDetCollection StockTransferDetRecords()
		{
			return new PowerPOS.StockTransferDetCollection().Where(StockTransferDet.Columns.StockTransferHdrRefNo, StockTransferHdrRefNo).Load();
		}
		#endregion
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this StockTransferHdr
		/// 
		/// </summary>
		public PowerPOS.InventoryLocation InventoryLocation
		{
			get { return PowerPOS.InventoryLocation.FetchByID(this.TransferFromLocationID); }
			set { SetColumnValue("TransferFromLocationID", value.InventoryLocationID); }
		}
		...
		/// 
		/// </summary>
		public PowerPOS.InventoryLocation InventoryLocationToTransferToLocationID
		{
			get { return PowerPOS.InventoryLocation.FetchByID(this.TransferToLocationID); }
			set { SetColumnValue("TransferToLocationID", value.InventoryLocationID); }
		}
		...
		/// </summary>
		public static void Insert(string varStockTransferHdrRefNo,DateTime varTransferDate,DateTime varRequiredDate,int? varTransferFromLocationID,int? varTransferToLocationID,string varUserName,string varRemark,string varStatus,bool? varDeleted,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			StockTransferHdr item = new StockTransferHdr();
			
			item.StockTransferHdrRefNo = varStockTransferHdrRefNo;
			
			item.TransferDate = varTransferDate;
			
			item.RequiredDate = varRequiredDate;
			
			item.TransferFromLocationID = varTransferFromLocationID;
			
			item.TransferToLocationID = varTransferToLocationID;
		...
		/// </summary>
		public static void Update(string varStockTransferHdrRefNo,DateTime varTransferDate,DateTime varRequiredDate,int? varTransferFromLocationID,int? varTransferToLocationID,string varUserName,string varRemark,string varStatus,bool? varDeleted,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			StockTransferHdr item = new StockTransferHdr();
        ...
        public static TableSchema.TableColumn StockTransferHdrRefNoColumn
        {
        ...
        public static TableSchema.TableColumn TransferFromLocationIDColumn
        {
        ...
        public static TableSchema.TableColumn TransferToLocationIDColumn
        {
		...
		{
			 public static string StockTransferHdrRefNo = @"StockTransferHdrRefNo";
			 public static string TransferDate = @"TransferDate";
			 public static string RequiredDate = @"RequiredDate";
			 public static string TransferFromLocationID = @"TransferFromLocationID";
			 public static string TransferToLocationID = @"TransferToLocationID";
