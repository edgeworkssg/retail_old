...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewPromoMasterDetail class.
    /// </summary>
    [Serializable]
    public partial class ViewPromoMasterDetailCollection : ReadOnlyList<ViewPromoMasterDetail, ViewPromoMasterDetailCollection>
    {        
        public ViewPromoMasterDetailCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ViewPromoMasterDetail view.
    /// </summary>
    [Serializable]
    public partial class ViewPromoMasterDetail : ReadOnlyRecord<ViewPromoMasterDetail>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ViewPromoMasterDetail", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                DataService.Providers["PowerPOS"].AddSchema("ViewPromoMasterDetail",schema);
            }
        }
        #endregion
        ...
        public ViewPromoMasterDetail(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewPromoMasterDetail(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewPromoMasterDetail(string columnName, object columnValue)
        {
            SetSQLProps();
