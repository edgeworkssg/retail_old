...
{
    /// <summary>
    /// Controller class for SalesCommissionDetails
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class SalesCommissionDetailController
    {
        // Preload our schema..
        SalesCommissionDetail thisSchemaLoad = new SalesCommissionDetail();
        ...
        public SalesCommissionDetailCollection FetchAll()
        {
            SalesCommissionDetailCollection coll = new SalesCommissionDetailCollection();
            Query qry = new Query(SalesCommissionDetail.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesCommissionDetailCollection FetchByID(object Id)
        {
            SalesCommissionDetailCollection coll = new SalesCommissionDetailCollection().Where("ID", Id).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public SalesCommissionDetailCollection FetchByQuery(Query qry)
        {
            SalesCommissionDetailCollection coll = new SalesCommissionDetailCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        {
            return (SalesCommissionDetail.Delete(Id) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object Id)
        {
            return (SalesCommissionDetail.Destroy(Id) == 1);
        }
