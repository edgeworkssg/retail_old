...
{
    /// <summary>
    /// Controller class for Camera
    /// </summary>
    [System.ComponentModel.DataObject]
    public partial class CameraController
    {
        // Preload our schema..
        Camera thisSchemaLoad = new Camera();
        ...
        public CameraCollection FetchAll()
        {
            CameraCollection coll = new CameraCollection();
            Query qry = new Query(Camera.Schema);
            coll.LoadAndCloseReader(qry.ExecuteReader());
            return coll;
        }
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public CameraCollection FetchByID(object CameraId)
        {
            CameraCollection coll = new CameraCollection().Where("CameraId", CameraId).Load();
            return coll;
        }
		
		[DataObjectMethod(DataObjectMethodType.Select, false)]
        public CameraCollection FetchByQuery(Query qry)
        {
            CameraCollection coll = new CameraCollection();
            coll.LoadAndCloseReader(qry.ExecuteReader()); 
            return coll;
        ...
        public bool Delete(object CameraId)
        {
            return (Camera.Delete(CameraId) == 1);
        }
        [DataObjectMethod(DataObjectMethodType.Delete, false)]
        public bool Destroy(object CameraId)
        {
            return (Camera.Destroy(CameraId) == 1);
        }
	    ...
	    public void Update(int CameraId,string CameraIp,int CameraNo,int PointOfSaleID,DateTime? CreatedOn,string CreatedBy,DateTime? ModifiedOn,string ModifiedBy,string Userfld1,string Userfld2,string Userfld3,string Userfld4,string Userfld5,string Userfld6,string Userfld7,string Userfld8,string Userfld9,string Userfld10,bool? Userflag1,bool? Userflag2,bool? Userflag3,bool? Userflag4,bool? Userflag5,decimal? Userfloat1,decimal? Userfloat2,decimal? Userfloat3,decimal? Userfloat4,decimal? Userfloat5,int? Userint1,int? Userint2,int? Userint3,int? Userint4,int? Userint5)
	    {
		    Camera item = new Camera();
	        item.MarkOld();
	        item.IsLoaded = true;
