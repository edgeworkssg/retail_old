...
{
	/// <summary>
	/// Strongly-typed collection for the ItemTagStatusDetail class.
	/// </summary>
    [Serializable]
	public partial class ItemTagStatusDetailCollection : ActiveList<ItemTagStatusDetail, ItemTagStatusDetailCollection>
	{	   
		public ItemTagStatusDetailCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ItemTagStatusDetailCollection</returns>
		public ItemTagStatusDetailCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ItemTagStatusDetail o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the ItemTagStatusDetail table.
	/// </summary>
	[Serializable]
	public partial class ItemTagStatusDetail : ActiveRecord<ItemTagStatusDetail>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public ItemTagStatusDetail()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public ItemTagStatusDetail(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ItemTagStatusDetail(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ItemTagStatusDetail(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ItemTagStatusDetail", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarItemTagStatusDetailID = new TableSchema.TableColumn(schema);
				colvarItemTagStatusDetailID.ColumnName = "ItemTagStatusDetailID";
				colvarItemTagStatusDetailID.DataType = DbType.Guid;
				colvarItemTagStatusDetailID.MaxLength = 0;
				colvarItemTagStatusDetailID.AutoIncrement = false;
				colvarItemTagStatusDetailID.IsNullable = false;
				colvarItemTagStatusDetailID.IsPrimaryKey = true;
				colvarItemTagStatusDetailID.IsForeignKey = false;
				colvarItemTagStatusDetailID.IsReadOnly = false;
				colvarItemTagStatusDetailID.DefaultSetting = @"";
				colvarItemTagStatusDetailID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarItemTagStatusDetailID);
				...
				DataService.Providers["PowerPOS"].AddSchema("ItemTagStatusDetail",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("ItemTagStatusDetailID")]
		[Bindable(true)]
		public Guid ItemTagStatusDetailID 
		{
			get { return GetColumnValue<Guid>(Columns.ItemTagStatusDetailID); }
			set { SetColumnValue(Columns.ItemTagStatusDetailID, value); }
		}
		...
		/// <summary>
		/// Returns a InventoryLocation ActiveRecord object related to this ItemTagStatusDetail
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Item ActiveRecord object related to this ItemTagStatusDetail
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(Guid varItemTagStatusDetailID,string varItemNo,string varSerialNo,int? varInventoryLocationID,string varMovementType,string varInventoryDetRefNo,DateTime? varInventoryDate,int? varStockOutReasonID,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemTagStatusDetail item = new ItemTagStatusDetail();
			
			item.ItemTagStatusDetailID = varItemTagStatusDetailID;
		...
		/// </summary>
		public static void Update(Guid varItemTagStatusDetailID,string varItemNo,string varSerialNo,int? varInventoryLocationID,string varMovementType,string varInventoryDetRefNo,DateTime? varInventoryDate,int? varStockOutReasonID,string varRemark,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			ItemTagStatusDetail item = new ItemTagStatusDetail();
        ...
        public static TableSchema.TableColumn ItemTagStatusDetailIDColumn
        {
		...
		{
			 public static string ItemTagStatusDetailID = @"ItemTagStatusDetailID";
