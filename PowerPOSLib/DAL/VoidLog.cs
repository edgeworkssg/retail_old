...
{
	/// <summary>
	/// Strongly-typed collection for the VoidLog class.
	/// </summary>
    [Serializable]
	public partial class VoidLogCollection : ActiveList<VoidLog, VoidLogCollection>
	{	   
		public VoidLogCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>VoidLogCollection</returns>
		public VoidLogCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the VoidLog table.
	/// </summary>
	[Serializable]
	public partial class VoidLog : ActiveRecord<VoidLog>, IActiveRecord
	{
		...
		public VoidLog(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public VoidLog(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("VoidLog", TableType.Table, DataService.GetInstance("PowerPOS"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarVoidLogID = new TableSchema.TableColumn(schema);
				colvarVoidLogID.ColumnName = "VoidLogID";
				colvarVoidLogID.DataType = DbType.Int32;
				colvarVoidLogID.MaxLength = 0;
				colvarVoidLogID.AutoIncrement = true;
				colvarVoidLogID.IsNullable = false;
				colvarVoidLogID.IsPrimaryKey = true;
				colvarVoidLogID.IsForeignKey = false;
				colvarVoidLogID.IsReadOnly = false;
				colvarVoidLogID.DefaultSetting = @"";
				colvarVoidLogID.ForeignKeyTableName = "";
				schema.Columns.Add(colvarVoidLogID);
				...
				TableSchema.TableColumn colvarWitnessName = new TableSchema.TableColumn(schema);
				colvarWitnessName.ColumnName = "WitnessName";
				colvarWitnessName.DataType = DbType.AnsiString;
				colvarWitnessName.MaxLength = 50;
				colvarWitnessName.AutoIncrement = false;
				colvarWitnessName.IsNullable = false;
				colvarWitnessName.IsPrimaryKey = false;
				colvarWitnessName.IsForeignKey = false;
				colvarWitnessName.IsReadOnly = false;
				colvarWitnessName.DefaultSetting = @"";
				colvarWitnessName.ForeignKeyTableName = "";
				schema.Columns.Add(colvarWitnessName);
				
				TableSchema.TableColumn colvarIsVoiding = new TableSchema.TableColumn(schema);
				colvarIsVoiding.ColumnName = "IsVoiding";
				colvarIsVoiding.DataType = DbType.Boolean;
				colvarIsVoiding.MaxLength = 0;
				colvarIsVoiding.AutoIncrement = false;
				colvarIsVoiding.IsNullable = false;
				colvarIsVoiding.IsPrimaryKey = false;
				colvarIsVoiding.IsForeignKey = false;
				colvarIsVoiding.IsReadOnly = false;
				colvarIsVoiding.DefaultSetting = @"";
				colvarIsVoiding.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsVoiding);
				...
				DataService.Providers["PowerPOS"].AddSchema("VoidLog",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("VoidLogID")]
		[Bindable(true)]
		public int VoidLogID 
		{
			get { return GetColumnValue<int>(Columns.VoidLogID); }
			set { SetColumnValue(Columns.VoidLogID, value); }
		}
		...
		[XmlAttribute("WitnessName")]
		[Bindable(true)]
		public string WitnessName 
		{
			get { return GetColumnValue<string>(Columns.WitnessName); }
			set { SetColumnValue(Columns.WitnessName, value); }
		}
		  
		[XmlAttribute("IsVoiding")]
		[Bindable(true)]
		public bool IsVoiding 
		{
			get { return GetColumnValue<bool>(Columns.IsVoiding); }
			set { SetColumnValue(Columns.IsVoiding, value); }
		}
		...
		public static void Insert(string varOrderHdrID,int varPointOfSaleID,string varCashierName,string varWitnessName,bool varIsVoiding,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			...
			item.WitnessName = varWitnessName;
			
			item.IsVoiding = varIsVoiding;
		...
		/// </summary>
		public static void Update(int varVoidLogID,string varOrderHdrID,int varPointOfSaleID,string varCashierName,string varWitnessName,bool varIsVoiding,DateTime? varCreatedOn,string varCreatedBy,DateTime? varModifiedOn,string varModifiedBy,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			VoidLog item = new VoidLog();
			
				item.VoidLogID = varVoidLogID;
        ...
        public static TableSchema.TableColumn VoidLogIDColumn
        {
        ...
        public static TableSchema.TableColumn WitnessNameColumn
        {
        ...
        public static TableSchema.TableColumn IsVoidingColumn
        {
		...
		{
			 public static string VoidLogID = @"VoidLogID";
			 ...
			 public static string WitnessName = @"WitnessName";
			 public static string IsVoiding = @"IsVoiding";
