...
{
	/// <summary>
	/// Strongly-typed collection for the MembershipGroup class.
	/// </summary>
    [Serializable]
	public partial class MembershipGroupCollection : ActiveList<MembershipGroup, MembershipGroupCollection>
	{	   
		public MembershipGroupCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MembershipGroupCollection</returns>
		public MembershipGroupCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                MembershipGroup o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MembershipGroup table.
	/// </summary>
	[Serializable]
	public partial class MembershipGroup : ActiveRecord<MembershipGroup>, IActiveRecord
	{
		...
		public MembershipGroup(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MembershipGroup(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MembershipGroup(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MembershipGroup", TableType.Table, DataService.GetInstance("PowerPOS"));
				...
				colvarMembershipGroupId.AutoIncrement = true;
				colvarMembershipGroupId.IsNullable = false;
				colvarMembershipGroupId.IsPrimaryKey = true;
				...
				DataService.Providers["PowerPOS"].AddSchema("MembershipGroup",schema);
			}
		}
		#endregion
		...
		{
			return new PowerPOS.MembershipCollection().Where(Membership.Columns.MembershipGroupId, MembershipGroupId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varMembershipGroupId,string varGroupName,double varDiscount,string varCreatedBy,string varModifiedBy,DateTime? varCreatedOn,DateTime? varModifiedOn,bool? varDeleted,string varUserfld1,string varUserfld2,string varUserfld3,string varUserfld4,string varUserfld5,string varUserfld6,string varUserfld7,string varUserfld8,string varUserfld9,string varUserfld10,bool? varUserflag1,bool? varUserflag2,bool? varUserflag3,bool? varUserflag4,bool? varUserflag5,decimal? varUserfloat1,decimal? varUserfloat2,decimal? varUserfloat3,decimal? varUserfloat4,decimal? varUserfloat5,int? varUserint1,int? varUserint2,int? varUserint3,int? varUserint4,int? varUserint5)
		{
			MembershipGroup item = new MembershipGroup();
