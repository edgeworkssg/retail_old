...
namespace PowerPOS{
    /// <summary>
    /// Strongly-typed collection for the ViewDWDailySalesSrc class.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesSrcCollection : ReadOnlyList<ViewDWDailySalesSrc, ViewDWDailySalesSrcCollection>
    {        
        public ViewDWDailySalesSrcCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the viewDW_DailySales_src view.
    /// </summary>
    [Serializable]
    public partial class ViewDWDailySalesSrc : ReadOnlyRecord<ViewDWDailySalesSrc>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("viewDW_DailySales_src", TableType.View, DataService.GetInstance("PowerPOS"));
                ...
                colvarPointSale.IsNullable = false;
                ...
                colvarInstallmentPaymentSale.IsNullable = false;
                ...
                colvarPayByInstallment.IsNullable = false;
                ...
                colvarPayByPoint.IsNullable = false;
                ...
                DataService.Providers["PowerPOS"].AddSchema("viewDW_DailySales_src",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDWDailySalesSrc()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDWDailySalesSrc(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDWDailySalesSrc(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDWDailySalesSrc(string columnName, object columnValue)
        {
            SetSQLProps();
