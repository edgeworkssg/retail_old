...
namespace PowerPOS.EZLink
{
    ...
    /// </summary>
    class EZLinkPurchasePacket : Packet
    {
        ...
        public override byte[] toBytes()
        {
            ...
            byte[] content = generateMessageHeader(EZLinkConstants.MessageHeader.FunctionCode.EZLINK_PURCHASE);
