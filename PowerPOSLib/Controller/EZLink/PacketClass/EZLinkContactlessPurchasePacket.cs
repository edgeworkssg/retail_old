...
namespace PowerPOS.EZLink
{
    ...
    /// </summary>
    class EZLinkContactlessPurchasePacket : Packet
    {
        ...
        public EZLinkContactlessPurchasePacket()
        {
            init();
        }
        ...
        public override byte[] toBytes()
        {
            ...
            byte[] content = generateMessageHeader(EZLinkConstants.MessageHeader.FunctionCode.EZLINK_CONTACTLESSPURCHASE);
