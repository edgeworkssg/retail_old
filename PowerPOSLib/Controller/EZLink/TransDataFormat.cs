...
namespace PowerPOS.EZLink
{
    ...
    class TransDataFormat
    {
        ...
        public TransDataFormat(string data, string cepasVersion)
        {
            ...
            if (cepasVersion.Equals(EZLinkConstants.MessageData.CEPASVersion.CEPAS_1.Value))
            {
                ...
                addKeyValueToDetails(key, dt.ToString(EZLinkConstants.DISPLAY_DATE_FORMAT));
                #endregion
            ...
            else if (cepasVersion.Equals(EZLinkConstants.MessageData.CEPASVersion.CEPAS_2.Value))
            {
