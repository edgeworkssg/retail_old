...
{
	public partial class DateControlMonthly : UserControl
	{
		private DateTime _day = DateTime.Now.Date;
		private string _format = "MMMM";
		...
		{
			_day = day.Date;
			lblDate.Text = _day.ToString("MMMM, yyyy");
			dtpDate.Value = _day;
